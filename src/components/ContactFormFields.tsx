...
const formI18n: Record<string, {
  ...
  de: {
    positions: [
      { value: "propietario", label: "Inhaber/in" },
      { value: "director", label: "F&B-Leitung" },
      { value: "sommelier", label: "Sommelier / Beverage Manager" },
      { value: "jefe-sala", label: "Restaurantleitung" },
      { value: "chef", label: "Küchenchef/in" },
      { value: "responsable-bebidas", label: "Einkaufsleitung" },
      { value: "gerente", label: "Geschäftsführung" },
      { value: "otro", label: "Andere Rolle" },
    ],
    references: [
      { value: "20-40", label: "20–40 Positionen" },
      { value: "40-80", label: "40–80 Positionen" },
      { value: "80-150", label: "80–150 Positionen" },
      { value: "150-300", label: "150–300 Positionen" },
      { value: "300-500", label: "300–500 Positionen" },
      { value: "500+", label: "Mehr als 500 Positionen" },
    ],
    businessTypes: [
      { value: "restaurante-independiente", label: "Unabhängiges Restaurant" },
      { value: "grupo-restauracion", label: "Restaurantgruppe" },
      { value: "hotel", label: "Hotel / Resort" },
      { value: "wine-bar", label: "Weinbar / Vinothek" },
      { value: "catering", label: "Catering / Events" },
      { value: "otro", label: "Andere Geschäftsart" },
    ],
    locations: [
      { value: "1", label: "1 Standort" },
      { value: "2-5", label: "2–5 Standorte" },
      { value: "6-15", label: "6–15 Standorte" },
      { value: "16-50", label: "16–50 Standorte" },
      { value: "50+", label: "Mehr als 50 Standorte" },
    ],
    challenges: [
      { value: "vender-mas-vino", label: "Weinumsatz steigern" },
      { value: "mejorar-margenes", label: "Marge pro Flasche verbessern" },
      { value: "rotacion-stock", label: "Gebundenen Bestand reduzieren / Rotation verbessern" },
      { value: "formar-equipo", label: "Serviceteam im Weinverkauf stärken" },
      { value: "optimizar-carta", label: "Sortiment und Weinkartenstruktur optimieren" },
      { value: "digitalizar-carta", label: "Weinkarte digitalisieren" },
      { value: "gestionar-multi-local", label: "Mehrere Standorte zentral steuern" },
      { value: "otro", label: "Andere Herausforderung" },
    ],
    labels: {
      restaurant: "Name des Restaurants", restaurantPh: "Z. B. Restaurant Weinblick",
      name: "Ihr vollständiger Name", namePh: "Vor- und Nachname",
      position: "Ihre Rolle im Betrieb", positionPh: "Welche Rolle haben Sie?",
      phone: "Telefon",
      email: "Geschäftliche E-Mail", emailPh: "sie@restaurant.de",
      city: "Stadt", cityPh: "Z. B. Berlin",
      references: "Positionen auf der Weinkarte", referencesPh: "Wie viele Positionen haben Sie?",
      businessType: "Art des Betriebs", businessTypePh: "Welche Art von Betrieb ist es?",
      locations: "Verwaltete Standorte", locationsPh: "Wie viele Standorte?",
      challenge: "Was möchten Sie an Ihrer Weinkarte verbessern?", challengePh: "Ihre wichtigste Herausforderung",
    },
  },
  pt: {
    positions: [
      { value: "propietario", label: "Proprietário/a" },
      { value: "director", label: "Diretor/a de F&B" },
      { value: "sommelier", label: "Sommelier / Responsável de bebidas" },
      { value: "jefe-sala", label: "Chefe de sala" },
      { value: "chef", label: "Chef executivo" },
      { value: "responsable-bebidas", label: "Responsável de compras" },
      { value: "gerente", label: "Gerente / Direção geral" },
      { value: "otro", label: "Outra função" },
    ],
    references: [
      { value: "20-40", label: "20–40 referências" },
      { value: "40-80", label: "40–80 referências" },
      { value: "80-150", label: "80–150 referências" },
      { value: "150-300", label: "150–300 referências" },
      { value: "300-500", label: "300–500 referências" },
      { value: "500+", label: "Mais de 500 referências" },
    ],
    businessTypes: [
      { value: "restaurante-independiente", label: "Restaurante independente" },
      { value: "grupo-restauracion", label: "Grupo de restauração" },
      { value: "hotel", label: "Hotel / Resort" },
      { value: "wine-bar", label: "Wine bar / Garrafeira" },
      { value: "catering", label: "Catering / Eventos" },
      { value: "otro", label: "Outro tipo de negócio" },
    ],
    locations: [
      { value: "1", label: "1 unidade" },
      { value: "2-5", label: "2–5 unidades" },
      { value: "6-15", label: "6–15 unidades" },
      { value: "16-50", label: "16–50 unidades" },
      { value: "50+", label: "Mais de 50 unidades" },
    ],
    challenges: [
      { value: "vender-mas-vino", label: "Aumentar vendas de vinho" },
      { value: "mejorar-margenes", label: "Melhorar margens por garrafa" },
      { value: "rotacion-stock", label: "Reduzir stock parado / melhorar rotação" },
      { value: "formar-equipo", label: "Formar a equipa de sala em vinho" },
      { value: "optimizar-carta", label: "Otimizar sortido e estrutura da carta" },
      { value: "digitalizar-carta", label: "Digitalizar a carta de vinhos" },
      { value: "gestionar-multi-local", label: "Centralizar gestão de várias unidades" },
      { value: "otro", label: "Outro desafio" },
    ],
    labels: {
      restaurant: "Nome do restaurante", restaurantPh: "Ex. Restaurante A Vinha",
      name: "O seu nome completo", namePh: "Nome e apelidos",
      position: "A sua função no negócio", positionPh: "Qual é a sua função?",
      phone: "Telefone",
      email: "Email profissional", emailPh: "voce@restaurante.pt",
      city: "Cidade", cityPh: "Ex. Lisboa",
      references: "Referências na carta", referencesPh: "Quantas referências tem?",
      businessType: "Tipo de estabelecimento", businessTypePh: "Que tipo de negócio é?",
      locations: "Unidades que gere", locationsPh: "Quantas unidades?",
      challenge: "O que quer melhorar na sua carta?", challengePh: "O seu principal desafio agora",
    },
  },
};

      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ¿Por qué necesitas Winerim?
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            ¿Alguna vez has tenido problemas gestionando aspectos de tu bodega?
            Winerim es la solución.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {features.map((feat, i) => (
            ...
            >
              <feat.icon
                size={28}
                className="text-wine mb-4 group-hover:text-wine-light transition-colors"
              />

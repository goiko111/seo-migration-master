...
const Footer = () => {
  ...
  const termsHref = lang === "es" ? "/terminos-y-condiciones-del-contrato" : localePath("/terminos");
  const coreLabel = ({ es: "Winerim Core · Carta y bodega", en: "Winerim Core · List and cellar", fr: "Winerim Core · Carte et cave", it: "Winerim Core · Carta e cantina", de: "Winerim Core · Karte und Keller", pt: "Winerim Core · Carta e garrafeira" } as const)[lang];
  const marginsLabel = ({ es: "Márgenes y pricing", en: "Margins and pricing", fr: "Marges et pricing", it: "Margini e pricing", de: "Margen und Pricing", pt: "Margens e pricing" } as const)[lang];
          ...
          <ScrollReveal delay={0.05} className="lg:col-span-2">
            ...
            <FooterLinks
              items={[
                ...
                { label: coreLabel, href: localePath("/producto/winerim-core") },
                { label: marginsLabel, href: localePath("/producto/winerim-core#core-margins") },
                ...
                ...(lang === "es" ? [{ label: "Precios módulos e integraciones", href: "/precios-modulos-integraciones" }] : []),
          ...
          <ScrollReveal delay={0.2} className="lg:col-span-1">
            ...
            <FooterLinks
              items={[
                ...
                { label: t.footer_privacy, href: privacyHref },
                { label: t.footer_terms, href: termsHref },
              ]}
            />
          </ScrollReveal>
        </div>

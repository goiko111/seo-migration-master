          ...
          <ScrollReveal delay={0.2} className="lg:col-span-1">
            ...
            <FooterLinks
              items={[
                ...
                { label: t.footer_distributors ?? ({ es: "Distribuidores", en: "Distributors", it: "Distributori", fr: "Distributeurs", de: "Distributoren", pt: "Distribuidores" } as Record<string, string>)[lang] ?? "Distributors", href: localePath("/distribuidor") },

...
const T: Record<Lang, any> = {
  es: {
    ...
    title: "Descubre cuánto margen pierde tu carta de vinos",
    subtitle: "Envía tu carta en 30 segundos. Recibe un diagnóstico inicial al instante y un informe personalizado en menos de 48 h.",
    proof: "Más de 500 cartas analizadas · Sin compromiso",
    ...
    fileHint: "Máx. 10 MB",
    cta: "Enviar carta para análisis",
    ...
    unlocking: "Generando…",
    successTitle: "¡Desbloqueo completado!",
    successText: "Tu informe ya está disponible:",
    openReport: "Abrir informe completo",
    captureText: "Te contactaremos en menos de 48h con tu informe personalizado.",
  ...
  en: {
    ...
    title: "Discover how much margin your wine list is losing",
    subtitle: "Submit your list in 30 seconds. Get an instant diagnosis and a personalised report within 48h.",
    proof: "500+ wine lists analysed · No commitment",
    ...
    fileHint: "Max 10 MB",
    cta: "Submit wine list for analysis",
    analyzing: "Analysing…",
    ...
    successText: "Your full report is now available:",
    openReport: "Open full report",
    captureText: "We'll contact you within 48h with your personalised report.",
  ...
  fr: {
    ...
    title: "Découvrez combien de marge votre carte des vins perd",
    subtitle: "Envoyez votre carte en 30 secondes. Recevez un diagnostic immédiat et un rapport personnalisé en moins de 48 h.",
    proof: "Plus de 500 cartes analysées · Sans engagement",
    ...
    fileHint: "Max 10 Mo",
    cta: "Envoyer la carte pour analyse",
    ...
    successTitle: "Débloqué !",
    successText: "Votre rapport complet est disponible :",
    openReport: "Ouvrir le rapport complet",
    captureText: "Nous vous contacterons sous 48h avec votre rapport personnalisé.",
  ...
  de: {
    ...
    title: "Entdecken Sie, wie viel Marge Ihre Weinkarte verliert",
    subtitle: "Senden Sie Ihre Karte in 30 Sekunden. Erhalten Sie sofort eine Diagnose und in weniger als 48 Std. einen persönlichen Bericht.",
    proof: "Über 500 Weinkarten analysiert · Unverbindlich",
    ...
    fileHint: "Max. 10 MB",
    cta: "Weinkarte zur Analyse senden",
    ...
    successTitle: "Freigeschaltet!",
    successText: "Ihr vollständiger Bericht ist verfügbar:",
    openReport: "Vollständigen Bericht öffnen",
    captureText: "Wir melden uns innerhalb von 48 Std. mit Ihrem personalisierten Bericht.",
  ...
  it: {
    ...
    title: "Scopri quanto margine perde la tua carta dei vini",
    subtitle: "Invia la tua carta in 30 secondi. Ricevi una diagnosi immediata e un report personalizzato in meno di 48 h.",
    proof: "Oltre 500 carte analizzate · Senza impegno",
    ...
    successTitle: "Sbloccato!",
    successText: "Il tuo report completo è disponibile:",
    openReport: "Apri report completo",
    captureText: "Ti contatteremo entro 48h con il report personalizzato.",
  ...
  pt: {
    ...
    title: "Descubra quanta margem a sua carta de vinhos está a perder",
    subtitle: "Envie a sua carta em 30 segundos. Receba um diagnóstico imediato e um relatório personalizado em menos de 48 h.",
    proof: "Mais de 500 cartas analisadas · Sem compromisso",
    ...
    unlocking: "A gerar…",
    successTitle: "Desbloqueado!",
    successText: "O seu relatório completo está disponível:",
    openReport: "Abrir relatório completo",
    captureText: "Contactaremos em menos de 48h com o seu relatório personalizado.",
    ...
    <section id="analizador" className="relative py-16 md:py-24 bg-gradient-to-b from-background to-secondary/20">
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-heading text-3xl md:text-5xl font-bold mb-4">{t.title}</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">{t.subtitle}</p>
          <p className="mt-4 text-xs font-semibold uppercase tracking-[0.22em] text-muted-foreground/70">{t.proof}</p>
        </div>

...
const copy: I18nMap<SAViaCopy> = {
  es: {
    ...
    seoDesc:
      "SAVia es el agente conversacional de Winerim. Consulta carta, ventas, stock, costes, margenes, facturas, albaranes y RIMs; explica lo que ocurre y prepara acciones sin ejecutar cambios criticos sin aprobacion humana.",
    breadcrumbProduct: "Producto",
    breadcrumbCurrent: "SAVia",
    badge: "SAVIA",
    h1: "Pregunta a tu bodega. SAVia responde con datos de Winerim.",
    subtitle:
      "SAVia es el agente conversacional de Winerim. Entiende tu carta, ventas, stock, albaranes, facturas, costes, margenes y RIMs para ayudarte a decidir sin perderte en dashboards.",
    primaryCta: "Ver SAVia en una demo",
    secondaryCta: "Conocer CloudRIM",
    heroNote: "Consulta, explica, prepara y hace preview. No ejecuta cambios criticos sin aprobacion humana.",
    ...
    examples: [
      ...
      "Que factura no cuadra con su albaran?",
      "Que RIM deberiamos revisar y que impacto tendria antes de aprobarlo?",
      "Que esta pasando con las ventas de vino por copa?",
    ],
    securityTitle: "SAVia prepara. El equipo decide.",
    securityText:
      "SAVia puede consultar, explicar, resumir, preparar acciones y mostrar preview de impacto. No cambia stock, PVP, costes, no confirma albaranes o facturas ni aplica RIMs por su cuenta: el equipo revisa, aprueba y ejecuta desde Winerim.",
    ...
    benefits: [
      ...
      { title: "Previews antes de aprobar", desc: "Puede dejar cambios listos y mostrar su impacto antes de que el equipo decida ejecutarlos." },
    ...
    decisionText:
      "Carta, ventas, stock, costes, albaranes, facturas, margenes, documentos procesados por CloudRIM y RIMs forman la base para responder con contexto operativo real.",
    ...
    faqs: [
      ...
      { q: "Puede cambiar precios o aplicar acciones sola?", a: "No. Las acciones criticas no se ejecutan sin aprobacion humana. SAVia puede preparar recomendaciones y previews, pero el equipo confirma cambios de precio, stock, costes, albaranes, facturas, RIMs o cambios de carta." },
      { q: "De donde salen las respuestas?", a: "De los datos de Winerim: carta, ventas, stock, costes, albaranes, facturas, margenes, RIMs y documentos procesados por CloudRIM." },
    ],
    related: [
  ...
  en: {
    ...
    seoDesc:
      "SAVia is Winerim's conversational agent. Ask about list, sales, stock, costs, margins, invoices, delivery notes and RIMs; it explains what is happening and prepares actions without executing critical changes without human approval.",
    breadcrumbProduct: "Product",
    breadcrumbCurrent: "SAVia",
    badge: "SAVIA",
    h1: "Ask your cellar. SAVia answers with Winerim data.",
    subtitle:
      "SAVia is Winerim's conversational agent. It understands your wine list, sales, stock, delivery notes, invoices, costs, margins and RIMs so you can make better decisions without getting lost in dashboards.",
    primaryCta: "See SAVia in a demo",
    secondaryCta: "Meet CloudRIM",
    heroNote: "It consults, explains, prepares and previews. It does not execute critical changes without human approval.",
    ...
    examples: [
      ...
      "Which invoice does not match its delivery note?",
      "Which RIM should we review and what would its impact be before approval?",
      "What is happening with wine-by-the-glass sales?",
    ],
    securityTitle: "SAVia prepares. The team decides.",
    securityText: "SAVia can consult, explain, summarize, prepare actions and preview impact. It does not change stock, prices or costs, confirm delivery notes or invoices, or apply RIMs on its own: the team reviews, approves and executes inside Winerim.",
    ...
    benefits: [
      ...
      { title: "Previews before approval", desc: "Can leave changes ready and show their impact before the team decides to execute them." },
    ...
    decisionText: "Wine list, sales, stock, costs, delivery notes, invoices, margins, CloudRIM-processed documents and RIMs become the basis for answers with real operating context.",
    ...
    faqs: [
      ...
      { q: "Can it change prices or execute actions alone?", a: "No. Critical actions are not executed without human approval. SAVia can prepare recommendations and previews, but the team confirms price, stock, cost, delivery note, invoice, RIM or list changes." },
      { q: "Where do answers come from?", a: "From Winerim data: list, sales, stock, costs, delivery notes, invoices, margins, RIMs and CloudRIM-processed documents." },
    ],
    related: [
  ...
  it: {
    ...
    subtitle: "SAVia capisce carta, vendite, stock, documenti, fatture, costi, margini e RIM per aiutarti a decidere senza perderti nei dashboard.",
    ...
    securityText: "SAVia consulta, spiega, riassume e prepara azioni con preview. Prezzi, stock, costi, conferme documenti/fatture, modifiche carta e RIM restano sotto controllo umano.",
    ...
    decisionText: "Carta, vendite, stock, costi, documenti, fatture, margini, RIM e dati CloudRIM diventano la base per risposte operative.",
  ...
  fr: {
    ...
    subtitle: "SAVia comprend carte, ventes, stock, bons, factures, couts, marges et RIM pour aider a decider sans se perdre dans les dashboards.",
    ...
    securityText: "SAVia peut consulter, expliquer, resumer, preparer et previsualiser. Prix, stock, couts, bons, factures, changements de carte et RIM restent sous controle humain et auditable.",
    ...
    decisionText: "Carte, ventes, stock, couts, bons, factures, marges, RIM et documents CloudRIM alimentent ses reponses.",
  ...
  de: {
    ...
    subtitle: "SAVia versteht Weinkarte, Verkauf, Bestand, Lieferscheine, Rechnungen, Kosten, Margen und RIMs, damit Entscheidungen ohne Dashboard-Suche klarer werden.",
    ...
    securityText: "SAVia kann abfragen, erklaeren, zusammenfassen, vorbereiten und Auswirkungen vorab zeigen. Preis-, Bestands-, Kosten-, Lieferschein-, Rechnungs-, Karten- und RIM-Entscheidungen bleiben menschlich kontrolliert.",
    ...
    decisionText: "Karte, Verkauf, Bestand, Kosten, Lieferscheine, Rechnungen, Margen, RIMs und CloudRIM-Dokumente bilden die Antwortbasis.",
  ...
  pt: {
    ...
    subtitle: "SAVia entende carta, vendas, stock, guias, faturas, custos, margens e RIMs para ajudar a decidir sem se perder em dashboards.",
    primaryCta: "Ver SAVia numa demo",
    secondaryCta: "Conhecer CloudRIM",
    heroNote: "Consulta, explica, prepara e mostra preview. Nao executa mudancas criticas sem aprovacao humana.",
    ...
    securityText: "SAVia consulta, explica, resume, prepara acoes e mostra preview de impacto. Precos, stock, custos, guias, faturas, mudancas de carta e RIMs ficam sob controlo humano e auditavel.",
    ...
    decisionText: "Carta, vendas, stock, custos, guias, faturas, margens, RIMs e documentos CloudRIM formam a base das respostas.",

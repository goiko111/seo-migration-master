...
const i18n: I18nMap<CoreI18n> = {
  es: {
    ...
    capabilities: [
      ...
      { title: "Compras y reposición", desc: "Conecta consumo, rentabilidad, stock, albaranes, facturas y tarifas para decidir mejor qué reponer, qué renegociar y qué no." },
    ...
    bridge_desc: "Winerim Core genera los diagnósticos y las recomendaciones. La capa de Inteligencia Dinámica los convierte en acciones sobre la carta en tiempo real; cuando afectan a costes, stock, PVP o cambios críticos, SAVia puede explicar el preview y el equipo aprueba desde Winerim.",
    bridge_flow: [
      ...
      "Core identifica que una factura cambia el coste real de varias copas",
      "SAVia prepara el preview y el equipo aprueba antes de tocar PVP, margen o RIMs",
    ],
  ...
  en: {
    ...
    capabilities: [
      ...
      { title: "Purchasing & replenishment", desc: "Connect consumption, profitability, stock, delivery notes, invoices and tariffs to decide what to reorder, renegotiate or stop buying." },
    ...
    bridge_desc: "Winerim Core generates diagnostics and recommendations. Dynamic Intelligence converts them into real-time list actions; when costs, stock, prices or critical changes are involved, SAVia can explain the preview and the team approves inside Winerim.",
    bridge_flow: [
      ...
      "Core detects that an invoice changes the real cost of several by-the-glass wines",
      "SAVia prepares the preview and the team approves before prices, margins or RIMs change",
    ],
  ...
  de: {
    ...
    what_pillars: [
      ...
      { label: "Empfiehlt", desc: "Schlägt priorisierte, simulierbare und ergebnisorientierte Maßnahmen vor." },
    ],

    cap_eyebrow: "Geschäftsfähigkeiten",
    cap_title: "Eine tiefe analytische Schicht, um ",
    cap_title_hl: "besser zu entscheiden",
    cap_subtitle: "Winerim Core bündelt die Intelligenz des Produkts in Fähigkeiten, die dabei helfen, das gesamte Weingeschäft besser zu steuern.",
    capabilities: [
      { title: "Pricing und Rentabilität", desc: "Berechnet, vergleicht und justiert Preise mit mehr Kriterium, um Marge und wirtschaftliche Kohärenz zu schützen." },
      { title: "Bestand und Rotation", desc: "Erkennt langsame Referenzen, gebundenes Kapital, Überbestände und Chancen zur Aktivierung oder Listung." },
      { title: "Einkauf und Nachbestellung", desc: "Verbindet Absatz, Rentabilität und Bestandsentwicklung, um besser zu entscheiden, was nachbestellt wird und was nicht." },
      { title: "Benchmark und Vergleich", desc: "Ermöglicht es, Mix, Preise, Margen und Kartenzustand mit anderen Restaurants oder zwischen Filialen zu vergleichen." },
      { title: "Simulation und Entscheidung", desc: "Erlaubt Szenarien zu testen, bevor Änderungen bei Preis, Sortiment oder Kartenstruktur umgesetzt werden." },
      { title: "Gesundheit und Architektur der Karte", desc: "Bewertet Balance, Preistreppe, Sortimentstiefe und kommerzielle Klarheit der Karte." },
    ],

    depth_title: "Echte analytische Tiefe, keine isolierten Features",
    depth_text: "Jede Fähigkeit von Winerim Core wird von einem Netzwerk aus vernetzten analytischen Modulen – mehr als 26 – gestützt, die Daten aus Pricing, Marge, Bestand, Rentabilität, Einkauf, Simulation, Architektur und Benchmark kombinieren.",
    depth_text2: "Sie müssen sie nicht als Einzelwerkzeuge sehen. Was zählt: Sie arbeiten zusammen, damit jede Entscheidung zu Ihrer Karte mit mehr Kontext und Kriterium fällt.",
    depth_micro: "Einige öffentliche Winerim-Tools sind vereinfachte Demos dieser analytischen Schicht.",

    tools_title: "Sichtbare Tools. Tieferer Motor.",
    tools_subtitle: "Einige öffentliche Winerim-Rechner und -Ressourcen zeigen einen Teil der Winerim-Core-Logik in vereinfachter Form.",
    tools_connections: [
      { tool: "Margen-Rechner", link: "/herramientas/calculadora-margen", core_label: "Vereinfachte Demo von Pricing und Rentabilität" },
      { tool: "Preisrechner pro Glas", link: "/herramientas/calculadora-precio-copa", core_label: "Vereinfachte Demo der Glas-Logik" },
      { tool: "Rechner toter Bestand", link: "/herramientas/calculadora-stock-muerto", core_label: "Vereinfachte Demo von gebundenem Kapital und Rotation" },
      { tool: "Durchschnittsbon-Rechner", link: "/herramientas/calculadora-ticket-medio", core_label: "Vereinfachte Demo von Mix und Durchdringung" },
      { tool: "Smart-Purchase-Rechner", link: "/herramientas/calculadora-compra-inteligente", core_label: "Vereinfachte Demo von Winerim Supply, verbunden mit Core" },
    ],
    tools_closing: "Tools helfen, einen Teil zu verstehen. Winerim Core verbindet alle Teile.",
    tools_cta: "Kostenlose Tools entdecken",

    bridge_eyebrow: "Core + Dynamic Intelligence",
    bridge_title: "Core analysiert. Dynamic Intelligence ",
    bridge_title_hl: "handelt.",
    bridge_desc: "Winerim Core erstellt Diagnosen und Empfehlungen. Die Dynamic-Intelligence-Schicht verwandelt sie in automatische Aktionen auf der Karte in Echtzeit: sie sortiert um, hebt hervor, blendet aus und passt Referenzen an Kontext, Bestand, Marge und Geschäftsziele an.",
    bridge_flow: [
      "Core erkennt, dass eine Referenz seit 3 Wochen nicht verkauft wurde",
      "Dynamic Intelligence stuft sie herab oder schlägt dem Gast eine Alternative vor",
      "Core identifiziert eine niedrige Durchschnittsmarge pro Glas",
      "Dynamic Intelligence priorisiert die Gläser mit bestem Beitrag",
    ],
    bridge_cta: "Dynamic Intelligence entdecken",

    final_eyebrow: "Bereit, Entscheidungen datenbasiert zu treffen?",
    final_title: "Fordern Sie eine Demo an und sehen Sie, was Winerim Core ",
    final_title_hl: "für Ihre Karte tun kann",
    final_desc: "Wir zeigen Ihnen, wie Winerim Core Ihre echte Karte analysiert, erkennt, was nicht funktioniert, und einen konkreten, ergebnisorientierten Aktionsplan erstellt.",
    final_cta: "Demo von Winerim Core anfordern",
    ...
    links: [
      { to: "/producto/inteligencia-dinamica", label: "Dynamic Intelligence: die taktische KI-Schicht", type: "solution" },
      { to: "/producto/winerim-supply", label: "Winerim Supply: Einkaufsintelligenz", type: "solution" },
      { to: "/funcionalidades", label: "Alle Winerim-Funktionen", type: "resource" },
      { to: "/herramientas", label: "Kostenlose Analyse-Tools", type: "tool" },
      { to: "/recursos/scorecard-rendimiento-carta", label: "Monatliche Karten-Scorecard", type: "resource" },
  ...
  pt: {
    ...
    what_pillars: [
      ...
      { label: "Recomenda", desc: "Propõe ações priorizadas, simuláveis e orientadas a resultado." },
    ],

    cap_eyebrow: "Capacidades de negócio",
    cap_title: "Uma camada analítica profunda para ",
    cap_title_hl: "decidir melhor",
    cap_subtitle: "O Winerim Core agrupa a inteligência do produto em capacidades que ajudam a gerir melhor todo o negócio do vinho.",
    capabilities: [
      { title: "Pricing e rentabilidade", desc: "Calcula, compara e ajusta preços com mais critério para proteger margem e coerência económica." },
      { title: "Stock e rotação", desc: "Deteta referências lentas, capital imobilizado, sobrestock e oportunidades de ativação ou descontinuação." },
      { title: "Compras e reposição", desc: "Liga consumo, rentabilidade e evolução de stock para decidir melhor o que repor e o que não." },
      { title: "Benchmark e comparação", desc: "Permite comparar mix, preços, margens e saúde de carta face a outros restaurantes ou entre unidades." },
      { title: "Simulação e decisão", desc: "Ajuda a testar cenários antes de executar alterações de pricing, sortido ou estrutura de carta." },
      { title: "Saúde e arquitetura da carta", desc: "Avalia equilíbrio, escada de preços, profundidade de oferta e clareza comercial da carta." },
    ],

    depth_title: "Profundidade analítica real, não features soltas",
    depth_text: "Cada capacidade do Winerim Core está suportada por uma rede de módulos analíticos interligados — mais de 26 — que cruzam dados de pricing, margem, stock, rentabilidade, compras, simulação, arquitetura e benchmark.",
    depth_text2: "Não precisa de os ver como ferramentas isoladas. O que importa é que trabalham em conjunto para que cada decisão sobre a sua carta seja tomada com mais contexto e mais critério.",
    depth_micro: "Algumas ferramentas públicas da Winerim são demos simplificadas desta camada analítica.",

    tools_title: "Ferramentas visíveis. Motor mais profundo.",
    tools_subtitle: "Algumas calculadoras e recursos públicos da Winerim mostram parte da lógica do Winerim Core em formato simplificado.",
    tools_connections: [
      { tool: "Calculadora de Margens", link: "/herramientas/calculadora-margen", core_label: "Demo simplificada de pricing e rentabilidade" },
      { tool: "Calculadora de Preço a Copo", link: "/herramientas/calculadora-precio-copa", core_label: "Demo simplificada de lógica a copo" },
      { tool: "Calculadora de Stock Parado", link: "/herramientas/calculadora-stock-muerto", core_label: "Demo simplificada de capital imobilizado e rotação" },
      { tool: "Calculadora de Ticket Médio", link: "/herramientas/calculadora-ticket-medio", core_label: "Demo simplificada de mix e penetração" },
      { tool: "Calculadora de Compra Inteligente", link: "/herramientas/calculadora-compra-inteligente", core_label: "Demo simplificada da Winerim Supply ligada ao Core" },
    ],
    tools_closing: "As ferramentas ajudam a perceber uma parte. O Winerim Core liga todas as peças.",
    tools_cta: "Explorar ferramentas gratuitas",

    bridge_eyebrow: "Core + Inteligência Dinâmica",
    bridge_title: "O Core analisa. A Inteligência Dinâmica ",
    bridge_title_hl: "atua.",
    bridge_desc: "O Winerim Core gera os diagnósticos e as recomendações. A camada de Inteligência Dinâmica transforma-os em ações automáticas sobre a carta em tempo real: reordena, destaca, oculta e adapta referências consoante contexto, stock, margem e objetivos de negócio.",
    bridge_flow: [
      "O Core deteta que uma referência há 3 semanas não vende",
      "A Inteligência Dinâmica baixa-a de posição ou sugere uma alternativa ao cliente",
      "O Core identifica que a margem média por copo é baixa",
      "A Inteligência Dinâmica prioriza os copos com melhor contribuição",
    ],
    bridge_cta: "Descobrir a Inteligência Dinâmica",

    final_eyebrow: "Pronto para decidir com dados?",
    final_title: "Peça uma demo e descubra o que o Winerim Core pode fazer ",
    final_title_hl: "pela sua carta",
    final_desc: "Mostramos-lhe como o Winerim Core analisa a sua carta real, deteta o que não funciona e gera um plano de ação concreto orientado a resultados.",
    final_cta: "Pedir demo do Winerim Core",
    ...
    links: [
      { to: "/producto/inteligencia-dinamica", label: "Inteligência Dinâmica: a camada de IA tática", type: "solution" },
      { to: "/producto/winerim-supply", label: "Winerim Supply: inteligência de compras", type: "solution" },
      { to: "/funcionalidades", label: "Todas as funcionalidades da Winerim", type: "resource" },
      { to: "/herramientas", label: "Ferramentas gratuitas de análise", type: "tool" },
      { to: "/recursos/scorecard-rendimiento-carta", label: "Scorecard mensal da carta", type: "resource" },
      ...
      { to: "/demo", label: "Pedir demo personalizada", type: "solution" },
    ],
  },
};

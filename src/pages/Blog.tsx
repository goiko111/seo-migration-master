...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Desde la carta hasta el trato en sala, cada detalle cuenta. Te explicamos cómo identificar los momentos clave del servicio y qué ajustes puedes aplicar.",
    image: "https://winerim.wine/wp-content/uploads/2025/08/experiencia-cliente-restaurante-01-1024x1024.jpg",
    category: "Estrategia",
    slug: "#",
  },
  {
    title: "\"Que apuesten por pequeñas bodegas, D.O y zonas vitivinícolas desconocidas, que hay auténticas joyas\"",
  ...
  },
  {
    ...
    excerpt: "Cada vez más restaurantes usan inteligencia artificial para automatizar procesos, personalizar recomendaciones y aumentar sus ventas.",
    image: "https://winerim.wine/wp-content/uploads/2025/07/Iia-para-restaurantes-las-mejores-aplicaciones-01-1024x1024.jpg",
    category: "Tecnología",
    slug: "#",
  },
  {
    title: "\"No os quedéis en el primer sorbo y probad el mismo vino en momentos distintos\"",
    excerpt: "Entrevista al sommelier Simone Monese: sostenibilidad, maridajes con alma y el vino como experiencia sensorial.",
  ...
  },
  {
    ...
    excerpt: "Desglosamos los factores que determinan cómo diseñar una carta de vinos perfecta para tu restaurante y que aumente tus ventas.",
  ...
  },
  {
    ...
    excerpt: "Analizamos los motivos y cómo aplicar un simple cambio puede atraer de nuevo a las nuevas generaciones hacia el vino.",

...
import mockupImg from "@/assets/winerim-tablet-hero.webp";
...
const de: WLT = {
  seoTitle: "Weinkarten-Software für Restaurants | Winerim",
  seoDesc: "Verwalten Sie Ihre Weinkarte, optimieren Sie Ihren Weinkeller und steigern Sie Weinverkäufe mit intelligenter Software für Gastronomie.",
  seoUrl: "https://winerim.wine/de/weinkarten-software",
  badge: "Weinkarten-Software",
  heroTitle1: "Weinkarten-Software für ",
  heroHighlight: "Restaurants",
  heroDesc: "Verwalten Sie Ihre Weinkarte, optimieren Sie Ihren Weinkeller und steigern Sie Weinverkäufe mit einer intelligenten Plattform für Gastronomie.",
  ctaDemo: "Demo anfragen", ctaAnalyse: "Meine Weinkarte analysieren",
  problemLabel: "Das Problem",
  problemTitle1: "Statische Weinkarten ", problemHighlight: "kosten Sie Verkäufe",
  problemIntro: "Die meisten Restaurants verlassen sich noch auf Papier- oder PDF-Weinkarten, die schwer zu navigieren, unmöglich anzupassen sind und dem Gast nicht helfen, mehr zu wählen oder zu ausgeben.",
  problems: [
    "Weinkarten, die schwer zu verstehen sind",
    "Fehlende Empfehlungen für Gäste",
    "Schlechte Preisstruktur",
    "Schwierigkeit, Referenzen zu aktualisieren",
    "Keine Analytik oder Verkaufsdaten",
  ],
  solutionLabel: "Die Lösung",
  solutionTitle1: "Was ist Weinkarten-",
  solutionHighlight: "verwaltungssoftware",
  solutionIntro: "Eine spezialisierte Plattform, die verändert, wie Restaurants Wein verwalten, präsentieren und verkaufen.",
  capabilities: [
    "Alle Weinreferenzen an einem Ort verwalten",
    "Die Weinkarte mit klaren Kategorien organisieren",
    "Weine anhand von Gastpräferenzen empfehlen",
    "Speisen- und Weinpaarungen sofort anzeigen",
    "Das Gasterlebnis an der Tafel verbessern",
    "Verkaufsdaten analysieren, um Ihren Weinkeller zu optimieren",
  ],
  featuresLabel: "Funktionen",
  featuresTitle1: "Wichtigste Funktionen moderner ",
  featuresHighlight: "Weinkarten-Software",
  features: [
    { title: "Digitale Weinkarte", desc: "Eine schöne, interaktive Weinkarte, die auf jedem Gerät zugänglich ist. Immer aktuell, einfach zu navigieren und zum Verkaufen entworfen." },
    { title: "Intelligente Filter", desc: "Gäste filtern nach Traube, Region, Stil oder Preis. Sie finden den perfekten Wein in Sekunden statt durch Seiten zu blättern." },
    { title: "Speisen- und Weinpaarungsvorschläge", desc: "Automatische Paarungsempfehlungen, die Weine mit Gerichten in Ihrem Menü verbinden und Gästen selbstbewusste Entscheidungen ermöglichen." },
    { title: "Weinergleichswerkzeuge", desc: "Nebeneinander-Weinvergleiche mit Verkostungsnotizen, Herkunft und Preis, damit Gäste Optionen klar evaluieren können." },
    { title: "Interaktive Beschreibungen", desc: "Klare Verkostungsnotizen, Produzentensegeschichten und visuelle Profile machen jeden Wein zugänglich — kein Sommelier erforderlich." },
    { title: "Empfehlungsmotor", desc: "KI-gestützte Vorschläge basierend auf Gastpräferenzen, gewählten Gerichten und Kontext, um durchschnittliche Ausgaben zu erhöhen." },
  ],
  benefitsLabel: "Vorteile",
  benefitsTitle1: "Warum Restaurants ",
  benefitsHighlight: "Weinkarten-Software wählen",
  benefits: [
    "Weinverkäufe steigern",
    "Weinkarten-Rotation verbessern",
    "Personal bei Weinempfehlungen helfen",
    "Gasterlebnis verbessern",
    "Wein leichter verständlich machen",
  ],
  resultsLabel: "Ergebnisse",
  resultsTitle1: "Echte Auswirkungen auf ",
  resultsHighlight: "Weineinnahmen",
  resultsIntro: "Restaurants, die intelligente Weinkarten-Plattformen nutzen, berichten konsistent über messbare Verbesserungen.",
  resultItems: [
    { label: "Höhere Weinverkäufe", desc: "Gezielte Empfehlungen und klare Beschreibungen helfen Gästen, vertrauensvoll zu wählen und mehr auszugeben." },
    { label: "Bessere Margen", desc: "Strategische Preistransparenz und intelligente Positionierung bewegen Gäste natürlicherweise zu höherwertigen Weinen." },
    { label: "Effizientes Weinkeller-Management", desc: "Echtzeit-Daten zeigen, was verkauft wird, was nicht, und wo die Lücken sind — hilfreich für Kaufentscheidungen." },
  ],
  resultStats: [
    { value: "+22%", label: "Durchschnittlicher Ticketertrag steigt" },
    { value: "+35%", label: "Weinbestellungswachstum" },
    { value: "3×", label: "Schnellere Listenaktualisierungen" },
    { value: "90%", label: "Personalvertrauen" },
  ],
  compLabel: "Vergleich",
  compTitle1: "Warum digitale Weinkarten die ",
  compHighlight: "Zukunft sind",
  compIntro: "Sehen Sie, wie intelligente Weinkarten-Software sich gegen traditionelle Formate vergleicht.",
  compHeaders: ["Funktion", "Papier", "PDF", "Digital"],
  compRows: [
    { feature: "Leicht zu aktualisieren", paper: false, pdf: "partial" as const, digital: true },
    { feature: "Interaktive Filter", paper: false, pdf: false, digital: true },
    { feature: "Speisen-Paarungen", paper: false, pdf: false, digital: true },
    { feature: "Weinempfehlungen", paper: false, pdf: false, digital: true },
    { feature: "Verkaufs-Analytik", paper: false, pdf: false, digital: true },
    { feature: "Gastfreundliches Design", paper: false, pdf: "partial" as const, digital: true },
    { feature: "Immer aktuell", paper: false, pdf: "partial" as const, digital: true },
    { feature: "Mobil-freundlich", paper: false, pdf: "partial" as const, digital: true },
  ],
  ctaLabel: "Jetzt anfangen",
  ctaTitle1: "Verwandeln Sie Ihre Weinkarte in ein System, das ",
  ctaHighlight: "mehr Wein verkauft",
  ctaDesc: "Sehen Sie, wie Winerim Ihr Weinprogramm verändern kann. Demo anfragen und das Potenzial Ihrer Weinkarte entdecken.",
  ctaDemoBtn: "Demo anfragen", ctaContactBtn: "Kontaktieren Sie uns",
  faqItems: [
    { q: "Was ist Weinkarten-Verwaltungssoftware?", a: "Weinkarten-Verwaltungssoftware ist eine spezialisierte Plattform, die Restaurants hilft, ihre Weinkarten zu digitalisieren, zu organisieren und zu optimieren. Sie enthält intelligente Filter, Speisen-Paarungsvorschläge und Verkaufs-Analytik, um Weineinnahmen zu erhöhen." },
    { q: "Wie erhöht digitale Weinkarten-Software Weinverkäufe?", a: "Digitale Weinkarten-Software erhöht Verkäufe, indem Weine durch Filter und Empfehlungen leichter zu entdecken sind, Speisen-Paarungen Bestellungen anregen und klare Beschreibungen Gästen helfen, vertrauensvoll zu wählen." },
    { q: "Welche Vorteile hat eine digitale Weinkarte gegenüber Papier oder PDF?", a: "Digitale Weinkarten sind immer aktuell, bieten interaktive Funktionen wie Filter und Paarungen, liefern Verkaufs-Analytik, funktionieren auf jedem Gerät und helfen aktiv durch intelligente Empfehlungen zu verkaufen — im Gegensatz zu statischen Papier- oder PDF-Listen." },
  ],
  hreflang: [
    { lang: "es", url: "https://winerim.wine/software-carta-de-vinos" },
    { lang: "en", url: "https://winerim.wine/wine-list-management-software" },
    { lang: "it", url: "https://winerim.wine/it/software-carta-vini" },
    { lang: "fr", url: "https://winerim.wine/fr/logiciel-carte-des-vins" },
    { lang: "de", url: "https://winerim.wine/de/weinkarten-software" },
  ],
};

const pt: WLT = {
  seoTitle: "Software para Carta de Vinhos em Restaurantes | Winerim",
  seoDesc: "Gira a sua carta de vinhos, otimize a garrafeira e aumente as vendas de vinho com software inteligente pensado para restauração.",
  seoUrl: "https://winerim.wine/pt/software-carta-de-vinhos",
  badge: "Software de carta de vinhos",
  heroTitle1: "Software para ",
  heroHighlight: "carta de vinhos",
  heroDesc: "Gira a sua carta, otimize a garrafeira e aumente as vendas de vinho com uma plataforma pensada para restauração.",
  ctaDemo: "Pedir demo", ctaAnalyse: "Analisar a minha carta",
  problemLabel: "O problema",
  problemTitle1: "As cartas estáticas estão-lhe a ",
  problemHighlight: "custar vendas",
  problemIntro: "A maioria dos restaurantes continua a depender de cartas em papel ou PDF difíceis de navegar, impossíveis de personalizar e que não ajudam o cliente a escolher — ou a gastar mais.",
  problems: [
    "Cartas de vinhos difíceis de perceber",
    "Falta de recomendações para o cliente",
    "Estrutura de preços deficiente",
    "Difícil atualizar referências",
    "Sem analítica ou dados de vendas",
  ],
  solutionLabel: "A solução",
  solutionTitle1: "O que é um software de ",
  solutionHighlight: "gestão de carta de vinhos",
  solutionIntro: "Uma plataforma especializada que transforma como os restaurantes gerem, apresentam e vendem vinho.",
  capabilities: [
    "Gerir todas as referências num único local",
    "Organizar a carta com categorias claras",
    "Recomendar vinhos consoante preferências do cliente",
    "Mostrar harmonizações ao instante",
    "Melhorar a experiência na mesa",
    "Analisar dados de vendas para otimizar a garrafeira",
  ],
  featuresLabel: "Funcionalidades",
  featuresTitle1: "Funcionalidades principais de um software ",
  featuresHighlight: "moderno de carta de vinhos",
  features: [
    { title: "Carta digital", desc: "Uma carta interativa acessível a partir de qualquer dispositivo. Sempre atualizada, fácil de navegar e pensada para vender." },
    { title: "Filtros inteligentes", desc: "O cliente filtra por casta, região, estilo ou preço. Encontra o vinho perfeito em segundos." },
    { title: "Sugestões de harmonização", desc: "Recomendações automáticas que conectam vinhos com pratos do seu menu." },
    { title: "Comparador de vinhos", desc: "Comparação lado a lado com notas de prova, origem e preço." },
    { title: "Descrições interativas", desc: "Notas de prova claras, histórias de produtores e perfis visuais que tornam cada vinho acessível." },
    { title: "Motor de recomendação", desc: "Sugestões com IA baseadas em preferências, pratos selecionados e contexto para aumentar o bilhete médio." },
  ],
  benefitsLabel: "Benefícios",
  benefitsTitle1: "Porque é que os restaurantes escolhem ",
  benefitsHighlight: "software de carta de vinhos",
  benefits: [
    "Aumentar as vendas de vinho",
    "Melhorar a rotação da carta",
    "Ajudar a equipa a recomendar",
    "Melhorar a experiência do cliente",
    "Tornar o vinho mais compreensível",
  ],
  resultsLabel: "Resultados",
  resultsTitle1: "Impacto real nos ",
  resultsHighlight: "rendimentos de vinho",
  resultsIntro: "Os restaurantes que usam plataformas inteligentes de carta de vinhos obtêm melhorias mensuráveis.",
  resultItems: [
    { label: "Mais vendas de vinho", desc: "Recomendações guiadas e descrições claras ajudam o cliente a escolher com confiança." },
    { label: "Melhores margens", desc: "Visibilidade estratégica de preços e posicionamento inteligente orientam o cliente para vinhos de maior valor." },
    { label: "Gestão eficiente de garrafeira", desc: "Dados em tempo real sobre o que se vende, o que não se vende e onde estão as lacunas." },
  ],
  resultStats: [
    { value: "+22%", label: "Aumento do bilhete médio" },
    { value: "+35%", label: "Crescimento de encomendas de vinho" },
    { value: "3×", label: "Atualização mais rápida" },
    { value: "90%", label: "Confiança da equipa" },
  ],
  compLabel: "Comparação",
  compTitle1: "Porque é que as cartas digitais são o ",
  compHighlight: "futuro",
  compIntro: "Veja como o software inteligente se compara aos formatos tradicionais.",
  compHeaders: ["Funcionalidade", "Papel", "PDF", "Digital"],
  compRows: [
    { feature: "Fácil de atualizar", paper: false, pdf: "partial" as const, digital: true },
    { feature: "Filtros interativos", paper: false, pdf: false, digital: true },
    { feature: "Harmonizações", paper: false, pdf: false, digital: true },
    { feature: "Recomendações", paper: false, pdf: false, digital: true },
    { feature: "Analítica de vendas", paper: false, pdf: false, digital: true },
    { feature: "Design amigável", paper: false, pdf: "partial" as const, digital: true },
    { feature: "Sempre atualizada", paper: false, pdf: "partial" as const, digital: true },
    { feature: "Compatível com móvel", paper: false, pdf: "partial" as const, digital: true },
  ],
  ctaLabel: "Comece agora",
  ctaTitle1: "Transforme a sua carta de vinhos num sistema que ",
  ctaHighlight: "vende mais vinho",
  ctaDesc: "Veja como a Winerim pode transformar o seu programa de vinhos. Peça uma demo e descubra o potencial da sua carta.",
  ctaDemoBtn: "Pedir demo", ctaContactBtn: "Contacte-nos",
  faqItems: [
    { q: "O que é um software de gestão de carta de vinhos?", a: "É uma plataforma especializada que ajuda os restaurantes a digitalizar, organizar e otimizar a sua carta de vinhos. Inclui filtros inteligentes, sugestões de harmonização e analítica de vendas." },
    { q: "Como é que o software de carta digital aumenta as vendas?", a: "Facilita a descoberta de vinhos com filtros e recomendações, sugere harmonizações que motivam encomendas e oferece descrições claras que ajudam o cliente a escolher com confiança." },
    { q: "Quais são as vantagens de uma carta digital em relação ao papel ou PDF?", a: "As cartas digitais estão sempre atualizadas, oferecem funcionalidades interativas, proporcionam analítica de vendas, funcionam em qualquer dispositivo e vendem ativamente através de recomendações inteligentes." },
  ],
  hreflang: [
    { lang: "es", url: "https://winerim.wine/software-carta-de-vinos" },
    { lang: "en", url: "https://winerim.wine/wine-list-management-software" },
...
const i18n: Record<string, WLT> = { es, en, it, fr, de, pt };
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9, x: 40 }} animate={{ opacity: 1, scale: 1, x: 0 }} transition={{ delay: 0.6, duration: 0.8 }} className="hidden lg:block">
              <div className="relative">
                ...
                <img src={mockupImg} alt="Winerim digital wine list software showing analytics dashboard on tablet and mobile" className="relative w-full max-w-lg mx-auto drop-shadow-2xl" loading="eager" {...({ fetchpriority: "high" } as Record<string, string>)} width={800} height={600} />
              </div>
            </motion.div>
          </div>
        </div>

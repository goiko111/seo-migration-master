...
const comparisonI = i({
  es: { title: "Intuición vs. análisis con datos", sub: "La diferencia entre cambiar la carta y optimizarla.", cols: ["Intuición", "Análisis con datos"], rows: [{ feature: "Detectar vinos sin rotación", options: ["partial" as const, true] }, { feature: "Identificar canibalización de referencias", options: [false, true] }, { feature: "Optimizar distribución de precios", options: ["partial" as const, true] }, { feature: "Medir impacto de los cambios", options: [false, true] }, { feature: "Priorizar acciones por impacto económico", options: [false, true] }, { feature: "Detectar oportunidades de venta por copa", options: ["partial" as const, true] }, { feature: "Alinear carta con perfil gastronómico", options: ["partial" as const, true] }, { feature: "Replicable y escalable a varios locales", options: [false, true] }] },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                <Breadcrumbs items={[{ label: t.hero.breadcrumb, href: "/herramientas" }, { label: t.hero.breadcrumb2 }]} />
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent/30 bg-accent/5 mb-8">
                  <Zap size={14} className="text-accent" />
                  <span className="text-xs font-semibold tracking-widest uppercase text-accent">{t.hero.badge}</span>
                </div>

                <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold leading-[1.08] mb-6">
                  {t.hero.h1_1}
                  <span className="text-gradient-wine italic">{t.hero.h1_hl}</span>
                  {t.hero.h1_2}
                </h1>
                ...
                <div className="flex items-center gap-6 mt-8 text-xs text-muted-foreground">
                  <span className="flex items-center gap-1.5"><Clock size={12} /> {t.hero.tag1}</span>
                  <span className="flex items-center gap-1.5"><ShieldCheck size={12} /> {t.hero.tag2}</span>
                  <span className="flex items-center gap-1.5"><CheckCircle2 size={12} /> {t.hero.tag3}</span>
                </div>
              </motion.div>
                ...
                <div className="relative bg-gradient-card rounded-xl border border-border p-8 glow-wine">
                  ...
                  <div className="relative space-y-4">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <div>
                        <p className="font-heading font-semibold text-sm">{t.vc.title}</p>
                        <p className="text-xs text-muted-foreground">{t.vc.sub}</p>
                      </div>
                    </div>
                    <div className="space-y-3">
                      {t.vc.bars.map((label, idx) => {
                        const pct = [72, 45, 88, 34, 60][idx];
                        return (
                          <div key={label}>
                    ...
                    <div className="pt-4 border-t border-border">
                      <p className="text-xs text-muted-foreground">{t.vc.potential}</p>
                      <p className="font-heading text-2xl font-bold text-gradient-wine">{t.vc.result}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <section className="section-padding bg-gradient-dark">
          <div className="max-w-5xl mx-auto">
            <ScrollReveal className="text-center mb-14">
              <p className="text-sm tracking-[0.3em] uppercase text-gradient-gold font-semibold mb-4">{t.painsSection.badge}</p>
              <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                {t.painsSection.title1}
                <span className="text-gradient-wine italic">{t.painsSection.titleHl}</span>
              </h2>
        ...
        <section className="section-padding bg-gradient-dark">
          <div className="max-w-5xl mx-auto">
            <ScrollReveal className="text-center mb-14">
              <p className="text-sm tracking-[0.3em] uppercase text-gradient-gold font-semibold mb-4">{t.analysis.badge}</p>
              <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                {t.analysis.title1}
                <span className="text-gradient-wine italic">{t.analysis.titleHl}</span>
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                {t.analysis.sub}
              </p>
        ...
        <section className="section-padding">
          <div className="max-w-5xl mx-auto">
            <ScrollReveal className="text-center mb-14">
              <p className="text-sm tracking-[0.3em] uppercase text-gradient-gold font-semibold mb-4">{t.report.badge}</p>
              <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold">
                {t.report.title1}
                <span className="text-gradient-wine italic">{t.report.titleHl}</span>
              </h2>
            </ScrollReveal>

            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {t.report.items.map((c, idx) => {
                const Icon = c.icon;
                return (
        ...
        <section className="section-padding bg-gradient-dark">
          <div className="max-w-4xl mx-auto">
            <ScrollReveal className="text-center mb-14">
              <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold">
                {t.steps.title1}
                <span className="text-gradient-wine italic">{t.steps.titleHl}</span>
              </h2>
            </ScrollReveal>

            <div className="grid md:grid-cols-3 gap-8">
              {t.steps.items.map((s, idx) => (
          ...
          <div className="max-w-3xl mx-auto">
            <ScrollReveal className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent/20 bg-accent/5 mb-6">
                ...
                <span className="text-xs font-semibold tracking-widest uppercase text-accent">{t.disc.badge}</span>
              </div>
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">
                {t.disc.title1}
                <span className="text-gradient-wine italic">{t.disc.titleHl}</span>
              </h2>
        ...
        <section className="section-padding bg-gradient-dark">
          <div className="max-w-4xl mx-auto">
            <ScrollReveal className="text-center mb-12">
              <p className="text-sm tracking-[0.3em] uppercase text-gradient-gold font-semibold mb-4">{t.who.badge}</p>
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">
                {t.who.title1}
                <span className="text-gradient-wine italic">{t.who.titleHl}</span>
              </h2>
            </ScrollReveal>

            <div className="grid sm:grid-cols-2 gap-5">
              {t.who.items.map((w, idx) => (
                <ScrollReveal key={idx} delay={idx * 0.07}>
            ...
            <ScrollReveal delay={0.3}>
              <div className="mt-8 p-5 rounded-xl border border-border bg-background flex items-start gap-3">
                ...
                <p className="text-sm text-muted-foreground">
                  <strong className="text-foreground">Nota:</strong> {t.who.note}
                </p>
              </div>
            </ScrollReveal>
          </div>
        ...
        <section className="section-padding">
          <div className="max-w-4xl mx-auto">
            <ScrollReveal className="text-center mb-12">
              <p className="text-sm tracking-[0.3em] uppercase text-gradient-gold font-semibold mb-4">{t.after.badge}</p>
              <h2 className="font-heading text-3xl md:text-4xl font-bold">
                {t.after.title1}
                <span className="text-gradient-wine italic">{t.after.titleHl}</span>
              </h2>
            </ScrollReveal>

            <div className="space-y-4">
              {t.after.items.map((item, idx) => (
                <ScrollReveal key={idx} delay={idx * 0.07}>
                  <div className="flex items-start gap-5 p-6 rounded-xl border border-border bg-gradient-card">
                    <span className="flex items-center justify-center w-10 h-10 rounded-full bg-wine/10 text-wine font-bold shrink-0 font-heading">{idx + 1}</span>
                    <div>
        ...
        <section id="formulario" className="section-padding bg-gradient-dark scroll-mt-24">
          <div className="max-w-2xl mx-auto">
            <ScrollReveal className="text-center mb-10">
              <p className="text-sm tracking-[0.3em] uppercase text-gradient-gold font-semibold mb-4">{t.form.badge}</p>
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">
                {t.form.title1}
                <span className="text-gradient-wine italic">{t.form.titleHl}</span>
              </h2>
              <p className="text-muted-foreground">
                {t.form.sub}
              </p>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                  <div>
                    <Label htmlFor="restaurant" className="text-sm font-medium">
                      {t.form.restaurantLabel} <span className="text-destructive">*</span>
                    </Label>
                    <Input
                      id="restaurant"
                      name="restaurant"
                      placeholder={t.form.restaurantPh}
                      required
                      maxLength={100}
                    ...
                    >
                      ...
                      <p className="text-sm text-muted-foreground">
                        {fileName ? (
                          ...
                          <>{t.form.dropText} <br /><span className="text-xs">{t.form.dropSub}</span></>
                        )}
                      </p>
                      <input
                        ref={fileRef}
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    {t.form.disclaimer}{" "}
                    <Link to="/privacidad" className="underline hover:text-foreground">Privacy</Link>.
                  </p>
                </form>
              </div>
            </ScrollReveal>
        ...
        {/* ═══════════ 13. FAQs ═══════════ */}
        <FAQSection faqs={t.faqs.items} title={t.faqs.title} />
              ...
              <div className="relative bg-gradient-card rounded-3xl border border-border p-8 sm:p-12 md:p-16 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                    {t.ctaFinal.title1}
                    <span className="text-gradient-wine italic">{t.ctaFinal.titleHl}</span>
                  </h2>

...
const DE: VerticalContent = {
  ...EN,
  metaTitle: "Winerim für Gastronomische Restaurants | Weinkarte mit KI",
  metaDescription: "Gastronomische Weinkarte mit Winerim: Rotation, intelligente Preisgestaltung, angereicherte Profile und KI-Empfehlungen für Ihre Gäste.",
  badgeLabel: "Haute Gastronomie",
  breadSolutions: "Lösungen",
  breadLabel: "Gastronomische Restaurants",
  heroTitle1: "Ihre Weinkarte verdient die gleiche Exzellenz wie ",
  heroTitleHighlight: "Ihre Küche",
  heroDesc: "Winerim wandelt komplexe Weinkarten in Entdeckungserlebnisse um, die den Durchschnitt erhöhen, Feinschmecker-Gäste binden und jede Referenz optimieren.",
  ctaDemo: "Demo anfragen", ctaContact: "Mit dem Team sprechen",
  forTitle: "Ist Winerim richtig für Ihr Restaurant?",
  forLabel: "Perfekt, wenn…",
  notForLabel: "Möglicherweise nicht für Sie, wenn…",
  painLabel: "Das Problem",
  painTitle1: "Die Herausforderungen von Wein in ",
  painTitleHighlight: "der gehobenen Gastronomie",
  tableLabel: "Vergleich",
  tableTitle: "Traditionelle Verwaltung vs. Winerim in der Gastronomie",
  tableHeaders: ["Bereich", "Ohne Winerim", "Mit Winerim"],
  solLabel: "Die Lösung",
  solTitle1: "Was Winerim einem ",
  solTitleHighlight: "gastronomischen Restaurant",
  howLabel: "In der Praxis",
  howTitle: "Wie es in der Gastronomie funktioniert",
  impactLabel: "Ergebnisse",
  impactTitle: "Messbare Auswirkungen in der gehobenen Gastronomie",
  impactSubtitle: "Basierend auf gastronomischen Restaurants, die Winerim bereits nutzen.",
  doesLabel: "Was Winerim macht",
  doesNotLabel: "Was Winerim nicht macht",
  doesTitle: "Klare Erwartungen",
  ctaLabel: "Nächster Schritt",
  ctaTitle: "Bereit, Ihre Weinkarte auf dem Niveau Ihrer Küche zu optimieren?",
  ctaDesc: "Fordern Sie eine kostenlose Analyse Ihrer Weinkarte an und entdecken Sie die Chancen, die Sie heute verpassen.",
...
const PT: VerticalContent = {
  ...EN,
  metaTitle: "Winerim para Restaurantes Gastronómicos | Carta de Vinhos com IA",
  metaDescription: "Carta de vinhos gastronómica com Winerim: rotação, precificação inteligente, perfis enriquecidos e recomendações IA para seus clientes.",
  badgeLabel: "Alta gastronomia",
  breadSolutions: "Soluções",
  breadLabel: "Restaurantes gastronómicos",
  heroTitle1: "Sua carta de vinhos merece a mesma excelência que ",
  heroTitleHighlight: "sua cozinha",
  heroDesc: "Winerim transforma cartas complexas em experiências de descoberta que aumentam o bilhete, fidelizam comensais gourmet e otimizam cada referência.",
  ctaDemo: "Solicitar demonstração", ctaContact: "Falar com a equipe",
  forTitle: "Winerim é certo para seu restaurante?",
  forLabel: "Perfeito se…",
  notForLabel: "Talvez não para você se…",
  painLabel: "O problema",
  painTitle1: "Os desafios do vinho na ",
  painTitleHighlight: "alta gastronomia",
  tableLabel: "Comparação",
  tableTitle: "Gestão tradicional vs. Winerim na gastronomia",
  tableHeaders: ["Área", "Sem Winerim", "Com Winerim"],
  solLabel: "A solução",
  solTitle1: "O que Winerim traz a um ",
  solTitleHighlight: "restaurante gastronómico",
  howLabel: "Na prática",
  howTitle: "Como funciona na gastronomia",
  impactLabel: "Resultados",
  impactTitle: "Impacto mensurável na alta gastronomia",
  impactSubtitle: "Baseado em restaurantes gastronómicos que já usam Winerim.",
  doesLabel: "O que Winerim faz",
  doesNotLabel: "O que Winerim não faz",
  doesTitle: "Expectativas claras",
  ctaLabel: "Próximo passo",
  ctaTitle: "Pronto para sua carta render no nível de sua cozinha?",
  ctaDesc: "Solicite uma análise gratuita de sua carta e descubra as oportunidades que está perdendo hoje.",

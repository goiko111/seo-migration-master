...
const i18n: I18nMap<PageContent> = {
  ...
  de: {
    ...
    heroSubtitle: "Strategien, um Ihre Weinkarte so zu strukturieren, dass Umsatz steigt, der Durchschnitts­bon wächst und Ihre Margen optimiert werden.",
    ctaAnalyze: "Meine Karte analysieren", ctaDemo: "Demo anfragen",
    introH2: "Wein: Ihre größte Rentabilitäts­chance",
    ...
    wmTip: "Vermeiden Sie Preislücken. Wenn Sie von 28 € auf 52 € springen, ohne Zwischen­optionen, fühlt sich der Gast gedrängt. Die Preisskala muss fließend sein, mit 2-3 Optionen pro Stufe.",
    ...
    resultsDesc: "Restaurants, die ihre Weinkarte mit Kriterium und Daten optimieren, erzielen signifikante Verbesserungen bei Schlüssel­kennzahlen.",
    ...
    profitPrinciples: [
      ...
      { icon: GlassWater, title: "Klares Angebot im Glas", desc: "Wein im Glas ist der Rentabilitäts­motor. Er ermöglicht Probieren, senkt die Einstiegs­hürde und erzeugt Margen über 70%. Mindestens 6-8 gut ausgewählte Optionen." },
    ],
    priceRanges: [
      ...
      { range: "30–50 €", label: "Mittelklasse", pct: "35-40%", desc: "Hier konzentriert sich der Großteil der Verkäufe. Charakter­weine, gutes Preis-Leistungs-Verhältnis und optimale Marge." },
      { range: "50–80 €", label: "Premium", pct: "15-20%", desc: "Für besondere Anlässe und Gäste, die etwas Besonderes suchen. Anerkannte Appellationen und Autoren­winzer." },
    ...
    selectionFactors: [
      ...
      { icon: DollarSign, title: "Durchschnitts­bon", desc: "Beträgt Ihr Durchschnitts­bon 40 €, sollte die Karte das Angebot zwischen 20-50 € pro Flasche konzentrieren. Wein sollte 30-40% der Gesamtausgabe ausmachen." },
    ...
    presentationTips: [
      ...
      { icon: Layers, title: "Klare, intuitive Kategorien", desc: "Wählen Sie ein Organisations­kriterium und halten Sie es bei. Nach Stil funktioniert für die meisten Gäste besser als nach Region. Maximal 4-5 Haupt­kategorien." },
    ...
    techBenefits: [
      { icon: BarChart3, title: "Kartenstruktur analysieren", desc: "Visualisieren Sie die Verteilung nach Typ, Preis und Stil. Erkennen Sie Ungleich­gewichte, Preislücken und Verbesserungs­chancen." },
      ...
      { icon: TrendingUp, title: "Rotation verbessern", desc: "Verkaufs­tracking pro Referenz. Erkennen Sie, welche Weine sich nicht bewegen, und treffen Sie Entscheidungen auf Basis realer Daten." },
    ],
    results: [
      { value: "+18%", label: "Durchschnitts­bon", desc: "Durchschnittlicher Anstieg der Ausgabe pro Tisch dank besser strukturierter Karte und klarer Empfehlungen." },
      { value: "+25%", label: "Bruttomarge", desc: "Margen­verbesserung durch optimierte Weinauswahl und angepasste Preisskala." },

...
const translations: Record<string, T> = {
  ...
  de: {
    metaTitle: "Wie man den Durchschnittsbon im Restaurant erhöht | Winerim",
    metaDesc: "Praktische Strategien zur Steigerung der durchschnittlichen Ausgaben pro Gast in Ihrem Restaurant. Entdecken Sie, wie Wein Ihr wirksamstes Instrument sein kann.",
    badge: "Rentabilität", breadLabel: "Durchschnittsbon erhöhen",
    heroTitle1: "Wie man den ", heroHighlight: "Durchschnittsbon", heroTitle2: " im Restaurant erhöht",
    heroDesc: "Praktische Strategien zur Steigerung der durchschnittlichen Ausgaben pro Gast, ohne das gastronomische Erlebnis zu beeinträchtigen.",
    ctaAnalyze: "Meine Weinkarte analysieren", ctaDemo: "Demo anfordern",
    introTitle1: "Der Durchschnittsbon: die Kennzahl, die die ", introHighlight: "Rentabilität definiert",
    introP1: "Die Steigerung des Durchschnittsbons ist eines der wichtigsten Ziele in der Gastronomie. Es geht nicht darum, die Preise zu erhöhen, sondern das Kauferlebnis zu verbessern, damit jeder Gast auf natürliche Weise mehr ausgibt.",
    introP2: "Die Faktoren, die den Durchschnittsbon am stärksten beeinflussen, sind:",
    introP3: "Von all diesen Faktoren ist Wein das wirksamste Instrument zur Steigerung des Durchschnittsbons: hohe Marge, leicht zu empfehlen und während des gesamten Essens präsent.",
    introFactors: ["Getränkeverkauf, insbesondere Wein", "Aktive Empfehlung des Personals", "Struktur und Gestaltung der Karte", "Gesamterlebnis des Gastes"],
    whyLabel: "Wein als Hebel", whyTitle1: "Warum Wein ", whyHighlight: "den Durchschnittsbon steigert",
    wineAdvantages: [
      { title: "Höhere Marge als andere Produkte", desc: "Wein bietet Margen von 65-75 %, höher als bei den meisten Produkten der Karte. Jedes verkaufte Glas steigert direkt die Rentabilität." },
      { title: "Einfach zu teilen", desc: "Eine Flasche wird am ganzen Tisch geteilt und erleichtert so den Verkauf. Man muss nicht jeden Gast einzeln überzeugen." },
      { title: "Begleitet das ganze Essen", desc: "Im Gegensatz zu anderen Produkten kann Wein vom Aperitif bis zum Dessert präsent sein und vervielfacht so die Verkaufschancen." },
      { title: "Mehrere Preisoptionen", desc: "Vom Glas ab 5 € bis zu Premium-Flaschen passt sich Wein dem Budget jedes Tisches an und maximiert die Ausgaben." },
    ],
    stratLabel: "Strategien", stratTitle1: "5 Wege, ", stratHighlight: "den Durchschnittsbon zu erhöhen",
    strategies: [
      { title: "Weine im Glas anbieten", desc: "Der Glasverkauf senkt die Einstiegshürde. Ein Gast, der keine Flasche bestellen würde, probiert ein Glas. Bieten Sie mindestens 6-8 Glasweine an." },
      { title: "Speisenbegleitungen mit Gerichten erstellen", desc: "Schlagen Sie einen bestimmten Wein zu jedem Gericht vor. Speisenbegleitungen erhöhen die Wertwahrnehmung und erleichtern die Entscheidung." },
      { title: "Weine aus der Karte empfehlen", desc: "Eine gut strukturierte Karte mit klaren Beschreibungen und hervorgehobenen Empfehlungen führt den Gast zu höherwertigen Weinen." },
      { title: "Den Wein dem Gast erklären", desc: "Wenn der Gast versteht, was er trinkt, ist er bereit, mehr zu zahlen. Weinkarten mit Verkostungsnotizen, Herkunft und Speisenbegleitungen machen den Unterschied." },
      { title: "Die Struktur der Karte verbessern", desc: "Ordnen Sie nach Stilen, nicht nur nach Regionen. Heben Sie 2-3 Weine pro Kategorie hervor. Platzieren Sie margenstarke Weine in sichtbaren Bereichen." },
    ],
    errLabel: "Vermeiden Sie diese Fehler", errTitle1: "Fehler, die ", errHighlight: "reduzieren",
    mistakes: [
      "Schwer verständliche Weinkarten mit übermäßig technischer Terminologie",
      "Zu viele Referenzen, die die Entscheidung des Gastes lähmen",
      "Schlecht verteilte Preise mit großen Sprüngen zwischen Optionen",
      "Fehlende Empfehlungen, die den Gast ohne Orientierung lassen",
      "Kein Glaswein-Angebot, wodurch Umsätze kleiner Tische verloren gehen",
      "Personal ohne Schulung, um Wein mit Selbstsicherheit zu empfehlen",
    ],
    techLabel: "Technologie", techTitle1: "Wie Winerim Ihnen hilft, ", techHighlight: "mehr zu verkaufen",
    techBenefits: [
      { title: "Weine automatisch empfehlen", desc: "Algorithmen, die den idealen Wein nach gewähltem Gericht, Vorlieben des Gastes und Tageszeit vorschlagen." },
      { title: "Den Wein dem Gast erklären", desc: "Digitale Karten mit Verkostungsnotizen, Speisenbegleitungen, Herkunft und Bewertungen. Der Gast fühlt sich informiert und sicher bei der Wahl." },
      { title: "Die Kaufentscheidung lenken", desc: "Interaktive Filter, Weinvergleicher und hervorgehobene Empfehlungen, die die Wahl erleichtern und den Bon erhöhen." },
      { title: "Die Karte mit Daten optimieren", desc: "Verkaufsanalysen, die zeigen, welche Weine funktionieren, welche wenig rotieren und wo Verbesserungsmöglichkeiten liegen." },
    ],
    impactLabel: "Wirkung", impactTitle1: "Echte ", impactHighlight: "Ergebnisse",
    metrics: [{ value: "+15 %", label: "Durchschnittsbon" }, { value: "+20 %", label: "Weinverkäufe" }, { value: "+30 %", label: "Referenzrotation" }],
    ctaFinalLabel: "Machen Sie den nächsten Schritt", ctaFinalTitle1: "Entdecken Sie, wie viel mehr Sie ", ctaFinalHighlight: "verkaufen könnten", ctaFinalDesc: "Wir analysieren Ihre Weinkarte und zeigen Ihnen konkrete Chancen zur Steigerung Ihres Durchschnittsbons.", ctaFinalButton: "Kartenanalyse anfordern",
    links: [{ label: "Mehr Wein verkaufen" }, { label: "Glaswein im Restaurant" }, { label: "Wein-ROI-Rechner" }, { label: "Weinkarten-Software" }],
  },
  pt: {
    metaTitle: "Como Aumentar o Bilhete Médio num Restaurante | Winerim",
    metaDesc: "Estratégias práticas para aumentar o gasto médio por cliente no seu restaurante. Descubra como o vinho pode ser a sua ferramenta mais eficaz.",
    badge: "Rentabilidade", breadLabel: "Aumentar bilhete médio",
    heroTitle1: "Como aumentar o ", heroHighlight: "bilhete médio", heroTitle2: " num restaurante",
    heroDesc: "Estratégias práticas para aumentar o gasto médio por cliente sem afetar a experiência gastronómica.",
    ctaAnalyze: "Analisar a minha carta de vinhos", ctaDemo: "Pedir demonstração",
    introTitle1: "O bilhete médio: a métrica que define a ", introHighlight: "rentabilidade",
    introP1: "Aumentar o bilhete médio é um dos objetivos mais importantes na restauração. Não se trata de subir preços, mas de melhorar a experiência de compra para que cada cliente gaste mais de forma natural.",
    introP2: "Os fatores que mais influenciam o bilhete médio são:",
    introP3: "De todos estes fatores, o vinho é a ferramenta mais eficaz para aumentar o bilhete médio: margem alta, fácil de recomendar e presente durante toda a refeição.",
    introFactors: ["Venda de bebidas, especialmente vinho", "Recomendação ativa do pessoal", "Estrutura e design da carta", "Experiência global do cliente"],
    whyLabel: "O vinho como alavanca", whyTitle1: "Porque o vinho ", whyHighlight: "aumenta o bilhete médio",
    wineAdvantages: [
      { title: "Maior margem do que outros produtos", desc: "O vinho oferece margens de 65-75 %, superiores à maioria dos produtos da carta. Cada copo vendido melhora diretamente a rentabilidade." },
      { title: "Fácil de partilhar", desc: "Uma garrafa é partilhada por toda a mesa, facilitando a venda. Não precisa de convencer cada comensal individualmente." },
      { title: "Acompanha toda a refeição", desc: "Ao contrário de outros produtos, o vinho pode estar presente do aperitivo à sobremesa, multiplicando as oportunidades de venda." },
      { title: "Múltiplas opções de preço", desc: "Desde copos a 5 € a garrafas premium, o vinho permite adaptar-se ao orçamento de cada mesa e maximizar o gasto." },
    ],
    stratLabel: "Estratégias", stratTitle1: "5 formas de ", stratHighlight: "aumentar o bilhete médio",
    strategies: [
      { title: "Oferecer vinhos a copo", desc: "A venda a copo reduz a barreira de entrada. Um cliente que não pediria uma garrafa experimenta um copo. Ofereça pelo menos 6-8 referências a copo." },
      { title: "Criar harmonizações com pratos", desc: "Sugira um vinho específico para cada prato destacado. As harmonizações aumentam a perceção de valor e facilitam a decisão do cliente." },
      { title: "Recomendar vinhos a partir da carta", desc: "Uma carta bem estruturada com descrições claras e recomendações destacadas guia o cliente para vinhos de maior valor." },
      { title: "Explicar o vinho ao cliente", desc: "Quando o cliente percebe o que bebe, está disposto a pagar mais. Fichas de vinho com notas de prova, origem e harmonizações fazem a diferença." },
      { title: "Melhorar a estrutura da carta", desc: "Organize por estilos, não apenas por regiões. Destaque 2-3 vinhos por categoria. Coloque os vinhos com maior margem em zonas de alta visibilidade." },
    ],
    errLabel: "Evite estes erros", errTitle1: "Erros que ", errHighlight: "reduzem",
    mistakes: [
      "Cartas de vinhos difíceis de perceber com terminologia demasiado técnica",
      "Demasiadas referências que paralisam a decisão do cliente",
      "Preços mal distribuídos com grandes saltos entre opções",
      "Falta de recomendações que deixam o cliente sem orientação",
      "Não oferecer vinho a copo, perdendo vendas de mesas pequenas",
      "Pessoal sem formação para recomendar vinho com confiança",
    ],
    techLabel: "Tecnologia", techTitle1: "Como a Winerim o ajuda a ", techHighlight: "vender mais",
    techBenefits: [
      { title: "Recomendar vinhos automaticamente", desc: "Algoritmos que sugerem o vinho ideal consoante o prato escolhido, as preferências do cliente e o momento do dia." },
      { title: "Explicar o vinho ao cliente", desc: "Fichas digitais com notas de prova, harmonizações, origem e pontuações. O cliente sente-se informado e seguro ao escolher." },
      { title: "Guiar a decisão de compra", desc: "Filtros interativos, comparador de vinhos e recomendações destacadas que simplificam a escolha e aumentam o bilhete." },
      { title: "Otimizar a carta com dados", desc: "Análises de vendas que mostram que vinhos funcionam, quais têm pouca rotação e onde estão as oportunidades de melhoria." },
    ],
    impactLabel: "Impacto", impactTitle1: "Resultados ", impactHighlight: "reais",
    metrics: [{ value: "+15 %", label: "Bilhete médio" }, { value: "+20 %", label: "Vendas de vinho" }, { value: "+30 %", label: "Rotação de referências" }],
    ctaFinalLabel: "Dê o próximo passo", ctaFinalTitle1: "Descubra quanto mais poderia ", ctaFinalHighlight: "vender", ctaFinalDesc: "Analisamos a sua carta de vinhos e mostramos-lhe oportunidades concretas para aumentar o seu bilhete médio.", ctaFinalButton: "Pedir análise da carta",
    links: [{ label: "Como vender mais vinho" }, { label: "Vinho a copo no restaurante" }, { label: "Calculadora ROI vinho" }, { label: "Software carta de vinhos" }],
  },
};

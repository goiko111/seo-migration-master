...
const content: Record<string, {
  ...
  fr: {
    ...
    cases: [
      {
        restaurant: "Restaurant gastronomique avec sommelier", city: "Espagne", cuisine: "Cuisine d'auteur avec menu dégustation", references: 80,
        situation: "Restaurant avec cave étendue dont la carte PDF empêchait les clients d'explorer au-delà des vins connus.",
        problems: ["Carte PDF longue et difficile à naviguer", "Faible rotation : beaucoup de références peu vendues", "Le sommelier ne couvrait pas tout le service", "Vins premium invisibles", "Aucune donnée sur les performances"],
        implementation: "La carte a été digitalisée avec Winerim, avec accords et recommandations contextuelles.",
        results: "Les clients ont commencé à explorer des références qu'ils ignoraient. Le personnel de salle a gagné en autonomie.",
        metrics: [{ label: "Références découvertes", value: "3×", icon: TrendingUp }, { label: "Temps gagné en salle", value: "–70%", icon: ShoppingCart }, { label: "Rotation cave", value: "Notable", icon: RotateCcw }],
      },
      {
        restaurant: "Gastrobar de vins naturels", city: "Espagne", cuisine: "Tapas gastronomiques et vins d'auteur", references: 40,
        situation: "Gastrobar avec clientèle jeune intéressée mais ne connaissant pas les références.",
        problems: ["Ardoise impossible à mettre à jour", "Vins inconnus sans contexte", "Clients commandant toujours la même chose", "Aucun accord suggéré", "Pertes au verre par manque de rotation"],
        implementation: "Carte digitale avec descriptions accessibles, profils gustatifs et accords automatiques.",
        results: "Les clients ont commencé à essayer de nouveaux vins. Les pertes ont diminué significativement.",
        metrics: [{ label: "Clients essayant des vins nouveaux", value: "2× plus", icon: TrendingUp }, { label: "Réduction pertes", value: "Significative", icon: ShoppingCart }, { label: "Satisfaction", value: "Élevée", icon: RotateCcw }],
      },
      {
        restaurant: "Hôtel avec restaurant et bar", city: "Espagne", cuisine: "Cuisine internationale", references: 120,
        situation: "Hôtel avec restaurant et bar gérant deux cartes différentes sans cohérence de prix.",
        problems: ["Deux cartes incohérentes", "Prix inconsistants", "Aucune analyse par référence", "Clients internationaux sans info", "Mises à jour manuelles coûteuses"],
        implementation: "Cartes unifiées avec prix cohérents et traduction automatique.",
        results: "Les clients internationaux ont eu accès à l'information dans leur langue. La gestion s'est radicalement simplifiée.",
        metrics: [{ label: "Langues disponibles", value: "4", icon: TrendingUp }, { label: "Gestion unifiée", value: "Oui", icon: ShoppingCart }, { label: "Temps de mise à jour", value: "–90%", icon: RotateCcw }],
      },
    ],
  },
};

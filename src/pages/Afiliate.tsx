    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="pt-32 pb-20 section-padding text-center">
          ...
          >
            Programa de{" "}
            <span className="text-gradient-wine">Afiliados</span>
          </motion.h1>
          <motion.p
          ...
          >
            Únete a la red de establecimientos que están transformando su carta de vinos. 
            Accede a todas las herramientas de Winerim.
          </motion.p>
          <motion.a
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <section className="section-padding bg-gradient-wine text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-primary-foreground mb-6">
              ¿Listo para transformar tu carta de vinos?
            </h2>
            <p className="text-primary-foreground/80 mb-8">
              Contacta con nosotros y descubre cómo Winerim puede impulsar tu negocio.
            </p>
            <a
              href="/contacto"
              className="inline-flex bg-background text-foreground px-8 py-3 rounded text-sm font-semibold tracking-wider uppercase hover:bg-background/90 transition-colors"
            >
              Contactar
            </a>
          </div>

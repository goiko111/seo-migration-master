...
i18n.it = {
  ...
  subtitle: "Winerim si adatta alla tua dimensione, alla tua ambizione e al tuo tipo di operazione. Senza sorprese, senza vincoli.",
  valuePillars: [
  ...
  compTitle: "Confronto dettagliato tra <em>piani</em>",
  compBadge: "Funzionalità per funzionalità",
  compCategories: [
    { name: "Carta digitale", rows: [
      { feature: "Carta digitale interattiva", starter: true, pro: true, enterprise: true },
      { feature: "Filtri per tipo, regione, prezzo", starter: true, pro: true, enterprise: true },
  ...
  faqs: [
    ...
    { q: "Funziona anche per cocktail?", a: "Winerim è specializzato in vini. Se la tua carta include cocktail, possiamo integrarli, ma il valore differenziale è nell'intelligenza applicata al vino." },
    { q: "Come si calcola il prezzo esatto?", a: "Il prezzo dipende dal numero di referenze e dal numero di locali. Richiedi un preventivo personalizzato e ricevi una proposta chiara in 24h." },
    { q: "Posso cambiare piano?", a: "Sì. Puoi passare da Starter a Pro o da Pro a Enterprise in qualsiasi momento. Senza interruzioni." },
  ],
...
i18n.fr = {
  ...
  subtitle: "Winerim s'adapte à votre taille, votre ambition et votre type d'opération. Sans surprises, sans engagement.",
  valuePillars: [
  ...
  compTitle: "Comparaison détaillée des <em>plans</em>",
  compBadge: "Fonctionnalité par fonctionnalité",
  compCategories: [
    { name: "Carte digitale", rows: [
      { feature: "Carte digitale interactive", starter: true, pro: true, enterprise: true },
      { feature: "Filtres par type, région, prix", starter: true, pro: true, enterprise: true },
  ...
  faqs: [
    ...
    { q: "Ça fonctionne aussi pour les cocktails ?", a: "Winerim est spécialisé dans le vin. D'autres boissons peuvent être incluses, mais la valeur différentielle est dans l'intelligence appliquée au vin." },
    { q: "Comment le prix exact est-il calculé ?", a: "Le prix dépend du nombre de références et de sites. Demandez un devis personnalisé et recevez une proposition claire en 24h." },
    { q: "Puis-je changer de plan ?", a: "Oui. Passez de Starter à Pro ou d'Enterprise à tout moment, sans interruption." },
  ],

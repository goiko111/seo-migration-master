...
const content: Record<string, {
  ...
  es: {
    ...
    metrics: [{ value: "+20%", label: "Ventas de vino" }, { value: "+15%", label: "Ticket medio" }, { value: "+30%", label: "Rotación de referencias" }],
  ...
  en: {
    ...
    metrics: [{ value: "+20%", label: "Wine sales" }, { value: "+15%", label: "Average ticket" }, { value: "+30%", label: "Reference rotation" }],
  ...
  fr: {
    ...
    metrics: [{ value: "+20%", label: "Ventes de vin" }, { value: "+15%", label: "Ticket moyen" }, { value: "+30%", label: "Rotation des références" }],

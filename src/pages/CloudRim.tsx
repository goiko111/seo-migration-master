...
const copy: I18nMap<CloudRimCopy> = {
  es: {
    ...
    seoDesc:
      "CloudRIM recoge cartas, ventas, albaranes, stock y tarifas de distribuidores para que Winerim los procese con IA y mantenga actualizada la operativa de vino del restaurante.",
    ...
    subtitle:
      "CloudRIM centraliza cartas, albaranes, ventas, stock y tarifas de distribuidores. El cliente sube, reenvia o conecta sus archivos; Winerim los clasifica, interpreta y los lleva al flujo correcto.",
    primaryCta: "Probar CloudRIM con mi restaurante",
    secondaryCta: "Ver integraciones",
    trustLine: "Portal, email, carpeta compartida, FTP/SFTP, API o proveedor: CloudRIM se adapta al punto donde ya vive la informacion.",
    inputLabel: "Input cloud",
    inputDesc: "Cartas, ventas, stock, tarifas y albaranes",
    problemKicker: "Operativa real",
    problemTitle: "El problema no es tener datos. Es conseguir que alguien los suba bien.",
    problemParagraphs: [
      "Las ventas estan en el TPV. Los albaranes llegan en papel o PDF. Las tarifas de distribuidores cambian por email. El stock se actualiza tarde. Y cuando el restaurante tiene que meter todo a mano, lo normal es que lo deje para otro dia.",
    ...
    howSteps: [
      "El restaurante sube o conecta documentos: carta, albaranes, ventas, stock, tarifas o reportes.",
      "CloudRIM detecta el tipo de documento y extrae la informacion relevante.",
      "Winerim enruta cada archivo al flujo correcto: carta, compras, ventas, stock, catalogo o margen.",
      "El equipo revisa solo lo que necesita confirmacion.",
    ],
    channelsTitle: "No obligamos al restaurante a cambiar su rutina",
    channelsText: "CloudRIM puede trabajar con:",
    channels: [
      "Portal de subida para cartas, albaranes y reportes.",
      ...
      "Documentacion de distribuidores en PDF, Excel o formatos operativos.",
    ],
    ...
    benefits: [
      ...
      "Menos errores al revisar albaranes, tarifas y costes.",
    ...
    controlText:
      "CloudRIM no sustituye al TPV, ERP ni a los distribuidores. Actua como capa operativa para recibir documentos y convertirlos en informacion util dentro de Winerim.",
    ...
    faqs: [
      ...
      { q: "Sirve para albaranes y tarifas de distribuidores?", a: "Si. CloudRIM esta pensado para procesar albaranes, facturas, tarifas, reportes de stock, cartas y exportaciones de ventas." },
    ],
    related: [
  ...
  en: {
    ...
    seoDesc:
      "CloudRIM collects wine lists, sales, delivery notes, stock and distributor tariffs so Winerim can process them with AI and keep wine operations up to date.",
    breadcrumbProduct: "Product",
    breadcrumbCurrent: "CloudRIM",
    badge: "CLOUDRIM",
    h1: "The document cloud where your restaurant drops files and Winerim does the heavy lifting",
    subtitle:
      "CloudRIM centralizes wine lists, delivery notes, sales, stock and distributor tariffs. The client uploads, forwards or connects files; Winerim classifies, interprets and routes them to the right workflow.",
    ...
    inputLabel: "Input cloud",
    inputDesc: "Lists, sales, stock, tariffs and delivery notes",
    problemKicker: "Real operations",
    problemTitle: "The problem is not having data. It is getting it uploaded correctly.",
    problemParagraphs: [
      "Sales sit in the POS. Delivery notes arrive on paper or PDF. Distributor tariffs change by email. Stock gets updated late. When teams have to enter everything by hand, it is easy to leave it for another day.",
    ...
    howSteps: [
      "The restaurant uploads or connects documents: list, delivery notes, sales, stock, tariffs or reports.",
      "CloudRIM detects the document type and extracts the relevant information.",
      "Winerim routes each file to the right workflow: list, purchasing, sales, stock, catalogue or margin.",
      "The team reviews only what needs confirmation.",
    ],
    ...
    benefits: ["Less manual admin", "Sales, purchase and stock data closer to reality", "Fewer errors in delivery notes and tariffs", "Better control of cost, stock and margin", "A clear inbox for what is missing, processed or needs review"],
    controlTitle: "CloudRIM organizes. Winerim decides where each data point goes.",
    controlText: "CloudRIM does not replace your POS, ERP or distributors. It acts as an operating layer to receive documents and turn them into useful Winerim data.",
    ...
    faqs: [
      ...
      { q: "Does it work with delivery notes and distributor tariffs?", a: "Yes. CloudRIM is designed for delivery notes, invoices, tariffs, stock reports, wine lists and sales exports." },
    ],
    related: [
  ...
  it: {
    ...
    seoDesc: "CloudRIM raccoglie carte, vendite, documenti, stock e tariffe dei distributori per farli processare da Winerim con IA.",
    breadcrumbProduct: "Prodotto",
    breadcrumbCurrent: "CloudRIM",
    badge: "CLOUDRIM",
    h1: "Il cloud dove il ristorante lascia i documenti e Winerim fa il lavoro pesante",
    subtitle: "CloudRIM centralizza carta, documenti d'acquisto, vendite, stock e tariffe. Winerim classifica, interpreta e porta ogni file nel flusso corretto.",
    ...
    inputLabel: "Input cloud",
    inputDesc: "Carte, vendite, stock, tariffe e documenti",
    ...
    howSteps: ["Il ristorante carica o collega carta, documenti, vendite, stock, tariffe o report.", "CloudRIM riconosce il tipo di documento ed estrae le informazioni rilevanti.", "Winerim instrada ogni file verso carta, acquisti, vendite, stock, catalogo o margine.", "Il team rivede solo cio che richiede conferma."],
    ...
    controlText: "CloudRIM non sostituisce POS, ERP o distributori: riceve documenti e li converte in dati utili dentro Winerim.",
  ...
  fr: {
    ...
    seoDesc: "CloudRIM collecte cartes, ventes, bons, stock et tarifs distributeurs pour que Winerim les traite avec IA.",
    breadcrumbProduct: "Produit",
    breadcrumbCurrent: "CloudRIM",
    badge: "CLOUDRIM",
    h1: "Le cloud ou le restaurant depose ses documents et Winerim fait le travail lourd",
    subtitle: "CloudRIM centralise carte, bons, ventes, stock et tarifs distributeurs. Winerim classe, interprete et route chaque fichier vers le bon flux.",
    ...
    inputLabel: "Input cloud",
    inputDesc: "Cartes, ventes, stock, tarifs et bons",
    ...
    howSteps: ["Le restaurant importe ou connecte carte, bons, ventes, stock, tarifs ou rapports.", "CloudRIM detecte le type de document et extrait l'information utile.", "Winerim route chaque fichier vers carte, achats, ventes, stock, catalogue ou marge.", "L'equipe ne revise que ce qui demande confirmation."],
    ...
    controlText: "CloudRIM ne remplace pas POS, ERP ou distributeurs. Il recoit les documents et les convertit en donnees utiles dans Winerim.",
  ...
  de: {
    ...
    seoDesc: "CloudRIM sammelt Karten, Verkaeufe, Lieferscheine, Bestand und Lieferantentarife, damit Winerim sie mit KI verarbeitet.",
    breadcrumbProduct: "Produkt",
    breadcrumbCurrent: "CloudRIM",
    badge: "CLOUDRIM",
    h1: "Die Cloud, in der Ihr Restaurant Dokumente ablegt und Winerim die schwere Arbeit erledigt",
    subtitle: "CloudRIM zentralisiert Weinkarten, Lieferscheine, Verkaeufe, Bestand und Lieferantentarife. Winerim klassifiziert, interpretiert und routet jede Datei in den richtigen Ablauf.",
    ...
    inputLabel: "Input cloud",
    inputDesc: "Karten, Verkaeufe, Bestand, Tarife und Lieferscheine",
    ...
    howSteps: ["Das Restaurant laedt oder verbindet Karte, Lieferscheine, Verkaeufe, Bestand, Tarife oder Reports.", "CloudRIM erkennt den Dokumenttyp und extrahiert die relevanten Informationen.", "Winerim routet jede Datei zu Karte, Einkauf, Verkauf, Bestand, Katalog oder Marge.", "Das Team prueft nur, was bestaetigt werden muss."],
    ...
    controlText: "CloudRIM ersetzt kein Kassensystem, ERP oder Lieferanten. Es empfaengt Dokumente und macht daraus nutzbare Winerim-Daten.",
  ...
  pt: {
    ...
    seoDesc: "CloudRIM recolhe cartas, vendas, guias, stock e tabelas de distribuidores para a Winerim processar com IA.",
    breadcrumbProduct: "Produto",
    breadcrumbCurrent: "CloudRIM",
    badge: "CLOUDRIM",
    h1: "A nuvem onde o restaurante deixa documentos e a Winerim faz o trabalho pesado",
    subtitle: "CloudRIM centraliza cartas, guias, vendas, stock e tabelas de distribuidores. A Winerim classifica, interpreta e encaminha cada ficheiro para o fluxo certo.",
    ...
    inputLabel: "Input cloud",
    inputDesc: "Cartas, vendas, stock, tabelas e guias",
    ...
    howTitle: "Como funciona CloudRIM",
    howSteps: ["O restaurante carrega ou liga documentos: carta, guias, vendas, stock, tabelas ou relatorios.", "CloudRIM deteta o tipo de documento e extrai a informacao relevante.", "A Winerim encaminha cada ficheiro para carta, compras, vendas, stock, catalogo ou margem.", "A equipa revê apenas o que precisa de confirmacao."],
    ...
    controlText: "CloudRIM nao substitui POS, ERP ou distribuidores. Recebe documentos e converte-os em dados uteis dentro da Winerim.",

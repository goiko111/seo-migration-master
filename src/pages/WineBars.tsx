...
const DE: VerticalContent = {
  ...EN,
  metaTitle: "Winerim für Weinbars | Intelligente Kartenverwaltung",
  metaDescription: "Optimieren Sie Ihre Weinbar mit Winerim: Rotation nach Glas, dynamische Preisgestaltung, Profile und Performance-Analytik pro Referenz.",
  badgeLabel: "Weinbars & Weinstube",
  breadSolutions: "Lösungen",
  breadLabel: "Weinbars",
  heroTitle1: "Ihre Glaswein-Karte verdient ",
  heroTitleHighlight: "Intelligenz, nicht Intuition",
  heroDesc: "Winerim transformiert die Weinkartenverwaltung in Weinbars: optimale Rotation nach Glas, Preisgestaltung zur Margenmaximierung und Profile, die Neugierige in Stammgäste verwandeln.",
  ctaDemo: "Demo anfragen", ctaContact: "Mit dem Team sprechen",
  forTitle: "Ist Winerim richtig für Ihre Weinbar?",
  forLabel: "Perfekt, wenn…",
  notForLabel: "Möglicherweise nicht für Sie, wenn…",
  painLabel: "Das Problem",
  painTitle1: "Die spezifischen Herausforderungen einer ",
  painTitleHighlight: "Weinbar",
  tableLabel: "Vergleich",
  tableTitle: "Traditionelle Verwaltung vs. Winerim in Weinbars",
  tableHeaders: ["Bereich", "Ohne Winerim", "Mit Winerim"],
  solLabel: "Die Lösung",
  solTitle1: "Was Winerim einer ",
  solTitleHighlight: "Weinbar",
  howLabel: "In der Praxis",
  howTitle: "Wie es in einer Weinbar funktioniert",
  impactLabel: "Ergebnisse",
  impactTitle: "Messbare Auswirkungen in Weinbars",
  impactSubtitle: "Basierend auf Weinbars, die Winerim bereits nutzen.",
  doesLabel: "Was Winerim macht",
  doesNotLabel: "Was Winerim nicht macht",
  doesTitle: "Klare Erwartungen",
  ctaLabel: "Nächster Schritt",
  ctaTitle: "Machen Sie jedes Glas zählt",
  ctaDesc: "Fordern Sie eine kostenlose Analyse Ihrer Glaswein-Karte an und erfahren Sie, wie viel Marge Sie auf dem Tresen hinterlassen.",
...
const PT: VerticalContent = {
  ...EN,
  metaTitle: "Winerim para Bares de Vinhos | Gestão Inteligente de Carta",
  metaDescription: "Otimize seu bar de vinhos com Winerim: rotação ao copo, preços dinâmicos, perfis e análise de desempenho por referência.",
  badgeLabel: "Bares de vinhos & adegas",
  breadSolutions: "Soluções",
  breadLabel: "Bares de vinhos",
  heroTitle1: "Sua carta de vinho ao copo merece ",
  heroTitleHighlight: "inteligência, não intuição",
  heroDesc: "Winerim transforma a gestão de vinhos em bares: rotação ideal ao copo, precificação que maximiza margem e fichas que convertem curiosos em clientes habituais.",
  ctaDemo: "Solicitar demonstração", ctaContact: "Falar com a equipe",
  forTitle: "Winerim é certo para seu bar de vinhos?",
  forLabel: "Perfeito se…",
  notForLabel: "Talvez não para você se…",
  painLabel: "O problema",
  painTitle1: "Os desafios específicos de um ",
  painTitleHighlight: "bar de vinhos",
  tableLabel: "Comparação",
  tableTitle: "Gestão tradicional vs. Winerim em bares de vinhos",
  tableHeaders: ["Área", "Sem Winerim", "Com Winerim"],
  solLabel: "A solução",
  solTitle1: "O que Winerim traz a um ",
  solTitleHighlight: "bar de vinhos",
  howLabel: "Na prática",
  howTitle: "Como funciona em um bar de vinhos",
  impactLabel: "Resultados",
  impactTitle: "Impacto mensurável em bares de vinhos",
  impactSubtitle: "Baseado em estabelecimentos que já usam Winerim.",
  doesLabel: "O que Winerim faz",
  doesNotLabel: "O que Winerim não faz",
  doesTitle: "Expectativas claras",
  ctaLabel: "Próximo passo",
  ctaTitle: "Faça cada copo contar",
  ctaDesc: "Solicite uma análise gratuita de sua carta ao copo e descubra quanto margem você está deixando no balcão.",
  ctaPrimary: "Analisar minha carta gratuitamente",
  ctaSecondary: "Solicitar demonstração",
  ctaMicro: "Sem compromisso. Relatório personalizado em menos de 48 horas.",
  nextStepsTitle: "Próximos passos",
};

const i18n: Record<string, VerticalContent> = { es: ES, en: EN, it: IT, fr: FR, de: DE, pt: PT };

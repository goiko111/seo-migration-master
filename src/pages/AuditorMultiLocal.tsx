...
const i18n: I18nMap<{
  ...
  de: {
    seo_title: "Weinkarten-Auditor für Multi-Standort-Gruppen | Winerim",
    seo_desc: "Vergleichen Sie die Weinkarten Ihrer Standorte: Sorten, Preisgestaltung, Glaswein und Durchschnittsbon. Erkennen Sie Inkonsistenzen und Verbesserungsmöglichkeiten.",
    jsonld_name: "Weinkarten-Auditor für Multi-Standort-Gruppen",
    jsonld_desc: "Vergleichen Sie Weinkarten mehrerer Standorte: Sorten, Preisgestaltung, Weinsatz, Glaswein und Durchschnittsbon.",
    bc_tools: "Werkzeuge", bc_page: "Multi-Standort-Auditor", bc_home: "Startseite",
    badge: "Werkzeug für Gruppen", h1: "Weinkarten-Auditor für Multi-Standort-Gruppen",
    subtitle: "Vergleichen Sie die Weinkartenverwaltung an Ihren Standorten. Erkennen Sie Preisinkonsistenzen, Sortierungsunausgewogenheiten und Verbesserungsmöglichkeiten.",
    summary_label: "Was dieses Werkzeug bewertet",
    summary_def: "Vergleicht 6 Dimensionen der Weinkarte zwischen Ihren Standorten und erstellt eine Konsistenzdiagnose mit standortspezifischen Warnungen.",
    summary_bullets: [
      "Sortiment: Anzahl der Referenzen und Ausgewogenheit zwischen Standorten.",
      "Preisgestaltung: Konsistenz der durchschnittlichen Flaschen- und Glaspreise.",
      "Weinsatz: % der Tische, die Wein pro Standort bestellen.",
      "Glaswein: Durchdringung und Preisgestaltung des Glaswein-Angebots.",
      "Durchschnittsbon: Weineinkauf pro Tisch und Abweichungen.",
    ],
    h2_data: "Daten pro Standort",
    lbl_refs: "Anzahl Referenzen", lbl_ticket: "Wein-Durchschnittsbon/Tisch (€)", lbl_wine_ratio: "% Tische mit Wein",
    lbl_glass_ratio: "% Glaswein-Verkäufe", lbl_bottle_price: "Durchschnittlicher Flaschenpreis (€)", lbl_glass_price: "Durchschnittlicher Glasweinpreis (€)",
    btn_add: "Standort hinzufügen", btn_audit: "Gruppe audieren",
    score_label: "Konsistenzwertung der Gruppe",
    score_high: "Hohe Konsistenz. Gute zentralisierte Kontrolle.",
    score_mid: "Moderate Konsistenz. Es gibt Standardisierungsmöglichkeiten.",
    score_low: "Niedrige Konsistenz. Ein Governance-Rahmen wird empfohlen.",
    dim_assortment: "Sortiment", dim_pricing_bottle: "Flaschenpreisgestaltung", dim_pricing_glass: "Glaswein-Preisgestaltung",
    dim_wine_ratio: "Weinsatz", dim_glass_ratio: "Glaswein-Satz", dim_avg_ticket: "Durchschnittsbon",
    th_local: "Standort", th_refs: "Ref", th_ticket: "Bon", th_wine: "% Wein", th_glass: "% Glas", th_pvp_bottle: "Flasche", th_pvp_glass: "Glas",
    group_avg: "Gruppendurchschnitt",
    alerts_title: "Erkannte Warnungen",
    best_ticket: "Bester Durchschnittsbon", worst_ticket: "Größte Verbesserungsmöglichkeit",
    interpret_title: "So interpretieren Sie diese Diagnose",
    interpret_p1: "Die Konsistenzwertung misst, wie einheitlich die Weinkartenverwaltung an Ihren Standorten ist. Eine hohe Wertung (≥75) weist auf ähnliche Standards hin. Eine niedrige Wertung (<50) deutet darauf hin, dass jeder Standort unabhängig operiert.",
    interpret_p2: "Warnungen kennzeichnen Standorte mit Werten, die signifikant vom Gruppendurchschnitt abweichen. Dies sind nicht immer Probleme: Ein Premium-Standort kann höhere Preise rechtfertigen. Das Ziel besteht darin, unbeabsichtigte Abweichungen zu erkennen.",
    cta_demo: "Demo für Gruppen anfordern", cta_solutions: "Lösungen für Gruppen anzeigen",
    edu_title: "Was in einer Restaurantgruppe zu bewerten ist",
    edu_blocks: [
      { icon: Layers, title: "Sortimentskohärenz", desc: "Haben alle Standorte eine proportionale Anzahl von Referenzen für ihr Profil?" },
      { icon: DollarSign, title: "Konsistenz der Preisgestaltung", desc: "Kostet derselbe Wein überall gleich? Ungerechtfertigte Unterschiede untergraben die Markenwahrnehmung." },
      { icon: BarChart3, title: "Durchschnittsbon-Benchmarking", desc: "Welcher Standort verkauft pro Tisch am meisten Wein? Der Referenzstandort hat replizierbare Praktiken." },
      { icon: Wine, title: "Glaswein-Penetration", desc: "Bieten alle Standorte Glaswein an? Ein Standort ohne Glaswein verliert 35-45% der Tische, die Wein bestellen würden." },
    ],
    when_title: "Wann sollte man dieses Werkzeug nutzen",
    when_items: [
      "Bei der Implementierung einer zentralisierten Weinkartenverwaltung in Ihrer Gruppe.",
      "Vor vierteljährlichen Vorstandssitzungen, um konkrete Daten zu präsentieren.",
      "Bei Preisinkonsistenzen zwischen Standorten.",
      "Wenn ein Standort bei Wein deutlich schlechter abschneidet.",
      "Bei der Vorbereitung der jährlichen Distributor-Verhandlung (konsolidiertes Volumen).",
      "Beim Öffnen eines neuen Standorts, um dessen Weinkarte nach Gruppenstandardards zu definieren.",
    ],
    faqs: [
      { q: "Ab wie vielen Standorten macht das Sinn?", a: "Bereits ab 2 Standorten können Sie vergleichen und Abweichungen erkennen. Ab 5 wird es unverzichtbar." },
      { q: "Kann ich Standorte mit sehr unterschiedlichen Profilen vergleichen?", a: "Ja, interpretieren Sie die Ergebnisse jedoch mit Urteilskraft. Der Wert liegt in der Erkennung ungerechtfertigter Abweichungen." },
      { q: "Ist eine niedrige Wertung immer schlecht?", a: "Nicht unbedingt. Wichtig ist, dass Abweichungen beabsichtigt sind." },
      { q: "Bietet Winerim diese Analyse automatisiert?", a: "Ja. Winerim zentralisiert die Verwaltung und erstellt vergleichende Echtzeit-Dashboards." },
    ],
    links: [
      { to: "/de/losungen/restaurant-gruppen", label: "Winerim für Restaurantgruppen", type: "solution" },
      { to: "/de/ressourcen/vorlagen-kontrolle-restaurantgruppen", label: "Kontrollvorlage für Gruppen", type: "resource" },
      { to: "/de/anleitung/weinkarte-verwaltung-restaurantgruppen", label: "Anleitung: Weinkarte in Gruppen verwalten", type: "guide" },
      { to: "/de/werkzeuge/durchschnittsbon-rechner", label: "Durchschnittsbon-Rechner", type: "tool" },
      { to: "/de/demo", label: "Demo für Gruppen anfordern", type: "solution" },
    ],
    final_cta_title: "Verwalten Sie den Wein Ihrer gesamten Gruppe von einem Armaturenbrett",
    final_cta_desc: "Winerim zentralisiert Weinkarte, Bestand und Analytik für alle Ihre Standorte. Automatisches Benchmarking, Abweichungswarnungen und Echtzeit-Sortimentskontrolle.",
    final_cta_btn: "Demo für Gruppen anfordern",
    issue_refs_low: (n, v, a) => `Sortiment deutlich unter Durchschnitt (${v} gegen ${Math.round(a)} Ref)`,
    issue_refs_high: (n, v, a) => `Sortiment deutlich über Durchschnitt (${v} gegen ${Math.round(a)} Ref). Mögliche Überkapazität.`,
    issue_price_low: (n, v, a) => `Durchschnittlicher Flaschenpreis deutlich unter (${v}€ gegen ${Math.round(a)}€). Überprüfen Sie die Preisgestaltung.`,
    issue_price_high: (n, v, a) => `Durchschnittlicher Flaschenpreis deutlich über (${v}€ gegen ${Math.round(a)}€). Durch Profil gerechtfertigt?`,
    issue_ratio_low: (n, v, a) => `Weinsatz sehr niedrig (${v}% gegen ${Math.round(a)}%). Verbesserungsmöglichkeit.`,
    issue_glass_low: (n, v) => `Glaswein-Satz unter 15%. Wachstumsmöglichkeit durch Glaswein.`,
    issue_glass_price_low: (n, v, a) => `Durchschnittlicher Glasweinpreis unter Durchschnitt (${v}€ gegen ${a}€).`,
    decides: ["Ob die Weinkartenverwaltung zwischen Standorten konsistent ist", "Welcher Standort mehr Aufmerksamkeit bei Preisgestaltung oder Sortiment benötigt", "Ob die Gruppe von zentralisierten Standards profitiert"],
    avoids: ["Dass jeder Standort ohne Aufsicht mit unterschiedlichen Kriterien operiert", "Preisabweichungen, die die Marke untergraben", "Verhandlungsmacht durch mangelnde konsolidierte Sicht verlieren"],
    impact: ["Verbesserungsmöglichkeiten in unterperformanten Standorten erkennen", "Verwaltung standardisieren und Ineffizienzen reduzieren", "Verhandlungen mit Distributoren mit Gruppendaten vorbereiten"],
  },
  pt: {
    seo_title: "Auditor de Carta de Vinhos para Grupos Multi-Local | Winerim",
    seo_desc: "Compare a carta de vinhos dos seus estabelecimentos: seleção, preços, vinho a copo e bilhete médio. Detete inconsistências e oportunidades de melhoria.",
    jsonld_name: "Auditor de Carta de Vinhos para Grupos Multi-Local",
    jsonld_desc: "Compare a carta de vinhos de múltiplos estabelecimentos: seleção, preços, rácio de vinho, vinho a copo e bilhete médio.",
    bc_tools: "Ferramentas", bc_page: "Auditor multi-local", bc_home: "Página Inicial",
    badge: "Ferramenta para grupos", h1: "Auditor de carta de vinhos para grupos multi-local",
    subtitle: "Compare a gestão de vinho nos seus estabelecimentos. Detete inconsistências de preço, desequilíbrios de seleção e oportunidades de melhoria.",
    summary_label: "O que esta ferramenta avalia",
    summary_def: "Compara 6 dimensões da carta de vinhos entre os seus estabelecimentos e gera um diagnóstico de coerência com alertas específicos por ponto de venda.",
    summary_bullets: [
      "Seleção: número de castas e equilíbrio entre estabelecimentos.",
      "Preços: coerência dos preços médios de garrafa e copo.",
      "Rácio de vinho: % de mesas que pedem vinho por estabelecimento.",
      "Vinho a copo: penetração e preço da oferta a copo.",
      "Bilhete médio: despesa em vinho por mesa e desvios.",
    ],
    h2_data: "Dados por estabelecimento",
    lbl_refs: "Nº castas", lbl_ticket: "Bilhete vinho/mesa (€)", lbl_wine_ratio: "% mesas com vinho",
    lbl_glass_ratio: "% vendas a copo", lbl_bottle_price: "Preço médio garrafa (€)", lbl_glass_price: "Preço médio copo (€)",
    btn_add: "Adicionar estabelecimento", btn_audit: "Auditar grupo",
    score_label: "Escanção de coerência do grupo",
    score_high: "Alta coerência. Bom controlo centralizado.",
    score_mid: "Coerência moderada. Existem oportunidades de padronização.",
    score_low: "Baixa coerência. Recomenda-se um framework de governance.",
    dim_assortment: "Seleção", dim_pricing_bottle: "Preço garrafa", dim_pricing_glass: "Preço a copo",
    dim_wine_ratio: "Rácio de vinho", dim_glass_ratio: "Rácio a copo", dim_avg_ticket: "Bilhete médio",
    th_local: "Estabelecimento", th_refs: "Castas", th_ticket: "Bilhete", th_wine: "% Vinho", th_glass: "% Copo", th_pvp_bottle: "Garrafa", th_pvp_glass: "Copo",
    group_avg: "Média do grupo",
    alerts_title: "Alertas detectados",
    best_ticket: "Melhor bilhete médio", worst_ticket: "Maior oportunidade de melhoria",
    interpret_title: "Como interpretar este diagnóstico",
    interpret_p1: "A escanção de coerência mede quão homogénea é a gestão de vinho entre os seus estabelecimentos. Uma escanção elevada (≥75) indica padrões similares. Uma escanção baixa (<50) sugere que cada estabelecimento opera de forma autónoma.",
    interpret_p2: "Os alertas sinalizam estabelecimentos com valores significativamente afastados da média do grupo. Nem sempre são problemas: um estabelecimento premium pode ter preços superiores justificados. O objetivo é detectar desvios não intencionados.",
    cta_demo: "Pedir demo para grupos", cta_solutions: "Ver soluções para grupos",
    edu_title: "O que avaliar num grupo de restauração",
    edu_blocks: [
      { icon: Layers, title: "Coerência de seleção", desc: "Todos os estabelecimentos têm um número de castas proporcional ao seu perfil?" },
      { icon: DollarSign, title: "Consistência de preços", desc: "O mesmo vinho custa o mesmo em toda a parte? Diferenças não justificadas minam a perceção da marca." },
      { icon: BarChart3, title: "Benchmarking de bilhete médio", desc: "Qual estabelecimento vende mais vinho por mesa? O estabelecimento de referência tem práticas replicáveis." },
      { icon: Wine, title: "Penetração de vinho a copo", desc: "Todos os estabelecimentos oferecem vinho a copo? Um estabelecimento sem vinho a copo perde 35-45% das mesas que pediriam vinho." },
    ],
    when_title: "Quando utilizar esta ferramenta",
    when_items: [
      "Ao implementar um sistema de gestão centralizada de vinho no seu grupo.",
      "Antes das reuniões trimestrais para trazer dados concretos.",
      "Ao detectar inconsistências de preço entre estabelecimentos.",
      "Quando um estabelecimento tem um desempenho significativamente pior em vinho.",
      "Ao preparar a negociação anual com distribuidores (volume consolidado).",
      "Ao abrir um novo estabelecimento e definir a sua carta com base nos padrões do grupo.",
    ],
    faqs: [
      { q: "A partir de quantos estabelecimentos faz sentido?", a: "A partir de 2 estabelecimentos já é possível comparar. A partir de 5, torna-se imprescindível." },
      { q: "Posso comparar estabelecimentos com perfis muito diferentes?", a: "Sim, mas interprete os resultados com critério. O valor está em detectar desvios não justificados." },
      { q: "Uma escanção baixa é sempre má?", a: "Não necessariamente. O importante é que os desvios sejam intencionais." },
      { q: "A Winerim oferece esta análise automatizada?", a: "Sim. A Winerim centraliza a gestão e gera dashboards comparativos em tempo real." },
    ],
    links: [
      { to: "/pt/solucoes/grupos-restauracao", label: "Winerim para grupos de restauração", type: "solution" },
      { to: "/pt/recursos/modelo-controlo-grupos-restauracao", label: "Modelo de controlo para grupos", type: "resource" },
      { to: "/pt/guias/gerir-carta-vinho-grupos-restauracao", label: "Guia: gerir carta de vinhos em grupos", type: "guide" },
      { to: "/pt/ferramentas/calculadora-bilhete-vinho", label: "Calculadora de bilhete médio", type: "tool" },
      { to: "/pt/demo", label: "Pedir demo para grupos", type: "solution" },
    ],
    final_cta_title: "Gerencie o vinho de todo o seu grupo a partir de um único painel",
    final_cta_desc: "A Winerim centraliza carta, stock e análise de todos os seus estabelecimentos. Benchmarking automático, alertas de desvio e controlo de seleção em tempo real.",
    final_cta_btn: "Pedir demo para grupos",
    issue_refs_low: (n, v, a) => `Seleção muito inferior à média do grupo (${v} contra ${Math.round(a)} castas)`,
    issue_refs_high: (n, v, a) => `Seleção muito superior à média (${v} contra ${Math.round(a)} castas). Possível sobredimensionamento.`,
    issue_price_low: (n, v, a) => `Preço médio de garrafa muito inferior (${v}€ contra ${Math.round(a)}€). Revise o preço.`,
    issue_price_high: (n, v, a) => `Preço médio de garrafa muito superior (${v}€ contra ${Math.round(a)}€). Justificado pelo perfil?`,
    issue_ratio_low: (n, v, a) => `Rácio de vinho muito baixo (${v}% contra ${Math.round(a)}%). Oportunidade de melhoria.`,
    issue_glass_low: (n, v) => `Rácio a copo inferior a 15%. Oportunidade de crescimento através do vinho a copo.`,
    issue_glass_price_low: (n, v, a) => `Preço médio a copo inferior à média (${v}€ contra ${a}€).`,
    decides: ["Se há coerência na gestão de vinho entre estabelecimentos", "Qual estabelecimento necessita mais atenção no preço ou seleção", "Se o grupo se beneficiaria de um padrão centralizado"],
    avoids: ["Que cada estabelecimento funcione com critérios diferentes sem controlo", "Desvios de preço que minam a marca", "Perder poder de negociação por falta de visão consolidada"],
    impact: ["Detectar oportunidades de melhoria em estabelecimentos com pior desempenho", "Padronizar a gestão e reduzir ineficiências", "Preparar negociações com distribuidores com dados do grupo"],
  },
};

...
const qt: Record<string, QT> = {
  ...
  de: {
    metaTitle: "Was ist Winerim | Intelligente Weinkarten-Software",
    metaDesc: "Winerim ist eine intelligente Plattform, die Restaurants hilft, mehr Wein zu verkaufen, ihren Weinkeller zu optimieren und das Kundenerlebnis zu verbessern.",
    breadLabel: "Was ist Winerim", badge: "Die Plattform",
    heroTitle1: "Was ist ", heroHighlight: "Winerim",
    heroDesc: "Winerim ist eine intelligente Plattform, die Restaurants dabei unterstützt, mehr Wein zu verkaufen, ihren Weinkeller zu optimieren und das Gästeerlebnis zu verbessern.",
    ctaDemo: "Demo anfordern", ctaAnalyze: "Meine Weinkarte analysieren",
    defLabel: "Definition", defTitle1: "Eine Software, die Ihre Weinkarte in ein ", defHighlight: "Verkaufsinstrument verwandelt",
    defDesc: "Winerim ist eine auf das Management und die Optimierung von Weinkarten in Restaurants spezialisierte Software. Sie kombiniert moderne Technologie mit önologischem Wissen, um die Art und Weise zu verändern, wie Restaurants Wein präsentieren, empfehlen und verkaufen.",
    defItems: ["Interaktive digitale Weinkarte", "Intelligente KI-Empfehlungen", "Verkaufsanalyse in Echtzeit", "Ganzheitliche Weinkellerverwaltung", "Preisoptimierung", "Automatische Speisenbegleitung"],
    problemLabel: "Das Problem", problemTitle1: "Welches Problem Winerim ", problemHighlight: "löst",
    problemDesc: "Wein ist das Produkt mit der höchsten Marge in der Gastronomie, doch die meisten Restaurants schöpfen sein Potenzial nicht aus.",
    problems: [
      { title: "Schwer verständliche Weinkarten", desc: "Lange Listen ohne Kontext und Struktur überfordern den Gast und drängen ihn dazu, das Günstigste oder Bekannteste zu wählen." },
      { title: "Unsichere Gäste bei der Weinwahl", desc: "Ohne klare Empfehlungen fürchtet der Gast, eine falsche Wahl zu treffen. Ergebnis: Er bestellt keinen Wein oder immer denselben." },
      { title: "Service ohne Zeit zur Beratung", desc: "Im laufenden Service kann das Serviceteam nicht immer jeden Tisch ausführlich zur Weinkarte beraten." },
      { title: "Weine ohne Rotation", desc: "Referenzen, die im Keller stehen bleiben, weil sie falsch bepreist, stilistisch doppelt besetzt oder nicht sichtbar sind." },
      { title: "Entscheidungen aus dem Bauch heraus", desc: "Einkauf, Preisgestaltung und Kartenstruktur werden ohne echte Leistungsdaten und ohne Verkaufsanalyse entschieden." },
    ],
    processLabel: "Der Prozess", processTitle1: "Wie Winerim ", processHighlight: "funktioniert",
    steps: [
      { title: "Laden Sie Ihre Weinkarte hoch", desc: "Laden Sie Ihre aktuelle Weinkarte in jedem beliebigen Format hoch. Winerim importiert und strukturiert alle Informationen automatisch." },
      { title: "Winerim organisiert und optimiert", desc: "Das System analysiert Preise, Kategorien und Stile und erkennt Verbesserungsmöglichkeiten in der Kartenstruktur." },
      { title: "Gäste interagieren", desc: "Die Gäste greifen auf eine intelligente digitale Weinkarte mit Filtern, Speisenbegleitung und personalisierten Empfehlungen zu." },
      { title: "Daten und Empfehlungen erhalten", desc: "Das Restaurant erhält Verkaufsanalysen, Leistungskennzahlen und laufende Optimierungsvorschläge." },
    ],
    featLabel: "Funktionen", featTitle1: "Alles, was Sie brauchen, um ", featHighlight: "mehr Wein zu verkaufen",
    features: [
      { title: "Interaktive digitale Weinkarte", desc: "Eine visuelle, navigierbare und stets aktuelle Weinkarte, die auf jedem Gerät funktioniert." },
      { title: "Weinempfehlungen", desc: "KI, die den idealen Wein auf Basis der Gästevorlieben, des gewählten Gerichts und des Kontexts vorschlägt." },
      { title: "Speisenbegleitung", desc: "Automatische Vorschläge zur Kombination jedes Weins mit den Gerichten der Speisekarte." },
      { title: "Filter und Vergleich", desc: "Der Gast filtert nach Typ, Region, Preis oder Stil und vergleicht Weine mit klaren Informationen nebeneinander." },
      { title: "Verkaufsanalyse", desc: "Dashboards mit echten Daten dazu, was sich verkauft, was rotiert, welche Marge erzielt wird und wo Chancen liegen." },
      { title: "Preisoptimierung", desc: "Analyse der Preisstruktur, um Lücken, Ungleichgewichte und Upselling-Potenziale zu erkennen." },
    ],
    benefitLabel: "Vorteile", benefitTitle1: "Was Restaurants mit ", benefitHighlight: "Winerim erreichen",
    benefits: ["Weinumsatz steigern", "Durchschnittsbon erhöhen", "Weinrotation optimieren", "Serviceteam entlasten", "Gästeerlebnis verbessern"],
    audienceLabel: "Zielgruppe", audienceTitle1: "Für wen ist ", audienceHighlight: "Winerim gedacht",
    audiences: [
      { title: "Unabhängige Restaurants", desc: "Von Bistros bis zu gastronomischen Restaurants, die ihr Weinangebot professionalisieren und mehr verkaufen möchten." },
      { title: "Weinbars und Vinotheken", desc: "Spezialisierte Lokale, die umfangreiche Karten managen und ein Entdeckererlebnis bieten wollen." },
      { title: "Hotels", desc: "Betriebe mit mehreren Outlets, die Konsistenz und eine zentrale Verwaltung des Weinangebots benötigen." },
      { title: "Restaurantgruppen", desc: "Ketten und Gruppen, die Weinkarten standortübergreifend standardisieren, analysieren und optimieren müssen." },
    ],
    faqs: [
      { q: "Was ist Winerim?", a: "Winerim ist eine intelligente Plattform zur Verwaltung von Weinkarten in Restaurants. Sie kombiniert eine interaktive digitale Karte, KI-Empfehlungen, Verkaufsanalysen und Werkzeuge zur Preisoptimierung, um mehr Wein zu verkaufen." },
      { q: "Welches Problem löst Winerim?", a: "Winerim löst die häufigsten Probleme beim Weinverkauf in Restaurants: schwer verständliche Karten, fehlende Empfehlungen, Weine ohne Rotation und Einkaufsentscheidungen aus dem Bauch heraus." },
      { q: "Wie funktioniert Winerim?", a: "Das Restaurant lädt seine Weinkarte hoch, Winerim organisiert und optimiert die Informationen, die Gäste interagieren mit einer intelligenten digitalen Karte und das Restaurant erhält Analysen sowie Vorschläge zur kontinuierlichen Verbesserung." },
      { q: "Für wen ist Winerim gedacht?", a: "Winerim ist für unabhängige Restaurants, Weinbars, Hotels und Restaurantgruppen konzipiert, die ihr Weinangebot professionalisieren, Umsätze steigern und ihren Weinkeller optimieren möchten." },
    ],
    ctaFLabel: "Beginnen Sie heute", ctaFTitle1: "Machen Sie Ihre Weinkarte zu einem ", ctaFHighlight: "Verkaufsinstrument",
    ctaFDesc: "Entdecken Sie, wie Winerim die Art und Weise verändert, wie Ihr Restaurant Wein verkauft. Unverbindlich.",
    ctaFDemo: "Demo anfordern", ctaFAnalyze: "Meine Karte analysieren",
    links: [{ label: "Weinkarten-Software" }, { label: "Wie man mehr Wein verkauft" }, { label: "Weinkarten-Analyzer" }, { label: "Pläne und Preise" }],
  },
  pt: {
    metaTitle: "O que é a Winerim | Software Inteligente de Carta de Vinhos",
    metaDesc: "A Winerim é uma plataforma inteligente que ajuda os restaurantes a vender mais vinho, otimizar a garrafeira e melhorar a experiência do cliente.",
    breadLabel: "O que é a Winerim", badge: "A plataforma",
    heroTitle1: "O que é a ", heroHighlight: "Winerim",
    heroDesc: "A Winerim é uma plataforma inteligente concebida para ajudar os restaurantes a vender mais vinho, otimizar a garrafeira e melhorar a experiência do cliente.",
    ctaDemo: "Pedir demo", ctaAnalyze: "Analisar a minha carta de vinhos",
    defLabel: "Definição", defTitle1: "Um software que transforma a sua carta numa ferramenta de ", defHighlight: "vendas",
    defDesc: "A Winerim é um software especializado na gestão e otimização de cartas de vinhos em restaurantes. Combina tecnologia avançada com conhecimento enológico para transformar a forma como os restaurantes apresentam, recomendam e vendem vinho.",
    defItems: ["Carta digital interativa", "Recomendações inteligentes com IA", "Análise de vendas em tempo real", "Gestão integral da garrafeira", "Otimização de preços", "Harmonizações automáticas com pratos"],
    problemLabel: "O problema", problemTitle1: "Que problema ", problemHighlight: "resolve",
    problemDesc: "O vinho é o produto com maior margem na restauração, mas a maioria dos restaurantes não aproveita o seu potencial.",
    problems: [
      { title: "Cartas difíceis de compreender", desc: "Listagens longas sem contexto nem estrutura que sobrecarregam o cliente e o empurram para o mais barato ou o mais conhecido." },
      { title: "Clientes inseguros ao escolher vinho", desc: "Sem recomendações claras, o cliente teme errar. Resultado: não pede vinho ou pede sempre o mesmo." },
      { title: "Equipa sem tempo para recomendar", desc: "Durante o serviço, a equipa de sala nem sempre consegue dedicar tempo a explicar a carta de vinhos a cada mesa." },
      { title: "Vinhos que não rodam", desc: "Referências que estagnam na garrafeira por mau posicionamento de preço, estilo duplicado ou falta de visibilidade." },
      { title: "Decisões baseadas na intuição", desc: "Compras, preços e estrutura de carta são decididos sem dados reais de desempenho nem análise de vendas." },
    ],
    processLabel: "O processo", processTitle1: "Como ", processHighlight: "funciona",
    steps: [
      { title: "Carregue a sua carta de vinhos", desc: "Envie a sua carta atual em qualquer formato. A Winerim importa e estrutura toda a informação automaticamente." },
      { title: "A Winerim organiza e otimiza", desc: "O sistema analisa preços, categorias e estilos e deteta oportunidades de melhoria na estrutura da carta." },
      { title: "Os clientes interagem", desc: "Os clientes acedem a uma carta digital inteligente com filtros, harmonizações e recomendações personalizadas." },
      { title: "Obtenha dados e recomendações", desc: "O restaurante recebe análises de vendas, métricas de desempenho e sugestões de otimização contínua." },
    ],
    featLabel: "Funcionalidades", featTitle1: "Tudo o que precisa para ", featHighlight: "vender mais vinho",
    features: [
      { title: "Carta digital interativa", desc: "Uma carta de vinhos visual, navegável e sempre atualizada que funciona em qualquer dispositivo." },
      { title: "Recomendações de vinho", desc: "IA que sugere o vinho ideal de acordo com as preferências do cliente, o prato escolhido e o contexto." },
      { title: "Harmonizações com pratos", desc: "Propostas de harmonização automáticas que ligam cada vinho aos pratos do menu." },
      { title: "Filtros e comparador", desc: "O cliente filtra por tipo, região, preço ou estilo e compara vinhos lado a lado com informação clara." },
      { title: "Análise de vendas", desc: "Dashboards com dados reais sobre o que se vende, o que roda, que margem gera e onde estão as oportunidades." },
      { title: "Otimização de preços", desc: "Análise da estrutura de preços para detetar lacunas, desequilíbrios e oportunidades de upselling." },
    ],
    benefitLabel: "Benefícios", benefitTitle1: "O que os restaurantes conseguem com a ", benefitHighlight: "Winerim",
    benefits: ["Aumentar as vendas de vinho", "Melhorar o ticket médio", "Otimizar a rotação de vinhos", "Apoiar a equipa de sala", "Melhorar a experiência do cliente"],
    audienceLabel: "Público-alvo", audienceTitle1: "Para quem é a ", audienceHighlight: "Winerim",
    audiences: [
      { title: "Restaurantes independentes", desc: "De bistrôs a restaurantes gastronómicos que pretendem profissionalizar a sua oferta de vinhos e vender mais." },
      { title: "Wine bars e garrafeiras", desc: "Espaços especializados que precisam de gerir cartas amplas e oferecer uma experiência de descoberta." },
      { title: "Hotéis", desc: "Unidades com vários pontos de venda que exigem coerência e gestão centralizada da oferta de vinhos." },
      { title: "Grupos de restauração", desc: "Cadeias e grupos que necessitam de padronizar, analisar e otimizar as cartas de vinhos em várias unidades." },
    ],
    faqs: [
      { q: "O que é a Winerim?", a: "A Winerim é uma plataforma inteligente de gestão de cartas de vinhos para restaurantes. Combina carta digital interativa, recomendações com IA, análise de vendas e ferramentas de otimização de preços para ajudar os restaurantes a vender mais vinho." },
      { q: "Que problema resolve a Winerim?", a: "A Winerim resolve os problemas mais comuns na venda de vinho em restaurantes: cartas difíceis de compreender, falta de recomendações, vinhos que não rodam e decisões de compra baseadas na intuição em vez de dados." },
      { q: "Como funciona a Winerim?", a: "O restaurante carrega a sua carta de vinhos, a Winerim organiza e otimiza a informação, os clientes interagem com uma carta digital inteligente com filtros e recomendações, e o restaurante obtém análises e sugestões de melhoria contínua." },
      { q: "Para quem foi pensada a Winerim?", a: "A Winerim foi concebida para restaurantes independentes, wine bars, hotéis e grupos de restauração que queiram profissionalizar a sua oferta de vinhos, aumentar vendas e otimizar a garrafeira." },
    ],
    ctaFLabel: "Comece hoje", ctaFTitle1: "Transforme a sua carta de vinhos numa ferramenta de ", ctaFHighlight: "vendas",
    ctaFDesc: "Descubra como a Winerim pode transformar a forma como o seu restaurante vende vinho. Sem compromisso.",
    ctaFDemo: "Pedir demo", ctaFAnalyze: "Analisar a minha carta",
    links: [{ label: "Software de carta de vinhos" }, { label: "Como vender mais vinho" }, { label: "Analisador de carta" }, { label: "Planos e preços" }],
  },
};
...
const QueEsWinerim = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {lang === "de" && (
        <section className="max-w-3xl mx-auto px-6 md:px-12 py-12">
          <QuickAnswer question="Was ist Winerim?" answer="Winerim ist eine intelligente Plattform zur Verwaltung von Weinkarten in Restaurants. Sie kombiniert eine interaktive digitale Weinkarte, KI-gestützte Empfehlungen, Verkaufsanalysen und Werkzeuge zur Preisoptimierung, um Restaurants dabei zu helfen, mehr Wein zu verkaufen und ihren Weinkeller besser zu verwalten." details={["100 % cloudbasiert — keine Installation oder spezielle Hardware erforderlich","Bereitstellung in 1–5 Tagen mit der bestehenden Weinkarte des Restaurants","Ersetzt nicht den Sommelier — ergänzt ihn mit Daten und Intelligenz"]} source="Winerim ist seit 2024 mit Restaurants, Hotels und Restaurantgruppen in Spanien und Europa aktiv." />
          <ComparisonTable title="Winerim vs. traditionelle Alternativen" subtitle="Objektiver Vergleich der gängigsten Arten, eine Weinkarte zu präsentieren" featureLabel="Merkmal" columns={["Papierkarte", "PDF / einfacher QR", "Winerim"]} highlightColumn={2} rows={[{feature:"Aktualisierung in Echtzeit",options:[false,false,true]},{feature:"Personalisierte Empfehlungen",options:[false,false,true]},{feature:"Automatische Speisenbegleitung",options:[false,false,true]},{feature:"Filter und Suche",options:[false,false,true]},{feature:"Verkaufsanalyse",options:[false,false,true]},{feature:"Bestandsverwaltung",options:[false,false,true]},{feature:"Angereicherte visuelle Informationen",options:[false,"partial",true]},{feature:"Druckkosten",options:[true,false,false]},{feature:"Funktioniert offline",options:[true,"partial",false]}]} />
          <NotForSection idealFor={["Restaurants mit 30+ Weinreferenzen","Weinbars mit breitem Angebot","Hotels mit Restaurant und Zimmerservice","Restaurantgruppen mit mehreren Standorten","Restaurants, die echte Daten zu ihren Weinverkäufen wollen"]} notFor={["Restaurants mit weniger als 15 Referenzen","Betriebe ohne Tischservice","Betriebe, die keinen Wein verkaufen","Restaurants, die keine Prozesse digitalisieren möchten"]} />
        </section>
      )}
      {lang === "pt" && (
        <section className="max-w-3xl mx-auto px-6 md:px-12 py-12">
          <QuickAnswer question="O que é a Winerim?" answer="A Winerim é uma plataforma inteligente de gestão de cartas de vinhos para restaurantes. Combina uma carta digital interativa, recomendações com IA, análise de vendas e ferramentas de otimização de preços para ajudar os restaurantes a vender mais vinho e gerir melhor a garrafeira." details={["100% na cloud — sem instalação nem hardware especial","Implementação em 1 a 5 dias com a carta existente do restaurante","Não substitui o sommelier — complementa-o com dados e inteligência"]} source="A Winerim opera desde 2024 com restaurantes, hotéis e grupos de restauração em Espanha e na Europa." />
          <ComparisonTable title="Winerim vs. alternativas tradicionais" subtitle="Comparação objetiva entre as formas mais comuns de apresentar uma carta de vinhos" featureLabel="Funcionalidade" columns={["Carta em papel", "PDF / QR simples", "Winerim"]} highlightColumn={2} rows={[{feature:"Atualização em tempo real",options:[false,false,true]},{feature:"Recomendações personalizadas",options:[false,false,true]},{feature:"Harmonizações automáticas",options:[false,false,true]},{feature:"Filtros e pesquisa",options:[false,false,true]},{feature:"Análise de vendas",options:[false,false,true]},{feature:"Gestão de stock",options:[false,false,true]},{feature:"Informação visual enriquecida",options:[false,"partial",true]},{feature:"Custo de impressão",options:[true,false,false]},{feature:"Funciona offline",options:[true,"partial",false]}]} />
          <NotForSection idealFor={["Restaurantes com 30+ referências de vinho","Wine bars com oferta ampla","Hotéis com restaurante e room service","Grupos de restauração com múltiplas unidades","Restaurantes que querem dados reais sobre as vendas de vinho"]} notFor={["Restaurantes com menos de 15 referências","Negócios sem serviço de mesa","Estabelecimentos que não vendem vinho","Restaurantes que preferem não digitalizar nenhum processo"]} />
        </section>
      )}

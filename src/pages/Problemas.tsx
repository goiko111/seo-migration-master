...
const content: Record<string, LangContent> = {
  ...
  de: {
    seoTitle: "Probleme mit der Weinkarte | Diagnose und Lösungen",
    seoDesc: "Funktioniert Ihre Weinkarte nicht? Vollständige Diagnose der häufigsten Probleme für Restaurants, Gäste und das Gesamterlebnis.",
    badge: "Diagnose", h1: "Probleme mit der Weinkarte",
    subtitle: "Alle Probleme, die den Weinumsatz in Ihrem Restaurant beeinflussen – gegliedert nach Perspektive: Restaurant, Gast und Gesamterlebnis.",
    blocks: [
      {
        badge: "Für das Restaurant", title: "17 Probleme, die Ihren Weinumsatz bremsen",
        pains: [
          { icon: Wine, title: "Die Karte verkauft nicht, sie informiert nur", desc: "Ihre Karte präsentiert Weine, leitet den Gast aber nicht zum Kauf." },
          { icon: TrendingDown, title: "Wein wird unter Wert verkauft", desc: "Der Weinumsatz liegt deutlich unter dem tatsächlichen Potenzial." },
          { icon: DollarSign, title: "Durchschnittlicher Weinbon zu niedrig", desc: "Gäste geben weniger für Wein aus, als sie könnten." },
          { icon: Clock, title: "Das Team hat keine Zeit für Weinverkauf", desc: "Der Service läuft schnell, kein Spielraum für Empfehlungen." },
          { icon: Brain, title: "Fehlendes Wissen für Empfehlungen", desc: "Das Servicepersonal beherrscht die Weinkarte nicht." },
          { icon: UserX, title: "Abhängigkeit vom Sommelier", desc: "Ohne den Sommelier empfiehlt niemand kompetent." },
          { icon: ListX, title: "Zu viele Referenzen ohne Verkaufsstrategie", desc: "Die Karte hat viele Weine, aber keine kommerzielle Ordnung." },
          { icon: Package, title: "Weine ohne Rotation", desc: "Referenzen, die sich nicht verkaufen und Kellerplatz blockieren." },
          { icon: ShoppingCart, title: "Einkauf ohne Rentabilitätskriterien", desc: "Weine werden ohne Margen- und Nachfrageanalyse eingekauft." },
          { icon: DollarSign, title: "Nicht optimierte Margen", desc: "Die Margen pro Referenz sind nicht durchgearbeitet." },
          { icon: Tag, title: "Falsch gesetzte Preise", desc: "Flaschen-/Glaspreise sind nicht auf die Strategie abgestimmt." },
          { icon: FileX, title: "Veraltete oder schwer pflegbare Karte", desc: "Die Aktualisierung ist langsam und fehleranfällig." },
          { icon: Eye, title: "Keine Sicht auf Kundeninteressen", desc: "Sie wissen nicht, welche Weine Ihre Gäste wirklich interessieren." },
          { icon: BarChart3, title: "Keine Datengrundlage für Entscheidungen", desc: "Einkauf und Kartengestaltung basieren auf Bauchgefühl." },
          { icon: Unplug, title: "Isoliertes Weinmanagement", desc: "Karte, Bestand und Umsatz sind nicht integriert." },
          { icon: GraduationCap, title: "Schwierige Personalschulung", desc: "Schulung des Teams in Weinfragen ist teuer und zeitaufwändig." },
          { icon: Gem, title: "Wein als Margenhebel ungenutzt", desc: "Wein könnte deutlich mehr Marge liefern als derzeit." },
        ],
      },
      {
        badge: "Für den Gast", title: "8 Barrieren bei der Weinwahl",
        pains: [
          { icon: HelpCircle, title: "Versteht die Karte nicht", desc: "Zu viele Fachinfos, zu wenig nützlicher Kontext." },
          { icon: ListX, title: "Ist von der Auswahl überfordert", desc: "Zu viele Optionen ohne klare Orientierung." },
          { icon: ChevronsDown, title: "Bestellt am Ende den günstigsten", desc: "Ohne Orientierung ist der Preis das einzige Kriterium." },
          { icon: Utensils, title: "Weiß nicht, was zum Gericht passt", desc: "Keine Informationen zur Speisenbegleitung." },
          { icon: BookX, title: "Versteht die Fachbegriffe nicht", desc: "Weinvokabular, das den durchschnittlichen Gast abschreckt." },
          { icon: ShieldAlert, title: "Hat Angst, sich falsch zu entscheiden", desc: "Unsicherheit bremst die Entdeckungsfreude." },
          { icon: Equal, title: "Empfindet alle Weine als gleich", desc: "Keine klare Differenzierung zwischen den Referenzen." },
          { icon: Compass, title: "Ungeleitete Auswahl", desc: "Die Weinwahl wird nicht unterstützt." },
        ],
      },
      {
        badge: "Für das Erlebnis", title: "4 Probleme, die das Gesamterlebnis beeinträchtigen",
        pains: [
          { icon: HeartCrack, title: "Eine schlechte Weinwahl ruiniert das Erlebnis", desc: "Ein schlecht gewählter Wein schadet dem gesamten Restaurantbesuch." },
          { icon: Lock, title: "Eine komplexe Karte bremst den Verkauf", desc: "Komplexität führt dazu, dass der Gast auf Wein verzichtet." },
          { icon: Unplug, title: "Wein ist nicht in den Service integriert", desc: "Wein wird separat behandelt, nicht als Teil des Erlebnisses." },
          { icon: Lightbulb, title: "Verpasste Chance zu beraten und zu verkaufen", desc: "Jede Interaktion rund um Wein ist eine ungenutzte Gelegenheit." },
        ],
      },
    ],
    summary_badge: "Zusammenfassung",
    summary_title: "Die 6 Grundprobleme",
    summary_items: ["Niedriger Weinumsatz", "Niedrige Konversion", "Schlechte Rotation", "Fehlendes Wissen im Service", "Entscheidungen ohne Daten", "Nicht-kommerzielle Weinkarte"],
    notFound: "Finden Sie Ihr Problem nicht?",
    notFoundDesc: "Analysieren Sie Ihre Weinkarte kostenlos und erhalten Sie eine personalisierte Diagnose mit Verbesserungsempfehlungen.",
    notFoundBtn: "Meine Karte kostenlos analysieren",
    cta_title: "Winerim löst all diese Probleme",
    cta_sub: "Entdecken Sie, wie unsere Plattform Ihre Karte in ein Werkzeug für Verkauf, Empfehlung, Management und Analyse verwandelt.",
    cta_btn: "Funktionen ansehen",
    linksTitle: "Verwandte Inhalte",
  },
  pt: {
    seoTitle: "Problemas com a Carta de Vinhos | Diagnóstico e Soluções",
    seoDesc: "A sua carta de vinhos não funciona? Diagnóstico completo dos problemas mais comuns para restaurantes, clientes e experiência global.",
    badge: "Diagnóstico", h1: "Problemas com a carta de vinhos",
    subtitle: "Todos os problemas que afetam as vendas de vinho no seu restaurante, organizados por perspetiva: restaurante, cliente e experiência global.",
    blocks: [
      {
        badge: "Para o restaurante", title: "17 problemas que travam as suas vendas de vinho",
        pains: [
          { icon: Wine, title: "A carta não vende, só informa", desc: "A sua carta apresenta vinhos mas não orienta o cliente para a compra." },
          { icon: TrendingDown, title: "O vinho está subvendido", desc: "As vendas de vinho estão muito abaixo do potencial real." },
          { icon: DollarSign, title: "Bilhete médio em vinho demasiado baixo", desc: "Os clientes gastam menos do que poderiam em vinho." },
          { icon: Clock, title: "A equipa não tem tempo para vender vinho", desc: "O serviço é rápido e não há margem para recomendar." },
          { icon: Brain, title: "Falta de conhecimento para recomendar", desc: "O pessoal de sala não domina a carta de vinhos." },
          { icon: UserX, title: "Dependência do escanção", desc: "Sem o escanção, ninguém recomenda bem." },
          { icon: ListX, title: "Demasiadas referências sem ordem comercial", desc: "A carta tem muitos vinhos mas sem estratégia de venda." },
          { icon: Package, title: "Vinhos parados sem rotação", desc: "Referências que não se vendem e ocupam espaço na garrafeira." },
          { icon: ShoppingCart, title: "Compras sem critério de rentabilidade", desc: "Vinhos comprados sem analisar margens nem procura." },
          { icon: DollarSign, title: "Margens não otimizadas", desc: "As margens por referência não estão trabalhadas." },
          { icon: Tag, title: "Preços mal definidos", desc: "Preços de garrafa ou copo desalinhados com a estratégia." },
          { icon: FileX, title: "Carta desatualizada ou difícil de manter", desc: "Atualizar a carta é lento e propenso a erros." },
          { icon: Eye, title: "Falta de visibilidade sobre o cliente", desc: "Não sabe que vinhos interessam realmente aos seus clientes." },
          { icon: BarChart3, title: "Sem dados para decidir", desc: "As decisões de compra e carta são tomadas por intuição." },
          { icon: Unplug, title: "Gestão de vinho desligada", desc: "Carta, stock e vendas não estão integrados." },
          { icon: GraduationCap, title: "Difícil formar o pessoal", desc: "Formar a equipa em vinhos é caro e demorado." },
          { icon: Gem, title: "Vinho subaproveitado como alavanca", desc: "O vinho poderia gerar muito mais margem do que gera." },
        ],
      },
      {
        badge: "Para o cliente", title: "8 barreiras que travam a escolha do vinho",
        pains: [
          { icon: HelpCircle, title: "Não percebe a carta", desc: "Demasiada informação técnica e pouco contexto útil." },
          { icon: ListX, title: "Fica assoberbado ao escolher", desc: "Muitas opções sem guia claro geram paralisia." },
          { icon: ChevronsDown, title: "Acaba por pedir o mais barato", desc: "Sem orientação, o preço é o único critério." },
          { icon: Utensils, title: "Não sabe o que combina com o prato", desc: "Falta informação sobre harmonizações." },
          { icon: BookX, title: "Não percebe os termos técnicos", desc: "Vocabulário enológico que afasta o cliente médio." },
          { icon: ShieldAlert, title: "Tem medo de se enganar", desc: "A insegurança trava a exploração." },
          { icon: Equal, title: "Perceciona os vinhos como iguais", desc: "Sem diferenciação clara entre referências." },
          { icon: Compass, title: "Escolha não guiada", desc: "A experiência de escolha de vinho não é assistida." },
        ],
      },
      {
        badge: "Para a experiência", title: "4 problemas que afetam a experiência global",
        pains: [
          { icon: HeartCrack, title: "Uma má harmonização arruína a experiência", desc: "Um vinho mal escolhido prejudica toda a experiência gastronómica." },
          { icon: Lock, title: "Uma carta complexa trava a venda", desc: "A complexidade leva ao abandono: o cliente não pede vinho." },
          { icon: Unplug, title: "O vinho não está integrado na sala", desc: "O vinho é tratado à parte, não como parte da experiência." },
          { icon: Lightbulb, title: "Perde-se a oportunidade de educar e vender", desc: "Cada interação com o vinho é uma oportunidade desperdiçada." },
        ],
      },
    ],
    summary_badge: "Resumo",
    summary_title: "Os 6 problemas raiz",
    summary_items: ["Vendas de vinho baixas", "Baixa conversão", "Má rotação", "Falta de conhecimento na sala", "Decisões sem dados", "Carta pouco comercial"],
    notFound: "Não encontra o seu problema?",
    notFoundDesc: "Analise a sua carta de vinhos grátis e receba um diagnóstico personalizado com recomendações de melhoria.",
    notFoundBtn: "Analisar a minha carta grátis",
    cta_title: "O Winerim resolve todos estes problemas",
    cta_sub: "Descubra como a nossa plataforma transforma a sua carta numa ferramenta de venda, recomendação, gestão e análise.",
    cta_btn: "Ver funcionalidades",

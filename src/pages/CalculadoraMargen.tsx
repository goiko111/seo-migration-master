...
const i18n: Record<string, LangContent> = {
  ...
  de: {
    seoTitle: "Weinmargen-Rechner für Restaurants | Winerim Core Demo",
    seoDesc: "Berechnen Sie den Verkaufspreis und die Marge jeder Flasche und jedes Glases Wein in Ihrem Restaurant. Demo des Pricing-Motors von Winerim Core.",
    breadTools: "Tools", breadCalc: "Margen-Rechner",
    demoBadge: "Demo · Winerim Core",
    h1a: "Weinmargen-Rechner für", h1b: "Restaurants",
    subtitle: "Entdecken Sie, wie viel Sie pro Flasche und pro Glas verlangen sollten, um eine rentable Marge zu halten — nach Weintyp, Preisklasse und Restaurantkontext.",
    demoTitle: "Demo des Pricing- und Rentabilitätsmotors von Winerim Core",
    demoDesc: "Dieses Tool nutzt kontinuierliche Interpolation zwischen Preisklassen, Kontextanpassung (CADJ) und Durchschnittsbon-Anpassung (TADJ) — eine vereinfachte Version davon, wie Winerim das Pricing mit echten Daten kalibriert.",
    wineCategories: [
      { id: "still", label: "Stillwein", icon: "🍷" },
      { id: "sparkling", label: "Schaumwein", icon: "🥂" },
      { id: "champagne", label: "Champagner", icon: "🍾" },
      { id: "dessert", label: "Dessert / Süßwein", icon: "🍯" },
      { id: "fortified", label: "Likörwein", icon: "🏺" },
    ],
    restaurantContexts: [
      { id: "casual", label: "Casual", icon: "🍴" },
      { id: "gastro", label: "Gourmet", icon: "⭐" },
      { id: "hotel", label: "Hotel", icon: "🏨" },
      { id: "winebar", label: "Weinbar", icon: "🍷" },
    ],
    decides: [
      "Welchen Multiplikator Sie je nach Weintyp, Einkaufspreis und Restaurantkontext anwenden sollten",
      "Ob Ihr aktuelles Pricing genügend Marge pro Glas und Flasche lässt",
      "Wie der Durchschnittsbon die Pricing-Strategie für Wein beeinflusst",
    ],
    avoids: [
      "Denselben Multiplikator ohne Kriterium auf die gesamte Karte anzuwenden",
      "Künstliche Sprünge im Pricing beim Überschreiten von Preisschwellen",
      "Preise festzulegen, die weder die Kosten pro Glas noch den Schwund decken",
    ],
    impact: [
      "Verbesserung der durchschnittlichen Bruttomarge um 5-15%",
      "Beverage Cost % kontrolliert und für jede Referenz sichtbar",
      "Pricing abgestimmt auf die tatsächliche Positionierung des Restaurants",
    ],
    inputTitle: "Daten Ihres Weins", wineCatLabel: "Weintyp", contextLabel: "Restaurantkontext", contextHint: "Passt den Multiplikator an Ihr Profil an",
    costLabel: "Einkaufspreis (€)", costUnit: "€/Flasche", costMin: "1 €", costMax: "100 €",
    currentPriceLabel: "Aktueller Kartenpreis (€)", currentPriceOpt: "optional", currentPricePlaceholder: "Leer lassen, falls nicht zutreffend",
    glassesLabel: "Gläser pro Flasche", glassesUnit: "Gläser",
    ticketLabel: "Durchschnittsbon des Restaurants (€)", ticketHint: "Passt den Multiplikator bei hochpreisigen Weinen in Kontexten mit hohem Bon an", ticketUnit: "€/Gast",
    multLabel: "Endgültiger Multiplikator", baseMult: "Interpolierte Basis", contextAdj: "CADJ", ticketAdj: "TADJ", finalMult: "Final",
    resultsTitle: "Vollständige Analyse", resultsSummary: "Ergebnistafel",
    metricCost: "Einkaufskosten", metricPvpCurrent: "Aktueller VK", metricPvpRec: "Empfohlener VK", metricDeviation: "Abweichung",
    metricMarginAbs: "Bruttomarge", metricMarginPct: "Marge %", metricBcPct: "Beverage Cost %",
    metricGlassPrice: "VK pro Glas", metricCostPerGlass: "Kosten pro Glas", metricBreakeven: "Gläser zur Kostendeckung",
    ...
    ranges: [
      { range: "Einstiegsweine", mult: "×3.5 – ×3.8", note: "Höhere Marge %, weil der absolute Preis niedrig ist" },
      { range: "Weine der Mittelklasse", mult: "×2.6 – ×3.0", note: "Gleichgewicht zwischen Marge und Preiswahrnehmung" },
      { range: "Premium+ Weine", mult: "×1.8 – ×2.3", note: "Geringere Marge %, um wettbewerbsfähige Preise zu halten" },
    ],
    glassRuleTitle: "Die Glasregel",
    glassRuleDesc: "Der Preis eines Glases Wein sollte ausreichen, damit die ersten 2-3 verkauften Gläser die Kosten der gesamten Flasche decken. So bleibt der Betrieb auch dann rentabel, wenn 1-2 Gläser durch Schwund verloren gehen.",
    errorsTitle: "Häufige Pricing-Fehler",
    errors: ["Denselben Multiplikator für alle Weine verwenden", "Nicht zwischen Stillwein, Schaumwein und Likörwein unterscheiden", "Keine progressive Preistreppe haben", "Den Durchschnittsbon bei der Preisfestlegung ignorieren"],
  ...
  pt: {
    seoTitle: "Calculadora de Margem de Vinho para Restaurantes | Demo Winerim Core",
    seoDesc: "Calcule o preço de venda e a margem de cada garrafa e cada copo de vinho no seu restaurante. Demo do motor de pricing do Winerim Core.",
    breadTools: "Ferramentas", breadCalc: "Calculadora de margem",
    demoBadge: "Demo · Winerim Core",
    h1a: "Calculadora de margem de vinho para", h1b: "restaurantes",
    subtitle: "Descubra quanto deve cobrar por cada garrafa e copo para manter uma margem rentável — consoante o tipo de vinho, gama e contexto do restaurante.",
    demoTitle: "Demo do motor de pricing e rentabilidade do Winerim Core",
    demoDesc: "Esta ferramenta aplica interpolação contínua entre gamas de preço, ajuste por contexto de restaurante (CADJ) e ajuste por bilhete médio (TADJ) — uma versão simplificada de como o Winerim calibra o pricing com dados reais.",
    wineCategories: [
      { id: "still", label: "Tranquilo", icon: "🍷" },
      { id: "sparkling", label: "Espumante", icon: "🥂" },
      { id: "champagne", label: "Champanhe", icon: "🍾" },
      { id: "dessert", label: "Sobremesa / Doce", icon: "🍯" },
      { id: "fortified", label: "Fortificado", icon: "🏺" },
    ],
    restaurantContexts: [
      { id: "casual", label: "Casual", icon: "🍴" },
    ...
    decides: [
      ...
      "Se o seu pricing atual deixa margem suficiente por copo e garrafa",
      "Como o bilhete médio influencia a estratégia de pricing do vinho",
    ],
    avoids: [
      "Aplicar o mesmo multiplicador a toda a carta sem critério",
      "Saltos artificiais no pricing ao cruzar limiares de preço",
      "Definir preços que não cobrem o custo por copo nem a quebra",
    ],
    impact: [
      "Melhoria da margem bruta média entre 5-15%",
      "Beverage Cost % controlado e visível para cada referência",
      "Pricing alinhado com o posicionamento real do restaurante",
    ],
    inputTitle: "Dados do seu vinho", wineCatLabel: "Tipo de vinho", contextLabel: "Contexto do restaurante", contextHint: "Ajusta o multiplicador consoante o seu perfil",
    costLabel: "Preço de compra (€)", costUnit: "€/garrafa", costMin: "1 €", costMax: "100 €",
    currentPriceLabel: "Preço atual na carta (€)", currentPriceOpt: "opcional", currentPricePlaceholder: "Deixe vazio se não se aplicar",
    glassesLabel: "Copos por garrafa", glassesUnit: "copos",
    ticketLabel: "Bilhete médio do restaurante (€)", ticketHint: "Ajusta o multiplicador em vinhos de gama alta para contextos de bilhete elevado", ticketUnit: "€/comensal",
    multLabel: "Multiplicador final", baseMult: "Base interpolada", contextAdj: "CADJ", ticketAdj: "TADJ", finalMult: "Final",
    resultsTitle: "Análise completa", resultsSummary: "Painel de resultados",
    metricCost: "Custo de compra", metricPvpCurrent: "PVP atual", metricPvpRec: "PVP recomendado", metricDeviation: "Desvio",
    metricMarginAbs: "Margem bruta", metricMarginPct: "Margem %", metricBcPct: "Beverage Cost %",
    metricGlassPrice: "PVP copo", metricCostPerGlass: "Custo copo", metricBreakeven: "Copos para cobrir o custo",
    bcLabel: "Beverage Cost", bcGood: "Ótimo", bcWarning: "Em risco", bcDanger: "Crítico",
    compareLabel: "Comparação com o seu preço atual", yourPrice: "O seu preço", recommended: "Recomendado", yourMargin: "A sua margem atual",
    deviationLabel: "Desvio",
    execTitle: "Leitura executiva",
    pricingGuide: "Guia de pricing", pricingTitle: "Como calcular o preço do vinho num", pricingTitleHighlight: "restaurante",
    multMethodTitle: "O método do multiplicador interpolado",
    multMethodDesc: "Em vez de aplicar um fator fixo por gama, o Winerim utiliza interpolação contínua: o multiplicador ajusta-se progressivamente consoante o preço de custo, evitando saltos artificiais junto aos limites de cada gama.",
    ranges: [
      { range: "Vinhos de entrada", mult: "×3.5 – ×3.8", note: "Margem % maior porque o preço absoluto é baixo" },
      { range: "Vinhos de gama média", mult: "×2.6 – ×3.0", note: "Equilíbrio entre margem e perceção de preço" },
      { range: "Vinhos premium+", mult: "×1.8 – ×2.3", note: "Margem % menor para manter preços competitivos" },
    ],
    glassRuleTitle: "A regra do copo",
    glassRuleDesc: "O preço de um copo de vinho deve ser suficiente para que os 2-3 primeiros copos vendidos cubram o custo da garrafa inteira. Assim, mesmo que se percam 1-2 copos por quebra, a operação continua rentável.",
    errorsTitle: "Erros comuns de pricing",
    errors: ["Usar o mesmo multiplicador para todos os vinhos", "Não diferenciar entre tranquilo, espumante e fortificado", "Não ter uma escada de preços progressiva", "Ignorar o bilhete médio ao definir o pricing do vinho"],
...
const execI18n: Record<string, {
  ...
  de: {
    title: "Winerim-Diagnose", health: "Margengesundheit", deviation: "Abweichung vs Ziel", advice: "Empfehlung",
    optimal: "Optimal", low: "Niedrig", critical: "Kritisch",
    yourMargin: "Ihre Marge", target: "Ziel",
    execHealthy: (cat, ctx) => `Das Pricing dieses ${cat} ist für einen ${ctx}-Kontext gut kalibriert. Marge und Beverage Cost liegen im Zielbereich. Beibehalten und vierteljährlich überprüfen.`,
    execLow: (cat, priceDiff) => `Dieser ${cat} lässt ${priceDiff} € potenzielle Marge ungenutzt. Heben Sie den VK progressiv an.`,
    execCritical: (cat, margin) => `Alarm: Die Marge dieses ${cat} beträgt ${margin}%, weit unter dem Zielbereich. Dringendes Handeln erforderlich.`,
    execAbove: (diff) => `Ihr aktueller Preis liegt ${diff} € über dem empfohlenen. Prüfen Sie die Auswirkung auf die Rotation.`,
    execBcWarn: (bc) => ` Der Beverage Cost (${bc}%) überschreitet den empfohlenen Schwellenwert von 28%.`,
  },
  pt: {
    title: "Diagnóstico Winerim", health: "Saúde da margem", deviation: "Desvio vs objetivo", advice: "Recomendação",
    optimal: "Ótimo", low: "Baixo", critical: "Crítico",
    yourMargin: "A sua margem", target: "Objetivo",
    execHealthy: (cat, ctx) => `O pricing deste ${cat} está bem calibrado para um contexto ${ctx}. A margem e o Beverage Cost estão no intervalo-objetivo. Manter e rever trimestralmente.`,
    execLow: (cat, priceDiff) => `Este ${cat} está a deixar ${priceDiff} € de margem potencial por capturar. Suba o PVP progressivamente.`,
    execCritical: (cat, margin) => `Alerta: a margem deste ${cat} é de ${margin}%, muito abaixo do intervalo-objetivo. Ação urgente necessária.`,
    execAbove: (diff) => `O seu preço atual está ${diff} € acima do recomendado. Verifique o impacto na rotação.`,
    execBcWarn: (bc) => ` O Beverage Cost (${bc}%) ultrapassa o limite recomendado de 28%.`,
  },
};

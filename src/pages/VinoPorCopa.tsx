...
const i18n: I18nMap<PageContent> = {
  ...
  de: {
    metaTitle: "Wie man Wein im Glas im Restaurant verkauft | Praxis-Leitfaden",
    metaDescription: "Praxisleitfaden, um ein rentables Offen-Ausschank-Angebot in Ihrem Restaurant zu gestalten.",
    url: "https://winerim.wine/de/wein-im-glas-restaurant",
    breadcrumbLabel: "Wein im Glas", badge: "Offener Ausschank",
    h1pre: "Wie man Wein im Glas in einem", h1accent: "Restaurant verkauft",
    subtitle: "Praxisleitfaden, um ein rentables Glas-Angebot zu gestalten, das für den Gast attraktiv und einfach zu managen ist.",
    ctaAnalyze: "Meine Weinkarte analysieren", ctaDemo: "Demo anfordern",
    introTag: "Die Chance", introH2pre: "Wein im Glas ist der wirkungsvollste Weg, um", introH2accent: "mehr Wein zu verkaufen",
    introP: "Offener Ausschank beseitigt die größte Hürde beim Weinverkauf: die Verpflichtung zu einer ganzen Flasche. Der Gast kann erkunden, probieren und genießen, ohne Risiko. Für das Restaurant ist das ein starkes Werkzeug, um Durchschnittsbon und Kellerrotation zu steigern.",
    introBenefits: [
      { icon: Users, text: "Reduziert die Angst des Gastes, falsch zu wählen" },
      { icon: Wine, text: "Ermöglicht mehr Weine pro Mahlzeit zu probieren" },
      { icon: TrendingUp, text: "Erhöht den Durchschnittsbon pro Tisch" },
      { icon: ShoppingCart, text: "Verbessert die Flaschenrotation im Weinkeller" },
    ],
    howManyTag: "Die richtige Menge", howManyH2pre: "Wie viele Weine sollte man", howManyH2accent: "im Glas anbieten?",
    howManySubtitle: "Zu viele Optionen verwirren. Zu wenige schränken ein. Entscheidend ist das Gleichgewicht je nach Restauranttyp.",
    glassOfferings: [
      { type: "Kleines Restaurant", range: "3 – 5 Weine", desc: "Essenzielle Auswahl: ein Weißer, ein Rosé und zwei bis drei Rote. Ausreichend, um alle Profile abzudecken, ohne die Verwaltung zu verkomplizieren." },
      { type: "Mittelgroßes Restaurant", range: "5 – 8 Weine", desc: "Ausgewogene Vielfalt mit Vertretung unterschiedlicher Stile und Regionen. Raum für einen Schaumwein und einen süßen oder aufgespriteten Wein." },
      { type: "Gastronomisches Restaurant", range: "8 – 12 Weine", desc: "Ambitionierte Glas-Karte, die vollständige Speisenbegleitung erlaubt. Mit Premium-Optionen und häufiger Rotation der Referenzen." },
    ],
    pricingTag: "Pricing-Strategie", pricingH2pre: "Wie man den Preis für Wein", pricingH2accent: "im Glas festlegt",
    pricingP: "Die gängigste Methode folgt einer einfachen Regel: <strong>Die Flaschenkosten mit den ersten 2–3 verkauften Gläsern decken</strong>. Der Rest ist Nettogewinn. Ein praktisches Beispiel:",
    pricingItems: [
      { label: "Flaschenkosten", value: "24 €", icon: Wine },
      { label: "Gläser pro Flasche", value: "5", icon: GlassWater },
      { label: "Preis pro Glas", value: "6 – 8 €", icon: Calculator },
    ],
    pricingRuleTitle: "💡 Die goldene Regel",
    pricingRuleP: "Bei 5 Gläsern zu je 7 € erzielen Sie 35 € Umsatz aus einer 24-€-Flasche. Die <strong>ersten zwei Gläser decken bereits die Kosten</strong>. Die drei verbleibenden sind reine Marge. Selbst bei 1–2 Verlustgläsern durch Schwund bleibt die Kalkulation rentabel.",
    pricingNote: "Für Premium-Weine senken Sie den Multiplikator (×1,5–2), um attraktive Preise zu halten. Für Einstiegsweine können Sie höhere Margen anwenden (×2,5–3), weil der absolute Preis niedrig bleibt.",
    bestTag: "Intelligente Auswahl", bestH2pre: "Welche Weine funktionieren", bestH2accent: "im Glas am besten",
    bestWines: [
      { icon: Star, title: "Vielseitige Weine", desc: "Weine, die zu vielen Gerichten passen, erleichtern die Empfehlung durch das Personal und die Entscheidung des Gastes." },
      { icon: Utensils, title: "Gastronomische Weine", desc: "Referenzen, die für das Essen gedacht sind, mit guter Säure und Struktur. Sie konvertieren am Tisch am besten." },
      { icon: Users, title: "Bekannte Weine", desc: "Herkünfte und Rebsorten, die der Gast kennt, schaffen Vertrauen. Rioja, Verdejo, Albariño und Malbec wirken als Anker." },
      { icon: TrendingUp, title: "Gutes Preis-Leistungs-Verhältnis", desc: "Wer im Glas bestellt, reagiert sensibel auf den Einzelpreis. Hohe wahrgenommene Qualität zu fairen Preisen maximiert Wiederbestellungen." },
    ],
    pairingTag: "Cross-Selling", pairingH2pre: "Speisenbegleitung vervielfacht den Glas-", pairingH2accent: "Verkauf",
    pairingP1: "Zu jedem Gericht der Karte einen Glaswein vorzuschlagen, ist die wirkungsvollste Verkaufstechnik in der Gastronomie. Der Gast nimmt die Empfehlung als Service wahr – nicht als Verkauf – und bestellt mehr.",
    pairingP2: "Wenn ein Gast <strong>\"Empfohlen zu diesem Gericht\"</strong> neben einem Glaswein sieht, steigt die Wahrscheinlichkeit der Bestellung deutlich. Es ist der natürlichste Verkauf überhaupt.",
    pairingLabel: "Beispiel einer Speisenbegleitung",
    pairingExamples: [
      { dish: "Burrata-Salat", wine: "Verdejo – 6,50 € / Glas" },
      { dish: "Pilzrisotto", wine: "Fassgegorener Chardonnay – 7 € / Glas" },
      { dish: "Entrecôte vom Grill", wine: "Ribera del Duero Crianza – 8 € / Glas" },
      { dish: "Schokoladentarte", wine: "Pedro Ximénez – 5,50 € / Glas" },
    ],
    techTag: "Die Lösung", techH2pre: "Wie Technologie den Glas-Verkauf", techH2accent: "stärkt",
    techSubtitle: "Tools wie Winerim automatisieren Empfehlungen und sorgen dafür, dass sich jedes Glas praktisch von selbst verkauft.",
    techFeatures: [
      { title: "Glasweine empfehlen", desc: "Das System empfiehlt den idealen Glaswein passend zum gewählten Gericht und den Gästevorlieben." },
      { title: "Speisenbegleitung zeigen", desc: "Jeder Glaswein wird mit den Gerichten der Karte verknüpft und vervielfacht so die Cross-Selling-Chancen." },
      { title: "Wein erklären", desc: "Klare Verkostungsnotizen, Herkünfte und Sensorik-Profile machen den Wein zugänglich – ohne Sommelier." },
      { title: "Entscheidung des Gastes erleichtern", desc: "Filter, Vergleiche und Empfehlungen beseitigen Entscheidungsparalyse und beschleunigen die Bestellung." },
    ],
    ctaTag: "Kostenlose Analyse", ctaH2pre: "Erfahren Sie, ob Ihr Glas-Angebot", ctaH2accent: "optimiert ist",
    ctaSubtitle: "Senden Sie uns Ihre Weinkarte und wir analysieren Auswahl, Preise, Speisenbegleitung und Verbesserungspotenziale im offenen Ausschank. Unverbindlich.",
    ctaPrimary: "Kostenlose Analyse anfordern", ctaSecondary: "Kontakt",
    faqs: [
      { q: "Wie viele Weine im Glas sollte ein Restaurant anbieten?", a: "Das hängt vom Typ ab: 3–5 für kleine Betriebe, 5–8 für mittelgroße Restaurants und 8–12 für gastronomische Restaurants." },
      { q: "Wie berechnet man den Preis für ein Glas Wein?", a: "Üblich ist, die Flaschenkosten durch die Anzahl der Gläser (meist 5) zu teilen und eine Marge aufzuschlagen. Ziel: Die Flaschenkosten mit den ersten 2–3 verkauften Gläsern decken." },
      { q: "Welche Weine eignen sich am besten für den Ausschank im Glas?", a: "Vielseitige Weine mit breiter Speisenbegleitung, bekannte Herkünfte, gastronomische Weine mit guter Säure und Weine mit gutem Preis-Leistungs-Verhältnis." },
      { q: "Wie steigere ich den Glas-Verkauf?", a: "Durch vorgeschlagene Speisenbegleitung zu jedem Gericht, digitale Tools, Schulung des Personals und ein rotierendes Angebot." },
    ],
    links: [
      { to: "/herramientas/calculadora-precio-vino-por-copa", label: "Preisrechner pro Glas", type: "tool" },
      { to: "/como-vender-mas-vino-en-un-restaurante", label: "Wie man mehr Wein verkauft", type: "guide" },
      { to: "/precio-vino-restaurante", label: "Weinpreis im Restaurant", type: "guide" },
    ],
  },
  pt: {
    metaTitle: "Como Vender Vinho a Copo num Restaurante | Guia Prático",
    metaDescription: "Guia prático para desenhar uma oferta de vinhos a copo rentável no seu restaurante.",
    url: "https://winerim.wine/pt/vinho-a-copo-restaurante",
    breadcrumbLabel: "Vinho a copo", badge: "Vinho a copo",
    h1pre: "Como vender vinho a copo num", h1accent: "restaurante",
    subtitle: "Guia prático para desenhar uma oferta de vinhos a copo rentável, atrativa para o cliente e fácil de gerir.",
    ctaAnalyze: "Analisar a minha carta de vinhos", ctaDemo: "Pedir demo",
    introTag: "A oportunidade", introH2pre: "O vinho a copo é a forma mais eficaz de", introH2accent: "vender mais vinho",
    introP: "Oferecer vinho a copo elimina a maior barreira da venda de vinho: o compromisso com uma garrafa inteira. O cliente pode explorar, provar e desfrutar sem risco. Para o restaurante, é uma ferramenta poderosa para aumentar o ticket médio e a rotação da garrafeira.",
    introBenefits: [
      { icon: Users, text: "Reduz o receio do cliente em escolher mal" },
      { icon: Wine, text: "Permite provar mais vinhos na mesma refeição" },
      { icon: TrendingUp, text: "Aumenta o ticket médio da mesa" },
      { icon: ShoppingCart, text: "Melhora a rotação de garrafas na garrafeira" },
    ],
    howManyTag: "A quantidade certa", howManyH2pre: "Quantos vinhos oferecer", howManyH2accent: "a copo?",
    howManySubtitle: "Demasiadas opções confundem. Poucas limitam. A chave está no equilíbrio consoante o tipo de restaurante.",
    glassOfferings: [
      { type: "Restaurante pequeno", range: "3 – 5 vinhos", desc: "Seleção essencial: um branco, um rosé e dois ou três tintos. Suficiente para cobrir todos os perfis sem complicar a gestão." },
      { type: "Restaurante médio", range: "5 – 8 vinhos", desc: "Variedade equilibrada com representação de estilos e regiões. Espaço para incluir um espumante e um vinho doce ou generoso." },
      { type: "Restaurante gastronómico", range: "8 – 12 vinhos", desc: "Carta a copo ambiciosa que permite harmonizações completas. Inclui opções premium e rotação frequente de referências." },
    ],
    pricingTag: "Estratégia de pricing", pricingH2pre: "Como fixar o preço do vinho", pricingH2accent: "a copo",
    pricingP: "O método mais comum parte de uma regra simples: <strong>cobrir o custo da garrafa com os primeiros 2-3 copos vendidos</strong>. O resto é lucro líquido. Vejamos um exemplo prático:",
    pricingItems: [
      { label: "Custo da garrafa", value: "24 €", icon: Wine },
      { label: "Copos por garrafa", value: "5", icon: GlassWater },
      { label: "Preço por copo", value: "6 – 8 €", icon: Calculator },
    ],
    pricingRuleTitle: "💡 A regra de ouro",
    pricingRuleP: "Com 5 copos a 7 € cada, fatura 35 € por uma garrafa de 24 €. Os <strong>dois primeiros copos já cobrem o custo</strong>. Os três restantes são margem pura. Mesmo com 1-2 copos perdidos por desperdício, a operação continua rentável.",
    pricingNote: "Para vinhos premium, ajuste o multiplicador para baixo (×1,5-2) para manter preços atrativos. Para vinhos de entrada pode aplicar margens maiores (×2,5-3) porque o preço absoluto continua baixo.",
    bestTag: "Seleção inteligente", bestH2pre: "Que vinhos funcionam melhor", bestH2accent: "a copo",
    bestWines: [
      { icon: Star, title: "Vinhos versáteis", desc: "Vinhos que funcionam com muitos pratos diferentes, facilitando a recomendação da equipa e a decisão do cliente." },
      { icon: Utensils, title: "Vinhos gastronómicos", desc: "Referências pensadas para acompanhar comida, com boa acidez e estrutura. São os que melhor convertem à mesa." },
      { icon: Users, title: "Vinhos conhecidos", desc: "Denominações e castas que o cliente reconhece geram confiança. Douro, Alvarinho, Vinho Verde ou Malbec funcionam como âncoras." },
      { icon: TrendingUp, title: "Boa relação qualidade-preço", desc: "O cliente que pede a copo é sensível ao preço unitário. Oferecer qualidade percebida alta a preço justo maximiza a repetição." },
    ],
    pairingTag: "Venda cruzada", pairingH2pre: "A harmonização multiplica a venda", pairingH2accent: "a copo",
    pairingP1: "Sugerir um vinho a copo junto a cada prato do menu é a técnica de venda mais eficaz na restauração. O cliente vê a recomendação como um serviço, não como uma venda — e pede mais.",
    pairingP2: "Quando o cliente vê <strong>«Recomendado com este prato»</strong> junto a um vinho a copo, a probabilidade de o pedir multiplica-se. É a venda mais natural que existe.",
    pairingLabel: "Exemplo de harmonização",
    pairingExamples: [
      { dish: "Salada de burrata", wine: "Alvarinho — 6,50 € / copo" },
      { dish: "Risoto de cogumelos", wine: "Chardonnay fermentado em barrica — 7 € / copo" },
      { dish: "Entrecôte grelhado", wine: "Douro Reserva — 8 € / copo" },
      { dish: "Tarte de chocolate", wine: "Porto Tawny — 5,50 € / copo" },
    ],
    techTag: "A solução", techH2pre: "Como a tecnologia potencia a venda", techH2accent: "a copo",
    techSubtitle: "Ferramentas como a Winerim automatizam as recomendações e fazem com que cada copo se venda por si só.",
    techFeatures: [
      { title: "Sugerir vinhos a copo", desc: "O sistema recomenda o vinho a copo ideal consoante o prato escolhido e as preferências do cliente." },
      { title: "Mostrar harmonizações", desc: "Cada vinho a copo aparece ligado aos pratos do menu, multiplicando as oportunidades de venda cruzada." },
      { title: "Explicar o vinho ao cliente", desc: "Notas de prova claras, origens e perfis sensoriais que tornam o vinho acessível sem necessidade de escanção." },
      { title: "Melhorar a decisão do cliente", desc: "Filtros, comparações e recomendações que eliminam a paralisia de escolha e aceleram o pedido." },
    ],
    ctaTag: "Análise gratuita", ctaH2pre: "Descubra se a sua oferta de vinhos a copo está", ctaH2accent: "otimizada",
    ctaSubtitle: "Envie-nos a sua carta e analisamos a seleção de vinhos a copo, preços, harmonizações e oportunidades de melhoria. Sem compromisso.",
    ctaPrimary: "Pedir análise gratuita", ctaSecondary: "Contactar",
    faqs: [
      { q: "Quantos vinhos a copo deve oferecer um restaurante?", a: "Depende do tipo de restaurante: entre 3-5 em estabelecimentos pequenos, 5-8 em restaurantes de dimensão média e 8-12 em restaurantes gastronómicos." },
      { q: "Como se calcula o preço de um vinho a copo?", a: "O método mais comum é dividir o custo da garrafa pelo número de copos (normalmente 5) e aplicar uma margem. O objetivo é cobrir o custo da garrafa com os primeiros 2-3 copos vendidos." },
      { q: "Que tipo de vinhos funcionam melhor a copo?", a: "Os vinhos versáteis que harmonizam com muitos pratos, as denominações conhecidas, os vinhos gastronómicos com boa acidez e os que oferecem boa relação qualidade-preço." },
      { q: "Como aumentar as vendas de vinho a copo?", a: "Sugerindo harmonizações com cada prato, utilizando ferramentas digitais, formando a equipa em técnicas de venda e mantendo uma oferta rotativa." },
    ],
    links: [
      { to: "/herramientas/calculadora-precio-vino-por-copa", label: "Calculadora preço a copo", type: "tool" },
      { to: "/como-vender-mas-vino-en-un-restaurante", label: "Como vender mais vinho", type: "guide" },
      { to: "/precio-vino-restaurante", label: "Preço do vinho no restaurante", type: "guide" },
    ],
  },
};

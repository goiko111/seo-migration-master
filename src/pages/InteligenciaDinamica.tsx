...
const i18n: I18nMap<{
  ...
  es: {
    ...
    hero_subtitle: "Inteligencia dinámica es la capa estratégica de Winerim que adapta visibilidad, recomendación, rotación y empuje comercial según margen, stock, albaranes, facturas, clima, afluencia y objetivo del restaurante.",
    ...
    s3_layers: [
      ...
      { num: "04", title: "Módulos RIM™", desc: "Deciden cuándo y por qué actuar según clima, afluencia, ventas, stock, albaranes, facturas, calendario o comportamiento real." },
    ],
    ...
    savia_subtitle: "Los dashboards muestran datos. SAVia ayuda a interpretarlos. Pregunta qué vinos están parados, qué costes han cambiado por una factura o albarán, qué RIM conviene revisar o qué oportunidades hay en la carta.",
    savia_questions: [
      ...
      "Qué RIM conviene preparar y qué impacto tendría antes de aprobarlo?",
    ],
    savia_control_title: "SAVia combina carta, ventas, stock, margen, compras, facturas, albaranes y documentos procesados",
    savia_control_text: "Convierte la operativa de vino en decisiones explicables. Puede consultar, resumir, preparar acciones y mostrar preview; no aplica RIMs ni cambios críticos sin aprobación humana.",
    savia_cta: "Ver SAVia",
    s4_badge: "Objetivos",
    ...
    s9b_core_items: ["Analiza márgenes, stock, albaranes, facturas y rentabilidad", "Diagnostica desequilibrios y oportunidades", "Simula escenarios antes de ejecutar", "Genera recomendaciones priorizadas"],
    s9b_id_label: "Inteligencia Dinámica",
    s9b_id_items: ["Reordena la carta según el objetivo activo", "Reacciona al contexto en tiempo real", "Prioriza referencias con mayor impacto", "Prepara cambios críticos para aprobación humana"],
    s9b_closing: "Core pone la inteligencia. Inteligencia Dinámica propone la acción y Winerim mantiene el control humano cuando el cambio es crítico.",
  ...
  en: {
    ...
    hero_subtitle: "Dynamic Intelligence is Winerim's strategic layer that adapts visibility, recommendations, rotation and commercial push based on margin, stock, delivery notes, invoices, weather, footfall and restaurant objectives.",

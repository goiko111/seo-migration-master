...
const content: Record<string, {
  ...
  es: {
    ...
    pos: [
      ...
      { name: "Clover", desc: "Pedidos, pagos, artículos y webhooks" },
  ...
  en: {
    ...
    pos: [
      ...
      { name: "Clover", desc: "Orders, payments, items and webhooks" },
  ...
  it: {
    ...
    pos: [
      ...
      { name: "Clover", desc: "Ordini, pagamenti, articoli e webhooks" },
  ...
  fr: {
    ...
    pos: [
      ...
      { name: "Clover", desc: "Commandes, paiements, articles et webhooks" },

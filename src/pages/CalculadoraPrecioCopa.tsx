...
const i18n: Record<string, LangContent> = {
  ...
  de: {
    seoTitle: "Glaswein-Preisrechner | Winerim Core Demo",
    seoDesc: "Berechnen Sie den optimalen Preis für Glaswein in Ihrem Restaurant. Demo des Pricing-Motors von Winerim Core mit Logik für Konservierung, Schwund und Weintyp.",
    breadTools: "Tools", breadCalc: "Glaswein-Preisrechner", demoBadge: "Demo · Winerim Core",
    h1a: "Preisrechner für Wein", h1b: "im Glas",
    subtitle: "Berechnen Sie den optimalen Preis, die Marge pro Glas und den Break-even-Punkt für Ihr Glaswein-Programm.",
    demoTitle: "Glaswein gut zu entscheiden ist mehr, als eine Flasche durch fünf zu teilen",
    demoDesc: "Winerim berücksichtigt Rentabilität, Weintyp, Konservierung, Schwund und kommerzielle Logik, um zu entscheiden, wann ein Wein im Glas angeboten werden sollte und zu welchem Preis.",
    wineTypes: [
      { id: "still-white", label: "Weißwein", glasses: 5, shelfLife: "48–72 Std.", preservation: 0, mult: 3.5, icon: "🥂" },
      { id: "still-red", label: "Rotwein", glasses: 5, shelfLife: "48–72 Std.", preservation: 0, mult: 3.2, icon: "🍷" },
      { id: "sparkling", label: "Schaumwein", glasses: 6, shelfLife: "12–24 Std.", preservation: 0.30, mult: 3.8, icon: "🍾" },
      { id: "fortified", label: "Likörwein / Süßwein", glasses: 8, shelfLife: "2–4 Wochen", preservation: 0, mult: 3.0, icon: "🫗" },
      { id: "premium", label: "Premium (Coravin)", glasses: 5, shelfLife: "4–8 Wochen", preservation: 0.80, mult: 2.5, icon: "🏆" },
    ],
    decides: [
      "Welche Weine ins Glasweinprogramm gehören und zu welchem Preis",
      "Wie viele Gläser Sie pro Weintyp verkaufen müssen, um die Flasche zu decken",
      "Ob ein Premiumwein im Glas mit einem Konservierungssystem rentabel ist",
    ],
    avoids: [
      "Gläser unter dem echten Break-even (inkl. Schwund) zu verkaufen",
      "Schaumweine im Glas anzubieten, ohne ihre begrenzte Haltbarkeit zu berücksichtigen",
      "Die Mehrkosten der Konservierung bei Premiumweinen zu ignorieren",
    ],
    impact: [
      "Kontrollierte und vorhersehbare Marge pro Glas je nach Typ",
      "Weniger Verluste durch angebrochene, nicht ausgetrunkene Flaschen",
      "Rentableres Glasweinprogramm und bessere Gästeerfahrung",
    ],
    inputTitle: "Flaschendaten", wineTypeLabel: "Weintyp",
    costLabel: "Einkaufspreis", costNote: "Anschaffungskosten (ohne MwSt.)",
    glassesLabel: "Gläser pro Flasche", glassesMin: "3 (großzügig)", glassesMax: "10 (Verkostung)",
    multLabel: "Multiplikator",
    recPrice: "Empfohlener Glaspreis", realCost: "Tatsächliche Kosten pro Glas", inclPreservation: "inkl. {n} € Konservierung",
    marginPerGlass: "Marge pro Glas", breakEven: "Break-even-Punkt", glassUnit: "Glas", glassesUnit: "Gläser", toRecoverCost: "zur Kostendeckung",
    shelfLife: "Geschätzte Haltbarkeit", onceOpened: "nach dem Öffnen",
    preservationCost: "Konservierungs-Mehrkosten", noSystem: "Kein spezielles System", coravinLabel: "Coravin / Inertgas",
    totalProfit: "Gesamtgewinn", totalProfitIf: (n) => `Gesamtgewinn, wenn alle ${n} Gläser verkauft werden`,
    revenue: "Umsatz", cost: "Kosten", preservationLabel: "Konservierung",
    notApplicable: "Nicht zutreffend",
    insightExcellent: (be, rem) => `Ausgezeichnetes Verhältnis: Die Flasche ist bereits mit ${be} Glas${be > 1 ? "" : ""} gedeckt. Die übrigen ${rem} sind Nettogewinn.`,
    insightWarning: "Achtung: Sie müssen alle Gläser verkaufen, um die Kosten zu decken. Überprüfen Sie den Multiplikator oder ziehen Sie ein anderes Format in Betracht.",
    insightNormal: (glasses, price, be) => `Mit ${glasses} Gläsern zu je ${price} € decken die ersten ${be} die Kosten. Der Rest ist Nettogewinn.`,
    tipsTitle: "Tipps zur Festlegung des Glaspreises",
    tips: [
      "Die klassische Regel: Der Glaspreis sollte es Ihnen ermöglichen, die Kosten der Flasche mit 2 verkauften Gläsern zu decken.",
      "Aus Schaumwein lassen sich 6-7 Gläser pro Flasche ziehen. Aus Rotwein 4-5. Passen Sie die Berechnung an den Typ an.",
      "Ein Multiplikator von ×3–×4 ist Standard. Weinbars erreichen bei Premium-Gläsern ×4–×5.",
      "Der Glaspreis sollte 35-40% des Flaschenpreises auf der Karte nicht überschreiten.",
      "Wenn eine Flasche nicht in 48-72 Stunden leer ist, müssen die Schwundkosten einkalkuliert werden.",
    ],
    faqs: [
      { q: "Wie viele Gläser ergibt eine Weinflasche?", a: "Eine Standardflasche mit 750 ml ergibt je nach Ausschankgröße 4 bis 6 Gläser. Im Restaurant üblich sind 5 Gläser zu je 150 ml." },
      { q: "Welchen Multiplikator soll ich verwenden?", a: "Das hängt vom Betriebstyp ab. Casual-Restaurants: ×3–×3.5. Gehobene Häuser: ×3.5–×4. Weinbars: ×4–×5." },
      { q: "Wie gehe ich mit dem Schwund um?", a: "Mit Konservierungssystemen (Coravin, Inertgas) hält der Wein 5-7 Tage. Ohne System sollten Sie mit 48-72 Stunden rechnen." },
    ],
    ctaBadge: "Winerim Core", ctaTitle: "Dieser Rechner ist nur der", ctaTitleHighlight: "Anfang",
    ctaDesc: "Winerim Core steuert das gesamte Glasweinprogramm: Rentabilität pro Glas, Schwundkontrolle, Warnungen für geöffnete Flaschen und optimale Rotation — mit echten Betriebsdaten, nicht mit generischen Formeln.",
    ctaPrimary: "Sehen, wie Winerim Core es löst", ctaSecondary: "Meine Karte kostenlos analysieren",
    internalLinks: [
      { to: "/vino-por-copa-restaurante", label: "Glaswein im Restaurant", type: "guide" },
      { to: "/calculadora-margen-vino", label: "Margen-Rechner", type: "tool" },
      { to: "/recursos/guia-vino-por-copa-para-restaurantes", label: "Glaswein-Leitfaden", type: "resource" },
      { to: "/producto/winerim-core", label: "Winerim Core: vollständige Analytik", type: "solution" },
      { to: "/demo", label: "Winerim-Demo anfragen", type: "solution" },
    ],
  },
  pt: {
    seoTitle: "Calculadora de Preço de Vinho a Copo | Demo Winerim Core",
    seoDesc: "Calcule o preço ótimo do vinho a copo no seu restaurante. Demo do motor de pricing do Winerim Core com lógica de conservação, quebra e tipo de vinho.",
    breadTools: "Ferramentas", breadCalc: "Calculadora de preço a copo", demoBadge: "Demo · Winerim Core",
    h1a: "Calculadora de preço de vinho", h1b: "a copo",
    subtitle: "Calcule o preço ótimo, a margem por copo e o ponto de equilíbrio para o seu programa de vinho a copo.",
    demoTitle: "Decidir bem o vinho a copo não é apenas dividir uma garrafa por cinco",
    demoDesc: "O Winerim tem em conta rentabilidade, tipo de vinho, conservação, quebra e lógica comercial para o ajudar a decidir quando convém servir um vinho a copo e a que preço.",
    wineTypes: [
      { id: "still-white", label: "Branco", glasses: 5, shelfLife: "48–72 h", preservation: 0, mult: 3.5, icon: "🥂" },
      { id: "still-red", label: "Tinto", glasses: 5, shelfLife: "48–72 h", preservation: 0, mult: 3.2, icon: "🍷" },
      { id: "sparkling", label: "Espumante", glasses: 6, shelfLife: "12–24 h", preservation: 0.30, mult: 3.8, icon: "🍾" },
      { id: "fortified", label: "Generoso / Doce", glasses: 8, shelfLife: "2–4 semanas", preservation: 0, mult: 3.0, icon: "🫗" },
      { id: "premium", label: "Premium (Coravin)", glasses: 5, shelfLife: "4–8 semanas", preservation: 0.80, mult: 2.5, icon: "🏆" },
    ],
    decides: [
      "Que vinhos merecem entrar no programa a copo e a que preço",
      "Quantos copos precisa de vender para cobrir a garrafa consoante o tipo de vinho",
      "Se um vinho premium a copo é rentável com sistema de conservação",
    ],
    avoids: [
      "Vender copos abaixo do ponto de equilíbrio real (incluindo a quebra)",
      "Oferecer espumantes a copo sem considerar a sua vida útil limitada",
      "Ignorar o sobrecusto de conservação em vinhos premium",
    ],
    impact: [
      "Margem por copo controlada e previsível consoante a tipologia",
      "Redução de perdas por garrafas abertas não terminadas",
      "Programa a copo mais rentável e com melhor experiência para o cliente",
    ],
    inputTitle: "Dados da garrafa", wineTypeLabel: "Tipo de vinho",
    costLabel: "Preço de compra", costNote: "Custo de aquisição (sem IVA)",
    glassesLabel: "Copos por garrafa", glassesMin: "3 (generosos)", glassesMax: "10 (prova)",
    multLabel: "Multiplicador",
    recPrice: "Preço por copo recomendado", realCost: "Custo real por copo", inclPreservation: "incl. {n} € conservação",
    marginPerGlass: "Margem por copo", breakEven: "Ponto de equilíbrio", glassUnit: "copo", glassesUnit: "copos", toRecoverCost: "para recuperar o custo",
    shelfLife: "Vida útil estimada", onceOpened: "depois de aberta",
    preservationCost: "Sobrecusto de conservação", noSystem: "Sem sistema especial", coravinLabel: "Coravin / gás inerte",
    totalProfit: "Lucro total", totalProfitIf: (n) => `Lucro total se forem vendidos todos os ${n} copos`,
    revenue: "Receita", cost: "Custo", preservationLabel: "Conservação",
    notApplicable: "Não se aplica",
    insightExcellent: (be, rem) => `Ótimo rácio: cobre a garrafa com apenas ${be} copo${be > 1 ? "s" : ""}. Os restantes ${rem} são lucro líquido.`,
    insightWarning: "Atenção: precisa de vender todos os copos para cobrir o custo. Reveja o multiplicador ou considere outro formato.",
    insightNormal: (glasses, price, be) => `Com ${glasses} copos a ${price} € cada um, os primeiros ${be} cobrem o custo. O resto é lucro líquido.`,
    tipsTitle: "Conselhos para definir o preço por copo",
    tips: [
      "A regra clássica: o preço do copo deve permitir-lhe recuperar o custo da garrafa com 2 copos vendidos.",
      "Os espumantes costumam dar 6-7 copos por garrafa. Os tintos, 4-5. Ajuste o cálculo ao tipo.",
      "Um multiplicador ×3–×4 é padrão. Os wine bars podem chegar a ×4–×5 em copos premium.",
      "O preço do copo não deve ultrapassar 35-40% do preço da mesma garrafa na carta.",
      "Se uma garrafa não se esgotar em 48-72 h, o custo de quebra deve ser incluído no cálculo.",
    ],
    faqs: [
      { q: "Quantos copos saem de uma garrafa de vinho?", a: "Uma garrafa padrão de 750 ml rende entre 4 e 6 copos consoante o tamanho da dose. O habitual nos restaurantes são 5 copos de 150 ml." },
      { q: "Que multiplicador devo usar?", a: "Depende do tipo de estabelecimento. Restaurantes casuais: ×3–×3.5. Gama média-alta: ×3.5–×4. Wine bars: ×4–×5." },
      { q: "Como giro a quebra?", a: "Com sistemas de conservação (Coravin, gás inerte) consegue manter o vinho 5-7 dias. Sem sistema, conte com 48-72 h." },
    ],
    ctaBadge: "Winerim Core", ctaTitle: "Esta calculadora é apenas o", ctaTitleHighlight: "princípio",
    ctaDesc: "O Winerim Core gere o programa a copo completo: rentabilidade por copo, controlo de quebra, alertas de garrafas abertas e rotação ótima — com dados reais da sua operação, não com fórmulas genéricas.",
    ctaPrimary: "Ver como o Winerim Core resolve", ctaSecondary: "Analisar a minha carta grátis",
    internalLinks: [
      { to: "/vino-por-copa-restaurante", label: "Vinho a copo em restaurantes", type: "guide" },
      { to: "/calculadora-margen-vino", label: "Calculadora de margens", type: "tool" },
      { to: "/recursos/guia-vino-por-copa-para-restaurantes", label: "Guia de vinho a copo", type: "resource" },
      { to: "/producto/winerim-core", label: "Winerim Core: analítica completa", type: "solution" },
      { to: "/demo", label: "Pedir demo do Winerim", type: "solution" },
    ],
  },
};
...
const CalculadoraPrecioCopa = () => {
  ...
  const canonicalUrl = `https://winerim.wine${localePath("/herramientas/calculadora-precio-vino-por-copa")}`;
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
            ...
            {(() => {
              const nl: Record<string, { title: string; withWaste: string; netProfit: string; netMargin: string; minRotation: string; glassesWeek: string; viability: string; viable: string; marginal: string; notViable: string; wasteNote: string; coravinNote: string; effectiveSold: string }> = {
                ...
                de: { title: "Nettorentabilität · Winerim", withWaste: "Mit konfiguriertem Schwund", netProfit: "Realer Nettogewinn", netMargin: "Nettomarge", minRotation: "Mindestwochenrotation", glassesWeek: "Gläser/Woche", viability: "Glaswein-Tragfähigkeit", viable: "Tragfähig", marginal: "Grenzwertig", notViable: "Nicht tragfähig", wasteNote: "Basiert auf dem oben konfigurierten Schwund. Passen Sie ihn an Ihren realen Betrieb an.", coravinNote: "Coravin/Inertgas reduziert den Schwund, aber die Konservierungs-Mehrkosten sind bereits einkalkuliert.", effectiveSold: "tatsächlich verkaufte Gläser" },
                pt: { title: "Rentabilidade líquida · Winerim", withWaste: "Com quebra configurada", netProfit: "Lucro líquido real", netMargin: "Margem líquida", minRotation: "Rotação mínima semanal", glassesWeek: "copos/semana", viability: "Viabilidade a copo", viable: "Viável", marginal: "Marginal", notViable: "Não viável", wasteNote: "Baseado na quebra configurada acima. Ajuste-a à sua operação real.", coravinNote: "Coravin/gás inerte reduz a quebra, mas o sobrecusto de conservação já está incluído no cálculo.", effectiveSold: "copos efetivamente vendidos" },
              };
              ...
              return (
                <div className="mt-5 rounded-xl border border-amber-500/20 bg-gradient-card p-5 space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-xs font-semibold tracking-[0.2em] uppercase text-amber-500">{n.title}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-lg border border-border bg-background text-center">
                      <p className="text-[10px] font-semibold tracking-widest uppercase text-muted-foreground mb-1">{n.minRotation}</p>
                      <p className="font-heading text-lg font-bold">{minGlassesPerWeek} {n.glassesWeek}</p>
                    </div>
                    <div className="p-3 rounded-lg border border-border bg-background text-center">
                      <p className="text-[10px] font-semibold tracking-widest uppercase text-muted-foreground mb-1">{n.viability}</p>
                      <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold ${viabilityBg} ${viabilityColor}`}>{viabilityLabel}</span>
                    </div>
                  </div>

                  <p className="text-[11px] text-muted-foreground leading-relaxed">
                    {hasPreservation ? n.coravinNote : n.wasteNote}
                  </p>
                </div>
              );
            })()}

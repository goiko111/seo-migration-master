...
const i18n: I18nMap<PageChrome> = {
  ...
  de: {
    seoTitle: "Benchmarks & Playbooks für Weinkarten | Winerim",
    seoDesc: "Branchenbenchmarks und praktische Playbooks zur Optimierung Ihrer Weinkarte. Referenzdaten, Aktionspläne und Expertencriteria für Restaurants.",
    badge: "Angewandtes Wissen",
    h1: "Benchmarks & Playbooks",
    subtitle: "Branchenreferenzdaten und praktische Aktionspläne zur Optimierung Ihrer Weinkarte, Verbesserung der Rentabilität und zum Verkauf von mehr Wein in Ihrem Restaurant.",
    summaryLabel: "Was Sie hier finden",
    summaryDef: "Dieser Bereich bringt Branchenbenchmarks und praktische Playbooks zur Optimierung Ihrer Weinkarte zusammen: Referenzdaten, Aktionspläne und Expertencriteria für echte Restaurants.",
    summaryBullets: [
      "Benchmarks mit Referenzbereichen zur Dimensionierung, Strukturierung und Preisgestaltung Ihrer Weinkarte.",
      "Playbooks mit Schritt-für-Schritt-Aktionsplänen zur Lösung konkreter Verkaufs-, Rotations- und Schulungsprobleme.",
      "Praktische Kriterien, nicht theoretisch: alles ist für echte Restaurants ausgelegt.",
    ],
    benchmarksLabel: "Benchmarks",
    benchmarksSub: "Branchenbezugspunkte zur Bewertung Ihrer Weinkarte und zur fundierten Entscheidungsfindung.",
    benchmarkBadge: "Benchmark",
    playbooksLabel: "Playbooks",
    playbooksSub: "Schritt-für-Schritt-Aktionspläne zur Lösung konkreter Herausforderungen und Verbesserung Ihrer Weinkartenverwaltung.",
    playbookBadge: "Playbook",
    viewBenchmark: "Benchmark ansehen",
    viewPlaybook: "Playbook ansehen",
    linksTitle: "Ergänzende Ressourcen",
    ctaH2: "Wenden Sie diese Kriterien mit Winerim an",
    ctaP: "Winerim automatisiert die Analyse, Optimierung und Verfolgung Ihrer Weinkarte, damit Sie mit weniger Aufwand bessere Entscheidungen treffen.",
    ctaBtn: "Meine Weinkarte kostenlos analysieren",
    ctaDemo: "Demo anfordern",
    faqs: [
      { q: "Was ist ein Benchmark für die Weinkarte?", a: "Ein Benchmark ist ein Referenzpunkt, mit dem Sie Ihre Weinkarte mit gängigen Branchenpraktiken vergleichen können. Es sind keine absoluten Zahlen, sondern Orientierungsspannen basierend auf der Erfahrung ähnlicher Restaurants." },
      { q: "Was ist ein Playbook für Restaurants?", a: "Ein Playbook ist ein strukturierter Aktionsplan, der Sie Schritt für Schritt durch die Lösung eines konkreten Problems Ihrer Weinkarte oder des Weinverkaufs führt." },
      { q: "Benötige ich Daten, um diese Benchmarks zu verwenden?", a: "Verkaufsdaten sind äußerst hilfreich, aber die Benchmarks sind so konzipiert, dass sie auch als qualititative Referenz zur Bewertung Ihrer Situation nützlich sind." },
      { q: "Sind sie auf alle Restauranttypen anwendbar?", a: "Der Inhalt ist nach Restauranttyp und Kontext organisiert. Jeder Benchmark und jedes Playbook zeigt, für wen es gedacht ist und wie man es anpasst." },
    ],
    links: [
      { to: "/de/leitfaden", label: "Praktische Leitfäden und herunterladbare Ressourcen", type: "guide" },
      { to: "/de/tools", label: "Kostenlose Analyse- und Pricing-Tools", type: "tool" },
      { to: "/de/weinkarten-software", label: "Intelligente Weinkartensoftware", type: "solution" },
      { to: "/de/produkt/dynamische-intelligenz", label: "Dynamische Intelligenz: KI für Weinkarten", type: "solution" },
      { to: "/de/fallstudien", label: "Fallstudien echter Restaurants", type: "solution" },
      { to: "/de/vergleiche", label: "Vergleichen Sie Winerim mit Alternativen", type: "solution" },
    ],
  },
  pt: {
    seoTitle: "Benchmarks & Playbooks para Cartas de Vinho | Winerim",
    seoDesc: "Benchmarks do setor e playbooks práticos para otimizar sua carta de vinhos. Dados de referência, planos de ação e critérios de especialistas para restaurantes.",
    badge: "Conhecimento aplicado",
    h1: "Benchmarks & Playbooks",
    subtitle: "Dados de referência do setor e planos de ação práticos para otimizar sua carta de vinhos, melhorar a rentabilidade e vender mais vinho no seu restaurante.",
    summaryLabel: "O que você encontrará aqui",
    summaryDef: "Esta secção reúne benchmarks do setor e playbooks práticos para otimizar sua carta de vinhos: dados de referência, planos de ação e critérios de especialistas para restaurantes reais.",
    summaryBullets: [
      "Benchmarks com intervalos de referência para dimensionar, estruturar e precificar sua carta de vinhos.",
      "Playbooks com planos de ação passo a passo para resolver desafios concretos de vendas, rotação e treinamento.",
      "Critérios práticos, não teóricos: tudo é projetado para ser aplicado em restaurantes reais.",
    ],
    benchmarksLabel: "Benchmarks",
    benchmarksSub: "Pontos de referência do setor para avaliar sua carta e tomar decisões informadas.",
    benchmarkBadge: "Benchmark",
    playbooksLabel: "Playbooks",
    playbooksSub: "Planos de ação passo a passo para resolver desafios concretos e melhorar sua gestão de vinhos.",
    playbookBadge: "Playbook",
    viewBenchmark: "Ver benchmark",
    viewPlaybook: "Ver playbook",
    linksTitle: "Recursos complementares",
    ctaH2: "Aplique estes critérios com Winerim",
    ctaP: "Winerim automatiza a análise, otimização e acompanhamento de sua carta de vinhos para que você tome melhores decisões com menos esforço.",
    ctaBtn: "Analisar minha carta gratuitamente",
    ctaDemo: "Solicitar demonstração",
    faqs: [
      { q: "O que é um benchmark de carta de vinhos?", a: "Um benchmark é um ponto de referência que permite comparar sua carta com as práticas comuns da indústria. Não são números absolutos, mas intervalos orientadores baseados na experiência de restaurantes semelhantes ao seu." },
      { q: "O que é um playbook para restaurantes?", a: "Um playbook é um plano de ação estruturado que o guia passo a passo para resolver um problema específico de sua carta de vinhos ou vendas de vinho." },
      { q: "Preciso de dados para usar esses benchmarks?", a: "Dados de vendas melhoram muito sua utilidade, mas os benchmarks são projetados para serem úteis mesmo como referência qualitativa para avaliar sua situação." },
      { q: "São aplicáveis a qualquer tipo de restaurante?", a: "O conteúdo é organizado por tipo de restaurante e contexto. Cada benchmark e playbook indica para quem foi concebido e como adaptá-lo." },
    ],
    links: [
      { to: "/pt/guias", label: "Guias práticos e recursos para download", type: "guide" },
      { to: "/pt/ferramentas", label: "Ferramentas gratuitas de análise e precificação", type: "tool" },
      { to: "/pt/software-carta-vinhos", label: "Software inteligente de carta de vinhos", type: "solution" },
      { to: "/pt/produto/inteligencia-dinamica", label: "Inteligência dinâmica: IA para cartas de vinhos", type: "solution" },
      { to: "/pt/estudos-caso", label: "Estudos de caso de restaurantes reais", type: "solution" },
      { to: "/pt/comparacoes", label: "Compare Winerim com alternativas", type: "solution" },
    ],
  },
};

...
const i18n: Record<string, LangContent> = {
  ...
  en: {
    ...
    internalLinks: [
      ...
      { to: "/decision-center/stock-rotacion", label: "Decision Center: stock and rotation", type: "decision-center" },
  ...
  de: {
    seoTitle: "Totbestand-Rechner für Weine | Winerim Core + Supply Demo",
    seoDesc: "Berechnen Sie, wie viel Kapital in Weinen ohne Rotation gebunden ist. Demo des Obsoleszenz-Erkennungsmotors von Winerim Core und Winerim Supply.",
    breadTools: "Tools", breadCalc: "Totbestand-Rechner", demoBadge: "Demo · Winerim Core + Supply",
    h1: "Totbestand-Rechner", subtitle: "Schätzen Sie, wie viel Kapital in Weinen ohne Rotation gebunden ist. Identifizieren Sie Referenzen, die sofortiges Handeln erfordern.",
    demoTitle: "Totbestand zu erkennen ist nur der Anfang",
    demoDesc: "Winerim hilft, gebundenes Kapital, Obsoleszenzrisiko und Opportunitätskosten zu quantifizieren, um bessere Rotations- und Einkaufsentscheidungen zu treffen.",
    decides: ["Welche Referenzen aufgrund mangelnder Rotation von der Karte genommen werden sollen", "Wie viel reales Kapital gebunden ist und dessen Opportunitätskosten", "Welche Weine zu fördern, im Glas auszuschenken, zu entfernen oder nicht nachzubestellen sind"],
    avoids: ["Weiterhin Referenzen zu kaufen, die sich nicht verkaufen", "Kapital ohne Sicht auf die echten Kosten zu binden", "Einkaufsentscheidungen ohne Rotations- oder Prioritätsdaten zu treffen"],
    impact: ["Freisetzung von Kapital, das in nicht rotierendem Bestand gebunden ist", "Senkung des Anteils des schlafenden Bestands unter 15%", "Objektive Kriterien, um Referenzen neu zu verhandeln, zu entfernen oder umzuwandeln"],
    catLabels: { entrada: "Einstieg", media: "Mittelklasse", premium: "Premium", alta: "Spitzenklasse" },
    refsTitle: "Referenzen mit geringer oder null Rotation", wineName: "Weinname", wineNamePlaceholder: "Z.B.: Riesling Spätlese...",
    units: "Einheiten", costUnit: "Kosten/Einh. (€)", daysSince: "Tage ohne Verkauf", category: "Kategorie",
    addRef: "Referenz hinzufügen", calculate: "Auswirkung berechnen",
    capitalLabel: "Gebundenes Kapital", opportunityCost: "Opportunitätskosten", annualized: "annualisierte Schätzung (8%)",
    sleepingPct: "% Schlafender Bestand", generalPriority: "Gesamtpriorität", signalAction: "Handlungssignal",
    deadStock: "Totbestand", deadStockLabel: "Totbestand (> 6 Monate)", slowRotation: "Langsame Rotation", slowRotationLabel: "Langsame Rotation (3-6 Monate)",
    alertLabel: "Warnung", alertLabelFull: "Warnung (< 3 Monate)",
    refs: "Referenz(en)", ref: "Refs",
    breakdownCat: "Aufschlüsselung nach Kategorie", detailRef: "Detail pro Referenz",
    thWine: "Wein", thUnits: "Einh.", thCapital: "Kapital", thDays: "Tage", thPriority: "Priorität", thRecommendation: "Empfehlung", thDepreciation: "Abschreibung", thCurrentValue: "Gesch. aktueller Wert",
    deprecLabels: { fresh: "Frisch", aging: "Reifend", declining: "Im Rückgang", critical: "Verschlechterung" },
    priorityLabels: { critical: "Kritisch", high: "Hoch", medium: "Mittel", low: "Niedrig" },
    recLabels: { remove: "Von Karte nehmen", glass: "Im Glas ausschenken", noRestock: "Nicht nachbestellen", boost: "Verkauf fördern" },
    insightHigh: () => `Mehr als 30% Ihrer analysierten Referenzen schlafen. Das deutet auf ein Einkaufs- oder Kartenarchitekturproblem hin. Winerim Core erkennt diese Situationen automatisch und Winerim Supply hilft zu entscheiden, was nicht nachbestellt werden sollte.`,
    insightMed: (pct, capital) => `Sie haben ${pct}% schlafenden Bestand. Das ist ein übliches, aber verbesserungsfähiges Niveau. Eine Überprüfung der als "Nicht nachbestellen" markierten Referenzen kann ${capital} an Kapital freisetzen.`,
    insightLow: "Ihr schlafender Bestand liegt unter 15%. Gutes Rotationsniveau. Führen Sie regelmäßige Überprüfungen fort, um eine Ansammlung zu verhindern.",
    actionsTitle: "Empfohlene Maßnahmen",
    actionDead: (count, capital) => `${count} Referenz(en) seit mehr als 6 Monaten unverkauft (${capital} gebunden). Maßnahme: im Glas anbieten, ins Degustationsmenü aufnehmen oder Rückgabe verhandeln.`,
    actionSlow: (count) => `${count} Referenz(en) mit langsamer Rotation (3-6 Monate). Für Promotionen oder Neuplatzierung als Chef-Empfehlung in Betracht ziehen.`,
    actionCapital: (capital) => `Sie haben ${capital} im Niedrigrotationsbestand. Überprüfen Sie die Einkaufskriterien und setzen Sie maximale Bestandslimits pro Referenz.`,
    actionPreventive: "Implementieren Sie eine vierteljährliche Rotationsüberprüfung, um Totweine zu erkennen, bevor sie monatelang bewegungslos bleiben.",
    summaryLabel: "Was ist Totbestand", summaryDef: "Totbestand bezeichnet Weinflaschen, die seit mehr als 90 Tagen unverkauft sind. Sie stellen gebundenes Kapital dar, das keine Rendite generiert, Lagerplatz beansprucht und mit der Zeit verderben kann.",
    summaryBullets: [
      "Warnung (30-90 Tage): Die Referenz benötigt Aufmerksamkeit, kann aber noch erholt werden",
      "Langsame Rotation (90-180 Tage): Promotionen, Glasausschank oder Neuplatzierung erwägen",
      "Totbestand (> 180 Tage): dringendes Handeln: liquidieren, zurückgeben oder entfernen",
      "Verderbsrisiko: junge Weine ohne Ausbau verlieren mit der Zeit an Frische",
    ],
    whenTitle: "Wann dieser Rechner zu verwenden ist", whenPoints: ["Vor einer Bestellung beim Distributor", "Bei der vierteljährlichen Kellerüberprüfung", "Wenn die Bestandsinvestition ohne Umsatzwachstum wächst", "Bei der Vorbereitung des Jahresabschlusses"],
    errorsTitle: "Häufige Fehler", errorsPoints: ["Totbestand nicht als reale Kosten zu verbuchen", "Mehr zu kaufen, ohne den angesammelten Bestand zu bewegen", "Darauf zu warten, dass sich ein Wein von selbst verkauft", "Keine Bestandslimits pro Referenz festzulegen"],
    faqs: [
      { q: "Ab wie vielen Tagen gilt etwas als Totbestand?", a: "Üblich sind 90 Tage ohne Verkauf für langsame Rotation und 180 Tage für Totbestand." },
      { q: "Was kann ich mit Totweinen tun?", a: "Sie zu einem Sonderpreis im Glas anbieten, in Degustationsmenüs einbeziehen, Rückgaben mit dem Lieferanten verhandeln, bei Abverkaufsveranstaltungen verkaufen oder spenden." },
      { q: "Wie viel Bestand sollte ein Restaurant haben?", a: "Der Bestand sollte vollständig innerhalb von 60-90 Tagen rotieren können." },
      { q: "Werden die Daten an einen Server gesendet?", a: "Nein. Alle Berechnungen erfolgen in Ihrem Browser." },
    ],
    coreCtaLabel: "Winerim Core", coreCtaTitle: "Automatische Obsoleszenz-Erkennung",
    coreCtaDesc: "Winerim Core überwacht die Rotation jeder Referenz, erkennt Totbestand automatisch und erzeugt Warnungen, bevor Kapital gebunden wird.",
    coreCtaSee: "Winerim Core ansehen",
    supplyCtaLabel: "Winerim Supply", supplyCtaTitle: "Datenbasierte Einkaufsentscheidungen",
    supplyCtaDesc: "Winerim Supply hilft zu entscheiden, was nicht nachbestellt, was mit Distributoren neu verhandelt und welche Referenzen ersetzt werden sollen, um Kapital freizusetzen und die Rotation zu verbessern.",
    supplyCtaSee: "Winerim Supply ansehen",
    criticalLabel: "Kritisch", highLabel: "Hoch", controlLabel: "Unter Kontrolle",
    interpretTitle: "Wie die Ergebnisse zu interpretieren sind",
    internalLinks: [
      { to: "/recursos/checklist-deteccion-vinos-muertos", label: "Checkliste zur Erkennung von Totweinen", type: "resource" },
      { to: "/herramientas/calculadora-compra-inteligente", label: "Einkaufsintelligenz-Rechner", type: "tool" },
      { to: "/producto/winerim-supply", label: "Winerim Supply: Einkaufsintelligenz", type: "solution" },
      { to: "/producto/winerim-core", label: "Winerim Core: Obsoleszenz-Erkennung", type: "solution" },
      ...
      { to: "/demo", label: "Kostenlose Demo anfordern", type: "solution" },
    ],
  },
  pt: {
    seoTitle: "Calculadora de Stock Morto de Vinhos | Demo Winerim Core + Supply",
    seoDesc: "Calcule quanto capital tem imobilizado em vinhos sem rotação. Demo do motor de deteção de obsolescência do Winerim Core e Winerim Supply.",
    breadTools: "Ferramentas", breadCalc: "Calculadora de stock morto", demoBadge: "Demo · Winerim Core + Supply",
    h1: "Calculadora de stock morto", subtitle: "Estime quanto capital tem imobilizado em vinhos sem rotação. Identifique quais as referências que necessitam de ação imediata.",
    demoTitle: "Detetar stock morto é apenas o princípio",
    demoDesc: "O Winerim ajuda a quantificar o capital imobilizado, o risco de obsolescência e o custo de oportunidade para tomar melhores decisões de rotação e compra.",
    decides: ["Que referências retirar da carta por falta de rotação", "Quanto capital real tem imobilizado e o seu custo de oportunidade", "Que vinhos impulsionar, servir a copo, retirar ou não repor"],
    avoids: ["Continuar a comprar referências que não se vendem", "Imobilizar capital sem visibilidade do custo real", "Tomar decisões de compra sem dados de rotação nem prioridade"],
    impact: ["Libertação de capital bloqueado em stock sem rotação", "Redução da percentagem de stock adormecido abaixo dos 15%", "Critério objetivo para renegociar, retirar ou reconverter referências"],
    catLabels: { entrada: "Entrada", media: "Gama média", premium: "Premium", alta: "Alta gama" },
    refsTitle: "Referências com baixa ou nula rotação", wineName: "Nome do vinho", wineNamePlaceholder: "Ex: Douro Reserva...",
    units: "Unidades", costUnit: "Custo/un (€)", daysSince: "Dias sem venda", category: "Categoria",
    addRef: "Adicionar referência", calculate: "Calcular impacto",
    capitalLabel: "Capital imobilizado", opportunityCost: "Custo de oportunidade", annualized: "estimativa anualizada (8%)",
    sleepingPct: "% Stock adormecido", generalPriority: "Prioridade geral", signalAction: "sinal de ação",
    deadStock: "Stock morto", deadStockLabel: "Stock morto (> 6 meses)", slowRotation: "Rotação lenta", slowRotationLabel: "Rotação lenta (3-6 meses)",
    alertLabel: "Em alerta", alertLabelFull: "Em alerta (< 3 meses)",
    refs: "referência(s)", ref: "refs",
    breakdownCat: "Discriminação por categoria", detailRef: "Detalhe por referência",
    thWine: "Vinho", thUnits: "Un", thCapital: "Capital", thDays: "Dias", thPriority: "Prioridade", thRecommendation: "Recomendação", thDepreciation: "Depreciação", thCurrentValue: "Valor atual est.",
    deprecLabels: { fresh: "Fresco", aging: "A envelhecer", declining: "Em declínio", critical: "Deterioração" },
    priorityLabels: { critical: "Crítica", high: "Alta", medium: "Média", low: "Baixa" },
    recLabels: { remove: "Retirar da carta", glass: "Servir a copo", noRestock: "Não repor", boost: "Impulsionar venda" },
    insightHigh: () => `Mais de 30% das suas referências analisadas estão adormecidas. Isto sugere um problema de compra ou de arquitetura de carta. O Winerim Core deteta estas situações automaticamente e o Winerim Supply ajuda a decidir o que não repor.`,
    insightMed: (pct, capital) => `Tem ${pct}% de stock adormecido. É um nível habitual mas melhorável. Uma revisão das referências marcadas como "Não repor" pode libertar ${capital} de capital.`,
    insightLow: "O seu stock adormecido está abaixo dos 15%. Bom nível de rotação. Mantenha a revisão periódica para que não se acumule.",
    actionsTitle: "Ações recomendadas",
    actionDead: (count, capital) => `${count} referência(s) há mais de 6 meses sem vender (${capital} imobilizados). Ação: oferecer a copo, em menu de degustação ou negociar devolução.`,
    actionSlow: (count) => `${count} referência(s) com rotação lenta (3-6 meses). Considere-as para promoções ou reposicionamento como recomendação do chef.`,
    actionCapital: (capital) => `Tem ${capital} em stock de baixa rotação. Reveja os critérios de compra e estabeleça limites de stock máximo por referência.`,
    actionPreventive: "Implemente uma revisão trimestral de rotação para detetar vinhos mortos antes que acumulem meses sem movimento.",
    summaryLabel: "O que é stock morto", summaryDef: "Stock morto são as garrafas de vinho que estão há mais de 90 dias sem vender. Representam capital imobilizado que não gera retorno, ocupa espaço na garrafeira e pode deteriorar-se com o tempo.",
    summaryBullets: [
      "Alerta (30-90 dias): a referência precisa de atenção mas ainda pode recuperar",
      "Rotação lenta (90-180 dias): considerar promoções, copo ou reposicionamento",
      "Stock morto (> 180 dias): ação urgente: liquidar, devolver ou eliminar",
      "Risco de deterioração: os vinhos jovens sem estágio perdem frescura com o tempo",
    ],
    whenTitle: "Quando usar esta calculadora", whenPoints: ["Antes de fazer uma encomenda ao distribuidor", "Na revisão trimestral da garrafeira", "Quando o investimento em stock cresce sem que cresçam as vendas", "Ao preparar o fecho fiscal"],
    errorsTitle: "Erros comuns", errorsPoints: ["Não contabilizar o stock morto como custo real", "Comprar mais sem ter escoado o acumulado", "Esperar que um vinho se venda sozinho", "Não estabelecer limites de stock por referência"],
    faqs: [
      { q: "A partir de quantos dias se considera stock morto?", a: "O critério habitual é 90 dias sem venda para rotação lenta e 180 dias para stock morto." },
      { q: "O que posso fazer com os vinhos mortos?", a: "Oferecê-los a copo a preço especial, incluí-los em menus de degustação, negociar devolução com o fornecedor, vendê-los em eventos de liquidação ou doá-los." },
      { q: "Quanto stock deve ter um restaurante?", a: "O stock deve poder rodar completamente em 60-90 dias." },
      { q: "Os dados são enviados para algum servidor?", a: "Não. Todos os cálculos são feitos no seu navegador." },
    ],
    coreCtaLabel: "Winerim Core", coreCtaTitle: "Deteção automática de obsolescência",
    coreCtaDesc: "O Winerim Core monitoriza a rotação de cada referência, deteta stock morto automaticamente e gera alertas antes que o capital se imobilize.",
    coreCtaSee: "Ver Winerim Core",
    supplyCtaLabel: "Winerim Supply", supplyCtaTitle: "Decisões de compra com critério",
    supplyCtaDesc: "O Winerim Supply ajuda a decidir o que não repor, o que renegociar com o distribuidor e que referências substituir para libertar capital e melhorar a rotação.",
    supplyCtaSee: "Ver Winerim Supply",
    criticalLabel: "Crítica", highLabel: "Alta", controlLabel: "Sob controlo",
    interpretTitle: "Como interpretar os resultados",
    internalLinks: [
      { to: "/recursos/checklist-deteccion-vinos-muertos", label: "Checklist de deteção de vinhos mortos", type: "resource" },
      { to: "/herramientas/calculadora-compra-inteligente", label: "Calculadora de compra inteligente", type: "tool" },
      { to: "/producto/winerim-supply", label: "Winerim Supply: inteligência de compras", type: "solution" },
      { to: "/producto/winerim-core", label: "Winerim Core: deteção de obsolescência", type: "solution" },
      ...
      { to: "/demo", label: "Pedir demo gratuita", type: "solution" },
    ],
  },
};
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            ...
            {(() => {
              const pl: Record<string, { title: string; subtitle: string; month3: string; month6: string; month12: string; capital: string; opportunity: string; total: string; liquidation: string; liqStep1: string; liqStep2: string; liqStep3: string; liqStep4: string; recoverable: string; ofCapital: string }> = {
                ...
                de: { title: "Untätigkeitsprojektion · Winerim", subtitle: "Was passiert, wenn Sie bei diesem Bestand nicht handeln", month3: "In 3 Monaten", month6: "In 6 Monaten", month12: "In 12 Monaten", capital: "Gebundenes Kapital", opportunity: "Akkumulierte Opportunitätskosten", total: "Gesamtkosten der Untätigkeit", liquidation: "Empfohlener Liquidationsplan", liqStep1: "Woche 1-2: Totbestand-Referenzen zum Sonderpreis im Glas anbieten", liqStep2: "Woche 3-4: Ins Degustationsmenü oder in vergünstigte Speisenbegleitungen aufnehmen", liqStep3: "Monat 2: Lieferanten für Rückgabe oder Umtausch der unverkauften Positionen kontaktieren", liqStep4: "Monat 3: Von der Karte nehmen und nicht nachbestellen. Budget auf die Top 5 nach Rotation umverteilen", recoverable: "Geschätzter Wiedergewinnungswert", ofCapital: "des Kapitals" },
                pt: { title: "Projeção de inação · Winerim", subtitle: "O que acontece se não agir sobre este stock", month3: "Em 3 meses", month6: "Em 6 meses", month12: "Em 12 meses", capital: "Capital imobilizado", opportunity: "Custo de oportunidade acumulado", total: "Custo total da inação", liquidation: "Plano de liquidação recomendado", liqStep1: "Semana 1-2: Colocar as referências de stock morto a copo a preço especial", liqStep2: "Semana 3-4: Incluir em menu de degustação ou harmonização com desconto", liqStep3: "Mês 2: Contactar fornecedor para devolução ou troca das que não se mexerem", liqStep4: "Mês 3: Retirar da carta e não repor. Realocar orçamento para o top 5 por rotação", recoverable: "Recuperável estimado", ofCapital: "do capital" },
              };

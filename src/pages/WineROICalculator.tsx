...
const i18n: I18nMap<Record<string, any>> = {
  ...
  de: {
    seo_title: "Wein-Umsatz-ROI-Rechner – Berechnen Sie Ihr Verkaufspotential | Winerim",
    seo_desc: "Berechnen Sie, wie viel Ihr Restaurant durch die Optimierung seiner Weinkarte verdienen kann. Kostenloser Simulator mit Wachstumsprognosen von 10%, 20% und 30%.",
    badge: "Kostenloser Simulator",
    h1_1: "Wine Sales ROI", h1_2: "Calculator",
    subtitle: "Entdecken Sie, wie viel Umsatz Ihr Restaurant durch die Optimierung seiner Weinkarte erzielen kann. Geben Sie Ihre Daten ein und erhalten Sie sofort Prognosen.",
    bread_tools: "Werkzeuge", bread_self: "Wine ROI Calculator",
    data_title: "Ihre Restaurantdaten",
    inputs: [
      { label: "Anzahl der Tische", suffix: "Tische" },
      { label: "Taegllicher Umsatz", suffix: "Gaenge/Tag" },
      { label: "Durchschnittlicher Weinbon", suffix: "Euro/Flasche" },
      { label: "Flaschen pro Gang", suffix: "Flaschen" },
    ],
    calc_btn: "ROI berechnen",
    current_label: "Aktuelle Weineinnahmen",
    daily: "Taeglich", monthly: "Monatlich", annual: "Jaehrlich",
    increment: "Steigerung",
    daily_plus: "+Taeglich", new_monthly: "Neuer Monatsumsatz", new_annual: "Neuer Jahresumsatz",
    chart_badge: "Visuelle Prognose",
    chart_title_1: "Jahresauswirkung auf", chart_title_2: "Umsatz",
    bar_title: "Jahresvergleich", line_title: "Monatsprognose",
    actual: "Aktuell", revenue: "Umsatz",
    cta_badge: "Naechster Schritt",
    cta_title_1: "Entdecken Sie, wie Sie Ihre", cta_title_2: "Weinverkaeufe steigern",
    cta_desc: "Wir zeigen Ihnen, wie Winerim diese Zahlen fuer Ihr Restaurant Wirklichkeit werden laesst.",
    cta_btn: "Demo anfordern",
    link_software: "Weinkarten-Software",
    link_ticket: "Durchschnittsbon erhoehen",
    link_cases: "Erfolgsbeispiele",
    link_demo: "Demo anfordern",
    months_short: ["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],
    locale: "de-DE", yr: "/Jahr",
    decides: ["Ob die Kartoptimierung rentabel ist", "Welche Umsatzsteigerung realistisch ist", "Wo das groesste Verbesserungspotential liegt: Volumen, Preis oder Durchdringung"],
    avoids: ["Entscheidungen ohne Auswirkungsanalyse treffen", "Das Verbesserungspotential der Karte unterschaetzen", "Investieren ohne Renditeprognose"],
    impact: ["Das potenzielle ROI der Optimierung quantifizieren", "Die Investition in Weinmanagementsoftware rechtfertigen", "Erreichbare Umsatzziele festlegen"],
  },
  pt: {
    seo_title: "Calculadora de ROI de Vendas de Vinho – Calcule Seu Potencial de Vendas | Winerim",
    seo_desc: "Calcule quanto seu restaurante pode ganhar otimizando sua carta de vinhos. Simulador gratuito com projecoes de crescimento de 10%, 20% e 30%.",
    badge: "Simulador gratuito",
    h1_1: "Wine Sales ROI", h1_2: "Calculator",
    subtitle: "Descubra quanto faturamento seu restaurante pode gerar otimizando sua carta de vinhos. Insira seus dados e obtenha projecoes instantaneas.",
    bread_tools: "Ferramentas", bread_self: "Wine ROI Calculator",
    data_title: "Dados do seu restaurante",
    inputs: [
      { label: "Numero de mesas", suffix: "mesas" },
      { label: "Rotacao diaria", suffix: "servicos/dia" },
      { label: "Bilhete medio de vinho", suffix: "Euro/garrafa" },
      { label: "Garrafas por servico", suffix: "garrafas" },
    ],
    calc_btn: "Calcular ROI",
    current_label: "Faturamento atual de vinho",
    daily: "Diario", monthly: "Mensal", annual: "Anual",
    increment: "aumento",
    daily_plus: "+Diario", new_monthly: "Novo mensal", new_annual: "Novo anual",
    chart_badge: "Projecao visual",
    chart_title_1: "Impacto anual no", chart_title_2: "faturamento",
    bar_title: "Comparacao anual", line_title: "Projecao mensal",
    actual: "Atual", revenue: "Faturamento",
    cta_badge: "Proximo passo",
    cta_title_1: "Descubra como aumentar suas", cta_title_2: "vendas de vinho",
    cta_desc: "Mostramos como a Winerim pode transformar esses numeros em realidade para seu restaurante.",
    cta_btn: "Solicitar demo",
    link_software: "Software de carta de vinhos",
    link_ticket: "Aumentar bilhete medio",
    link_cases: "Casos de sucesso",
    link_demo: "Solicitar demo",
    months_short: ["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"],
    locale: "pt-PT", yr: "/ano",
    decides: ["Se investir na otimizacao da carta e rentavel", "Qual aumento de faturamento e realistico", "Onde esta o maior potencial: volume, preco ou penetracao"],
    avoids: ["Tomar decisoes sem quantificar o impacto real", "Subestimar o potencial de melhoria da carta", "Investir sem projecao de retorno"],
    impact: ["Quantificar o ROI potencial da otimizacao", "Justificar o investimento em ferramentas de gestao de vinho", "Estabelecer objetivos de faturamento alcancaveis"],
  },
};

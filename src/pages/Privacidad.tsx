...
const Privacidad = () => {
  ...
  const esPath = lang === "es" && location.pathname === "/politica-privacidad" ? "/politica-privacidad" : "/privacidad";

  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <SEOHead title={t.seoTitle} description={t.seoDesc} url={`https://winerim.wine${lang === "es" ? esPath : localePath("/privacidad")}`} hreflang={allLangPaths(esPath)} noindex />

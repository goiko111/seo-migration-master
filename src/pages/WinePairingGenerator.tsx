...
const i18n: I18nMap<Record<string, any>> = {
  ...
  de: {
    seo_title: "Speisenbegleitung-Generator – KI-Weinempfehlungen | Winerim",
    seo_desc: "Geben Sie ein Gericht ein und erhalten Sie 3 Weinempfehlungen mit Erklaerung. Kostenloses KI-gesteuertes Werkzeug.",
    badge: "KI Sommelier",
    h1_1: "Wine Pairing", h1_2: "Generator",
    subtitle: "Geben Sie Ihr Gericht ein und lassen Sie unseren KI-Sommelier die besten Weine zur Speisenbegleitung empfehlen.",
    bread_tools: "Werkzeuge", bread_self: "Wine Pairing Generator",
    describe_title: "Beschreiben Sie Ihr Gericht",
    dish_label: "Gerichttyp *", dish_placeholder: "Z.B. Pilzrisotto, Gegrilltes Rumpsteak...",
    ingredient_label: "Zutat *", ingredient_placeholder: "Z.B. Pilze, Rind, Kabeljau...",
    cuisine_label: "Kueche", cuisine_placeholder: "Z.B. Mittelmeerlaender, Japanisch, Peruanisch...",
    intensity_label: "Gerichtintensitaet",
    intensities: [
      { value: "ligero", label: "Leicht", desc: "Salate, Ceviches, Carpaccios" },
      { value: "medio", label: "Mittel", desc: "Pasta, Reis, Fisch" },
      { value: "intenso", label: "Intensiv", desc: "Rotes Fleisch, Eintopf, Schmorfleisch" },
      { value: "muy-intenso", label: "Sehr intensiv", desc: "Wild, Geraeuchert, Gewuerzt" },
    ],
    generate_btn: "Empfehlungen generieren",
    generating: "Speisenbegleitung wird generiert...",
    new_pairing: "Neue Paarung",
    analysis_title: "Paarungsanalyse",
    tip_title: "Sommelier-Tipp",
    error_empty: "Geben Sie mindestens den Gerichttyp und die Zutat ein",
    error_generate: "Fehler bei der Generierung. Bitte versuchen Sie es erneut.",
    cta_badge: "Fuer Restaurants",
    cta_title_1: "Intelligente Speisenbegleitungen fuer", cta_title_2: "Ihre Gaeste",
    cta_desc: "Restaurants nutzen Winerim, um intelligente Speisenbegleitungen anzubieten, direkt in ihrer digitalen Weinkarte integriert.",
    cta_btn: "Demo anfordern",
    link_pairing: "Speisenbegleitungsstrategie", link_sell: "Mehr Wein verkaufen",
    link_analyzer: "Weikartenanalysator", link_demo: "Winerim-Demo anfordern",
    decides: ["Welchen Wein fuer jedes Gericht empfehlen", "Wie man die Paarung dem Gast kommuniziert", "Welche Stile zum Menu passen"],
    avoids: ["Generische Empfehlungen ohne Kriterium", "Sich nur auf die Intuition des Servicepersonals verlassen", "Verkaeufe durch fehlende aktive Vorschlaege verlieren"],
    impact: ["Wein-Gericht-Querverkauf erhoehen", "Wahrnehmung professioneller Bedienung verbessern", "Durchschnittsbon durch begruendete Empfehlungen erhoehen"],
  },
  pt: {
    seo_title: "Gerador de Harmonizacoes de Vinhos – Recomendacoes com IA | Winerim",
    seo_desc: "Digite um prato e obtenha 3 recomendacoes de vinho com explicacao da harmonizacao. Ferramenta gratuita com IA.",
    badge: "IA Escanção",
    h1_1: "Wine Pairing", h1_2: "Generator",
    subtitle: "Digite seu prato e deixe nosso escanção de IA recomendar os melhores vinhos para harmonizar.",
    bread_tools: "Ferramentas", bread_self: "Wine Pairing Generator",
    describe_title: "Descreva seu prato",
    dish_label: "Tipo de prato *", dish_placeholder: "Ex: Risoto de cogumelos, Bife grelhado...",
    ingredient_label: "Ingrediente principal *", ingredient_placeholder: "Ex: Cogumelos, Carne, Bacalhau...",
    cuisine_label: "Tipo de cusinha", cuisine_placeholder: "Ex: Mediterranea, Japonesa, Peruana...",
    intensity_label: "Intensidade do prato",
    intensities: [
      { value: "ligero", label: "Leve", desc: "Saladas, ceviches, carpaccios" },
      { value: "medio", label: "Medio", desc: "Massas, arroz, peixes" },
      { value: "intenso", label: "Intenso", desc: "Carnes vermelhas, guisados, brasados" },
      { value: "muy-intenso", label: "Muito intenso", desc: "Caca, fumados, especiados" },
    ],
    generate_btn: "Gerar recomendacoes",
    generating: "Gerando harmonizacao...",
    new_pairing: "Nova harmonizacao",
    analysis_title: "Analise da harmonizacao",
    tip_title: "Dica do escanção",
    error_empty: "Digite pelo menos o tipo de prato e o ingrediente principal",
    error_generate: "Erro ao gerar. Tente novamente.",
    cta_badge: "Para restaurantes",
    cta_title_1: "Harmonizacoes inteligentes para", cta_title_2: "seus clientes",
    cta_desc: "Restaurantes usam Winerim para oferecer harmonizacoes inteligentes aos clientes, integradas diretamente em sua carta digital.",
    cta_btn: "Solicitar demo",
    link_pairing: "Estrategia de harmonizacao", link_sell: "Como vender mais vinho",
    link_analyzer: "Analisador de carta", link_demo: "Solicitar demo Winerim",
    decides: ["Qual vinho recomendar para cada prato", "Como comunicar a harmonizacao ao cliente", "Que estilos se adequam ao seu menu"],
    avoids: ["Recomendacoes genericas sem criterio", "Depender apenas da intuicao do pessoal de servico", "Perder vendas por falta de sugestoes ativas"],
    impact: ["Aumentar a venda cruzada vinho-prato", "Melhorar a percepcao de servico profissional", "Elevar o bilhete medio com recomendacoes fundamentadas"],
  },
};

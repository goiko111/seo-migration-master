...
const i18n: I18nMap<{
  ...
  de: {
    seo_title: "Diagnostik Glaswein für Restaurants | Winerim",
    seo_desc: "Evaluieren Sie kostenlos Ihr Glaswein-Angebot: Stilabdeckung, Preisbalance, Margen und Rotation. Umsetzbare Erkenntnisse.",
    jsonld_name: "Diagnostik Glaswein", jsonld_desc: "Evaluieren Sie, ob Ihr Glaswein-Angebot in Stilen, Preisen und Rentabilität ausgewogen ist.",
    breadcrumb_tools: "Tools", breadcrumb_page: "Glaswein-Diagnostik",
    badge: "Kostenloses Tool", h1: "Glaswein-Diagnostik",
    subtitle: "Evaluieren Sie, ob Ihr Glaswein-Angebot in Stilen, Preisen und Rentabilität ausgewogen ist. Erhalten Sie umsetzbare Erkenntnisse.",
    h2_wines: "Ihre Glasweine",
    style_labels: { espumoso: "Schaumwein", blanco: "Weißwein", rosado: "Rosé", tinto: "Rotwein", dulce: "Süßwein/Likörwein" },
    lbl_name: "Name", lbl_style: "Stil", lbl_pvp: "Glaspreis (€)", lbl_cost: "Glaskosten (€)", lbl_sales: "Verkäufe/Woche",
    btn_add: "+ Referenz hinzufügen", btn_diagnose: "Diagnostik starten",
    score_label: "Bewertung Ihres Glaswein-Angebots",
    score_80: "Ihr Glaswein-Angebot ist gut konzipiert.", score_60: "Es gibt klare Verbesserungsmöglichkeiten.",
    score_40: "Ihr Angebot benötigt wichtige Anpassungen.", score_low: "Ihr Glaswein-Programm erfordert eine gründliche Überprüfung.",
    kpi_coverage: "Stilabdeckung", kpi_margin: "Durchschnittsmarge", kpi_range: "Preisspanne", kpi_sales: "Verkäufe/Woche", kpi_glasses: "Gläser",
    h3_detail: "Detaillierte Diagnostik",
    diag_coverage_ok: "Gute Stilabdeckung. Sie decken die Haupttypen ab.",
    diag_coverage_warn: (m) => `Fehlende Stile: ${m}. Dies begrenzt die Auswahlmöglichkeiten des Gastes.`,
    diag_range_ok: (min, max) => `Angemessene Preisspanne: ${min}€ – ${max}€. Gute Preisleiter.`,
    diag_range_warn: (min, max) => `Enge Preisspanne (${min}€ – ${max}€). Erweitern Sie, um mehr Gastprofile zu erreichen.`,
    diag_margin_ok: (m) => `Durchschnittsmarge von ${m}%. Guter Bereich für Glaswein.`,
    diag_margin_warn: (m) => `Durchschnittsmarge von ${m}%. Verbessern Sie die Preisgestaltung teurerer Referenzen.`,
    diag_margin_bad: (m) => `Durchschnittsmarge von ${m}%. Zu niedrig. Überprüfen Sie Preisgestaltung oder Kaufkosten.`,
    diag_low_margin: (n, names) => `${n} Referenz(en) mit Marge < 60%: ${names}.`,
    diag_no_sales: (n, names) => `${n} Referenz(en) ohne Verkäufe diese Woche: ${names}. Erwägen Sie Rotation.`,
    diag_few: "Begrenztes Angebot. Weniger als 4 Gläser lassen dem Gast zu wenig Optionen.",
    diag_many: "Mehr als 12 Gläser können operative Komplexität und Verschwendung erzeugen. Überprüfen Sie, ob alle rotieren.",
    cta_title: "Möchten Sie die Verwaltung Ihres Glaswein-Angebots automatisieren?",
    cta_desc: "Winerim überwacht automatisch die Leistung jedes Glases, schlägt Rotationen vor und optimiert die Preisgestaltung in Echtzeit.",
    cta_analyze: "Meine Weinkarte analysieren", cta_demo: "Demo anfordern",
    edu_title: "So interpretieren Sie die Diagnostik",
    summary_label: "Zusammenfassung",
    summary_def: "Die Glaswein-Diagnostik evaluiert vier Schlüsseldimensionen: Stilabdeckung, Preisbalance, operative Marge und Rotation.",
    summary_bullets: [
      "Stilabdeckung: mindestens Schaumwein, Weiß-, Rosé- und Rotwein",
      "Preisspanne: das teuerste Glas sollte mindestens doppelt so teuer sein wie das günstigste",
      "Marge pro Glas: Mindestziel von 65% auf Verkaufspreis",
      "Rotation: jedes Glas sollte mindestens einmal pro Woche verkauft werden",
    ],
    blocks: [
      { title: "Wann verwenden", points: ["Bei Start oder Erneuerung Ihres Glaswein-Programms", "Wenn die Verschwendung 15% übersteigt", "Wenn Sie nicht wissen, ob Ihre Auswahl ausgewogen ist", "Vor dem Treffen mit Ihrem Lieferanten"] },
      { title: "Häufige Fehler", points: ["Nur Rotweine pro Glas anbieten", "Einheitspreis für alle Gläser", "Referenzen wochenlang nicht rotieren", "Verschwendung als Kostenvariable ignorieren"] },
    ],
    faqs: [
      { q: "Wie viele Glasweine sollte ich anbieten?", a: "Zwischen 6 und 12 ist der empfohlene Bereich für die meisten Restaurants." },
      { q: "Welche Marge sollte ein Glaswein haben?", a: "Das Ziel ist eine Bruttomarge von über 65% auf dem Verkaufspreis." },
      { q: "Wie oft sollte ich die Gläser rotieren?", a: "Idealerweise rotieren Sie mindestens 2-3 Referenzen alle 2-4 Wochen." },
      { q: "Sollte ich Schaumwein pro Glas anbieten?", a: "Sehr empfohlen. Schaumwein pro Glas hat hohe Nachfrage und gute Margen." },
    ],
    links: [
      { to: "/de/glaswein-preis-rechner", label: "Glaswein-Preisrechner", type: "tool" },
      { to: "/de/ressourcen/glaswein-strategie-vorlage", label: "Glaswein-Strategievorlagen", type: "resource" },
      { to: "/de/benchmarks-playbooks/benchmark-glaswein-strategie", label: "Benchmark: Glaswein-Strategie", type: "guide" },
      { to: "/de/benchmarks-playbooks/playbook-glaswein-optimieren", label: "Playbook: Glaswein optimieren", type: "guide" },
    ],
    decides: ["Ob Ihr Glaswein-Programm in Stilen und Preisen ausgewogen ist", "Welche Glasweine die beste reale Marge haben", "Ob Rotation die Beibehaltung jeder Referenz rechtfertigt"],
    avoids: ["Nur Rotweine pro Glas ohne Vielfalt anbieten", "Einheitspreis für alle Glasweine", "Schwund als Kostenvariable ignorieren"],
    impact: ["Rentabilität des Glaswein-Programms optimieren", "Angebot ausgleichen, um mehr Tische zu gewinnen", "Schwund mit kontrollierter Rotation reduzieren"],
  },
  pt: {
    seo_title: "Diagnóstico Vinho a Copo para Restaurantes | Winerim",
    seo_desc: "Avalie gratuitamente sua oferta de vinho a copo: cobertura de estilos, equilíbrio de preços, margens e rotação. Feedback acionável.",
    jsonld_name: "Diagnóstico Vinho a Copo", jsonld_desc: "Avalie se sua oferta de vinho a copo está equilibrada em estilos, preços e rentabilidade.",
    breadcrumb_tools: "Ferramentas", breadcrumb_page: "Diagnóstico vinho a copo",
    badge: "Ferramenta gratuita", h1: "Diagnóstico vinho a copo",
    subtitle: "Avalie se sua oferta de vinho a copo está equilibrada em estilos, preços e rentabilidade. Receba feedback acionável.",
    h2_wines: "Seus vinhos a copo",
    style_labels: { espumoso: "Espumante", blanco: "Branco", rosado: "Rosé", tinto: "Tinto", dulce: "Doce/Licoroso" },
    lbl_name: "Nome", lbl_style: "Estilo", lbl_pvp: "Preço copo (€)", lbl_cost: "Custo copo (€)", lbl_sales: "Vendas/sem",
    btn_add: "+ Adicionar referência", btn_diagnose: "Executar diagnóstico",
    score_label: "Pontuação de sua oferta a copo",
    score_80: "Sua oferta a copo está bem concebida.", score_60: "Há claras oportunidades de melhoria.",
    score_40: "Sua oferta precisa de ajustes significativos.", score_low: "Seu programa a copo requer revisão profunda.",
    kpi_coverage: "Cobertura estilos", kpi_margin: "Margem média", kpi_range: "Faixa preços", kpi_sales: "Vendas/semana", kpi_glasses: "copos",
    h3_detail: "Diagnóstico detalhado",
    diag_coverage_ok: "Boa cobertura de estilos. Você cobre as principais categorias.",
    diag_coverage_warn: (m) => `Estilos faltantes: ${m}. Isso limita as opções do cliente.`,
    diag_range_ok: (min, max) => `Faixa de preços adequada: €${min} – €${max}. Boa escada de preços.`,
    diag_range_warn: (min, max) => `Faixa de preços estreita (€${min} – €${max}). Expanda para atingir mais perfis de clientes.`,
    diag_margin_ok: (m) => `Margem média de ${m}%. Bom intervalo para vinho a copo.`,
    diag_margin_warn: (m) => `Margem média de ${m}%. Considere melhorar a precificação em referências mais caras.`,
    diag_margin_bad: (m) => `Margem média de ${m}%. Muito baixa. Revise a precificação ou custos de compra.`,
    diag_low_margin: (n, names) => `${n} referência(s) com margem < 60%: ${names}.`,
    diag_no_sales: (n, names) => `${n} referência(s) sem vendas esta semana: ${names}. Considere rotacionar.`,
    diag_few: "Oferta limitada. Menos de 4 copos deixa opções muito limitadas ao cliente.",
    diag_many: "Mais de 12 copos pode criar complexidade operacional e quebra. Verifique se todos rodam.",
    cta_title: "Quer automatizar a gestão de sua oferta a copo?",
    cta_desc: "Winerim monitora automaticamente o desempenho de cada copo, sugere rotações e otimiza a precificação em tempo real.",
    cta_analyze: "Analisar minha carta", cta_demo: "Solicitar demonstração",
    edu_title: "Como interpretar o diagnóstico",
    summary_label: "Em resumo",
    summary_def: "O diagnóstico a copo avalia quatro dimensões-chave: cobertura de estilos, equilíbrio de preços, margem operacional e rotação.",
    summary_bullets: [
      "Cobertura de estilos: pelo menos espumante, branco, rosé e tinto",
      "Faixa de preços: o copo mais caro deve custar pelo menos o dobro do mais barato",
      "Margem por copo: objetivo mínimo de 65% sobre preço de venda",
      "Rotação: cada copo deve vender-se pelo menos uma vez por semana",
    ],
    blocks: [
      { title: "Quando usar", points: ["Ao lançar ou renovar seu programa a copo", "Quando a quebra exceder 15%", "Se não tiver certeza se sua seleção está equilibrada", "Antes de reunir com seu distribuidor"] },
      { title: "Erros comuns", points: ["Oferecer apenas tintos a copo", "Preço único para todos os copos", "Não rotacionar referências por semanas", "Ignorar a quebra como variável de custo"] },
    ],
    faqs: [
      { q: "Quantos vinhos a copo devo oferecer?", a: "Entre 6 e 12 é a faixa recomendada para a maioria dos restaurantes." },
      { q: "Qual margem deve ter um vinho a copo?", a: "O objetivo é uma margem bruta superior a 65% sobre o preço de venda." },
      { q: "Com que frequência devo rotacionar copos?", a: "Idealmente, rotacione pelo menos 2-3 referências a cada 2-4 semanas." },
      { q: "Devo incluir espumante a copo?", a: "Altamente recomendado. Espumante a copo tem alta demanda e boas margens." },
    ],
    links: [
      { to: "/pt/calculadora-preco-vinho-copo", label: "Calculadora de preço a copo", type: "tool" },
      { to: "/pt/recursos/modelo-estrategia-vinho-copo", label: "Modelo estratégia vinho a copo", type: "resource" },
      { to: "/pt/benchmarks-playbooks/benchmark-estrategia-copo", label: "Benchmark: estratégia a copo", type: "guide" },
      { to: "/pt/benchmarks-playbooks/playbook-otimizar-vinho-copo", label: "Playbook: otimizar vinho a copo", type: "guide" },
    ],
    decides: ["Se seu programa a copo está equilibrado em estilos e preços", "Quais vinhos a copo têm a melhor margem real", "Se a rotação justifica manter cada referência"],
    avoids: ["Oferecer apenas tintos a copo sem diversidade", "Preço único para todos os vinhos a copo", "Ignorar a quebra como variável de custo"],
    impact: ["Otimizar a rentabilidade do programa a copo", "Equilibrar a oferta para captar mais mesas", "Reduzir a quebra com rotação controlada"],
  },
};

...
const i18n: I18nMap<PainPageData> = {
  ...
  de: {
    slug: "probleme/weinkarte-verkauft-nicht",
    metaTitle: "Ihre Weinkarte verkauft nicht? Diagnose & Lösung",
    metaDescription: "Ihre Weinkarte erzielt keinen Umsatz? Entdecken Sie die 5 häufigsten Ursachen und wie Sie diese mit Daten, Strategie und Technologie beheben.",
    heroTitle: "Ihre Weinkarte verkauft nicht",
    heroSubtitle: "Es ist eines der häufigsten Probleme in der Gastronomie. Die gute Nachricht: Es gibt eine Lösung. Wir erklären, warum das passiert und wie Sie es korrigieren können.",
    heroBadge: "Diagnose",
    ctaPrimaryText: "Weinkarte kostenlos analysieren",
    ctaPrimaryUrl: "/de/weinkarten-analysator",
    ctaFinalTitle: "Lassen Sie Ihre Weinkarte nicht weiter Geld verlieren",
    ctaFinalDescription: "Mit Winerim können Sie Ihre Weinkarte in Minuten diagnostizieren und umsetzbare Empfehlungen zur Umsatzsteigerung erhalten.",
    symptom: "Sie haben eine Weinkarte mit guten Referenzen, aber der Weinumsatz ist niedrig. Die Gäste bestellen ‚den Hauswein' oder verzichten ganz auf Wein. Der durchschnittliche Weinbon stagniert.",
    symptomDetails: "Dieses Problem betrifft über 60 % der Restaurants. Es liegt nicht an der Weinqualität, sondern daran, wie Weine präsentiert, strukturiert und empfohlen werden.",
    causes: [
      "Die Karte hat zu viele Referenzen und der Gast erstarrt vor Entscheidungslähmung. Er wählt die günstigste Option oder bestellt gar keinen Wein.",
      "Die Preise sind nicht gut strukturiert. Es gibt keine klare Preisspanne, die zum Kauf einlädt, oder der günstigste Wein ist noch zu teuer.",
      "Die Karte bietet keine Orientierung. Ohne Verkostungsnotizen, Speisenempfehlungen oder klare Kategorien weiß der Gast nicht, was er wählen soll, und ist auf das Servicepersonal angewiesen, das nicht immer beraten kann.",
      "Das Servicepersonal hat weder die Schulung noch die Werkzeuge, um Wein zu empfehlen. Ohne Sicherheit vermeiden sie Empfehlungen.",
      "Die Karte wird nicht aktualisiert. Weine ohne Rotation, veraltete Preise und Referenzen, die nicht zum aktuellen Menü passen.",
    ],
    economicImpact: "Ein Restaurant mit 100 Gedecken pro Tag, das seine Weinbestellquote von 30 % auf 50 % steigert, kann monatlich zusätzlich 3.000–8.000 € allein mit Wein erwirtschaften.",
    economicImpactDetails: "Die Wirkung beschränkt sich nicht auf den Umsatz. Wein hat eine höhere Bruttomarge als Speisen (60–75 % vs. 30–40 %), sodass jede verkaufte Flasche überproportional zum Gewinn des Restaurants beiträgt.",
    solution: [
      { step: "Prüfen Sie Ihre aktuelle Karte", description: "Analysieren Sie, wie viele Referenzen Sie haben, welche sich verkaufen und welche nicht. Identifizieren Sie Weine ohne Verkauf seit 90+ Tagen und entfernen oder ersetzen Sie diese." },
      { step: "Strukturieren Sie nach Stil, nicht nach Region", description: "Gliedern Sie die Karte in Kategorien, die der Gast versteht: frische Weißweine, elegante Rotweine, Schaumweine … Vermeiden Sie Fachjargon." },
      { step: "Optimieren Sie die Preise", description: "Überprüfen Sie die Preistreppe. Stellen Sie sicher, dass Sie attraktive Angebote in der Spanne 20–35 € haben – dem umsatzstärksten Bereich." },
      { step: "Fügen Sie Orientierung zur Karte hinzu", description: "Integrieren Sie kurze Verkostungsnotizen, Intensitätssymbole, Empfehlungen zur Speisenbegleitung und Sommelier-Favoriten." },
      { step: "Setzen Sie digitale Werkzeuge ein", description: "Eine digitale Weinkarte mit Filtern, Empfehlungen und automatischen Speisenbegleitungen vervielfacht die Konversion." },
      { step: "Messen und optimieren Sie laufend", description: "Definieren Sie KPIs: Anteil der Tische mit Weinbestellung, durchschnittlicher Weinbon, Referenz-Rotation." },
    ],
    winerimModules: [
      { name: "Interaktive digitale Karte", description: "Ermöglicht dem Gast, die Karte mit Filtern nach Stil, Preis, Speisenbegleitung und Region zu erkunden. Beseitigt die Entscheidungslähmung." },
      { name: "Intelligenter Empfehlungsgeber", description: "Schlägt Weine basierend auf Gästepräferenzen und gewähltem Menü vor. Funktioniert wie ein digitaler Sommelier – rund um die Uhr." },
      { name: "Automatische Speisenbegleitungen", description: "Verknüpft jedes Menügericht mit den passendsten Weinen der Karte. Fördert Cross-Selling ohne Abhängigkeit von der Personalschulung." },
      { name: "Verkaufsanalytik", description: "Dashboard mit realen Daten: Was verkauft sich, was rotiert nicht, welche Margen erzielt jede Referenz und wie entwickelt sich der Durchschnittsbon." },
      { name: "Glaswein-Management", description: "Spezielles Modul zur Verwaltung des Glaswein-Angebots, Preisoptimierung und intelligenter Referenz-Rotation." },
      { name: "Preisoptimierung", description: "Intelligente Pricing-Tools, die Ihre Karte analysieren und Anpassungen vorschlagen, um die Bruttomarge zu maximieren, ohne an Wettbewerbsfähigkeit zu verlieren." },
    ],
    faqs: [
      { q: "Woran erkenne ich, dass meine Weinkarte nicht funktioniert?", a: "Die wichtigsten Indikatoren sind: Weniger als 40 % der Tische bestellen Wein, über 30 % der Referenzen haben sich in 90 Tagen nicht verkauft, und der durchschnittliche Weinbon stagniert seit 6+ Monaten." },
      { q: "Wie schnell zeigt sich die Wirkung einer Kartenoptimierung?", a: "Änderungen bei Struktur, Preisgestaltung und Präsentation zeigen in der Regel innerhalb von 4–8 Wochen Ergebnisse. Restaurants mit digitaler Karte verzeichnen typischerweise 15–25 % mehr Weinumsatz im ersten Quartal." },
      { q: "Brauche ich einen Sommelier für eine gute Weinkarte?", a: "Nicht unbedingt. Mit den richtigen Werkzeugen (wie Winerim) kann jedes Restaurant eine professionelle Karte mit Empfehlungen, Speisenbegleitungen und optimierter Preisgestaltung führen – ohne einen Vollzeit-Sommelier." },
      { q: "Wie viele Referenzen sollte meine Karte haben?", a: "Das hängt vom Restauranttyp ab, aber die allgemeine Regel lautet: Lieber 50 gut ausgewählte Referenzen mit Rotation als 150, die Verwirrung und Totbestand erzeugen. Jeder Wein muss seine Präsenz mit Verkaufsdaten rechtfertigen." },
    ],
    relatedLinks: [
      { label: "Eine rentable Weinkarte erstellen", url: "/de/weinkarte-erstellen" },
      ...
      { label: "Weinkarten-Analysator", url: "/de/weinkarten-analysator" },
      { label: "Papierkarte vs. digitale Karte", url: "/de/papierkarte-vs-digital" },
      { label: "Weinkarten-Software", url: "/de/weinkarten-software" },
    ],
  },
  pt: {
    slug: "problemas/carta-vinhos-nao-vende",
    metaTitle: "A Sua Carta de Vinhos Não Vende? Diagnóstico e Solução",
    metaDescription: "A sua carta de vinhos não gera vendas? Descubra as 5 causas mais comuns e como resolvê-las com dados, estratégia e tecnologia.",
    heroTitle: "A sua carta de vinhos não vende",
    heroSubtitle: "É um dos problemas mais frequentes na restauração. A boa notícia: tem solução. Explicamos porque acontece e como corrigir.",
    heroBadge: "Diagnóstico",
    ctaPrimaryText: "Analisar a sua carta grátis",
    ctaPrimaryUrl: "/pt/analisador-carta-vinhos",
    ctaFinalTitle: "Não deixe a sua carta continuar a perder dinheiro",
    ctaFinalDescription: "Com o Winerim pode diagnosticar a sua carta de vinhos em minutos e receber recomendações acionáveis para melhorar as suas vendas.",
    symptom: "Tem uma carta de vinhos com boas referências, mas as vendas de vinho são baixas. Os clientes pedem 'o vinho da casa' ou simplesmente não pedem vinho. O bilhete médio em vinho está estagnado.",
    symptomDetails: "Este problema afeta mais de 60 % dos restaurantes. Não se trata da qualidade dos vinhos, mas de como são apresentados, estruturados e recomendados.",
    causes: [
      "A carta tem demasiadas referências e o cliente bloqueia perante tanta escolha. A paralisia de decisão faz com que escolha o mais barato ou não peça nada.",
      "Os preços não estão bem estruturados. Não há uma faixa de preço clara que convide à compra, ou o vinho mais barato é ainda demasiado caro.",
      "A carta não oferece orientação. Sem notas de prova, harmonizações ou categorias claras, o cliente não sabe o que escolher e depende de um empregado que nem sempre consegue recomendar.",
      "O pessoal de sala não tem formação nem ferramentas para recomendar vinho. Sem confiança, evitam a recomendação.",
      "A carta não é atualizada. Vinhos sem rotação, preços desatualizados e referências que não encaixam no menu atual.",
    ],
    economicImpact: "Um restaurante com 100 talheres diários que melhore o seu rácio de venda de vinho de 30 % para 50 % pode gerar entre 3.000 € e 8.000 € adicionais por mês só em vinho.",
    economicImpactDetails: "O impacto não é apenas nas receitas. O vinho tem uma margem bruta superior à da comida (60–75 % vs. 30–40 %), pelo que cada garrafa vendida contribui desproporcionalmente para o lucro do restaurante.",
    solution: [
      { step: "Audite a sua carta atual", description: "Analise quantas referências tem, quais se vendem e quais não. Identifique vinhos com mais de 90 dias sem venda e elimine-os ou substitua-os." },
      { step: "Reestruture por estilo, não por região", description: "Organize a carta em categorias que o cliente perceba: brancos frescos, tintos elegantes, espumantes… Evite jargão técnico." },
      { step: "Otimize o pricing", description: "Reveja a curva de preços. Certifique-se de que tem opções atrativas na faixa 20–35 €, a mais vendida." },
      { step: "Acrescente orientação à carta", description: "Inclua notas de prova breves, ícones de intensidade, sugestões de harmonização e destaques do escanção." },
      { step: "Implemente ferramentas digitais", description: "Uma carta digital com filtros, recomendações e harmonizações automáticas multiplica a conversão." },
      { step: "Meça e otimize continuamente", description: "Estabeleça KPIs: rácio de mesas que pedem vinho, bilhete médio em vinho, rotação de referências." },
    ],
    winerimModules: [
      { name: "Carta digital interativa", description: "Permite ao cliente explorar a carta com filtros por estilo, preço, harmonização e região. Elimina a paralisia de escolha." },
      { name: "Recomendador inteligente", description: "Sugere vinhos com base nas preferências do cliente e no menu escolhido. Funciona como um escanção digital disponível 24/7." },
      { name: "Harmonizações automáticas", description: "Liga cada prato do menu aos vinhos mais adequados da carta. Facilita a venda cruzada sem depender da formação do pessoal." },
      { name: "Analítica de vendas", description: "Dashboard com dados reais sobre o que se vende, o que não roda, que margens gera cada referência e como evolui o bilhete médio." },
      { name: "Gestão de vinho a copo", description: "Módulo específico para gerir a oferta de vinho a copo, otimizar preços e rodar referências de forma inteligente." },
      { name: "Otimização de preços", description: "Ferramentas de pricing inteligente que analisam a sua carta e sugerem ajustes para maximizar a margem bruta sem perder competitividade." },
    ],
    faqs: [
      { q: "Como sei se a minha carta de vinhos não está a funcionar?", a: "Os indicadores principais são: menos de 40 % das mesas pedem vinho, mais de 30 % das referências não se vendem em 90 dias, e o bilhete médio em vinho está estagnado há 6+ meses." },
      { q: "Quanto tempo demora a ver o impacto da otimização da carta?", a: "As alterações em estrutura, pricing e apresentação costumam mostrar resultados em 4–8 semanas. Restaurantes que implementam carta digital registam um aumento de 15–25 % nas vendas de vinho no primeiro trimestre." },
      { q: "Preciso de um escanção para ter uma boa carta?", a: "Não necessariamente. Com as ferramentas certas (como o Winerim), qualquer restaurante pode ter uma carta profissional com recomendações, harmonizações e pricing otimizado sem depender de um escanção a tempo inteiro." },
      { q: "Quantas referências deve ter a minha carta?", a: "Depende do tipo de restaurante, mas a regra geral é: melhor 50 referências bem selecionadas e com rotação do que 150 que geram confusão e stock morto. Cada vinho deve justificar a sua presença com dados de venda." },
    ],
    relatedLinks: [
      { label: "Como fazer uma carta de vinhos rentável", url: "/pt/como-fazer-carta-vinhos" },
      { label: "Como vender mais vinho num restaurante", url: "/pt/vender-mais-vinho-restaurante" },
      { label: "Calculadora de margem de vinho", url: "/pt/calculadora-margem-vinho" },
      { label: "Analisador de carta de vinhos", url: "/pt/analisador-carta-vinhos" },
      { label: "Carta em papel vs. carta digital", url: "/pt/carta-papel-vs-digital" },
      { label: "Software de carta de vinhos", url: "/pt/software-carta-vinhos" },
    ],
  },
};

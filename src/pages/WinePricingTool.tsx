...
const i18n: I18nMap<Record<string, any>> = {
  ...
  de: {
    seo_title: "Weinkarten-Analysator – Optimales Weinpreismodell | Winerim",
    seo_desc: "Berechnen Sie den optimalen Verkaufspreis fuer jeden Wein auf Ihrer Weinkarte. Kostenloses Werkzeug mit Multiplikatoren, Positionierung und Preispsychologie.",
    badge: "Kostenloses Werkzeug",
    h1_1: "Wine Pricing", h1_2: "Optimizer",
    subtitle: "Finden Sie den optimalen Verkaufspreis fuer jeden Wein auf Ihrer Weinkarte. Maximieren Sie Margen ohne Umsatzbuessen.",
    bread_tools: "Werkzeuge", bread_self: "Wine Pricing Optimizer",
    params: "Parameter",
    cost_label: "Einkaufspreis",
    rest_label: "Restauranttyp",
    ticket_label: "Durchschnittsbon",
    wine_label: "Weintyp",
    recommended: "Empfohlener Preis",
    multiplier: "Multiplikator", margin_label: "Marge",
    range_title: "Preisspanne", price_label: "Preis",
    cost_chart: "Kosten", min_chart: "Minimum", rec_chart: "Empfohlen", max_chart: "Maximum",
    rest_types: [
      { value: "bistro", label: "Bistro / Weinstube" }, { value: "casual", label: "Casual Dining" },
      { value: "winebar", label: "Wine Bar" }, { value: "gastro", label: "Fine Dining" },
      { value: "hotel", label: "Hotel / Resort" },
    ],
    wine_types: [
      { value: "house", label: "Hauswein" }, { value: "mid", label: "Mittleres Segment" },
      { value: "premium", label: "Premium" }, { value: "icon", label: "Praedikat / Gran Reserva" },
    ],
    positioning: {
      house: { title: "Karteneingang", desc: "Der erste Wein, den der Gast sieht. Sollte preiswert und qualitaetsgerecht sein, um Vertrauen zu schaffen." },
      mid: { title: "Sweet Spot", desc: "Hier konzentriert sich das groesste Verkaufsvolumen. Wahrgenommen als hervorragendes Preis-Leistungs-Verhaeltnis." },
      premium: { title: "Oberes Segment", desc: "Fuer Gaeste, die nach etwas Besonderem suchen. Der niedrigere Multiplikator wird durch Mehrwertwahrnehmung kompensiert." },
      icon: { title: "Aspirationale Referenz", desc: "Preisanker, der den Rest der Karte zugaenglicher macht. Verkauft sich durch Prestige." },
    },
    tips_low_cost: "Bei Einstiegsweine ist der Gast sehr preissensibel. Jeder Euro zaehlt.",
    tips_high_cost: "Bei hoeheren Kosten schaetzt der Gast die Weingeschichte mehr als den exakten Preis.",
    tips_low_price: "Unter 25 Euro vergleichen Gaeste mit Supermarktpreisen. Begruenden Sie mit Kontext.",
    tips_high_price: "Ueber 25 Euro ist die Entscheidung emotionaler. Kostnotizen und Empfehlungen sind entscheidend.",
    tips_round: "Vermeiden Sie runde Preise ab ,00 — Preise wie {price} wirken zugaenglicher.",
    tips_compromise: "Positionieren Sie diesen Wein zwischen einer guenstigeren und einer teureren Option, um den Kompromisseffekt zu aktivieren.",
    cta_badge: "Automatische Optimierung",
    cta_title_1: "Winerim optimiert die Preise", cta_title_2: "fuer Ihre gesamte Weinkarte",
    cta_desc: "Hoeren Sie auf, Wein fuer Wein zu kalkulieren. Winerim analysiert Ihre gesamte Karte und schlaegt die optimale Preisstrategie vor.",
    cta_btn: "Demo anfordern",
    link_pricing: "So preisen Sie Wein richtig", link_margin: "Margenrechner",
    link_profitable: "Rentable Weinkarte", link_mapping: "Wine-Mapping-Vorlage",
    locale: "de-DE",
    decides: ["Welchen Preis Sie fuer jeden Wein festlegen", "Welchen Multiplikator Sie je Typ und Positionierung verwenden", "Ob Ihr aktueller Preis ueber oder unter dem Optimum liegt"],
    avoids: ["Einen festen Multiplikator fuer die gesamte Karte verwenden", "Preise ohne Beruecksichtigung der Gastpsychologie festlegen", "Marge verlieren bei Weinen, die mehr bringen koennten"],
    impact: ["Margen maximieren ohne Umschlagsbuessen", "Eine schlussige Preisleiter ohne Spruenge schaffen", "Den Mehrwert der gesamten Karte verbessern"],
  },
  pt: {
    seo_title: "Analisador de Cartas de Vinhos – Preco Otimo do Vinho | Winerim",
    seo_desc: "Calcule o preco de venda otimo para cada vinho da sua carta. Ferramenta gratuita com multiplicadores, posicionamento e psicologia dos precos.",
    badge: "Ferramenta gratuita",
    h1_1: "Wine Pricing", h1_2: "Optimizer",
    subtitle: "Encontre o preco de venda otimo para cada vinho da sua carta. Maximize margens sem perder vendas.",
    bread_tools: "Ferramentas", bread_self: "Wine Pricing Optimizer",
    params: "Parametros",
    cost_label: "Preco de compra",
    rest_label: "Tipo de restaurante",
    ticket_label: "Bilhete medio",
    wine_label: "Tipo de vinho",
    recommended: "Preco recomendado",
    multiplier: "multiplicador", margin_label: "margem",
    range_title: "Intervalo de precos", price_label: "Preco",
    cost_chart: "Custo", min_chart: "Minimo", rec_chart: "Recomendado", max_chart: "Maximo",
    rest_types: [
      { value: "bistro", label: "Bistrô / Tasca" }, { value: "casual", label: "Casual dining" },
      { value: "winebar", label: "Wine bar" }, { value: "gastro", label: "Gastronomico" },
      { value: "hotel", label: "Hotel / Resort" },
    ],
    wine_types: [
      { value: "house", label: "Vinho da casa" }, { value: "mid", label: "Gama media" },
      { value: "premium", label: "Premium" }, { value: "icon", label: "Iconica / Gran reserva" },
    ],
    positioning: {
      house: { title: "Entrada da carta", desc: "Primeiro vinho que o cliente ve. Deve ser atraente em preco e qualidade para gerar confianca." },
      mid: { title: "Zona media (sweet spot)", desc: "Onde se concentra o maior volume de vendas. Percebido como excelente relacao qualidade-preco." },
      premium: { title: "Zona alta", desc: "Para clientes que procuram algo especial. O multiplicador mais baixo e compensado pela percepcao de valor." },
      icon: { title: "Referencia aspiracional", desc: "Ancore de preco que torna o resto da carta mais acessivel. Vende-se pelo prestigio." },
    },
    tips_low_cost: "Em vinhos de entrada, o cliente e muito sensivel ao preco. Cada euro conta.",
    tips_high_cost: "Acima de um certo custo, o cliente valoriza mais a historia do vinho que o preco exato.",
    tips_low_price: "Abaixo de 25 euros, os clientes comparam com precos de supermercado. Justifique com contexto.",
    tips_high_price: "Acima de 25 euros, a decisao e mais emocional. As notas de degustacao e a recomendacao sao cruciais.",
    tips_round: "Evite precos redondos em ,00 — precos como {price} sao percebidos como mais acessiveis.",
    tips_compromise: "Coloque este vinho entre um mais barato e um mais caro para ativar o efeito de compromisso.",
    cta_badge: "Otimizacao automatica",
    cta_title_1: "Winerim otimiza os precos de", cta_title_2: "toda a sua carta",
    cta_desc: "Deixe de calcular vinho por vinho. Winerim analisa toda a sua carta e sugere a estrategia de precos otima.",
    cta_btn: "Solicitar demo",
    link_pricing: "Como precificar vinho", link_margin: "Calculadora de margens",
    link_profitable: "Carta de vinhos rentavel", link_mapping: "Modelo wine mapping",
    locale: "pt-PT",
    decides: ["Que preco definir para cada vinho", "Qual multiplicador aplicar por tipo e posicionamento", "Se seu preco atual esta acima ou abaixo do otimo"],
    avoids: ["Usar um multiplicador fixo para toda a carta", "Definir precos sem considerar a psicologia do cliente", "Perder margem em vinhos onde poderia cobrar mais"],
    impact: ["Otimizar margens sem perder rotacao", "Criar uma escada de precos coerente e sem lacunas", "Melhorar a percepcao de valor de toda a carta"],
  },
};

...
const solutions = [
  ...
  { to: "/barometro-cartas-vino-2026", icon: BarChart3, title: "Barómetro Winerim 2026", desc: "Metodología y patrones agregados para comparar cartas de vino sin publicar datos sensibles." },

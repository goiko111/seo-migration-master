...
const i18n: I18nMap<{
  ...
  de: {
    metaTitle: "Beispiele für Weinkarten für Restaurants | Modelle und Vorlagen",
    metaDescription: "Echte Beispiele gut strukturierter Weinkarten für kleines Restaurant, Weinstube und Gourmet-Restaurant.",
    url: "https://winerim.wine/de/weinkarten-beispiele",
    breadcrumbParent: "Leitfäden", breadcrumbCurrent: "Weinkarten-Beispiele",
    badge: "Modelle und Vorlagen",
    h1pre: "Weinkarten-Beispiele für", h1accent: "Restaurants",
    subtitle: "Gut strukturierte Kartenmodelle für verschiedene Restauranttypen. Erfahren Sie, wie Sie Ihre Weinkarte organisieren, gestalten und optimieren.",
    structureLabel: "Empfohlene Struktur",
    tipsTag: "Praktischer Leitfaden",
    tipsH2pre: "Schlüssel für eine", tipsH2accent: "wirksame Weinkarte",
    ctaTag: "Kostenlose Analyse",
    ctaH2pre: "Ist Ihre Weinkarte", ctaH2accent: "gut strukturiert",
    ctaDesc: "Senden Sie uns Ihre Weinkarte und wir zeigen Ihnen, wie Sie ihre Struktur, Preise und Kategorien verbessern. Unverbindlich.",
    ctaBtn: "Meine Weinkarte analysieren",
    examples: [
      {
        icon: Store, title: "Kleines Restaurant", type: "Bistro / Gastronomische Kneipe", references: "15 – 25 Positionen",
        description: "Eine kompakte und sorgfältig kuratierte Karte, in der jeder Wein einen klaren Zweck hat. Einfach zu verwalten, einfach zu empfehlen und einfach für den Gast zu verstehen.",
        structure: ["Nach Typ gruppieren (Weiße, Rote, Rosé)", "3-5 Weine pro Glas einschließen", "1 Empfehlung pro Kategorie hervorheben", "Preisleiter ohne Lücken"],
        priceRange: "18 € – 45 €",
        sections: [
          { category: "Weiße", wines: [{ name: "Albariño Pazo Señorans", origin: "Rías Baixas", price: "24 €" }, { name: "Verdejo Menade", origin: "Rueda", price: "20 €" }, { name: "Godello Guímaro", origin: "Valdeorras", price: "28 €" }] },
          { category: "Rote", wines: [{ name: "Crianza Muga", origin: "Rioja", price: "26 €" }, { name: "Mencía Descendientes de J. Palacios", origin: "Bierzo", price: "32 €" }, { name: "Garnacha Comando G", origin: "Sierra de Gredos", price: "38 €" }] },
        ],
      },
      {
        icon: Wine, title: "Weinstube", type: "Spezialisierte Weinstube", references: "40 – 60 Positionen",
        description: "Eine umfangreichere Karte, die nach Stil und sensorischem Profil organisiert ist, nicht nur nach Typ. Ideal für neugierige Gäste, die verschiedene Weine entdecken möchten.",
        structure: ["Nach Stil organisieren (frisch, strukturiert, süß)", "Eigener Bereich für Weine pro Glas (8-12)", "Naturweine und Autorenweineincludieren", "Kurze Verkostungsnotizen hinzufügen"],
        priceRange: "20 € – 70 €",
        sections: [
          { category: "Frisch und leicht", wines: [{ name: "Txakoli Ameztoi", origin: "Getariako Txakolina", price: "22 €" }, { name: "Muscadet Sèvre et Maine", origin: "Loiretal", price: "24 €" }, { name: "Grüner Veltliner Loimer", origin: "Kamptal, Österreich", price: "28 €" }] },
          { category: "Charaktervoll", wines: [{ name: "Nebbiolo Langhe Produttori", origin: "Piemont", price: "34 €" }, { name: "Syrah Alain Graillot", origin: "Crozes-Hermitage", price: "42 €" }, { name: "Alte Garnacha Alfredo Maestro", origin: "Calatayud", price: "30 €" }] },
          { category: "Schaumweine", wines: [{ name: "Cava Recaredo Brut Nature", origin: "Penedès", price: "32 €" }, { name: "Champagne Pierre Gimonnet", origin: "Champagne", price: "52 €" }] },
        ],
      },
      {
        icon: Star, title: "Gourmet-Restaurant", type: "Haute Cuisine / Fine Dining", references: "80 – 200+ Positionen",
        description: "Eine umfangreiche Karte, die nach Regionen und Subregionen organisiert ist und Premium-Sektionen sowie Sommelier-Auswahl enthält.",
        structure: ["Nach Hauptregion und Unterabschnitten organisieren", "Bereich 'Sommelier-Auswahl' hervorgehoben", "Große Formate (Magnum) einschließen", "Empfohlene Paarungen mit Degustationsmenü", "Premium-Weine pro Glas (10-15 Positionen)"],
        priceRange: "25 € – 300 €+",
        sections: [
          { category: "Spanien – Weiße", wines: [{ name: "Albariño Do Ferreiro Cepas Vellas", origin: "Rías Baixas", price: "48 €" }, { name: "Viura Remelluri Blanco", origin: "Rioja", price: "42 €" }, { name: "Xarel·lo Recaredo Serral del Vell", origin: "Penedès", price: "65 €" }] },
          { category: "Frankreich – Rote", wines: [{ name: "Châteauneuf-du-Pape E. Guigal", origin: "Südliche Rhône", price: "68 €" }, { name: "Gevrey-Chambertin Dugat-Py", origin: "Burgund", price: "120 €" }, { name: "Margaux Château Palmer", origin: "Bordeaux", price: "195 €" }] },
          { category: "Sommelier-Auswahl", wines: [{ name: "Pingus", origin: "Ribera del Duero", price: "280 €" }, { name: "Vega Sicilia Único", origin: "Ribera del Duero", price: "250 €" }, { name: "Clos Mogador", origin: "Priorat", price: "85 €" }] },
        ],
      },
    ],
    tips: [
      { icon: Layers, title: "Wie man Weine organisiert", points: ["Nach Typ gruppieren (Weiß, Rot, Rosé, Schaumwein) bei kleinen Karten", "Nach Region oder Stil bei großen, komplexen Karten gruppieren", "Weine-pro-Glas-Bereich trennen", "Ausgezeichnete Kategorie einschließen (Empfehlungen, Chefauswahl)"] },
      { icon: TrendingUp, title: "Wie man Preise verteilt", points: ["Progressive Preisleiter ohne starke Sprünge erstellen", "Die meisten Positionen im mittleren Preisbereich konzentrieren", "Abnehmende Multiplikatoren verwenden (höhere Marge bei Einsteiger-Weinen)", "Lücken von mehr als 10 € zwischen aufeinanderfolgenden Positionen vermeiden"] },
      { icon: BarChart3, title: "Wie man Kategorien strukturiert", points: ["Jede Kategorie sollte mindestens 3 Optionen haben", "Kriterien (Typ + Region) nicht auf derselben Ebene vermischen", "Empfohlene Weine in prominenten Positionen platzieren", "Stilvielfalt innerhalb jeder Kategorie sicherstellen"] },
    ],
    links: [
    ...
    faqData: [
      ...
      { q: "Wie wird eine Weinkarte organisiert?", a: "Kleine Karten werden nach Typ organisiert (Weiß, Rot, Rosé). Große, komplexe Karten werden nach Region oder Stil organisiert. Es ist immer ratsam, Weine pro Glas zu trennen und Empfehlungen hervorzuheben." },
      { q: "Wie werden Preise auf einer Weinkarte verteilt?", a: "Mit einer progressiven Leiter ohne Lücken, wobei die meisten Positionen im mittleren Preisbereich konzentriert sind und abnehmende Multiplikatoren verwendet werden, damit Premium-Weine wettbewerbsfähige Preise behalten." },
    ],
  },
  pt: {
    metaTitle: "Exemplos de Carta de Vinhos para Restaurantes | Modelos e Templates",
    metaDescription: "Exemplos reais de cartas de vinhos bem estruturadas para pequeno restaurante, adega de vinhos e restaurante gastronómico.",
    url: "https://winerim.wine/pt/exemplos-carta-vinhos",
    breadcrumbParent: "Guias", breadcrumbCurrent: "Exemplos de carta de vinhos",
    badge: "Modelos e templates",
    h1pre: "Exemplos de carta de vinhos para", h1accent: "restaurantes",
    subtitle: "Modelos de cartas bem estruturadas para diferentes tipos de restaurante. Saiba como organizar, desenhar e otimizar sua carta de vinhos.",
    structureLabel: "Estrutura recomendada",
    tipsTag: "Guia prático",
    tipsH2pre: "Chaves para desenhar uma carta de vinhos", tipsH2accent: "eficaz",
    ctaTag: "Análise gratuita",
    ctaH2pre: "Sua carta está", ctaH2accent: "bem estruturada",
    ctaDesc: "Envie-nos sua carta de vinhos e mostraremos como melhorar sua estrutura, preços e categorias. Sem compromisso.",
    ctaBtn: "Analisar minha carta de vinhos",
    examples: [
      {
        icon: Store, title: "Pequeno restaurante", type: "Bistrô / Taverna gastronómica", references: "15 – 25 referências",
        description: "Uma carta compacta e bem curada, onde cada vinho tem um propósito claro. Fácil de gerir, fácil de recomendar e fácil de compreender para o cliente.",
        structure: ["Agrupar por tipo (brancos, tintos, rosés)", "Incluir 3-5 vinhos a copo", "Destacar 1 recomendação por categoria", "Escada de preços sem lacunas"],
        priceRange: "18 € – 45 €",
        sections: [
          { category: "Brancos", wines: [{ name: "Albariño Pazo Señorans", origin: "Rías Baixas", price: "24 €" }, { name: "Verdejo Menade", origin: "Rueda", price: "20 €" }, { name: "Godello Guímaro", origin: "Valdeorras", price: "28 €" }] },
          { category: "Tintos", wines: [{ name: "Crianza Muga", origin: "Rioja", price: "26 €" }, { name: "Mencía Descendientes de J. Palacios", origin: "Bierzo", price: "32 €" }, { name: "Garnacha Comando G", origin: "Sierra de Gredos", price: "38 €" }] },
        ],
      },
      {
        icon: Wine, title: "Adega de vinhos", type: "Adega de vinhos especializada", references: "40 – 60 referências",
        description: "Uma carta mais ampla organizada por estilo e perfil sensorial, não apenas por tipo. Ideal para clientes exploradores que querem descobrir vinhos diferentes.",
        structure: ["Organizar por estilo (frescos, estruturados, doces)", "Secção dedicada de vinhos a copo (8-12)", "Incluir vinhos naturais e de autor", "Adicionar breves notas de prova"],
        priceRange: "20 € – 70 €",
        sections: [
          { category: "Frescos e ligeiros", wines: [{ name: "Txakoli Ameztoi", origin: "Getariako Txakolina", price: "22 €" }, { name: "Muscadet Sèvre et Maine", origin: "Vale do Loira", price: "24 €" }, { name: "Grüner Veltliner Loimer", origin: "Kamptal, Áustria", price: "28 €" }] },
          { category: "Com carácter", wines: [{ name: "Nebbiolo Langhe Produttori", origin: "Piemonte", price: "34 €" }, { name: "Syrah Alain Graillot", origin: "Crozes-Hermitage", price: "42 €" }, { name: "Garnacha velha Alfredo Maestro", origin: "Calatayud", price: "30 €" }] },
          { category: "Espumantes", wines: [{ name: "Cava Recaredo Brut Nature", origin: "Penedès", price: "32 €" }, { name: "Champagne Pierre Gimonnet", origin: "Champagne", price: "52 €" }] },
        ],
      },
      {
        icon: Star, title: "Restaurante gastronómico", type: "Alta cozinha / Fine dining", references: "80 – 200+ referências",
        description: "Uma carta extensa organizada por regiões e sub-regiões, com secções premium e seleção do escanção.",
        structure: ["Organizar por região principal e subsecções", "Secção 'Seleção do escanção' destacada", "Incluir formatos grandes (Magnum)", "Harmonizações sugeridas com menu de degustação", "Vinhos a copo premium (10-15 referências)"],
        priceRange: "25 € – 300 €+",
        sections: [
          { category: "Espanha – Brancos", wines: [{ name: "Albariño Do Ferreiro Cepas Vellas", origin: "Rías Baixas", price: "48 €" }, { name: "Viura Remelluri Blanco", origin: "Rioja", price: "42 €" }, { name: "Xarel·lo Recaredo Serral del Vell", origin: "Penedès", price: "65 €" }] },
          { category: "França – Tintos", wines: [{ name: "Châteauneuf-du-Pape E. Guigal", origin: "Ródano Sul", price: "68 €" }, { name: "Gevrey-Chambertin Dugat-Py", origin: "Borgonha", price: "120 €" }, { name: "Margaux Château Palmer", origin: "Bordéus", price: "195 €" }] },
          { category: "Seleção do escanção", wines: [{ name: "Pingus", origin: "Ribera del Duero", price: "280 €" }, { name: "Vega Sicilia Único", origin: "Ribera del Duero", price: "250 €" }, { name: "Clos Mogador", origin: "Priorat", price: "85 €" }] },
        ],
      },
    ],
    tips: [
      { icon: Layers, title: "Como organizar os vinhos", points: ["Agrupar por tipo (branco, tinto, rosé, espumante) em cartas pequenas", "Agrupar por região ou estilo em cartas amplas e complexas", "Separar a secção de vinhos a copo", "Incluir uma categoria destacada (recomendações, seleção do chef)"] },
      { icon: TrendingUp, title: "Como distribuir os preços", points: ["Criar uma escada progressiva sem saltos bruscos", "Concentrar o maior número de referências na zona média", "Usar multiplicadores decrescentes (margem maior em vinhos de entrada)", "Evitar lacunas de mais de 10 € entre referências consecutivas"] },
      { icon: BarChart3, title: "Como estruturar as categorias", points: ["Cada categoria deve ter pelo menos 3 opções", "Não misturar critérios (tipo + região) no mesmo nível", "Colocar os vinhos recomendados em posição destacada", "Garantir variedade de estilos dentro de cada categoria"] },
    ],
    links: [
    ...
    faqData: [
      ...
      { q: "Como se organiza uma carta de vinhos?", a: "As cartas pequenas organizam-se por tipo (branco, tinto, rosé). As cartas amplas e complexas organizam-se por região ou estilo. É sempre aconselhável separar os vinhos a copo e destacar as recomendações." },
      { q: "Como se distribuem os preços numa carta de vinhos?", a: "Com uma escada progressiva sem lacunas, concentrando referências na zona média de preço e usando multiplicadores decrescentes para que os vinhos premium mantenham preços competitivos." },
    ],
  },
};

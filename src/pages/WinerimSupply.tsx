...
const i18n: I18nMap<{
  ...
  es: {
    ...
    seo_desc: "Winerim Supply cruza costes reales, pedidos, albaranes, facturas, tarifas y distribuidores para ayudarte a decidir qué comprar, qué renegociar y qué no reponer.",
    ...
    hero_subtitle: "Winerim Supply cruza costes reales, pedidos, albaranes, facturas, tarifas, stock, rotación y distribuidores para ayudarte a decidir qué merece la pena seguir comprando, qué renegociar y qué no reponer.",
    ...
    s2_paragraphs: [
      ...
      "Conectando los datos de venta, margen, rotación y stock que ya genera <link>Winerim Core</link> con pedidos, albaranes, facturas y tarifas procesadas por CloudRIM, Supply añade una capa de inteligencia sobre la cadena de aprovisionamiento: analiza qué te conviene comprar, cuál es el coste real y si tus distribuidores te ofrecen las mejores condiciones.",
    ...
    s2_pillars: [
      { label: "Compra con criterio", desc: "Ventas, stock, albaranes y facturas informan cada pedido." },
      { label: "Negocia con ventaja", desc: "Tarifas y costes reales frente al mercado." },
    ...
    s3_subtitle: "Seis capacidades diseñadas para que cada euro invertido en bodega tenga un coste real trazable y un retorno medible en la carta.",
    s3_caps: [
      { title: "Coste real por referencia", desc: "Cruza pedidos, albaranes, facturas y tarifas para saber qué coste debe alimentar margen, stock y decisiones de compra." },
      { title: "Conciliación albarán-factura", desc: "Cuando CloudRIM detecta una factura o un albarán, Winerim compara proveedor, líneas, cantidades, precios y totales antes de actualizar costes." },
      ...
      { title: "Alertas de sobreprecio y tarifa", desc: "Notificación cuando una factura, albarán o tarifa deja una referencia por encima de lo esperado para tu perfil, volumen o proveedor." },
      ...
      { title: "Scoring de distribuidores", desc: "Evalúa a tus proveedores según coste real, desviaciones de tarifa, fiabilidad de entrega, amplitud de catálogo y condiciones comerciales." },
    ],
    ...
    s6_subtitle: "Te mostramos cómo Winerim Supply transforma tus decisiones de compra con datos reales de carta, stock, albaranes, facturas, tarifas y mercado.",
    ...
    faqs: [
      { q: "¿Winerim Supply sustituye a mi distribuidor?", a: "No. Supply no vende ni intermedia. Analiza pedidos, albaranes, facturas, tarifas y datos de compra para que negocies con más información y tomes mejores decisiones de reposición." },
      { q: "¿Cómo se calcula el coste real?", a: "Winerim cruza tarifas, albaranes y facturas procesadas por CloudRIM con el proveedor, las líneas, cantidades, precios y totales. Si algo no cuadra, queda en revisión antes de afectar márgenes o decisiones de compra." },
  ...
  en: {
    ...
    seo_desc: "Winerim Supply connects real costs, orders, delivery notes, invoices, tariffs and distributors to help you decide what to buy, renegotiate and stop restocking.",
    ...
    hero_subtitle: "Winerim Supply connects real costs, orders, delivery notes, invoices, tariffs, stock, rotation and distributors to help you decide what's worth restocking, renegotiating or dropping.",
    ...
    s2_paragraphs: [
      ...
      "By connecting sales, margin, rotation and stock data already generated by <link>Winerim Core</link> with orders, delivery notes, invoices and tariffs processed by CloudRIM, Supply adds a layer of intelligence to the supply chain: it analyses what's worth buying, the real cost and whether your distributors are offering the best terms.",
    ...
    s2_pillars: [
      { label: "Buy with criteria", desc: "Sales, stock, delivery notes and invoices inform every order." },
      { label: "Negotiate with advantage", desc: "Tariffs and real costs against the market." },
    ...
    s3_subtitle: "Six capabilities designed so every euro invested in your cellar has a traceable real cost and a measurable return on the wine list.",
    s3_caps: [
      { title: "Real cost per reference", desc: "Crosses orders, delivery notes, invoices and tariffs to know which cost should feed margin, stock and purchasing decisions." },
      { title: "Delivery note to invoice reconciliation", desc: "When CloudRIM detects an invoice or delivery note, Winerim compares supplier, lines, quantities, prices and totals before updating costs." },
      ...
      { title: "Overprice and tariff alerts", desc: "Flags when an invoice, delivery note or tariff leaves a reference above what is expected for your profile, volume or supplier." },
      ...
      { title: "Distributor scoring", desc: "Evaluates suppliers by real cost, tariff deviations, delivery reliability, catalogue breadth and commercial terms." },
    ],
  ...
  de: {
    seo_title: "Winerim Supply | Einkaufsintelligenz für Restaurants",
    seo_desc: "Winerim Supply analysiert Einkaufspreise, Distributoren, Rotation und Chancen, um Ihnen zu helfen, besser zu entscheiden, was gekauft, neu verhandelt oder nicht mehr nachbestellt wird.",
    seo_url: "https://winerim.wine/de/produkt/winerim-supply",
    breadcrumbs: [{ label: "Start", href: "/" }, { label: "Funktionen", href: "/funcionalidades" }, { label: "Winerim Supply" }],
    hero_badge: "WINERIM SUPPLY",
    hero_title_1: "Die Schicht, die Ihnen hilft, besser einzukaufen – ",
    hero_title_highlight: "nicht nur besser zu verkaufen",
    hero_subtitle: "Winerim Supply analysiert Einkaufspreise, Bestand, Rotation, Chancen und Distributoren, damit Sie entscheiden können, was sich weiter zu kaufen lohnt, was neu zu verhandeln ist und was nicht mehr nachbestellt werden sollte.",
    hero_journey: "Besser einkaufen → Besser analysieren → Besser verkaufen",
    hero_cta_primary: "Winerim Supply ansehen",
    hero_cta_secondary: "So verbindet es sich mit Winerim Core",
    s2_eyebrow: "Was ist Winerim Supply",
    s2_title_1: "Die Schicht, die verbindet, was Sie ",
    s2_title_sells: "verkaufen",
    s2_title_buys: "einkaufen",
    s2_paragraphs: [
      "Die meisten Restaurants managen ihren Weineinkauf aus Gewohnheit: Bestellungen werden wiederholt, Referenzen aus Tradition gehalten und Verhandlungen ohne Daten geführt. <strong>Winerim Supply ändert diese Logik.</strong>",
      "Indem es Verkaufs-, Margen-, Rotations- und Bestandsdaten aus <link>Winerim Core</link> verbindet, legt Supply eine Intelligenzschicht über die Lieferkette: Es analysiert, was sich zu kaufen lohnt, zu welchem Preis Sie gegenüber dem Markt zahlen und ob Ihre Distributoren die besten Konditionen bieten.",
      "Es ersetzt nicht Ihre Beziehung zu Lieferanten. Es bereichert sie mit Daten, damit jede Kaufentscheidung durch eine vollständige Sicht auf das Geschäft gestützt wird.",
    ],
    s2_pillars: [
      { label: "Mit Kriterium einkaufen", desc: "Verkaufs- und Rotationsdaten informieren jede Bestellung." },
      { label: "Im Vorteil verhandeln", desc: "Preisvergleich gegenüber dem Markt." },
      { label: "Mit Logik nachbestellen", desc: "Automatisiert die Einkaufsliste anhand echter Nachfrage." },
    ],
    s3_eyebrow: "Fähigkeiten",
    s3_title_1: "Intelligenz angewandt auf jede ",
    s3_title_highlight: "Einkaufsentscheidung",
    s3_subtitle: "Sechs Fähigkeiten, damit jeder im Keller investierte Euro eine messbare Rendite auf der Karte erzielt.",
    s3_caps: [
      { title: "Einkaufspreisvergleich", desc: "Vergleicht, was Sie pro Referenz zahlen, mit aggregierten Netzwerkdaten, um zu prüfen, ob Ihr Preis wettbewerbsfähig ist oder Spielraum für Neuverhandlungen besteht." },
      { title: "Chancenerkennung", desc: "Identifiziert Referenzen, die Restaurants mit ähnlichem Profil erfolgreich einkaufen und die Sie noch nicht auf der Karte haben." },
      { title: "Überpreis-Alarme", desc: "Automatische Benachrichtigung, wenn der Einkaufspreis einer Referenz deutlich über dem Mittel Ihres Profils und Volumens liegt." },
      { title: "Kauf-/Nichtnachkauf-Empfehlung", desc: "Basierend auf Rotation, Marge, aktuellem Bestand und Verkaufstrend empfiehlt das System, was nachbestellt, auslaufen oder getestet werden soll." },
      { title: "Distributoren-Scoring", desc: "Bewertet Ihre Lieferanten nach Preis, Lieferzuverlässigkeit, Katalogbreite und Handelskonditionen im Vergleich zu Alternativen." },
      { title: "Intelligente Einkaufsliste", desc: "Erstellt Bestellvorschläge basierend auf Beständen, Abverkaufstempo, Nachfrageprognose und aktiven Kartenzielen." },
    ],
    s4_eyebrow: "Der Netzwerkvorteil",
    s4_title_1: "Je mehr Restaurants Winerim nutzen, ",
    s4_title_highlight: "desto bessere Daten für alle",
    s4_paragraphs: [
      "Winerim Supply funktioniert nicht wie ein generischer Preisvergleich. Es nutzt echte, anonymisierte Daten von Restaurants, die die Plattform bereits einsetzen. Preisvergleiche, Überpreis-Alarme und Einkaufschancen basieren auf <strong>realen Transaktionen von Betrieben mit ähnlichem Profil</strong>.",
      "Mit wachsendem Netzwerk steigt die Einkaufsintelligenz. Ein Netzwerk-Effekt, bei dem jedes neu hinzukommende Restaurant die Datenbasis reichhaltiger, Vergleiche zuverlässiger und Empfehlungen präziser macht.",
    ],
    s4_pillars: [
      { label: "Anonymisierte Daten", desc: "Kein Restaurant sieht individuelle Daten eines anderen." },
      { label: "Vergleichbare Profile", desc: "Nur Betriebe mit ähnlichem Volumen und Typ werden verglichen." },
      { label: "Netzwerkeffekt", desc: "Mehr Restaurants = bessere Einkaufs-Benchmarks." },
    ],
    s5_eyebrow: "Gruppen und Multi-Standort",
    s5_title_1: "Für Gruppen ist Supply ",
    s5_title_highlight: "noch leistungsstärker",
    s5_cards: [
      { title: "Konsolidierte Einkaufssicht", desc: "Bündelt die Bestellungen aller Standorte der Gruppe, um Ineffizienzen, Dopplungen und Chancen zur Verhandlung auf Gruppenebene zu erkennen." },
      { title: "Interner Einkaufs-Benchmark", desc: "Vergleicht Einkaufspreise zwischen Standorten derselben Gruppe. Erkennt, wenn ein Standort für dieselbe Referenz mehr zahlt, und standardisiert Konditionen." },
      { title: "Katalog-Vereinheitlichung", desc: "Identifiziert, welche Referenzen mehrere Standorte teilen und welche standortspezifisch sind, und erleichtert die Rationalisierung des Gruppenkatalogs." },
      { title: "Zentralisierte Empfehlungen", desc: "Die Einkaufsleitung der Gruppe erhält konsolidierte Empfehlungen auf Basis der tatsächlichen Performance jeder Referenz pro Standort." },
    ],
    s5_link: "Komplette Lösung für Restaurantgruppen ansehen",
    s6_eyebrow: "Intelligent einkaufen",
    s6_title_1: "Hören Sie auf, aus Gewohnheit zu kaufen. ",
    s6_title_highlight: "Kaufen Sie mit Daten.",
    s6_subtitle: "Wir zeigen Ihnen, wie Winerim Supply Ihre Kaufentscheidungen mit echten Daten aus Ihrer Karte, Ihrem Bestand und dem Markt verändert.",
    s6_cta_primary: "Supply-Demo anfordern",
    s6_cta_secondary: "Mit dem Team sprechen",
    faq_title: "Häufige Fragen zu Winerim Supply",
    faqs: [
      { q: "Ersetzt Winerim Supply meinen Distributor?", a: "Nein. Supply verkauft nicht und vermittelt nicht. Es analysiert Ihre Einkaufsdaten und vergleicht sie mit Marktbenchmarks, damit Sie fundierter verhandeln und bessere Nachbestellentscheidungen treffen." },
      { q: "Wie werden die Preisvergleiche erzeugt?", a: "Aus anonymisierten, aggregierten Daten von Restaurants, die Winerim nutzen. Individuelle Daten werden nie geteilt; verwendet werden nur Durchschnittswerte pro Profil und vergleichbarem Volumen." },
      { q: "Brauche ich Winerim Core, um Supply zu nutzen?", a: "Supply nutzt die von Core erzeugten Daten (Verkäufe, Margen, Rotation, Bestand). Beide wirken als komplementäre Schichten innerhalb derselben Plattform." },
      { q: "Kann ich Supply für eine Gruppe mit mehreren Standorten nutzen?", a: "Ja. Tatsächlich ist die konsolidierte Einkaufssicht auf Gruppenebene eine der stärksten Funktionen von Supply: Sie erkennt Preisabweichungen zwischen Standorten und Chancen für gemeinsame Verhandlung." },
      { q: "Ist Supply in allen Plänen verfügbar?", a: "Supply wird schrittweise ausgerollt. Sprechen Sie mit dem Team, um die Verfügbarkeit je nach Plan und Geschäftsprofil zu klären." },
    ],
    il: [
      { to: "/producto/winerim-core", label: "Winerim Core: 26 analytische Module", type: "solution" },
      { to: "/producto/inteligencia-dinamica", label: "Dynamic Intelligence: taktische KI für die Karte", type: "solution" },
      { to: "/herramientas/calculadora-compra-inteligente", label: "Smart-Purchase-Rechner", type: "tool" },
      { to: "/herramientas/calculadora-stock-muerto", label: "Rechner toter Bestand", type: "tool" },
      { to: "/decision-center/compras-reposicion", label: "Decision Center: Einkauf und Nachbestellung", type: "decision-center" },
      { to: "/decision-center/stock-rotacion", label: "Decision Center: Bestand und Rotation", type: "decision-center" },
      ...
      { to: "/demo", label: "Personalisierte Demo anfordern", type: "solution" },
    ],
  },
  pt: {
    seo_title: "Winerim Supply | Inteligência de compras para restaurantes",
    seo_desc: "A Winerim Supply analisa preços de compra, distribuidores, rotação e oportunidades para o ajudar a decidir o que comprar, o que renegociar e o que não repor.",
    seo_url: "https://winerim.wine/pt/produto/winerim-supply",
    breadcrumbs: [{ label: "Início", href: "/" }, { label: "Funcionalidades", href: "/funcionalidades" }, { label: "Winerim Supply" }],
    hero_badge: "WINERIM SUPPLY",
    hero_title_1: "A camada que o ajuda a comprar melhor, ",
    hero_title_highlight: "não apenas a vender melhor",
    hero_subtitle: "A Winerim Supply analisa preços de compra, stock, rotação, oportunidades e distribuidores para o ajudar a decidir o que vale a pena continuar a comprar, o que renegociar e o que não repor.",
    hero_journey: "Comprar melhor → Analisar melhor → Vender melhor",
    hero_cta_primary: "Quero ver a Winerim Supply",
    hero_cta_secondary: "Ver como se liga ao Winerim Core",
    s2_eyebrow: "O que é a Winerim Supply",
    s2_title_1: "A camada que liga o que ",
    s2_title_sells: "vende",
    s2_title_buys: "compra",
    s2_paragraphs: [
      "A maioria dos restaurantes gere as compras de vinho por inércia: repete encomendas, mantém referências por hábito e negoceia sem dados. <strong>A Winerim Supply muda essa lógica.</strong>",
      "Ligando os dados de venda, margem, rotação e stock que o <link>Winerim Core</link> já gera, a Supply acrescenta uma camada de inteligência sobre a cadeia de abastecimento: analisa o que lhe convém comprar, a que preço está a pagar face ao mercado e se os seus distribuidores oferecem as melhores condições.",
      "Não substitui a sua relação com os fornecedores. Enriquece-a com dados para que cada decisão de compra seja suportada por uma visão completa do negócio.",
    ],
    s2_pillars: [
      { label: "Compre com critério", desc: "Dados de venda e rotação informam cada encomenda." },
      { label: "Negoceie em vantagem", desc: "Comparativo de preços face ao mercado." },
      { label: "Reponha com lógica", desc: "Automatiza a lista de compras segundo a procura real." },
    ],
    s3_eyebrow: "Capacidades",
    s3_title_1: "Inteligência aplicada a cada ",
    s3_title_highlight: "decisão de compra",
    s3_subtitle: "Seis capacidades pensadas para que cada euro investido em garrafeira tenha um retorno mensurável na carta.",
    s3_caps: [
      { title: "Comparativo de preços de compra", desc: "Cruza o que paga por cada referência com dados agregados da rede para saber se o seu preço é competitivo ou se há margem para renegociar." },
      { title: "Deteção de oportunidades", desc: "Identifica referências que outros restaurantes de perfil semelhante estão a comprar com bons resultados e que ainda não tem em carta." },
      { title: "Alertas de sobrepreço", desc: "Notificação automática quando o preço de compra de uma referência está significativamente acima da média para o seu perfil e volume." },
      { title: "Recomendação de compra / não reposição", desc: "Com base em rotação, margem, stock atual e tendência de venda, o sistema recomenda o que repor, o que deixar morrer e o que testar." },
      { title: "Scoring de distribuidores", desc: "Avalia os seus fornecedores quanto a preço, fiabilidade de entrega, amplitude de catálogo e condições comerciais face a alternativas." },
      { title: "Lista de compras inteligente", desc: "Gera propostas de encomenda com base em níveis de stock, velocidade de saída, previsão de procura e objetivos de carta ativos." },
    ],
    s4_eyebrow: "A vantagem de rede",
    s4_title_1: "Quantos mais restaurantes usam a Winerim, ",
    s4_title_highlight: "melhores dados para todos",
    s4_paragraphs: [
      "A Winerim Supply não funciona como um comparador genérico. Alimenta-se de dados reais e anonimizados de restaurantes que já usam a plataforma. Isso significa que os comparativos de preço, os alertas de sobrepreço e as oportunidades de compra assentam em <strong>transações reais de negócios com perfis semelhantes ao seu</strong>.",
      "À medida que a rede cresce, a inteligência de compra melhora. É um efeito de rede em que cada restaurante que se junta torna os dados mais ricos, os comparativos mais fiáveis e as recomendações mais precisas.",
    ],
    s4_pillars: [
      { label: "Dados anonimizados", desc: "Nenhum restaurante vê os dados individuais de outro." },
      { label: "Perfis comparáveis", desc: "Apenas se comparam negócios de volume e tipo semelhante." },
      { label: "Efeito de rede", desc: "Mais restaurantes = melhores benchmarks de compra." },
    ],
    s5_eyebrow: "Grupos e multi-local",
    s5_title_1: "Para grupos, a Supply é ",
    s5_title_highlight: "ainda mais poderosa",
    s5_cards: [
      { title: "Visão consolidada de compras", desc: "Agrupa as encomendas de todas as unidades do grupo para detetar ineficiências, duplicidades e oportunidades de negociação conjunta com distribuidores." },
      { title: "Benchmark interno de compras", desc: "Compara preços de compra entre unidades do mesmo grupo. Deteta se uma unidade paga mais pela mesma referência e padroniza condições." },
      { title: "Unificação de catálogos", desc: "Identifica que referências partilham várias unidades e quais são específicas, facilitando a racionalização do catálogo ao nível do grupo." },
      { title: "Recomendações centralizadas", desc: "A direção de compras do grupo recebe recomendações consolidadas baseadas no desempenho real de cada referência em cada unidade." },
    ],
    s5_link: "Ver solução completa para grupos de restauração",
    s6_eyebrow: "Compre com inteligência",
    s6_title_1: "Deixe de comprar por inércia. ",
    s6_title_highlight: "Compre com dados.",
    s6_subtitle: "Mostramos-lhe como a Winerim Supply transforma as suas decisões de compra com dados reais da sua carta, do seu stock e do mercado.",
    s6_cta_primary: "Pedir demo da Supply",
    s6_cta_secondary: "Falar com a equipa",
    faq_title: "Perguntas frequentes sobre a Winerim Supply",
    faqs: [
      { q: "A Winerim Supply substitui o meu distribuidor?", a: "Não. A Supply não vende nem intermedeia. Analisa os seus dados de compra e compara-os com benchmarks de mercado para que negoceie com mais informação e tome melhores decisões de reposição." },
      { q: "Como se geram os comparativos de preço?", a: "A partir de dados anonimizados e agregados de restaurantes que usam a Winerim. Nunca se partilham dados individuais; usam-se apenas médias por perfil e volume semelhante." },
      { q: "Preciso de ter o Winerim Core para usar a Supply?", a: "A Supply alimenta-se dos dados que o Core gera (vendas, margens, rotação, stock). Funcionam como camadas complementares dentro da mesma plataforma." },
      { q: "Posso usar a Supply num grupo com várias unidades?", a: "Sim. De facto, a visão consolidada de compras a nível de grupo é uma das funcionalidades mais poderosas da Supply: deteta desvios de preço entre unidades e oportunidades de negociação conjunta." },
      { q: "A Supply está disponível em todos os planos?", a: "A Supply está a ser disponibilizada de forma progressiva. Contacte a equipa para conhecer a disponibilidade consoante o seu plano e perfil de negócio." },
    ],
    il: [
      { to: "/producto/winerim-core", label: "Winerim Core: 26 módulos analíticos", type: "solution" },
      { to: "/producto/inteligencia-dinamica", label: "Inteligência Dinâmica: IA tática para a carta", type: "solution" },
      { to: "/herramientas/calculadora-compra-inteligente", label: "Calculadora de compra inteligente", type: "tool" },
      { to: "/herramientas/calculadora-stock-muerto", label: "Calculadora de stock parado", type: "tool" },
      { to: "/decision-center/compras-reposicion", label: "Decision Center: compras e reposição", type: "decision-center" },
      { to: "/decision-center/stock-rotacion", label: "Decision Center: stock e rotação", type: "decision-center" },
      ...
      { to: "/demo", label: "Pedir uma demo personalizada", type: "solution" },
    ],
  },
};

...
const i18n: I18nMap<Record<string, any>> = {
  ...
  de: {
    seo_title: "Wine List Score: Deine Weinkarte audieren (0-100) | Winerim",
    seo_desc: "Bewerte deine Weinkarte mit einem Score von 0 bis 100. Kostenlose Diagnose: Struktur, Ausgewogenheit, Preisgestaltung, Glas, Rotation und kommerzielles Potenzial.",
    badge: "Kostenloses Werkzeug",
    h1: "Wine List Score",
    subtitle: (n: number) => `Beantworte ${n} Fragen und erhalte einen Gesamtscore von 0 bis 100 mit Diagnose pro Block. Entdecke, wo deine Weinkarte hervorragend ist und wo sie an Potenzial verliert.`,
    bread_tools: "Werkzeuge", bread_self: "Wine List Score",
    answered_of: (a: number, t: number) => `${a} von ${t} Fragen beantwortet`,
    calc_btn: "Wine List Score berechnen",
    score_label: "Dein Wine List Score",
    score_80: "Deine Weinkarte ist sehr gut optimiert. Es gibt noch Platz für Exzellenz.",
    score_60: "Guter Ausgangspunkt mit klaren Verbesserungsmoglichkeiten.",
    score_40: "Deine Weinkarte hat wichtige Bereiche, die Aufmerksamkeit benotigen.",
    score_low: "Deine Weinkarte benötigt eine grundliche Überprufung, um ihr Potenzial zu erreichen.",
    diagnosis: "Diagnose-Zusammenfassung",
    strengths: "Starke Punkte",
    weaknesses: "Prioritare Verbesserungsbereiche",
    cta_title: "Möchtest du eine professionelle Analyse deiner Weinkarte?",
    cta_desc: "Schicke uns deine Weinkarte und unser Team liefert einen umfassenden Bericht mit konkreten Verbesserungsempfehlungen.",
    cta_analyze: "Meine Weinkarte analysieren",
    cta_demo: "Demo anfordern",
    methodology_title: "Was der Wine List Score misst",
    methodology_label: "Methodologie",
    methodology_def: "Der Wine List Score bewertet deine Weinkarte anhand von 6 Dimensionen: Struktur & Organisation, Ausgewogenheit & Vielfalt, Preisgestaltung & Margen, Glaswein-Angebot, Rotation & Management und kommerzielles Potenzial. Jeder Block tràgt zum Gesamtscore von 0 bis 100 bei.",
    methodology_bullets: [
      "Struktur: Ist die Karte navigierbar, klar und mit nützlichen Beschreibungen?",
      "Ausgewogenheit: Gibt es eine Vielfalt von Typologien, Regionen und Profilen?",
      "Preisgestaltung: Sind die Margen differenziert und die Preisstaffeln progressiv?",
      "Glas: Ist das Glaswein-Angebot ausreichend und kontrolliert?",
      "Rotation: Wird die Karte aktualisiert und werden alle Referenzen verkauft?",
      "Kommerziell: Gibt es Empfehlungen, Speisenbegleitung und ist das Team geschult?",
    ],
    faqs: [
      { q: "Was ist ein guter Score fur eine Weinkarte?", a: "Über 70 gilt als gut optimierte Weinkarte. Zwischen 50 und 70 gibt es klare Moglichkeiten. Unter 50 benötigt die Weinkarte strukturelle Verbesserungen." },
      { q: "Ersetzt dieser Auditor eine professionelle Analyse?", a: "Nein. Es ist eine schnelle Selbstbewertung, die Verbesserungsbereiche identifiziert. Eine professionelle Analyse untersucht jede Referenz im Detail mit Marktdaten und Branchen-Benchmarks." },
      { q: "Wie oft sollte ich diese Auditorium durchführen?", a: "Mindestens quartalsweise oder jedes Mal, wenn du signifikante Anderungen an der Weinkarte vornahst." },
      { q: "Werden meine Daten gespeichert?", a: "Nein. Alle Berechnungen erfolgen in deinem Browser. Es werden keine Daten versendet oder gespeichert." },
    ],
    link_analyzer: "KI-gestützter Weinkarten-Analyzer",
    link_checklist: "Checkliste: Verkauft deine Weinkarte wirklich?",
    link_playbook: "Playbook: Rentable Weinkarte aufbauen",
    link_software: "Weinkarten-Software",
    decides: ["Welche Bereiche deiner Weinkarte sofortige Verbesserungen benotigen", "Ob Struktur, Preisgestaltung und Ausgewogenheit ausgerichtet sind", "Welcher Block Prioritat hat: Glas, Rotation oder kommerzielles Potenzial"],
    avoids: ["Blinde Flecken in der Weinkarte ohne Diagnose belassen", "Zeit in Bereiche investieren, die bereits gut funktionieren", "Weinkarten-Entscheidungen ohne Bewertungsrahmen treffen"],
    impact: ["Einen 360-Grad-Überblick uber die Gesundheit deiner Weinkarte erhalten", "Verbesserungen mit der grossten Umsatzauswirkung priorisieren", "Eine Baseline zum Messen des Fortschritts etablieren"],
    blocks: [
      { id: "estructura", title: "Struktur und Organisation", questions: [
        { text: "Wie viele Referenzen hat deine Weinkarte?", options: [{ label: "< 20", score: 5 }, { label: "20-60", score: 10 }, { label: "60-120", score: 8 }, { label: "> 120", score: 4 }] },
        { text: "Ist sie in klare Kategorien organisiert?", options: [{ label: "Ja, intuitiv", score: 10 }, { label: "Ja, technisch", score: 6 }, { label: "Nicht klar", score: 2 }] },
        { text: "Enthalt sie Weinbeschreibungen?", options: [{ label: "Ja, sensorisch", score: 10 }, { label: "Nur Bezeichnung", score: 5 }, { label: "Nein", score: 1 }] },
      ]},
      { id: "equilibrio", title: "Ausgewogenheit und Vielfalt", questions: [
        { text: "Gibt es Weisweine, Rotweine, Rosé und Schaumweine?", options: [{ label: "Alle Typen", score: 10 }, { label: "Es fehlen 1-2", score: 6 }, { label: "Nur Rot/Weiss", score: 2 }] },
        { text: "Gibt es regionale Vielfalt?", options: [{ label: "National + international", score: 10 }, { label: "Nur national", score: 6 }, { label: "Nur 1-2 Regionen", score: 3 }] },
        { text: "Gibt es Weine fur verschiedene Kundschaftsprofile?", options: [{ label: "Ja, abwechslungsreich", score: 10 }, { label: "Eher einheitlich", score: 4 }, { label: "Habe ich nicht überlegt", score: 1 }] },
      ]},
      { id: "pricing", title: "Preisgestaltung und Margen", questions: [
        { text: "Verwendest du differenzierte Multiplikatoren nach Preisbereich?", options: [{ label: "Ja, gestaffelt", score: 10 }, { label: "Fester Multiplikator", score: 4 }, { label: "Kein System", score: 1 }] },
        { text: "Gibt es eine nahtlose Preisstaffel?", options: [{ label: "Ja, progressiv", score: 10 }, { label: "Einige Lucken", score: 5 }, { label: "Nicht überprüft", score: 2 }] },
        { text: "Kennst du die Marge pro Referenz?", options: [{ label: "Ja, pro Referenz", score: 10 }, { label: "Nur insgesamt", score: 5 }, { label: "Nein", score: 1 }] },
      ]},
      { id: "copa", title: "Glaswein", questions: [
        { text: "Bietest du Glaswein an?", options: [{ label: "Ja, 6+ Referenzen", score: 10 }, { label: "Ja, 2-5", score: 6 }, { label: "Nein", score: 0 }] },
        { text: "Kontrollierst du Glasverluste?", options: [{ label: "Ja, ich messe sie", score: 10 }, { label: "Ungefahr", score: 4 }, { label: "Nein", score: 1 }] },
      ]},
      { id: "rotacion", title: "Rotation und Management", questions: [
        { text: "Wie oft aktualisierst du die Weinkarte?", options: [{ label: "Monatlich oder quartalsweise", score: 10 }, { label: "Halbjährlich", score: 5 }, { label: "Fast nie", score: 1 }] },
        { text: "Hast du Referenzen, die sich monatelang nicht verkaufen?", options: [{ label: "Nein, alle rotieren", score: 10 }, { label: "Einige", score: 5 }, { label: "Mehrere", score: 1 }] },
      ]},
      { id: "comercial", title: "Kommerzielles Potenzial", questions: [
        { text: "Gibt es Empfehlungen, die auf der Weinkarte hervorgehoben sind?", options: [{ label: "Ja, sichtbar", score: 10 }, { label: "Das Team kennt sie", score: 5 }, { label: "Nein", score: 1 }] },
        { text: "Kann das Team Wein empfehlen?", options: [{ label: "Ja, geschult", score: 10 }, { label: "Einige", score: 5 }, { label: "Nein", score: 1 }] },
        { text: "Schlagt ihr Speisen-Wein-Paarungen vor?", options: [{ label: "Ja, auf Karte oder verbal", score: 10 }, { label: "Manchmal", score: 5 }, { label: "Nein", score: 1 }] },
      ]},
    ],
  },
  pt: {
    seo_title: "Wine List Score: Audita a Tua Carta de Vinhos (0-100) | Winerim",
    seo_desc: "Avalia a tua carta de vinhos com uma pontuação de 0 a 100. Diagnóstico gratuito: estrutura, equilíbrio, preços, vinho a copo, rotação e potencial.",
    badge: "Ferramenta gratuita",
    h1: "Wine List Score",
    subtitle: (n: number) => `Responde a ${n} perguntas e obtém uma pontuação global de 0 a 100 com diagnóstico por blocos. Descobre onde a tua carta se destaca e onde perde potencial.`,
    bread_tools: "Ferramentas", bread_self: "Wine List Score",
    answered_of: (a: number, t: number) => `${a} de ${t} perguntas respondidas`,
    calc_btn: "Calcular Wine List Score",
    score_label: "A Tua Pontuação Wine List Score",
    score_80: "A tua carta está muito bem otimizada. Ainda há margem para a excelência.",
    score_60: "Bom ponto de partida com oportunidades claras de melhoria.",
    score_40: "A tua carta tem áreas importantes que necessitam de atenção.",
    score_low: "A tua carta necessita de uma revisão aprofundada para atingir o seu potencial.",
    diagnosis: "Resumo do diagnóstico",
    strengths: "Pontos fortes",
    weaknesses: "Áreas de melhoria prioritárias",
    cta_title: "Queres uma análise profissional da tua carta?",
    cta_desc: "Envia-nos a tua carta e a nossa equipa entregar-te-á um relatório completo com recomendações concretas de melhoria.",
    cta_analyze: "Analisar a minha carta",
    cta_demo: "Solicitar demonstração",
    methodology_title: "O que o Wine List Score mede",
    methodology_label: "Metodologia",
    methodology_def: "O Wine List Score avalia a tua carta de vinhos em 6 dimensões: estrutura e organização, equilíbrio e diversidade, preços e margens, oferta a copo, rotação e gestão, e potencial comercial. Cada bloco contribui para a pontuação global de 0 a 100.",
    methodology_bullets: [
      "Estrutura: a carta é navegável, clara e com descrições úteis?",
      "Equilíbrio: há variedade de tipologias, regiões e perfis?",
      "Preços: as margens são diferenciadas e a escala de preços progressiva?",
      "Copo: a oferta a copo é suficiente e controlada?",
      "Rotação: a carta é atualizada e todas as referências se vendem?",
      "Comercial: há recomendações, harmonizações e a equipa está formada?",
    ],
    faqs: [
      { q: "Qual é uma boa pontuação para uma carta de vinhos?", a: "Acima de 70 considera-se uma carta bem otimizada. Entre 50 e 70 há oportunidades claras. Abaixo de 50, a carta necessita de melhorias estruturais." },
      { q: "Este auditor substitui uma análise profissional?", a: "Não. É uma auto-avaliação rápida que identifica áreas de melhoria. Uma análise profissional examina cada referência em detalhe com dados de mercado e benchmarks do sector." },
      { q: "Com que frequência devo fazer esta auditoria?", a: "Trimestralmente no mínimo, ou sempre que faças alterações significativas à carta." },
      { q: "Os meus dados são armazenados?", a: "Não. Todos os cálculos são feitos no teu navegador. Nenhum dado é enviado ou armazenado." },
    ],
    link_analyzer: "Analisador de carta de vinhos com IA",
    link_checklist: "Checklist: a tua carta realmente vende?",
    link_playbook: "Playbook: construir uma carta rentável",
    link_software: "Software de carta de vinhos",
    decides: ["Quais áreas da tua carta necessitam de melhoria imediata", "Se estrutura, preços e equilíbrio estão alinhados", "Qual bloco priorizar: copo, rotação ou potencial comercial"],
    avoids: ["Manter pontos cegos na carta sem diagnosticar", "Investir tempo em áreas que já funcionam bem", "Tomar decisões sobre a carta sem um framework de avaliação"],
    impact: ["Obter uma visão 360º da saúde da tua carta", "Priorizar melhorias com maior impacto nas vendas", "Estabelecer uma linha de base para medir progresso"],
    blocks: [
      { id: "estructura", title: "Estrutura e organização", questions: [
        { text: "Quantas referências tem a tua carta?", options: [{ label: "< 20", score: 5 }, { label: "20-60", score: 10 }, { label: "60-120", score: 8 }, { label: "> 120", score: 4 }] },
        { text: "Está organizada em categorias claras?", options: [{ label: "Sim, intuitivas", score: 10 }, { label: "Sim, técnicas", score: 6 }, { label: "Não está clara", score: 2 }] },
        { text: "Inclui descrições de vinhos?", options: [{ label: "Sim, sensoriais", score: 10 }, { label: "Só a denominação", score: 5 }, { label: "Não", score: 1 }] },
      ]},
      { id: "equilibrio", title: "Equilíbrio e diversidade", questions: [
        { text: "Há brancos, tintos, rosés e espumantes?", options: [{ label: "Todas as tipologias", score: 10 }, { label: "Faltam 1-2", score: 6 }, { label: "Só tintos/brancos", score: 2 }] },
        { text: "Há variedade de regiões?", options: [{ label: "Nacional + internacional", score: 10 }, { label: "Só nacional", score: 6 }, { label: "Concentrada em 1-2 regiões", score: 3 }] },
        { text: "Há vinhos para diferentes perfis de cliente?", options: [{ label: "Sim, variado", score: 10 }, { label: "Bastante homogéneo", score: 4 }, { label: "Não pensei nisso", score: 1 }] },
      ]},
      { id: "pricing", title: "Preços e margens", questions: [
        { text: "Usas multiplicadores diferenciados por faixa de preço?", options: [{ label: "Sim, escalonados", score: 10 }, { label: "Multiplicador fixo", score: 4 }, { label: "Nenhum sistema", score: 1 }] },
        { text: "Há uma escala de preços sem saltos bruscos?", options: [{ label: "Sim, progressiva", score: 10 }, { label: "Há alguns buracos", score: 5 }, { label: "Não verifiquei", score: 2 }] },
        { text: "Conheces a margem de cada referência?", options: [{ label: "Sim, por referência", score: 10 }, { label: "Só a global", score: 5 }, { label: "Não", score: 1 }] },
      ]},
      { id: "copa", title: "Vinho a copo", questions: [
        { text: "Oferes vinho a copo?", options: [{ label: "Sim, 6+ referências", score: 10 }, { label: "Sim, 2-5", score: 6 }, { label: "Não", score: 0 }] },
        { text: "Controlas a perda a copo?", options: [{ label: "Sim, meço-a", score: 10 }, { label: "Mais ou menos", score: 4 }, { label: "Não", score: 1 }] },
      ]},
      { id: "rotacion", title: "Rotação e gestão", questions: [
        { text: "Com que frequência atualizas a carta?", options: [{ label: "Mensal ou trimestral", score: 10 }, { label: "Semestral", score: 5 }, { label: "Quase nunca", score: 1 }] },
        { text: "Tens referências que não se vendem há meses?", options: [{ label: "Não, todas rodam", score: 10 }, { label: "Algumas", score: 5 }, { label: "Várias", score: 1 }] },
      ]},
      { id: "comercial", title: "Potencial comercial", questions: [
        { text: "Há recomendações destacadas na carta?", options: [{ label: "Sim, visíveis", score: 10 }, { label: "A equipa sabe-as", score: 5 }, { label: "Não", score: 1 }] },
        { text: "A equipa sabe recomendar vinho?", options: [{ label: "Sim, formada", score: 10 }, { label: "Alguns", score: 5 }, { label: "Não", score: 1 }] },
        { text: "Sugerem harmonizações com os pratos?", options: [{ label: "Sim, na carta ou verbalmente", score: 10 }, { label: "Às vezes", score: 5 }, { label: "Não", score: 1 }] },
      ]},
    ],
  },
};

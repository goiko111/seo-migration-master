...
const i18n: I18nMap<Record<string, any>> = {
  ...
  de: {
    seo_title: "Rechner: Auswirkungen auf den Weindurchschnittsbon | Winerim-Demo",
    seo_desc: "Simulieren Sie die Auswirkungen von Weinpenetration, Glas- vs. Flaschenverkauf und Referenzmix auf den Durchschnittsbon Ihres Restaurants. Kostenloses Tool.",
    badge: "Demo · Winerim Core",
    h1: "Rechner: Auswirkungen des Weins auf den Durchschnittsbon",
    subtitle: "Simulieren Sie, wie sich Ihr monatlicher Weinumsatz verändert, wenn Sie Penetration, Referenzmix und Glaswein-Strategie verbessern.",
    bread_tools: "Werkzeuge",
    bread_self: "Rechner Weindurchschnittsbon",
    intro_title: "Der Durchschnittsbon verbessert sich nicht allein durch mehr Verkauf. Er verbessert sich durch einen besseren Mix und eine bessere Aktivierung.",
    intro_desc: "Winerim hilft Ihnen, die Auswirkungen von Weinpenetration, Glasweinverkauf, Referenzmix und Weinkartensichtbarkeit auf den Durchschnittsbon des Restaurants zu simulieren.",
    summary_label: "Was dieses Werkzeug simuliert",
    summary_def: "Vergleicht Szenarien zur Verbesserung des Weindurchschnittsbons durch Kombination dreier Hebel: Penetration (% der Tische, die Wein bestellen), Mix (durchschnittliche Ausgaben pro Tisch) und Glaswein (Glas-vs-Flasche-Verhältnis).",
    summary_bullets: [
      "Vier editierbare Szenarien: konservativ, Basis, optimiert und aggressiv.",
      "Saisonalität und Restaurantkontext wenden automatische Anpassungen an.",
      "Glas und Flasche werden separat ausgewiesen für eine präzisere Analyse.",
    ],
    input_title: "Geben Sie Ihre Daten ein",
    covers_label: "Tägliche Gedecke (Durchschnitt)",
    covers_help: "Durchschnittliche Gästezahl pro Tag.",
    days_label: "Öffnungstage pro Monat",
    penetration_label: "Aktuelle Weinpenetration (%)",
    penetration_help: "% der Tische, die mindestens einen Wein bestellen.",
    glass_ticket_label: "Durchschnittsbon pro Glas (€)",
    glass_ticket_help: "Durchschnittspreis eines verkauften Glases.",
    bottle_ticket_label: "Durchschnittsbon pro Flasche (€)",
    bottle_ticket_help: "Durchschnittspreis einer verkauften Flasche.",
    glass_ratio_label: "Aktueller Glasweinanteil am Umsatz (%)",
    glass_ratio_help: "% des Weinumsatzes, der auf Glaswein entfällt.",
    season_label: "Jahreszeit",
    context_label: "Restaurantprofil",
    summer: "Sommer", winter: "Winter", spring: "Frühling", autumn: "Herbst",
    casual: "Casual", gastro: "Gourmet", hotel: "Hotel", winebar: "Weinbar",
    simulate_btn: "Szenarien simulieren",
    results_title: "Verbesserungsszenarien",
    current_label: "Aktuelle Situation",
    tables_wine_month: "Tische mit Wein / Monat",
    glass_revenue: "Glasumsatz",
    bottle_revenue: "Flaschenumsatz",
    total_revenue: "Gesamtumsatz Wein",
    scenario_label: "Szenario",
    penetration: "Penetration",
    ticket_per_table: "Bon / Tisch",
    glass_ratio: "Glasanteil",
    conservative: "Konservativ",
    base: "Basis",
    optimized: "Optimiert",
    aggressive: "Aggressiv",
    conservative_desc: "Minimale Anpassungen: zugänglicher Glaswein, subtiles Pricing.",
    base_desc: "Datengesteuerte Kartenoptimierung: Mix, Preistreppe und Glaswein.",
    optimized_desc: "Premium-Glaswein + sichtbare Speisenbegleitung + aktive Empfehlung.",
    aggressive_desc: "Vollständige Transformation: Karte, Glaswein, Schulung und dynamische Aktivierung.",
    edit_scenario: "Bearbeiten",
    reset_scenario: "Zurücksetzen",
    delta_penetration: "Δ Penetration (pp)",
    delta_ticket: "Δ Gesamtbon (%)",
    delta_glass: "Δ Glasanteil (pp)",
    delta_glass_ticket: "Δ Glasbon (%)",
    delta_bottle_ticket: "Δ Flaschenbon (%)",
    impact_month: "Monatliche Auswirkung",
    impact_year: "Jährliche Auswirkung",
    vs_current: "vs. aktuell",
    new_penetration: "Neue Penetration",
    new_glass_ratio: "Neuer Glasanteil",
    new_glass_ticket: "Neuer Glasbon",
    new_bottle_ticket: "Neuer Flaschenbon",
    reading_title: "Szenarienauswertung · Winerim",
    reading_conservative: "Mit minimalen Anpassungen wird bereits eine messbare Wirkung erzielt. Ideal als erster Schritt, bevor Ressourcen gebunden werden.",
    reading_base: "Die datenbasierte Optimierung ist das rentabelste Szenario im Verhältnis Aufwand/Wirkung. Glaswein + Preistreppe ist die effizienteste Kombination.",
    reading_optimized: "Erfordert Teamschulung und Premium-Glaswein. Die Rendite ist hoch, erfordert aber operatives Engagement.",
    reading_aggressive: "Tiefgreifende Transformation: Karte, Glaswein, Team und dynamische Aktivierung. Nur mit einer Datenplattform wie Winerim tragfähig.",
    season_effect: "Saisoneffekt",
    season_effect_desc: "Die Saisonalität passt Penetration, Bon und Glaswein an. Im Sommer steigt der Glasweinkonsum; im Winter die Ausgaben pro Tisch.",
    context_effect: "Kontexteffekt",
    glass_split: "Glas",
    bottle_split: "Flasche",
    penetration_level: "Penetrationsniveau",
    low: "Niedrig", moderate: "Mittel", good: "Gut", high: "Hoch",
    primary_lever: "Prioritätshebel",
    exec_title: "Executive-Auswertung · Winerim",
    lowAdvice: "Priorität: Glaswein-Programm aktivieren, um Tische zu gewinnen, die heute keinen Wein bestellen.",
    modAdvice: "Chance: Mix im mittleren bis oberen Segment verbessern, um den Bon zu erhöhen, ohne die Penetration zu verändern.",
    goodAdvice: "Fokus: Marge pro Glas und Sichtbarkeit der Premium-Referenzen optimieren.",
    highAdvice: "Hervorragende Penetration. Fokus auf Erhöhung des Durchschnittsbons mit Premium-Glaswein und sichtbaren Speisenbegleitungen.",
    interpret_title: "Wie diese Szenarien zu lesen sind",
    interpret_p1: "Die Szenarien sind kumulativ: Jede Stufe fügt Hebel zur vorherigen hinzu. <strong>Konservativ</strong> ist das Minimum. <strong>Aggressiv</strong> erfordert eine angebundene Datenplattform.",
    interpret_p2: "Eine Verbesserung von 15-25 % ist ein realistischer Bereich für Restaurants, die ihre Karte datengestützt optimieren. Ergebnisse über 30 % erfordern erhebliche strukturelle Änderungen.",
    edu_title: "Wie Sie den Weindurchschnittsbon verbessern",
    edu_items: [
      { title: "Premium-Glaswein als Hebel", desc: "Ein Glas zwischen 8-12 € verankert den wahrgenommenen Wert und lässt das Standardglas als attraktive Option erscheinen." },
      { title: "Sichtbare Speisenbegleitung auf der Karte", desc: "Jedes Hauptgericht mit einem vorgeschlagenen Wein senkt die Entscheidungshürde. Restaurants mit sichtbaren Speisenbegleitungen verkaufen 15-25 % mehr Wein." },
      { title: "Aktive Empfehlung durch das Team", desc: "'Zu diesem Gericht passt dieser Verdejo ausgezeichnet, darf ich Ihnen ein Glas einschenken?' ist die rentabelste Verkaufsaktion in der Gastronomie." },
      { title: "Preistreppe ohne Lücken", desc: "Wenn zwischen Ihrem 5-€-Glas und der günstigsten Flasche zu 22 € ein Sprung liegt, verlieren Sie den Gast, der 8-10 € ausgeben würde." },
    ],
    mistakes_title: "Häufige Fehler beim Versuch, den Durchschnittsbon zu erhöhen",
    mistakes: [
      { error: "Preise ohne Daten erhöhen", fix: "Preise zu erhöhen, ohne die Elastizität zu messen, kann das Volumen senken. Erst messen, dann anpassen." },
      { error: "Einstiegsoptionen eliminieren", fix: "Einstiegsweine sind für 40 % der Tische das Tor zum Wein." },
      { error: "Den Kellner unter Druck setzen, 'mehr zu verkaufen'", fix: "Ohne Schulung und Werkzeuge erzeugt Druck Unbehagen, keinen Verkauf." },
      { error: "Den Glaswein als Hebel ignorieren", fix: "Glaswein ist der sicherste Weg, den Anteil der Tische zu erhöhen, die Wein bestellen." },
    ],
    faqs: [
      { q: "Ist eine Verbesserung von 20 % realistisch?", a: "Ja, für Restaurants, die mit einem niedrigen Weinanteil (< 40 % der Tische) starten und keine Glaswein-Strategie oder aktive Empfehlung haben. Mit Kartenoptimierung + Teamschulung sind 15-25 % ein üblicher Bereich." },
      { q: "Wie lange dauert es, bis die Wirkung spürbar wird?", a: "Pricing- und Glasweinverbesserungen zeigen sich in 2-4 Wochen. Teamschulung liefert Ergebnisse in 1-2 Wochen. Winerim ermöglicht die Messung der Wirkung ab dem ersten Tag." },
      { q: "Was hat mehr Wirkung: mehr Tische, die bestellen, oder höhere Ausgaben pro Tisch?", a: "Das hängt vom Ausgangspunkt ab. Bestellen weniger als 35 % der Tische Wein, ist die Priorität, den Anteil zu erhöhen. Ist der Anteil bereits hoch, ist der Hebel die Erhöhung des Bons." },
      { q: "Berechnet Winerim dies automatisch?", a: "Ja. Winerim überwacht den Weindurchschnittsbon pro Tisch, den Anteil der bestellenden Tische und die monatliche Entwicklung. Darüber hinaus werden konkrete Maßnahmen zur Verbesserung jedes Hebels vorgeschlagen." },
    ],
    cta_title: "Winerim verbindet Analyse und Aktion in Echtzeit",
    cta_desc: "Winerim Core analysiert Penetration, Mix und Glaswein. Die Dynamische Intelligenz aktiviert die Team-Empfehlungen im Service, damit die Wirkung in echten Umsatz umgesetzt wird.",
    cta_link_label: "Sehen Sie, wie Winerim Core mit der Dynamischen Intelligenz verbunden ist",
    cta_core: "Winerim Core ansehen",
    cta_id: "Dynamische Intelligenz",
    decides: [
      "Ob der Prioritätshebel mehr Tische sind, die Wein bestellen, oder höhere Ausgaben pro Tisch",
      "Welches Szenario (konservativ, Basis, optimiert, aggressiv) die höchste Rendite für Ihr Profil liefert",
      "Welche reale Wirkung jeder Hebel auf den Monatsumsatz hat",
    ],
    avoids: [
      "Preise ohne Elastizitätsdaten oder Sichtbarkeit der Wirkung zu erhöhen",
      "In Schulung zu investieren, ohne zu wissen, welcher Hebel zuerst zu betätigen ist",
      "Kartenentscheidungen ohne quantifizierte Renditeschätzung zu treffen",
    ],
    impact: [
      "Geschätzte und umsetzbare monatliche Umsatzsteigerung pro Szenario",
      "Priorisierung der Hebel mit der größten Wirkung für Ihren Geschäftstyp",
      "Quantitative Grundlage zur Rechtfertigung von Investitionen in Karte, Glaswein oder Schulung",
    ],
    locale: "de-DE",
    currency: "€",
    link_analyzer: "Kostenloser Weinkarten-Analyzer",
    link_ticket_article: "Wie man den Durchschnittsbon mit Daten verbessert",
    link_assortment: "Sortiment nach Durchschnittsbon",
    link_margin: "Weinmargen-Rechner",
    link_core: "Winerim Core: vollständige Analytik",
    link_demo: "Winerim-Demo anfragen",
    perMonth: "/Mo.",
    perYear: "/Jahr",
  },
  pt: {
    seo_title: "Calculadora de Impacto no Bilhete Médio de Vinho | Demo Winerim",
    seo_desc: "Simule o impacto da penetração do vinho, copo vs garrafa e mix de referências no bilhete médio do seu restaurante. Ferramenta gratuita.",
    badge: "Demo · Winerim Core",
    h1: "Calculadora de impacto do vinho no bilhete médio",
    subtitle: "Simule como muda a sua faturação mensal em vinho ao melhorar a penetração, o mix de referências e a estratégia a copo.",
    bread_tools: "Ferramentas",
    bread_self: "Calculadora bilhete médio vinho",
    intro_title: "O bilhete médio não melhora apenas por vender mais. Melhora com melhor mix e melhor ativação.",
    intro_desc: "A Winerim ajuda a simular o impacto da penetração do vinho, da venda a copo, do mix de referências e da visibilidade da carta no bilhete médio do restaurante.",
    summary_label: "O que esta ferramenta simula",
    summary_def: "Compara cenários de melhoria do bilhete médio de vinho combinando três alavancas: penetração (% de mesas que pedem vinho), mix (gasto médio por mesa) e copo (rácio copo vs garrafa).",
    summary_bullets: [
      "Quatro cenários editáveis: conservador, base, otimizado e agressivo.",
      "Sazonalidade e contexto do restaurante aplicam ajustes automáticos.",
      "Copo e garrafa são analisados separadamente para maior precisão.",
    ],
    input_title: "Introduza os seus dados",
    covers_label: "Couverts diários (média)",
    covers_help: "Número médio de comensais por dia.",
    days_label: "Dias de abertura por mês",
    penetration_label: "Penetração atual do vinho (%)",
    penetration_help: "% de mesas que pedem pelo menos um vinho.",
    glass_ticket_label: "Bilhete médio por copo (€)",
    glass_ticket_help: "Preço médio de um copo vendido.",
    bottle_ticket_label: "Bilhete médio por garrafa (€)",
    bottle_ticket_help: "Preço médio de uma garrafa vendida.",
    glass_ratio_label: "Rácio atual de venda a copo (%)",
    glass_ratio_help: "% da faturação de vinho correspondente a copo.",
    season_label: "Estação do ano",
    context_label: "Perfil do restaurante",
    summer: "Verão", winter: "Inverno", spring: "Primavera", autumn: "Outono",
    casual: "Casual", gastro: "Gastronómico", hotel: "Hotel", winebar: "Wine bar",
    simulate_btn: "Simular cenários",
    results_title: "Cenários de melhoria",
    current_label: "Situação atual",
    tables_wine_month: "Mesas com vinho / mês",
    glass_revenue: "Faturação copo",
    bottle_revenue: "Faturação garrafa",
    total_revenue: "Faturação total de vinho",
    scenario_label: "Cenário",
    penetration: "Penetração",
    ticket_per_table: "Bilhete / mesa",
    glass_ratio: "Rácio copo",
    conservative: "Conservador",
    base: "Base",
    optimized: "Otimizado",
    aggressive: "Agressivo",
    conservative_desc: "Ajustes mínimos: copo acessível, pricing subtil.",
    base_desc: "Otimização da carta com dados: mix, escalão e copo.",
    optimized_desc: "Copo premium + harmonização visível + recomendação ativa.",
    aggressive_desc: "Transformação completa: carta, copo, formação e ativação dinâmica.",
    edit_scenario: "Editar",
    reset_scenario: "Repor",
    delta_penetration: "Δ Penetração (pp)",
    delta_ticket: "Δ Bilhete geral (%)",
    delta_glass: "Δ Rácio copo (pp)",
    delta_glass_ticket: "Δ Bilhete copo (%)",
    delta_bottle_ticket: "Δ Bilhete garrafa (%)",
    impact_month: "Impacto mensal",
    impact_year: "Impacto anual",
    vs_current: "vs atual",
    new_penetration: "Nova penetração",
    new_glass_ratio: "Novo rácio copo",
    new_glass_ticket: "Novo bilhete copo",
    new_bottle_ticket: "Novo bilhete garrafa",
    reading_title: "Leitura por cenário · Winerim",
    reading_conservative: "Com ajustes mínimos já se gera um impacto mensurável. Ideal como primeiro passo antes de comprometer recursos.",
    reading_base: "A otimização baseada em dados é o cenário mais rentável na relação esforço/impacto. Copo + escalão de preços é a combinação mais eficiente.",
    reading_optimized: "Requer formação da equipa e copo premium. O retorno é alto, mas exige compromisso operacional.",
    reading_aggressive: "Transformação profunda: carta, copo, equipa e ativação dinâmica. Apenas viável com plataforma de dados como a Winerim.",
    season_effect: "Efeito sazonal",
    season_effect_desc: "A sazonalidade ajusta penetração, bilhete e copo. No verão sobe o consumo a copo; no inverno, o gasto por mesa.",
    context_effect: "Efeito de contexto",
    glass_split: "Copo",
    bottle_split: "Garrafa",
    penetration_level: "Nível de penetração",
    low: "Baixo", moderate: "Moderado", good: "Bom", high: "Alto",
    primary_lever: "Alavanca prioritária",
    exec_title: "Leitura executiva · Winerim",
    lowAdvice: "Prioridade: ativar programa a copo para captar mesas que hoje não pedem vinho.",
    modAdvice: "Oportunidade: melhorar o mix de gama média-alta para subir o bilhete sem alterar a penetração.",
    goodAdvice: "Foco: otimizar margem por copo e visibilidade de referências premium.",
    highAdvice: "Excelente penetração. Foco em aumentar o bilhete médio com copo premium e harmonizações visíveis.",
    interpret_title: "Como interpretar estes cenários",
    interpret_p1: "Os cenários são cumulativos: cada nível adiciona alavancas ao anterior. <strong>Conservador</strong> é o mínimo viável. <strong>Agressivo</strong> requer uma plataforma de dados ligada.",
    interpret_p2: "Uma melhoria de 15-25% é um intervalo realista para restaurantes que otimizam a sua carta com dados. Resultados superiores a 30% exigem alterações estruturais significativas.",
    edu_title: "Como melhorar o bilhete médio em vinho",
    edu_items: [
      { title: "Copo premium como alavanca", desc: "Um copo entre 8-12 € ancora o valor percebido e faz com que o copo standard pareça uma boa opção." },
      { title: "Harmonização visível na carta", desc: "Cada prato principal com um vinho sugerido reduz a barreira de decisão. Restaurantes com harmonizações visíveis vendem 15-25% mais vinho." },
      { title: "Recomendação ativa da equipa", desc: "'Com este prato fica muito bem este Verdejo, sirvo-lhe um copo?' é a ação de venda mais rentável em restauração." },
      { title: "Escalão de preços sem saltos", desc: "Se há um salto entre o copo a 5 € e a garrafa mais barata a 22 €, perde o cliente que gastaria 8-10 €." },
    ],
    mistakes_title: "Erros comuns ao tentar subir o bilhete médio",
    mistakes: [
      { error: "Subir preços sem dados", fix: "Subir preços sem medir a elasticidade pode baixar o volume. Primeiro mede, depois ajusta." },
      { error: "Eliminar opções de entrada", fix: "Os vinhos de entrada são a porta de entrada ao vinho para 40% das mesas." },
      { error: "Pressionar o empregado para 'vender mais'", fix: "Sem formação nem ferramentas, a pressão gera desconforto, não vendas." },
      { error: "Ignorar o copo como alavanca", fix: "O copo é a forma mais segura de aumentar a % de mesas que pedem vinho." },
    ],
    faqs: [
      { q: "Uma melhoria de 20% é realista?", a: "Sim, para restaurantes que partem de um rácio de vinho baixo (< 40% das mesas) e não têm estratégia a copo nem recomendação ativa. Com otimização de carta + formação da equipa, 15-25% é um intervalo habitual." },
      { q: "Quanto tempo demora a notar-se o impacto?", a: "As melhorias de pricing e copo notam-se em 2-4 semanas. A formação da equipa gera resultados em 1-2 semanas. A Winerim permite medir o impacto desde o primeiro dia." },
      { q: "O que tem mais impacto: mais mesas que peçam ou maior gasto por mesa?", a: "Depende do ponto de partida. Se menos de 35% das mesas pedem vinho, a prioridade é aumentar o rácio. Se o rácio já é alto, a alavanca é subir o bilhete." },
      { q: "A Winerim calcula isto automaticamente?", a: "Sim. A Winerim monitoriza o bilhete médio em vinho por mesa, o rácio de mesas que pedem e a evolução mensal. Sugere ainda ações concretas para melhorar cada alavanca." },
    ],
    cta_title: "A Winerim liga análise e ação em tempo real",
    cta_desc: "A Winerim Core analisa penetração, mix e copo. A Inteligência Dinâmica ativa as recomendações da equipa em sala para que o impacto se traduza em faturação real.",
    cta_link_label: "Veja como a Winerim Core se liga com a Inteligência Dinâmica",
    cta_core: "Ver Winerim Core",
    cta_id: "Inteligência Dinâmica",
    decides: [
      "Se a alavanca prioritária é mais mesas a pedir vinho ou maior gasto por mesa",
      "Que cenário (conservador, base, otimizado, agressivo) gera mais retorno com o seu perfil",
      "Quanto impacto real tem cada alavanca na faturação mensal",
    ],
    avoids: [
      "Subir preços sem dados de elasticidade nem visibilidade de impacto",
      "Investir em formação sem saber que alavanca mover primeiro",
      "Tomar decisões de carta sem uma estimativa quantificada de retorno",
    ],
    impact: [
      "Incremento de faturação mensal estimado e acionável por cenário",
      "Priorização das alavancas com maior impacto para o seu tipo de negócio",
      "Base quantitativa para justificar investimentos em carta, copo ou formação",
    ],
    locale: "pt-PT",
    currency: "€",
    link_analyzer: "Analisador de carta gratuito",
    link_ticket_article: "Como melhorar o bilhete médio com dados",

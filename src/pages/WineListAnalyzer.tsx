...
const i18n: I18nMap<{
  ...
  de: {
    seo_title: "Wine List Analyzer – Analysieren Sie Ihre Weinkarte | Winerim",
    seo_desc: "Kostenloses Tool zur Analyse Ihrer Weinkarte. Entdecken Sie Verbesserungsmöglichkeiten in Struktur, Preisgestaltung und Vielfalt mit einer Bewertung von 0 bis 100.",
    jsonld_name: "Wine List Analyzer", jsonld_desc: "Analysieren Sie Ihre Weinkarte und entdecken Sie Verbesserungsmöglichkeiten in Struktur, Preisgestaltung und Vielfalt.",
    bc_tools: "Werkzeuge", bc_page: "Wine List Analyzer",
    badge: "Kostenloses Werkzeug",
    h1_1: "Analysieren Sie Ihre Weinkarte in ", h1_hl: "Sekunden",
    subtitle: "Entdecken Sie, wie Sie die Struktur Ihrer Karte verbessern, Preise optimieren und Weinverkäufe steigern.",
    btn_upload: "Weinkarte hochladen",
    h2_how: "Wie möchten Sie Ihre Karte teilen?", h2_how_sub: "Wählen Sie eine Methode zum Hochladen oder Eingeben Ihrer Weinkarte",
    mode_file: "Datei hochladen", mode_file_desc: "PDF, Excel, CSV oder TXT",
    mode_paste: "Text einfügen", mode_paste_desc: "Weinkarte kopieren und einfügen",
    mode_url: "Link einfügen", mode_url_desc: "URL Ihrer Online-Karte",
    paste_placeholder: "Geben Sie hier Ihre Weinkarte ein: Namen, Regionen, Preise, Kategorien...",
    url_placeholder: "https://ihrerestaurant.de/weinkarte",
    chars_extracted: "Zeichen extrahiert",
    btn_analyze: "Karte analysieren", btn_analyzing: "Karte wird analysiert...",
    btn_another: "← Weitere Karte analysieren",
    score_label: "Score Ihrer Karte", refs_analyzed: "Referenzen analysiert",
    lbl_recommendations: "Empfehlungen",
    lbl_duplicates: "Doppelte Stile", lbl_price_gaps: "Preisgaps", lbl_glass_potential: "Glaswein-Potenzial",
    report_badge: "Vollständiger Bericht",
    report_title_1: "Erhalten Sie den vollständigen Bericht per ", report_title_hl: "E-Mail",
    report_desc: "Unser Sommelierteam überprüft Ihre Karte und sendet Ihnen einen detaillierten Bericht mit personalisierten Empfehlungen.",
    report_sent: "Anfrage versendet! Wir melden uns bald bei Ihnen.",
    btn_send_report: "Vollständigen Bericht abrufen",
    ph_email: "ihr@email.com *", ph_restaurant: "Restaurant", ph_city: "Stadt",
    static_badge: "Was wir analysieren",
    static_title_1: "Eine vollständige Diagnose Ihrer ", static_title_hl: "Weinkarte",
    static_cards: [
      { icon: Layers, title: "Struktur", desc: "Organisation nach Kategorien, Balance zwischen Weintypen und Abschnitten." },
      { icon: TrendingUp, title: "Preisverteilung", desc: "Preistreppe, Gaps und Konzentration nach Bereich." },
      { icon: Wine, title: "Vielfalt und Balance", desc: "Diversität von Regionen, Sorten und Stilen. Duplikate erkannt." },
      { icon: GlassWater, title: "Glaswein-Potenzial", desc: "Weine als Kandidaten für Glaswein zur Umsatzsteigerung." },
      { icon: AlertTriangle, title: "Erkannte Lücken", desc: "Ungedeckte Preisbereich und fehlende Kategorien." },
      { icon: Lightbulb, title: "Gelegenheiten", desc: "Konkrete Empfehlungen zur Verbesserung von Umsatz und Gewinnspanne." },
    ],
    links: [
      { to: "/de/blog/wie-organisiert-man-eine-weinkarte", label: "Wie man eine Weinkarte organisiert", type: "guide" },
      { to: "/de/blog/wie-man-eine-rentable-weinkarte-entwirft", label: "Wie man eine rentable Weinkarte entwirft", type: "guide" },
      { to: "/de/ressourcen/checkliste-rentable-weinkarte", label: "Checkliste rentable Weinkarte", type: "resource" },
      { to: "/de/demo", label: "Winerim-Demo anfordern", type: "solution" },
    ],
    toast_error_empty: "Geben Sie den Inhalt Ihrer Weinkarte ein oder laden Sie ihn hoch",
    toast_error_analyze: "Fehler beim Analysieren der Karte. Bitte versuchen Sie es erneut.",
    toast_error_send: "Fehler beim Versenden. Bitte versuchen Sie es erneut.",
    toast_email_invalid: "Ungültige E-Mail",
    toast_success: "Anfrage versendet! Wir melden uns bald bei Ihnen.",
    toast_file_error: "Datei konnte nicht gelesen werden. Versuchen Sie das Format .txt oder .csv",
    decides: ["Ob die Kartenstruktur den Verkauf unterstützt oder behindert", "Welche Preis- und Stilgaps vorhanden sind", "Welche Weine für Glas-Service in Frage kommen"],
    avoids: ["Eine unausgewogene Karte unwissentlich zu bewahren", "Konkurrierende Stile zu duplizieren", "Verkäufe durch unzureichende Abdeckung bei Schlüsselbereichen zu verlieren"],
    impact: ["Verborgene Verkaufschancen in der Karte entdecken", "Einträge ohne Auswirkung reduzieren und Platz freigeben", "Das Gasterlebnis mit einer klareren Karte verbessern"],
  },
  pt: {
    seo_title: "Wine List Analyzer – Analise a Sua Carta de Vinhos | Winerim",
    seo_desc: "Ferramenta gratuita para analisar a sua carta de vinhos. Detecte oportunidades de melhoria em estrutura, preços e variedade com uma pontuação de 0 a 100.",
    jsonld_name: "Wine List Analyzer", jsonld_desc: "Analise a sua carta de vinhos e descubra oportunidades de melhoria em estrutura, preços e variedade.",
    bc_tools: "Ferramentas", bc_page: "Wine List Analyzer",
    badge: "Ferramenta gratuita",
    h1_1: "Analise a sua carta de vinhos em ", h1_hl: "segundos",
    subtitle: "Descubra como melhorar a estrutura da sua carta, otimizar preços e aumentar as vendas de vinho.",
    btn_upload: "Enviar carta de vinhos",
    h2_how: "Como deseja partilhar a sua carta?", h2_how_sub: "Escolha um método para enviar ou introduzir a sua carta de vinhos",
    mode_file: "Enviar ficheiro", mode_file_desc: "PDF, Excel, CSV ou TXT",
    mode_paste: "Colar texto", mode_paste_desc: "Copiar e colar a sua carta",
    mode_url: "Colar ligação", mode_url_desc: "URL da sua carta em linha",
    paste_placeholder: "Cole aqui a sua carta de vinhos: nomes, regiões, preços, categorias...",
    url_placeholder: "https://seurestacrante.pt/carta-de-vinhos",
    chars_extracted: "caracteres extraídos",
    btn_analyze: "Analisar carta", btn_analyzing: "A analisar carta...",
    btn_another: "← Analisar outra carta",
    score_label: "Pontuação da sua carta", refs_analyzed: "referências analisadas",
    lbl_recommendations: "Recomendações",
    lbl_duplicates: "Duplicados de estilo", lbl_price_gaps: "Falhas de preço", lbl_glass_potential: "Potencial a copo",
    report_badge: "Relatório completo",
    report_title_1: "Receba o relatório completo por ", report_title_hl: "email",
    report_desc: "A nossa equipa de escanções analisará a sua carta e enviar-lhe-á um relatório detalhado com recomendações personalizadas.",
    report_sent: "Pedido enviado! Contactá-lo-emos em breve.",
    btn_send_report: "Receber relatório completo",
    ph_email: "si@email.com *", ph_restaurant: "Restaurante", ph_city: "Cidade",
    static_badge: "O que analisamos",
    static_title_1: "Um diagnóstico completo da sua ", static_title_hl: "carta de vinhos",
    static_cards: [
      { icon: Layers, title: "Estrutura", desc: "Organização por categorias, equilíbrio entre tipos de vinho e secções." },
      { icon: TrendingUp, title: "Distribuição de preços", desc: "Escada de preços, falhas e concentração por gama." },
      { icon: Wine, title: "Variedade e equilíbrio", desc: "Diversidade de regiões, castas e estilos. Duplicados detectados." },
      { icon: GlassWater, title: "Potencial a copo", desc: "Vinhos candidatos ao serviço a copo para aumentar as vendas." },
      { icon: AlertTriangle, title: "Falhas detectadas", desc: "Gamas de preço não cobertas e categorias ausentes." },
      { icon: Lightbulb, title: "Oportunidades", desc: "Recomendações concretas para melhorar vendas e margens." },
    ],
    links: [
      { to: "/pt/blog/como-organizar-carta-de-vinos", label: "Como organizar uma carta de vinhos", type: "guide" },
      { to: "/pt/blog/como-desenhar-carta-vinos-rentavel", label: "Como desenhar uma carta rentável", type: "guide" },
      { to: "/pt/recursos/checklist-carta-de-vinos-rentavel", label: "Checklist carta rentável", type: "resource" },
      { to: "/pt/demo", label: "Solicitar demo de Winerim", type: "solution" },
    ],
    toast_error_empty: "Introduza ou envie o conteúdo da sua carta de vinhos",
    toast_error_analyze: "Erro ao analisar a carta. Tente novamente.",
    toast_error_send: "Erro ao enviar. Tente novamente.",
    toast_email_invalid: "Email inválido",
    toast_success: "Pedido enviado! Contactá-lo-emos em breve.",
    toast_file_error: "Não foi possível ler o ficheiro. Tente com formato .txt ou .csv",
    decides: ["Se a estrutura da carta facilita ou impede a venda", "Que falhas de preço e estilo existem", "Quais os vinhos candidatos a servir a copo"],
    avoids: ["Manter uma carta desequilibrada sem o saber", "Duplicar estilos que competem entre si", "Perder vendas por falta de cobertura em gamas-chave"],
    impact: ["Detectar oportunidades de venda ocultas na carta", "Reduzir referências sem impacto e libertar espaço", "Melhorar a experiência do cliente com uma carta mais clara"],
  },
};

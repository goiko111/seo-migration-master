...
export type LanguageCode = SupportedLang | "de" | "pt";

export const SUPPORTED_LANGS: LanguageCode[] = ["es", "en", "it", "fr", "de", "pt"];
...
export const ROUTE_MAP: Record<LanguageCode, Record<string, string>> = {
  es: {},
  en: {
    "/": "/en",
    "/blog": "/en/blog",
  ...
  de: {
    ...
    "/precios": "/de/pricing",
    "/contacto": "/de/contact",
    "/funcionalidades": "/de/features",
    "/clientes": "/de/clients",
    "/integraciones": "/de/integrations",
    "/casos-exito": "/de/case-studies",
    "/herramientas": "/de/tools",
    "/guias-y-recursos": "/de/guides",
    "/recursos": "/de/resources",
    "/soluciones": "/de/solutions",
    "/problemas": "/de/challenges",
    "/sommelier-corner": "/de/sommelier-corner",
    "/afiliate": "/de/affiliate",
    "/software-carta-de-vinos": "/de/wine-list-management-software",
    "/que-es-winerim": "/de/what-is-winerim",
    "/privacidad": "/de/privacy",
    "/terminos": "/de/terms",
    "/analisis-carta": "/de/wine-list-analysis",
    "/calculadora-margen-vino": "/de/wine-margin-calculator",
    "/herramientas/calculadora-precio-vino-por-copa": "/de/tools/wine-by-glass-price-calculator",
  ...
  pt: {
    ...
    "/clientes": "/pt/clients",
    "/integraciones": "/pt/integrations",
    "/casos-exito": "/pt/case-studies",
    "/herramientas": "/pt/tools",
    "/guias-y-recursos": "/pt/guides",
    "/recursos": "/pt/resources",
    "/soluciones": "/pt/solutions",
    "/problemas": "/pt/challenges",
    "/sommelier-corner": "/pt/sommelier-corner",
    "/afiliate": "/pt/affiliate",
    "/software-carta-de-vinos": "/pt/wine-list-management-software",
    "/que-es-winerim": "/pt/what-is-winerim",
    "/privacidad": "/pt/privacy",
    "/terminos": "/pt/terms",
    "/analisis-carta": "/pt/wine-list-analysis",
    "/calculadora-margen-vino": "/pt/wine-margin-calculator",
    "/herramientas/calculadora-precio-vino-por-copa": "/pt/tools/wine-by-glass-price-calculator",

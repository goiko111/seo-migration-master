export type SupportedLang = "es" | "en" | "it" | "fr" | "de" | "pt";
...
export const ROUTE_MAP: Record<SupportedLang, Record<string, string>> = {
  ...
  it: {
    ...
    "/wine-list-analyzer": "/it/analizzatore-carta-vini",
    "/wine-pricing-tool": "/it/strumento-pricing-vini",
    "/wine-pairing-generator": "/it/generatore-abbinamenti-ia",
    "/wine-roi-calculator": "/it/calcolatrice-roi-vini",
    "/wine-list-benchmark": "/it/benchmark-carta-vini",
  ...
  fr: {
    ...
    "/wine-list-analyzer": "/fr/analyseur-carte-vins",
    "/wine-pricing-tool": "/fr/outil-pricing-vins",
    "/wine-pairing-generator": "/fr/generateur-accords-ia",
    "/wine-roi-calculator": "/fr/calculateur-roi-vins",
    "/wine-list-benchmark": "/fr/benchmark-carte-vins",
  ...
  de: {
    ...
    "/soluciones/restaurantes-gastronomicos": "/de/loesungen/fine-dining",
    "/soluciones/wine-bars": "/de/loesungen/weinbars",
    "/soluciones/hoteles": "/de/loesungen/hotels",
    "/soluciones/restaurantes-sin-sumiller": "/de/loesungen/ohne-sommelier",
    "/soluciones/carta-amplia": "/de/loesungen/grosse-weinkarte",
    "/soluciones/carta-crecimiento": "/de/loesungen/wachsende-weinkarte",
    "/soluciones/inteligencia-de-compras": "/de/loesungen/einkaufsintelligenz",
    "/sobre-nosotros": "/de/ueber-uns",
    "/empleo": "/de/karriere",
    "/benchmarks-playbooks": "/de/benchmarks-playbooks",
    "/comparativas": "/de/vergleiche",
    "/decision-center": "/de/decision-center",
    "/implantacion": "/de/implementierung",
    ...
    "/wine-list-analyzer": "/de/weinkarten-analyzer",
    "/wine-pricing-tool": "/de/wein-pricing-tool",
    "/wine-pairing-generator": "/de/weinbegleitung-generator",
    "/wine-roi-calculator": "/de/wein-roi-rechner",
    "/wine-list-benchmark": "/de/weinkarten-benchmark",
    "/guias/como-estructurar-carta-vinos-grupo-restauracion": "/de/ratgeber/weinkarte-restaurantgruppe-strukturieren",
    "/guias/como-fijar-estrategia-rentable-vino-por-copa": "/de/ratgeber/rentable-glasausschank-strategie",
    "/guias/como-detectar-vinos-muertos-referencias-frenan-rentabilidad": "/de/ratgeber/totbestand-weine-erkennen",
    "/guias/como-formar-equipo-sala-para-vender-vino": "/de/ratgeber/service-team-wein-verkaufen-trainieren",
    "/guias/como-usar-datos-para-decidir-que-vinos-comprar": "/de/ratgeber/daten-nutzen-weinkauf-entscheiden",
    "/guias/como-conectar-carta-stock-ventas-margen": "/de/ratgeber/weinkarte-bestand-verkauf-marge-verbinden",
    "/guias/como-gestionar-carta-vinos-grupos-restauracion": "/de/ratgeber/weinkarten-restaurantgruppen-verwalten",
    "/guias/como-implantar-vino-por-copa-sin-perder-margen": "/de/ratgeber/glasausschank-ohne-margenverlust",
    "/guias/como-usar-winerim-sin-sumiller": "/de/ratgeber/winerim-ohne-sommelier-nutzen",
    "/guias/como-decidir-surtido-segun-ticket-medio-tipo-local": "/de/ratgeber/weinauswahl-nach-durchschnittsbon",
    "/guias/como-detectar-canibalizacion-vinos-carta": "/de/ratgeber/wein-kannibalisierung-erkennen",
    "/guias/como-revisar-carta-vinos-cada-mes": "/de/ratgeber/weinkarte-monatlich-ueberpruefen",
    "/guias/como-mejorar-la-rotacion-de-vinos-en-un-restaurante": "/de/ratgeber/weinrotation-im-restaurant-verbessern",
    "/guias/como-crear-una-estrategia-de-maridaje-en-restauracion": "/de/ratgeber/speisen-wein-kombinationsstrategie-restaurant",
    "/como-vender-mas-vino-en-un-restaurante": "/de/wie-man-mehr-wein-im-restaurant-verkauft",
    "/precio-vino-restaurante": "/de/weinpreise-im-restaurant",
    "/vino-por-copa-restaurante": "/de/wein-im-glas-restaurant",
    "/inteligencia-artificial-restaurantes": "/de/kuenstliche-intelligenz-restaurants",
  ...
  pt: {
    ...
    "/soluciones/restaurantes-gastronomicos": "/pt/solucoes/restaurantes-gastronomicos",
    "/soluciones/wine-bars": "/pt/solucoes/wine-bars",
    "/soluciones/hoteles": "/pt/solucoes/hoteis",
    "/soluciones/restaurantes-sin-sumiller": "/pt/solucoes/sem-sommelier",
    "/soluciones/carta-amplia": "/pt/solucoes/carta-vinhos-extensa",
    "/soluciones/carta-crecimiento": "/pt/solucoes/carta-vinhos-crescimento",
    "/soluciones/inteligencia-de-compras": "/pt/solucoes/inteligencia-compras",
    "/sobre-nosotros": "/pt/sobre-nos",
    "/empleo": "/pt/carreiras",
    "/benchmarks-playbooks": "/pt/benchmarks-playbooks",
    "/comparativas": "/pt/comparativos",
    "/decision-center": "/pt/decision-center",
    "/implantacion": "/pt/implementacao",
    ...
    "/wine-list-analyzer": "/pt/analisador-carta-vinhos",
    "/wine-pricing-tool": "/pt/ferramenta-pricing-vinhos",
    "/wine-pairing-generator": "/pt/gerador-harmonizacoes-ia",
    "/wine-roi-calculator": "/pt/calculadora-roi-vinhos",
    "/wine-list-benchmark": "/pt/benchmark-carta-vinhos",
    "/guias/como-estructurar-carta-vinos-grupo-restauracion": "/pt/guias/como-estruturar-carta-vinhos-grupo-restauracao",
    "/guias/como-fijar-estrategia-rentable-vino-por-copa": "/pt/guias/estrategia-rentavel-vinho-por-copo",
    "/guias/como-detectar-vinos-muertos-referencias-frenan-rentabilidad": "/pt/guias/como-detectar-vinhos-mortos",
    "/guias/como-formar-equipo-sala-para-vender-vino": "/pt/guias/como-formar-equipa-sala-vender-vinho",
    "/guias/como-usar-datos-para-decidir-que-vinos-comprar": "/pt/guias/como-usar-dados-para-decidir-que-vinhos-comprar",
    "/guias/como-conectar-carta-stock-ventas-margen": "/pt/guias/como-conectar-carta-stock-vendas-margem",
    "/guias/como-gestionar-carta-vinos-grupos-restauracion": "/pt/guias/como-gerir-carta-vinhos-grupos-restauracao",
    "/guias/como-implantar-vino-por-copa-sin-perder-margen": "/pt/guias/como-implementar-vinho-por-copo-sem-perder-margem",
    "/guias/como-usar-winerim-sin-sumiller": "/pt/guias/como-usar-winerim-sem-sommelier",
    "/guias/como-decidir-surtido-segun-ticket-medio-tipo-local": "/pt/guias/como-escolher-selecao-vinhos-por-ticket-medio",
    "/guias/como-detectar-canibalizacion-vinos-carta": "/pt/guias/como-detectar-canibalizacao-vinhos",
    "/guias/como-revisar-carta-vinos-cada-mes": "/pt/guias/como-rever-carta-vinhos-todos-meses",
    "/guias/como-mejorar-la-rotacion-de-vinos-en-un-restaurante": "/pt/guias/como-melhorar-rotacao-vinhos-restaurante",
    "/guias/como-crear-una-estrategia-de-maridaje-en-restauracion": "/pt/guias/estrategia-harmonizacao-vinhos-restaurante",
    "/como-vender-mas-vino-en-un-restaurante": "/pt/como-vender-mais-vinho-restaurante",
    "/precio-vino-restaurante": "/pt/preco-vinho-restaurante",
    "/vino-por-copa-restaurante": "/pt/vinho-por-copo-restaurante",
    "/inteligencia-artificial-restaurantes": "/pt/inteligencia-artificial-restaurantes",

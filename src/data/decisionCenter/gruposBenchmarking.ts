...
const gruposBenchmarkingContent: DeepAreaContent = {
  ...
  bg: "bg-rose-500/10",
  links: [
    { label: "Soluciones para grupos", href: "/soluciones/grupos-restauracion", description: "Cómo Winerim ayuda a grupos multiunidad a gobernar la categoría vino" },
    { label: "Winerim Core", href: "/producto/winerim-core", description: "Motor analítico con benchmarking interno, desviaciones y scoring por local" },

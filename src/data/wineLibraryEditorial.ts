...
const grapeEditorialProfiles: Record<string, EditorialProfileSeed> = {
  ...
  graciano: {
    ...
    priority: 31,
    serviceTemp: "15-17 C",
    glass: "Rioja / Burdeos amplia",
    decanting: "30-45 min si es monovarietal joven o con crianza",
    listRole: "sommelierDiscovery",
    cue: "regionFirst",
    margin: "handSellDiscovery",
    avoid: "tooYoung",
    menuHooks: ["roastedLamb", "grilledMeat", "agedCheese"],
  },
  muscadet: {
    slug: "muscadet",
    priority: 32,
    ...
    margin: "byGlassVelocity",
    avoid: "genericHouseWhite",
    menuHooks: ["shellfish", "whiteFish", "ceviche"],
  },
  semillon: {
    slug: "semillon",
    priority: 33,
    serviceTemp: "8-11 C",
    glass: "Blanco con volumen / universal amplia",
    decanting: "10-20 min en secos con crianza o reduccion",
    listRole: "premiumWhite",
    cue: "textureMinerality",
    margin: "premiumStep",
    avoid: "unspecifiedOak",
    menuHooks: ["poultry", "butterSauce", "blueCheese"],
  },
  assyrtiko: {
    slug: "assyrtiko",
    priority: 34,
    serviceTemp: "8-10 C",
    glass: "Blanco mineral / universal",
    decanting: "No decantar; servir con frio estable",
    listRole: "sommelierDiscovery",
    cue: "freshnessSalinity",
    margin: "handSellDiscovery",
    avoid: "warmService",
    menuHooks: ["shellfish", "whiteFish", "salads"],
  },
  vermentino: {
    slug: "vermentino",
    priority: 35,
    serviceTemp: "8-10 C",
    glass: "Blanco mediterraneo / universal",
    decanting: "No decantar; proteger frescura y salinidad",
    listRole: "seafoodWhite",
    cue: "freshnessSalinity",
    margin: "byGlassVelocity",
    avoid: "genericHouseWhite",
    menuHooks: ["shellfish", "whiteFish", "tapas"],
  },
  carmenere: {
    slug: "carmenere",
    priority: 36,
    serviceTemp: "15-17 C",
    glass: "Burdeos / universal amplia",
    decanting: "20-40 min si tiene crianza o perfil vegetal marcado",
    listRole: "mediterraneanRed",
    cue: "regionFirst",
    margin: "handSellDiscovery",
    avoid: "sameProfile",
    menuHooks: ["grilledMeat", "pork", "asianSpice"],
  },
  tannat: {
    slug: "tannat",
    priority: 37,
    serviceTemp: "16-18 C",
    glass: "Burdeos amplia",
    decanting: "45-75 min en vinos jovenes o estructurados",
    listRole: "premiumGlobalRed",
    cue: "structure",
    margin: "handSellDiscovery",
    avoid: "tooYoung",
  ...
  "petit-verdot": {
    ...
    serviceTemp: "16-18 C",
    glass: "Burdeos amplia",
    decanting: "45-60 min si es monovarietal concentrado",
    listRole: "premiumGlobalRed",
    cue: "structure",
    margin: "premiumStep",
    avoid: "tooYoung",
    menuHooks: ["steak", "grilledMeat", "mushrooms"],
  },
  torrontes: {
    slug: "torrontes",
    priority: 39,
    serviceTemp: "7-9 C",
    glass: "Blanco aromatico",
    decanting: "No decantar; servir frio y proteger aromas",
    listRole: "aromaticWhite",
    cue: "aromaticFreshness",
    margin: "handSellDiscovery",
    avoid: "sameProfile",
    menuHooks: ["asianSpice", "salads", "ceviche"],
  },
  corvina: {
    slug: "corvina",
    priority: 40,
    serviceTemp: "15-17 C",
    glass: "Borgona / universal amplia",
    decanting: "30-60 min en Amarone, Ripasso o vinos con appassimento",
    listRole: "premiumGlobalRed",
    cue: "regionFirst",
    margin: "knownPremium",
    avoid: "alcoholOverweight",
    menuHooks: ["duck", "mushrooms", "blueCheese"],
  },
};

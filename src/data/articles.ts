...
Con el vino, es importante el diálogo con uno mismo y la experiencia en soledad sin interrupciones.`,
  ...
  "alex-peiro": {
    ...
    body: `Originario de Palafrugell, Àlex Peiró tiene el restaurante en la sangre desde pequeño. Hoy es el responsable de elevar la experiencia gastronómica del comensal en Restaurante Casamar, donde la carta de vinos funciona como una prolongación natural de la cocina, del territorio y del ritmo de sala.

...
const es: PresentationContent = {
  ...
  sPainsItems: [
    { pain: "La sala recomienda menos de lo que podría.", antidote: "Notas de cata, maridajes y argumentarios listos para que sumiller y sala vendan más." },
    { pain: "El comensal se bloquea al elegir.", antidote: "Filtros sensoriales y comparador de vinos para encontrar su vino en segundos." },
    { pain: "Maridajes fallidos arruinan el plato.", antidote: "Sugerencia plato ↔ vino basada en ingredientes, técnica y carta real." },
    { pain: "Carta y stock no se hablan.", antidote: "Inventario en tiempo real conectado a la carta que ve el cliente." },
    { pain: "Botellas que nunca se mueven.", antidote: "Detecta vinos dormidos y propone cómo darles salida." },
  ],
  ...
  s5Items: [
    ...
    { title: "Sala y sumiller más fuertes", body: "Tu equipo recomienda con datos vivos, fichas actualizadas y maridajes a mano." },
    { title: "Más venta sugerida", body: "Destaca las referencias que más interesan al restaurante en cada mesa." },
    ...
    { title: "Más conversión", body: "Menos dudas en mesa, más botellas vendidas." },
  ],
  ...
  s7Pillars: [
    ...
    { title: "Maridaje automático", body: "Recomienda el vino perfecto para cada plato según ingredientes y técnica." },
    ...
    { title: "Gestión de stock", body: "Inventario vivo, avisos cuando faltan botellas y propuestas de pedido." },
    { title: "Pricing y márgenes", body: "Ajusta precios y márgenes con datos de venta reales." },
  ],
  ...
  s8PairingBody: "Recomienda el vino perfecto para cada plato considerando ingredientes, técnica y preferencias. Una herramienta que tu sumiller y tu sala usan en cada servicio.",
  ...
  s10Items: [
    ...
    { title: "Avisos de stock", body: "Te avisamos cuando quedan pocas botellas." },
    { title: "Mejor rotación", body: "Mantén los vinos rentables siempre en carta." },
    { title: "Pedidos automatizados", body: "Sin desabastecimiento ni sobrestock." },
    { title: "Mejor rentabilidad", body: "Sugerencias basadas en lo que de verdad se vende." },
  ],
  ...
  sMgmtItems: [
    { title: "Un solo panel", body: "Carta, stock, precios, márgenes y rendimiento del equipo en una sola vista." },
    { title: "Inteligencia dinámica", body: "Recomendaciones que se recalculan cada día según ventas reales, estacionalidad y demanda." },
    { title: "Avisos a tiempo", body: "Vinos sin rotación, caídas de margen o referencias agotadas: te enteras antes del servicio." },
    ...
    { title: "Sala y sumiller al día", body: "Notas de cata, maridajes y argumentarios siempre actualizados, listos para usar en mesa." },
  ...
  s12Steps: [
    { title: "App", body: "Carta y bodega en el móvil del comensal y del equipo, en cualquier momento." },
    { title: "Tablet", body: "La herramienta de sala: ficha del vino, maridaje y stock al instante." },
    { title: "QR", body: "Acceso directo desde la mesa, sin instalar nada." },
    { title: "Web", body: "Carta navegable desde cualquier navegador, en cualquier dispositivo." },
  ],
  s13Eyebrow: "Clientes",
  ...
  sPricingTitle: "Compara los planes",
  sPricingSubtitle: "Los precios de Winerim se adaptan al número de referencias de tu carta y al número de locales. Solicita una propuesta personalizada sin compromiso.",
  sPricingPlans: [
    {
      name: "Starter",
      badge: "PLAN LEGACY",
      ...
      features: [
        ...
        "Fichas de vino con foto y notas",
    ...
    },
    {
      ...
      fits: "Para restaurantes con ambición y cartas con profundidad.",
      features: [
    ...
    },
    {
      ...
      solves: "Resuelve: inconsistencia entre locales, falta de benchmarking, decisiones de compra débiles.",
      ...
      features: [
        ...
        "Reporting ejecutivo consolidado",
        "API personalizada",
...
const en: PresentationContent = {
  ...
  sPainsItems: [
    { pain: "Floor staff recommends less than they could.", antidote: "Tasting notes, pairings and talking points ready so sommelier and floor sell more." },
    { pain: "Diners freeze when choosing.", antidote: "Sensory filters and a comparator that finds their wine in seconds." },
    { pain: "Failed pairings ruin the dish.", antidote: "Dish-to-wine suggestions based on ingredients, technique and your real list." },
    { pain: "Menu and stock don't talk.", antidote: "Real-time inventory connected to the menu the guest sees." },
    { pain: "Bottles that never move.", antidote: "Detects dormant references and proposes how to move them." },
  ],
  ...
  s5Items: [
    ...
    { title: "A stronger floor and sommelier", body: "Your team recommends with live data, up-to-date wine sheets and pairings on hand." },
    { title: "More suggestive selling", body: "Surface the references the restaurant cares about, table by table." },
    ...
    { title: "Higher conversion", body: "Fewer doubts at the table, more bottles sold." },
  ],
  ...
  s7Pillars: [
    ...
    { title: "Automatic pairing", body: "Picks the perfect wine for every dish based on ingredients and technique." },
    ...
    { title: "Stock management", body: "Live inventory, low-stock warnings and order suggestions." },
    { title: "Pricing & margins", body: "Adjust prices and margins with real sales data." },
  ],
  s8Eyebrow: "Features",
  ...
  s8PairingBody: "Recommends the perfect wine for every dish based on ingredients, technique and preferences. A tool your sommelier and floor use in every service.",
  s9Eyebrow: "Features",
  ...
  s10Items: [
    ...
    { title: "Stock warnings", body: "We notify you when bottles are running low." },
    { title: "Better rotation", body: "Keep profitable wines always on the list." },
    { title: "Automated ordering", body: "No stockouts, no overstock." },
    { title: "Better profitability", body: "Suggestions based on what actually sells." },
  ],
  ...
  sMgmtItems: [
    { title: "One single panel", body: "Menu, stock, prices, margins and team performance in a single view." },
    { title: "Dynamic intelligence", body: "Recommendations recalculated daily from real sales, seasonality and demand." },
    { title: "Warnings on time", body: "Slow-moving wines, margin drops or out-of-stock labels: you find out before service." },
    ...
    { title: "Floor and sommelier ready", body: "Tasting notes, pairings and talking points always up to date, ready to use at the table." },
  ...
  s12Steps: [
    { title: "App", body: "List and cellar on the diner's and team's phone, anytime." },
    { title: "Tablet", body: "The floor tool: wine sheet, pairing and stock at a glance." },
    { title: "QR", body: "Direct access from the table, no install required." },
    { title: "Web", body: "List browsable from any browser, on any device." },
  ],
  s13Eyebrow: "Clients",
  ...
  sPricingTitle: "Compare the plans",
  sPricingSubtitle: "Winerim pricing adapts to the number of references on your list and the number of venues. Request a tailored proposal — no commitment.",
  sPricingPlans: [
    {
      name: "Starter",
      badge: "LEGACY PLAN",
      tagline: "Your wine list, digitized and professional",
      solves: "Solves: static list, scattered information, poor wine image.",
      fits: "For legacy clients and restaurants with simple operations.",
      features: [
        "Interactive digital list with filters",
        "Wine fiches with photo and notes",
        "Custom QR for the floor",
        "Guest mobile access",
    ...
    },
    {
      ...
      tagline: "Analyze better. Sell better.",
      solves: "Solves: low average ticket, slow rotation, weak pricing, uninformed decisions.",
      fits: "For ambitious restaurants with deep wine lists.",
      features: [
        "Everything in Starter",
        "Real-time sales analytics",
        "Pricing & margin optimization",
        "Interactive Wine Mapping",
        "Wine comparator for guests",
        "By-the-glass optimization",
        "Rotation & dead stock alerts",
    ...
    },
    {
      name: "Enterprise",
      badge: "INTELLIGENCE SUITE",
      tagline: "Govern sales, purchasing and assortment with full intelligence",
      solves: "Solves: inconsistency across venues, lack of benchmarking, weak purchasing decisions.",
      fits: "For hospitality groups, hotel chains and multi-unit operations.",
      features: [
        "Everything in Pro",
        "Winerim Core Full",
        "Full Dynamic Intelligence",
        "Full Winerim Supply",
        "Centralized multi-venue panel",
        "Cross-venue benchmarking",
        "Advanced POS & PMS integrations",
...
const fr: PresentationContent = {
  ...
  sPricingTitle: "Comparez les formules",
  sPricingSubtitle: "Les tarifs de Winerim s'adaptent au nombre de références de votre carte et au nombre d'établissements. Demandez une proposition personnalisée sans engagement.",
  sPricingPlans: [
    {
      name: "Starter",
      badge: "PLAN LEGACY",
      tagline: "Votre carte, digitalisée et professionnelle",
      solves: "Résout : carte statique, information dispersée, image pauvre du vin.",
      fits: "Pour clients legacy et restaurants avec opération simple.",
      features: [
        "Carte digitale interactive avec filtres",
        "Fiches de vin avec photo et notes",
        "QR personnalisé pour la salle",
        "Accès depuis le mobile du client",
    ...
    {
      name: "Pro",
      badge: "PLAN COMMERCIAL",
      tagline: "Mieux analyser. Mieux vendre.",
      solves: "Résout : ticket moyen bas, rotation lente, pricing faible, décisions peu informées.",
      fits: "Pour restaurants ambitieux avec cartes approfondies.",
      features: [
        "Tout du plan Starter",
        "Analytique de ventes en temps réel",
        "Optimisation des prix et marges",
        "Wine Mapping interactif",
        "Comparateur de vins pour le client",
        "Optimisation du vin au verre",
        "Alertes de rotation et stock mort",
    ...
    },
    {
      name: "Enterprise",
      badge: "INTELLIGENCE SUITE",
      tagline: "Gouvernez les ventes, achats et assortiment avec intelligence complète",
      solves: "Résout : incohérence entre établissements, manque de benchmarking, décisions d'achat faibles.",
      fits: "Pour groupes de restauration, chaînes hôtelières et opérations multi-sites.",
      features: [
        "Tout du plan Pro",
        "Winerim Core Full",
        "Intelligence Dynamique complète",
        "Winerim Supply complet",
        "Multi-sites centralisé",
        "Benchmarking entre unités",
        "Intégrations POS et PMS avancées",
        "Reporting exécutif consolidé",
        "API personnalisée",
        "Onboarding dédié et account manager",
        "SLA garanti",
      ],
      cta: "Nous contacter",
    },
...
const it: PresentationContent = {
  ...
  sPricingTitle: "Confronta i piani",
  sPricingSubtitle: "I prezzi di Winerim si adattano al numero di referenze della tua carta e al numero di locali. Richiedi una proposta personalizzata senza impegno.",
  sPricingPlans: [
    {
      name: "Starter",
      badge: "PIANO LEGACY",
      tagline: "La tua carta, digitalizzata e professionale",
      solves: "Risolve: carta statica, informazioni disperse, immagine povera del vino.",
      fits: "Per clienti legacy e ristoranti con operativa semplice.",
      features: [
        "Carta digitale interattiva con filtri",
        "Schede vino con foto e note",
        "QR personalizzato per la sala",
        "Accesso dal mobile del cliente",
    ...
    {
      name: "Pro",
      badge: "PIANO COMMERCIALE",
      tagline: "Analizza meglio. Vendi meglio.",
      solves: "Risolve: ticket medio basso, rotazione lenta, pricing debole, decisioni poco informate.",
      fits: "Per ristoranti ambiziosi con carte approfondite.",
      features: [
        "Tutto del piano Starter",
        "Analitica vendite in tempo reale",
        "Ottimizzazione prezzi e margini",
        "Wine Mapping interattivo",
        "Comparatore vini per il cliente",
        "Ottimizzazione vino al bicchiere",
        "Alert rotazione e stock morto",
        "Raccomandazioni intelligenti contestuali",
    ...
    },
    {
      name: "Enterprise",
      badge: "INTELLIGENCE SUITE",
      tagline: "Governare vendita, acquisto e assortimento con intelligenza completa",
      solves: "Risolve: incoerenza tra locali, mancanza di benchmarking, decisioni di acquisto deboli.",
      fits: "Per gruppi di ristorazione, catene alberghiere e operazioni multi-unità.",
      features: [
        "Tutto del piano Pro",
        "Winerim Core Full",
        "Intelligenza Dinamica completa",
        "Winerim Supply completo",
        "Multi-locale centralizzato",
        "Benchmarking tra unità",
        "Integrazioni POS e PMS avanzate",
        "Reporting esecutivo consolidato",
        "API personalizzata",
        "Onboarding dedicato e account manager",
        "SLA garantito",
      ],
      cta: "Contattaci",
    },
...
const de: PresentationContent = {
  ...
  sPricingTitle: "Vergleichen Sie die Pläne",
  sPricingSubtitle: "Die Winerim-Preise passen sich der Anzahl der Referenzen auf Ihrer Karte und der Anzahl der Standorte an. Fordern Sie ein unverbindliches, maßgeschneidertes Angebot an.",
  sPricingPlans: [
    {
      name: "Starter",
      badge: "LEGACY-PLAN",
      tagline: "Ihre Karte, digitalisiert und professionell",
      solves: "Löst: statische Karte, verstreute Informationen, schlechtes Wein-Image.",
      fits: "Für Legacy-Kunden und Restaurants mit einfachem Betrieb.",
      features: [
        "Interaktive digitale Karte mit Filtern",
        "Wein-Steckbriefe mit Foto und Notizen",
        "Individueller QR-Code für den Service",
        "Zugriff vom Handy des Gastes",
    ...
    },
    {
      name: "Pro",
      badge: "COMMERCIAL-PLAN",
      tagline: "Besser analysieren. Besser verkaufen.",
      solves: "Löst: niedriger Durchschnittsumsatz, langsame Rotation, schwache Preisgestaltung, uninformierte Entscheidungen.",
      fits: "Für ehrgeizige Restaurants mit umfangreichen Karten.",
      features: [
        "Alles aus dem Starter-Plan",
        "Echtzeit-Verkaufsanalysen",
        "Preis- und Margenoptimierung",
        "Interaktives Wine Mapping",
        "Wein-Vergleich für Gäste",
        "Optimierung des Weins beim Glas",
        "Rotations- und toter Bestand-Alarme",
        "Kontextabhängige intelligente Empfehlungen",
        "Prioritäts-Support",
      ],
      cta: "Demo anfragen",
      highlight: true,
    },
    {
      name: "Enterprise",
      badge: "INTELLIGENCE SUITE",
      tagline: "Verkauf, Einkauf und Sortiment mit vollständiger Intelligenz steuern",
      solves: "Löst: Inkonsistenz zwischen Standorten, mangelndes Benchmarking, schwache Einkaufsentscheidungen.",
      fits: "Für Gastronomiegruppen, Hotelketten und Multi-Standort-Betriebe.",
      features: [
        "Alles aus dem Pro-Plan",
        "Winerim Core Full",
        "Vollständige dynamische Intelligenz",
        "Vollständiges Winerim Supply",
        "Zentralisiertes Multi-Standort-Panel",
        "Benchmarking zwischen Standorten",
        "Erweiterte POS- und PMS-Integrationen",
        "Konsolidierte Executive-Reports",
        "Individuelle API",
        "Dediziertes Onboarding und Account Manager",
        "Garantierte SLA",
      ],
      cta: "Kontaktieren",
    },
...
const pt: PresentationContent = {
  ...
  sPricingTitle: "Compare os planos",
  sPricingSubtitle: "Os preços da Winerim adaptam-se ao número de referências da sua carta e ao número de locais. Solicite uma proposta personalizada sem compromisso.",
  sPricingPlans: [
    {
      name: "Starter",
      badge: "PLANO LEGACY",
      tagline: "A sua carta, digitalizada e profissional",
      solves: "Resolve: carta estática, informação dispersa, imagem pobre do vinho.",
      fits: "Para clientes legacy e restaurantes com operativa simples.",
      features: [
        "Carta digital interativa com filtros",
        "Fichas de vinho com foto e notas",
        "QR personalizado para a sala",
        "Acesso do mobile do cliente",
    ...
    },
    {
      ...
      tagline: "Analise melhor. Venda melhor.",
      solves: "Resolve: ticket médio baixo, rotação lenta, pricing fraco, decisões pouco informadas.",
      fits: "Para restaurantes ambiciosos com cartas com profundidade.",
      features: [
        "Tudo do plano Starter",
        "Analítica de vendas em tempo real",
        "Otimização de preços e margens",
        "Wine Mapping interativo",
        "Comparador de vinhos para o cliente",
        "Otimização do vinho por copo",
        "Alertas de rotação e stock morto",
    ...
    },
    {
      name: "Enterprise",
      badge: "INTELLIGENCE SUITE",
      tagline: "Governe venda, compra e surtido com inteligência completa",
      solves: "Resolve: inconsistência entre locais, falta de benchmarking, decisões de compra fracas.",
      fits: "Para grupos de restauração, cadeias hoteleiras e operações multiunidade.",
      features: [
        "Tudo do plano Pro",
        "Winerim Core Full",
        "Inteligência Dinâmica completa",
        "Winerim Supply completo",
        "Multi-local centralizado",
        "Benchmarking entre unidades",
        "Integrações POS e PMS avançadas",
        "Reporting executivo consolidado",
        "API personalizada",

...
-- Allow admins/editors to upload files
...
-- Allow admins/editors to update files
...
-- Allow admins/editors to delete files
...
-- Allow public read access (images displayed on website)

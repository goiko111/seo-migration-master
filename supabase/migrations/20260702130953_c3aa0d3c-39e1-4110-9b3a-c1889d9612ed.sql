-- Blog cadence: schedule weekly Mondays + enrich editorial appendices across all languages
-- Combined migrations 20260702090000 and 20260702124500
...
-- Note: editorial appendix enrichment block from 20260702124500 is data-only and long;
-- run it separately via the insert tool after this migration is approved.

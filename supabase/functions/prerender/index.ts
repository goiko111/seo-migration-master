...
const STATIC_PAGE_LABELS: Record<string, Record<WineLibraryLang, string>> = {
  ...
  '/herramientas/calculadora-precio-vino-por-copa': { es: 'Calculadora de precio por copa', en: 'Wine by-the-glass price calculator', it: 'Calcolatrice prezzo vino al calice', fr: 'Calculateur prix vin au verre', de: 'Glaspreis-Rechner', pt: 'Calculadora preco vinho por copo' },
  ...
  '/herramientas/calculadora-ticket-medio-vino': { es: 'Calculadora de ticket medio de vino', en: 'Average wine ticket calculator', it: 'Calcolatrice scontrino medio vino', fr: 'Calculateur ticket moyen vin', de: 'Durchschnittsbon-Rechner', pt: 'Calculadora de ticket medio' },

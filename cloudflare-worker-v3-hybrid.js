...
const STATIC_WORKER_PRERENDER_PAGES = {
  ...
  '/en/learn-wine': {
    ...
    sections: [
      ...
      ['Published guides', 'Learn Wine links tasting, vocabulary, pairings, wine types, beginner grapes and wine regions for restaurant service.'],
    ],
    links: [['Wine Library', '/en/wine-library'], ['Glossary', '/en/wine-library/glossary'], ['Pairings', '/en/wine-library/pairings'], ['Taste wine in five steps', '/en/article/how-to-taste-wine-in-five-steps'], ['Tasting vocabulary', '/en/article/wine-tasting-vocabulary'], ['Basic pairings', '/en/article/basic-food-and-wine-pairing-for-restaurants'], ['Wine types', '/en/article/types-of-wine-restaurant-wine-list'], ['Grapes to know', '/en/article/grapes-to-know-when-starting-with-wine'], ['Wine regions', '/en/article/wine-regions-to-know-for-restaurant-service'], ['Analyze list', '/en/wine-list-analysis']],
  },
  '/it/imparare-il-vino': {
    lang: 'it',
    ...
    sections: [
      ...
      ['Guide pubblicate', 'Imparare il vino collega degustazione, vocabolario, abbinamenti, tipi di vino, vitigni e regioni per la sala.'],
    ],
    links: [['Biblioteca', '/it/biblioteca-vino'], ['Glossario', '/it/biblioteca-vino/glossario'], ['Abbinamenti', '/it/biblioteca-vino/abbinamenti'], ['Degustare in cinque passaggi', '/it/article/come-degustare-il-vino-in-cinque-passaggi'], ['Vocabolario degustazione', '/it/article/vocabolario-degustazione-vino'], ['Abbinamenti base', '/it/article/abbinamenti-base-cibo-vino-per-ristoranti'], ['Tipi di vino', '/it/article/tipi-di-vino-per-capire-una-carta'], ['Vitigni per iniziare', '/it/article/vitigni-da-conoscere-per-iniziare'], ['Regioni vinicole', '/it/article/regioni-vinicole-da-conoscere-in-ristorante'], ['Analisi carta', '/it/analisi-carta']],
  },
  '/fr/apprendre-le-vin': {
    lang: 'fr',
  ...
  '/pt/aprender-vinho': {
    ...
    sections: [
      ...
      ['Guias publicados', 'Aprender vinho liga prova, vocabulario, harmonizacoes, tipos de vinho, castas e regioes para a sala.'],
    ],
    links: [['Biblioteca', '/pt/biblioteca-vinho'], ['Glossario', '/pt/biblioteca-vinho/glossario'], ['Harmonizacoes', '/pt/biblioteca-vinho/harmonizacoes'], ['Provar em cinco passos', '/pt/article/como-provar-vinho-em-cinco-passos'], ['Vocabulario de prova', '/pt/article/vocabulario-de-prova-de-vinho'], ['Harmonizacoes basicas', '/pt/article/harmonizacoes-basicas-para-restaurantes'], ['Tipos de vinho', '/pt/article/tipos-de-vinho-para-entender-uma-carta'], ['Castas para comecar', '/pt/article/castas-para-conhecer-ao-comecar'], ['Regioes vinicolas', '/pt/article/regioes-vinicolas-para-conhecer-em-restaurante'], ['Analise carta', '/pt/analise-carta']],
  },
  '/integraciones': {
    lang: 'es',

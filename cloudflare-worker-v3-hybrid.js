...
const STATIC_WORKER_PRERENDER_PAGES = {
  ...
  '/aprender-vino': {
    ...
    sections: [
      ...
      ['Primeras guias publicadas', 'La primera oleada enlaza como catar vino en cinco pasos, vocabulario de cata y maridajes basicos para restaurantes.'],
    ],
    links: [['Biblioteca', '/biblioteca-vino'], ['Glosario', '/biblioteca-vino/glosario'], ['Maridajes', '/biblioteca-vino/maridajes'], ['Catar vino en cinco pasos', '/article/como-catar-vino-en-cinco-pasos'], ['Vocabulario de cata', '/article/vocabulario-de-cata-de-vino'], ['Maridajes basicos', '/article/maridajes-basicos-para-restaurantes'], ['Analizar carta', '/analisis-carta']],
  },
  '/en/learn-wine': {
    lang: 'en',
    ...
    sections: [
      ...
      ['First published guides', 'The first Learn Wine wave links how to taste wine in five steps, wine tasting vocabulary and basic food and wine pairing for restaurants.'],
    ],
    links: [['Wine Library', '/en/wine-library'], ['Glossary', '/en/wine-library/glossary'], ['Pairings', '/en/wine-library/pairings'], ['Taste wine in five steps', '/en/article/how-to-taste-wine-in-five-steps'], ['Tasting vocabulary', '/en/article/wine-tasting-vocabulary'], ['Basic pairings', '/en/article/basic-food-and-wine-pairing-for-restaurants'], ['Analyze list', '/en/wine-list-analysis']],
  },
  '/it/imparare-il-vino': {
    lang: 'it',
  ...
  '/fr/apprendre-le-vin': {
    ...
    sections: [
      ...
      ['Premiers guides publies', 'La premiere vague relie comment deguster le vin en cinq etapes, vocabulaire de degustation et accords mets-vins de base pour restaurants.'],
    ],
    links: [['Bibliotheque', '/fr/bibliotheque-vin'], ['Glossaire', '/fr/bibliotheque-vin/glossaire'], ['Accords', '/fr/bibliotheque-vin/accords'], ['Deguster en cinq etapes', '/fr/article/comment-deguster-le-vin-en-cinq-etapes'], ['Vocabulaire de degustation', '/fr/article/vocabulaire-de-degustation-du-vin'], ['Accords de base', '/fr/article/accords-mets-vins-de-base-pour-restaurants'], ['Analyse carte', '/fr/analyse-carte']],
  },
  '/de/wein-lernen': {
    lang: 'de',

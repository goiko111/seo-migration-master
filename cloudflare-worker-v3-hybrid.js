...
const STATIC_WORKER_PRERENDER_PAGES = {
  ...
  '/presentacion': {
    ...
    description: 'Winerim conecta carta, TPV, stock, compras, margenes, CloudRIM, SAVia, RIMs, Wine Cellar y Wine Lockers para operar el vino con datos.',
    h1: 'La reVINOlucion de la carta de vinos',
    subtitle: 'Inteligencia dinamica para vender mas vino, controlar mejor la bodega y dar una experiencia memorable.',
    canonical: '/presentacion',
    schemaType: 'WebPage',
    alternates: PRESENTATION_ALTERNATES,
    sections: [
      ['Una carta que ayuda a elegir', 'Notas de cata, maridaje automatico, filtros sensoriales y comparador reducen las dudas del comensal y dan mejores argumentos a sala y sumiller.'],
      ['CloudRIM: del documento al dato operativo', 'Recibe cartas, albaranes, facturas, tarifas, ventas y stock; identifica origen y tipo, extrae la informacion, la enruta y mantiene trazabilidad.'],
      ['Winerim Core: carta y bodega conectadas', 'Core mantiene una referencia para carta, stock y bodega fisica. Wine Cellar ubica cada botella y Wine Lockers controla las botellas privadas de clientes.'],
      ['Margenes: proteger rentabilidad', 'Cruza coste real, PVP, copa, rotacion y stock para detectar erosion, capital inmovilizado y escenarios de pricing antes de cambiar la carta.'],
      ['Winerim Supply: comprar con criterio', 'Compara tarifas, disponibilidad y demanda para preparar reposicion, negociacion y pedidos con contexto de stock y margen.'],
      ['RIMs: motores especializados', 'MarginRIM, StockRIM, FocusRIM, ClimateRIM, CleanRIM y SmartRIM convierten senales de negocio en propuestas concretas.'],
      ['SAVia: preguntar antes de actuar', 'SAVia explica evidencia, impacto y alternativas, prepara un preview y mantiene los cambios criticos sujetos a aprobacion humana.'],
      ['Para quien es', 'Restaurantes, hoteles, wine bars y grupos que quieren una operacion de vino mas rentable, trazable, actualizada y facil de gobernar.'],
    ],
    links: [['Demo', '/demo'], ['Producto', '/software-carta-de-vinos'], ['Funcionalidades', '/funcionalidades'], ['Analizar carta', '/analisis-carta']],
  },
  '/en/presentation': {
    lang: 'en',
    title: 'Winerim Presentation | The wine operating system',
    description: 'Winerim connects wine list, POS, stock, purchasing, margins, CloudRIM, SAVia, RIMs, Wine Cellar and Wine Lockers in one operating system.',
    h1: 'The reVINOlution of the wine list',
    subtitle: 'Dynamic intelligence to sell more wine, manage the cellar in real time and create a memorable experience.',
    canonical: '/en/presentation',
    schemaType: 'WebPage',
    alternates: PRESENTATION_ALTERNATES,
    sections: [
      ['A list that helps guests choose', 'Tasting notes, automatic pairing, sensory filters and wine comparison reduce doubt and give the floor and sommelier stronger selling arguments.'],
      ['CloudRIM: from document to operating data', 'Receives lists, delivery notes, invoices, catalogues, sales and stock; identifies source and type, extracts, routes and preserves traceability.'],
      ['Winerim Core: connected list and cellar', 'Core maintains one reference for the list, stock and physical cellar. Wine Cellar locates every bottle and Wine Lockers tracks private guest bottles.'],
      ['Margins: protect profitability', 'Combines true cost, selling price, glass, rotation and stock to detect erosion, tied-up capital and pricing scenarios before the list changes.'],
      ['Winerim Supply: purchase with criteria', 'Compares catalogues, availability and demand to prepare replenishment, negotiation and orders with stock and margin context.'],
      ['RIMs: specialist engines', 'MarginRIM, StockRIM, FocusRIM, ClimateRIM, CleanRIM and SmartRIM turn business signals into concrete proposals.'],
      ['SAVia: ask before acting', 'SAVia explains evidence, impact and alternatives, prepares a preview and keeps critical changes subject to human approval.'],
      ['Who it is for', 'Restaurants, hotels, wine bars and groups that want a more profitable, traceable, current and easier-to-govern wine operation.'],
    ],
    links: [['Demo', '/en/demo'], ['Product', '/en/wine-list-management-software'], ['Features', '/en/features'], ['Analyze wine list', '/en/wine-list-analysis']],
  },
  '/it/presentazione': {
    lang: 'it',
    title: 'Presentazione Winerim | Il sistema operativo del vino',
    description: 'Winerim collega carta, POS, stock, acquisti, margini, CloudRIM, SAVia, RIMs, Wine Cellar e Wine Lockers.',
    h1: 'La reVINOluzione della carta dei vini',
    subtitle: 'Intelligenza dinamica per vendere piu vino, gestire la cantina in tempo reale e creare un esperienza memorabile.',
    canonical: '/it/presentazione',
    schemaType: 'WebPage',
    alternates: PRESENTATION_ALTERNATES,
    sections: [
      ['Una carta che aiuta a scegliere', 'Note di degustazione, abbinamento automatico, filtri sensoriali e comparatore riducono i dubbi e rafforzano la vendita in sala.'],
      ['CloudRIM: dal documento al dato operativo', 'Riceve carte, bolle, fatture, listini, vendite e stock; identifica origine e tipo, estrae, instrada e conserva la tracciabilita.'],
      ['Winerim Core: carta e cantina connesse', 'Core mantiene una referenza per carta, stock e cantina fisica. Wine Cellar localizza ogni bottiglia e Wine Lockers traccia quelle private dei clienti.'],
      ['Margini: proteggere la redditivita', 'Incrocia costo reale, prezzo, calice, rotazione e stock per rilevare erosione, capitale immobilizzato e scenari prima dei cambi.'],
      ['Winerim Supply: acquistare con criterio', 'Confronta listini, disponibilita e domanda per preparare riordino, negoziazione e ordini con contesto di stock e margine.'],
      ['RIMs: motori specializzati', 'MarginRIM, StockRIM, FocusRIM, ClimateRIM, CleanRIM e SmartRIM trasformano segnali di business in proposte concrete.'],
      ['SAVia: chiedere prima di agire', 'SAVia spiega evidenze, impatto e alternative, prepara un anteprima e mantiene i cambi critici soggetti ad approvazione umana.'],
      ['Per chi e', 'Ristoranti, hotel, wine bar e gruppi che vogliono una gestione del vino piu redditizia, tracciabile, aggiornata e governabile.'],
    ],
    links: [['Demo', '/it/demo'], ['Prodotto', '/it/software-carta-vini'], ['Funzionalita', '/it/funzionalita'], ['Analisi carta', '/it/analisi-carta']],
  },
  '/fr/presentation': {
    lang: 'fr',
    title: 'Presentation Winerim | Le systeme dexploitation du vin',
    description: 'Winerim relie carte, caisse, stock, achats, marges, CloudRIM, SAVia, RIMs, Wine Cellar et Wine Lockers.',
    h1: 'La reVINOlution de la carte des vins',
    subtitle: 'Intelligence dynamique pour vendre plus de vin, gerer la cave en temps reel et creer une experience memorable.',
    canonical: '/fr/presentation',
    schemaType: 'WebPage',
    alternates: PRESENTATION_ALTERNATES,
    sections: [
      ['Une carte qui aide a choisir', 'Notes de degustation, accords automatiques, filtres sensoriels et comparateur reduisent les hesitations et renforcent les arguments de la salle.'],
      ['CloudRIM : du document a la donnee operationnelle', 'Recoit cartes, bons, factures, tarifs, ventes et stocks; identifie source et type, extrait, route et conserve la tracabilite.'],
      ['Winerim Core : carte et cave connectees', 'Core maintient une reference pour carte, stock et cave physique. Wine Cellar localise chaque bouteille et Wine Lockers suit les bouteilles privees.'],
      ['Marges : proteger la rentabilite', 'Croise cout reel, prix, verre, rotation et stock pour detecter erosion, capital immobilise et scenarios avant les changements.'],
      ['Winerim Supply : acheter avec des criteres', 'Compare tarifs, disponibilite et demande pour preparer reassort, negociation et commandes avec contexte de stock et marge.'],
      ['RIMs : moteurs specialises', 'MarginRIM, StockRIM, FocusRIM, ClimateRIM, CleanRIM et SmartRIM transforment les signaux metier en propositions concretes.'],
      ['SAVia : interroger avant dagir', 'SAVia explique preuves, impact et alternatives, prepare un apercu et maintient les changements critiques soumis a validation humaine.'],
      ['Pour qui', 'Restaurants, hotels, bars a vin et groupes souhaitant une operation vin plus rentable, tracable, actuelle et facile a gouverner.'],
    ],
    links: [['Demo', '/fr/demo'], ['Produit', '/fr/logiciel-carte-des-vins'], ['Fonctionnalites', '/fr/fonctionnalites'], ['Analyse carte', '/fr/analyse-carte']],
  },
  '/de/praesentation': {
    lang: 'de',
    title: 'Winerim Praesentation | Das Betriebssystem fuer Wein',
    description: 'Winerim verbindet Weinkarte, Kasse, Bestand, Einkauf, Margen, CloudRIM, SAVia, RIMs, Wine Cellar und Wine Lockers.',
    h1: 'Die reVINOlution der Weinkarte',
    subtitle: 'Dynamische Intelligenz fuer mehr Weinverkauf, Kellersteuerung in Echtzeit und ein besonderes Erlebnis.',
    canonical: '/de/praesentation',
    schemaType: 'WebPage',
    alternates: PRESENTATION_ALTERNATES,
    sections: [
      ['Eine Karte, die bei der Auswahl hilft', 'Verkostungsnotizen, automatische Pairings, sensorische Filter und Weinvergleich reduzieren Zweifel und staerken die Verkaufsargumente im Service.'],
      ['CloudRIM: vom Dokument zu operativen Daten', 'Empfaengt Karten, Lieferscheine, Rechnungen, Preislisten, Verkauf und Bestand; erkennt Quelle und Typ, extrahiert, routet und bewahrt Nachvollziehbarkeit.'],
      ['Winerim Core: verbundene Karte und Keller', 'Core verwaltet eine Referenz fuer Karte, Bestand und physischen Keller. Wine Cellar lokalisiert jede Flasche, Wine Lockers verfolgt private Flaschen.'],
      ['Margen: Rentabilitaet schuetzen', 'Verbindet echte Kosten, Preis, Glas, Rotation und Bestand, um Erosion, gebundenes Kapital und Preisszenarien vor Aenderungen zu erkennen.'],
      ['Winerim Supply: mit Kriterien einkaufen', 'Vergleicht Preislisten, Verfuegbarkeit und Nachfrage und bereitet Nachkauf, Verhandlung und Bestellung mit Bestands- und Margenkontext vor.'],
      ['RIMs: spezialisierte Engines', 'MarginRIM, StockRIM, FocusRIM, ClimateRIM, CleanRIM und SmartRIM machen aus Geschaeftssignalen konkrete Vorschlaege.'],
      ['SAVia: fragen, bevor gehandelt wird', 'SAVia erklaert Belege, Wirkung und Alternativen, bereitet eine Vorschau vor und laesst kritische Aenderungen menschlich freigeben.'],
      ['Fuer wen', 'Restaurants, Hotels, Weinbars und Gruppen, die einen profitableren, nachvollziehbaren, aktuellen und leichter steuerbaren Weinbetrieb wollen.'],
    ],
    links: [['Demo', '/de/demo'], ['Produkt', '/de/weinkarten-software'], ['Funktionen', '/de/funktionen'], ['Weinkarten-Analyse', '/de/weinkarten-analyse']],
  },
  '/pt/apresentacao': {
    lang: 'pt',
    title: 'Apresentacao Winerim | O sistema operativo do vinho',
    description: 'A Winerim liga carta, POS, stock, compras, margens, CloudRIM, SAVia, RIMs, Wine Cellar e Wine Lockers.',
    h1: 'A reVINOlução da carta de vinhos',
    subtitle: 'Inteligencia dinamica para vender mais vinho, gerir a garrafeira em tempo real e criar uma experiencia memoravel.',
    canonical: '/pt/apresentacao',
    schemaType: 'WebPage',
    alternates: PRESENTATION_ALTERNATES,
    sections: [
      ['Uma carta que ajuda a escolher', 'Notas de prova, harmonizacao automatica, filtros sensoriais e comparador reduzem duvidas e reforcam os argumentos da equipa de sala.'],
      ['CloudRIM: do documento ao dado operacional', 'Recebe cartas, guias, faturas, tabelas, vendas e stock; identifica origem e tipo, extrai, encaminha e preserva a rastreabilidade.'],
      ['Winerim Core: carta e garrafeira ligadas', 'Core mantem uma referencia para carta, stock e garrafeira fisica. Wine Cellar localiza cada garrafa e Wine Lockers acompanha as garrafas privadas.'],
      ['Margens: proteger a rentabilidade', 'Cruza custo real, preco, copo, rotacao e stock para detetar erosao, capital imobilizado e cenarios antes de alterar a carta.'],
      ['Winerim Supply: comprar com criterio', 'Compara tabelas, disponibilidade e procura para preparar reposicao, negociacao e pedidos com contexto de stock e margem.'],
      ['RIMs: motores especializados', 'MarginRIM, StockRIM, FocusRIM, ClimateRIM, CleanRIM e SmartRIM transformam sinais de negocio em propostas concretas.'],
      ['SAVia: perguntar antes de agir', 'SAVia explica evidencia, impacto e alternativas, prepara uma previa e mantem alteracoes criticas sujeitas a aprovacao humana.'],
      ['Para quem e', 'Restaurantes, hoteis, wine bars e grupos que querem uma operacao de vinho mais rentavel, rastreavel, atual e facil de governar.'],
    ],
